  ...
  Module Impl_core_clone_Clone_for_alloc_alloc_Global.
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "alloc::alloc::Global" ], self |) in
      ...
      | [], [], [ self; layout; zeroed ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "alloc::alloc::Global" ], self |) in
          let layout := M.alloc (| Ty.path "core::alloc::layout::Layout", layout |) in
          let zeroed := M.alloc (| Ty.path "bool", zeroed |) in
          M.catch_return
            (Ty.apply
              (Ty.path "core::result::Result")
              []
            ...
            ltac:(M.monadic
              (M.match_operator (|
                ...
                [
                  ...
                  fun γ =>
                    ltac:(M.monadic
                      (let size := M.copy (| Ty.path "usize", γ |) in
                      M.read (|
                ...
                M.alloc (|
                  ...
                  M.match_operator (|
                    ...
                    [
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          (let old_size := M.copy (| Ty.path "usize", γ |) in
                          let γ :=
                            M.alloc (|
                              Ty.path "bool",
                              M.call_closure (|
                                          ...
                                          M.call_closure (|
                                            ...
                                            [
                                              ...
                                              M.call_closure (|
                                                Ty.path "usize",
                                                BinOp.Wrap.sub,
                                                [ M.read (| new_size |); M.read (| old_size |) ]
                                              |)
                                            ]
                                          |) in
                                        M.alloc (| Ty.tuple [], Value.Tuple [] |)
                ...
                M.alloc (|
                  ...
                  M.match_operator (|
                    ...
                    [
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          (let new_size := M.copy (| Ty.path "usize", γ |) in
                          let γ :=
                            M.alloc (|
                              Ty.path "bool",
                              M.call_closure (|
  ...
  Module handle_alloc_error.
    ...
    *)
    Definition ct_error (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ β0 ] =>
        ltac:(M.monadic
          (let β0 := M.alloc (| Ty.path "core::alloc::layout::Layout", β0 |) in
          M.match_operator (|
            Ty.path "never",
            β0,
            [
                            ...
                            M.deref (|
                              M.borrow (|
                                ...
                                M.alloc (|
                                  ...
                                  Value.Array [ mk_str (| "allocation failed" |) ]
                                |)
                              |)
                            |)
                          |)
