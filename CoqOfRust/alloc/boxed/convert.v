      ...
      *)
      Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ cow ] =>
          ltac:(M.monadic
            (let cow :=
              M.alloc (| Ty.apply (Ty.path "alloc::borrow::Cow") [] [ Ty.path "str" ], cow |) in
            M.match_operator (|
              Ty.apply
                (Ty.path "alloc::boxed::Box")
                []
      ...
      *)
      Definition from (A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ s ] =>
          ltac:(M.monadic
            (let s :=
              M.alloc (| Ty.apply (Ty.path "alloc::boxed::Box") [] [ Ty.path "str"; A ], s |) in
            M.match_operator (|
              Ty.apply
                (Ty.path "alloc::boxed::Box")
                []
              ...
              [
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let raw := M.copy (| Ty.apply (Ty.path "*mut") [] [ Ty.path "str" ], γ0_0 |) in
    ...
    Module Impl_core_convert_From_alloc_string_String_for_alloc_boxed_Box_Dyn_core_error_Error_Trait_core_marker_Sync_AutoTrait_core_marker_Send_AutoTrait_alloc_alloc_Global.
      ...
      *)
      Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ err ] =>
          ltac:(M.monadic
            (let err := M.alloc (| Ty.path "alloc::string::String", err |) in
            (* Unsize *)
            M.pointer_coercion
              (* Unsize *)
              (M.pointer_coercion
    ...
    Module Impl_core_convert_From_alloc_string_String_for_alloc_boxed_Box_Dyn_core_error_Error_Trait_alloc_alloc_Global.
      ...
      *)
      Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ str_err ] =>
          ltac:(M.monadic
            (let str_err := M.alloc (| Ty.path "alloc::string::String", str_err |) in
            (* Unsize *)
            M.pointer_coercion
              (M.read (|
                let~ err1 :
                ...
                let~ err2 :
                  ...
                  (* Unsize *) M.pointer_coercion (M.read (| err1 |)) in
                M.alloc (|
                  Ty.apply
                    (Ty.path "alloc::boxed::Box")
                    []
                  ...
                  (* Unsize *) M.pointer_coercion (M.read (| err2 |))
                |)
              |))))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
      ...
      *)
      Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ err ] =>
          ltac:(M.monadic
            (let err :=
              M.alloc (| Ty.apply (Ty.path "alloc::borrow::Cow") [] [ Ty.path "str" ], err |) in
            (* Unsize *)
            M.pointer_coercion
              (M.call_closure (|
                Ty.apply
          ...
          ltac:(M.monadic
            ...
            M.read (|
              let~ err :
                ...
                (* Unsize *) M.pointer_coercion (M.read (| self |)) in
              M.alloc (|
                Ty.apply
                  (Ty.path "core::result::Result")
                  []
