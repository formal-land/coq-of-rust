      ...
      Definition new_unsize
        ...
        | [], [ T ], [ value ] =>
          ltac:(M.monadic
            ...
            M.read (|
              M.match_operator (|
                Some (Ty.apply (Ty.path "alloc::boxed::thin::ThinBox") [] [ Dyn ]),
                M.alloc (| Value.Tuple [] |),
                [
                  fun γ =>
                    ltac:(M.monadic
      ...
      Definition deref (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| self |) in
            M.read (|
              let~ value : Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ] :=
                M.call_closure (|
                  Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                  M.get_associated_function (|
                    Ty.apply (Ty.path "alloc::boxed::thin::ThinBox") [] [ T ],
                ...
                M.read (|
                  ...
                  let~ pointer : Ty.apply (Ty.path "*mut") [] [ T ] :=
                    M.call_closure (|
                      ...
                      |),
                      [
                        M.cast (Ty.apply (Ty.path "*mut") [] [ Ty.tuple [] ]) (M.read (| value |));
                        M.read (| metadata |)
                      ]
                    |) in
                  M.alloc (|
      ...
      Definition drop (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| self |) in
            M.read (|
              let~ value : Ty.apply (Ty.path "&mut") [] [ T ] :=
                M.call_closure (|
                  Ty.apply (Ty.path "&mut") [] [ T ],
                  M.get_trait_method (|
                    "core::ops::deref::DerefMut",
      ...
      Definition new (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [ H; T ], [ header; value ] =>
          ltac:(M.monadic
            ...
            let value := M.alloc (| value |) in
            M.read (|
              let~ ptr : Ty.apply (Ty.path "alloc::boxed::thin::WithHeader") [] [ H ] :=
                M.call_closure (|
                  ...
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      let~ result : Ty.apply (Ty.path "alloc::boxed::thin::WithHeader") [] [ H ] :=
                        Value.StructTuple
                          "alloc::boxed::thin::WithHeader"
                          [ M.read (| ptr |); Value.StructTuple "core::marker::PhantomData" [] ] in
                      let~ _ : Ty.tuple [] :=
                        M.call_closure (|
                          Ty.tuple [],
          ...
          ltac:(M.monadic
            ...
            M.read (|
              ...
              let~ alloc : Ty.apply (Ty.path "&") [] [ H ] :=
                M.read (| M.get_constant "alloc::boxed::thin::new_unsize_zst_discriminant" |) in
