                            ...
                            ltac:(M.monadic
                              ...
                              let γ1_0 :=
                                M.SubPointer.get_struct_tuple_field (|
                                  ...
                                  0
                                |) in
                              let self_min := M.copy (| Ty.apply (Ty.path "&") [] [ T ], γ1_0 |) in
                              let γ1_0 :=
                                M.SubPointer.get_struct_tuple_field (|
                                  γ0_1,
                                  "core::option::Option::Some",
                                  0
                                |) in
                              let self_max := M.copy (| Ty.apply (Ty.path "&") [] [ T ], γ1_0 |) in
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                          let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                          let self_min := M.copy (| Ty.apply (Ty.path "&") [] [ T ], γ0_0 |) in
                          let self_max := M.copy (| Ty.apply (Ty.path "&") [] [ T ], γ0_1 |) in
                          M.match_operator (|
                            Ty.apply
                                  ...
                                  fun γ =>
                                    ltac:(M.monadic
                                      ...
                                      let γ1_0 :=
                                        ...
                                        |) in
                                      let other_min :=
                                        M.copy (| Ty.apply (Ty.path "&") [] [ T ], γ1_0 |) in
                                      let γ1_0 :=
                                        M.SubPointer.get_struct_tuple_field (|
                                          γ0_1,
                                          "core::option::Option::Some",
                            ...
                            [
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  let other_max :=
                                    M.copy (| Ty.apply (Ty.path "&") [] [ T ], γ0_1 |) in
                                  Value.mkStructRecord
                                    "alloc::collections::btree::set::Difference"
                                    []
                                    [ T; A ]
                              ...
                              [
                                fun γ =>
                                  ltac:(M.monadic
                                    (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                                    let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                                    let k := M.copy (| Ty.apply (Ty.path "&") [] [ T ], γ0_0 |) in
                                    M.read (| k |)))
                              ]
                            |)))
                  ...
                  M.call_closure (|
                    ...
                    M.get_trait_method (|
                      ...
                      Ty.apply
                        ...
                        []
                        [ T; Ty.function [ Ty.apply (Ty.path "&") [] [ T ] ] (Ty.path "bool"); A ],
                      [],
                      [],
                      "for_each",
                      [],
      ...
      Module Impl_core_convert_From_where_core_cmp_Ord_T_array_N_T_for_alloc_collections_btree_set_BTreeSet_T_alloc_alloc_Global.
        ...
        *)
        Definition from
          ...
          | [], [], [ arr ] =>
            ltac:(M.monadic
              (let arr := M.alloc (| Ty.apply (Ty.path "array") [ N ] [ T ], arr |) in
              M.catch_return
                (Ty.apply
                  (Ty.path "alloc::collections::btree::set::BTreeSet")
                  []
                    ...
                    let~ _ : Ty.tuple [] :=
                      M.call_closure (|
                        ...
                        M.get_associated_function (|
                          ...
                          []
                        |),
                        [ (* Unsize *) M.pointer_coercion (M.borrow (| Pointer.Kind.MutRef, arr |))
                        ]
                      |) in
                    let~ iter :
                        Ty.apply
                            ...
                            Value.mkStructRecord
                              ...
                              [
                                ...
                                ("other_set",
                                  M.borrow (|
                                    Pointer.Kind.Ref,
                                    M.deref (| M.read (| M.deref (| M.read (| other_set |) |) |) |)
                                  |))
                              ]));
                        fun γ =>
                          ltac:(M.monadic
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                      let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                      let self_len := M.copy (| Ty.path "usize", γ0_0 |) in
                      let other_len := M.copy (| Ty.path "usize", γ0_1 |) in
                      Value.Tuple
                        [
                          M.call_closure (|
                            Ty.path "usize",
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                      let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                      let a_len := M.copy (| Ty.path "usize", γ0_0 |) in
                      let b_len := M.copy (| Ty.path "usize", γ0_1 |) in
                      Value.Tuple
                        [
                          Value.Integer IntegerKind.Usize 0;
                          Value.StructTuple
                            ...
                            Value.mkStructRecord
                              ...
                              [
                                ...
                                ("large_set",
                                  M.borrow (|
                                    Pointer.Kind.Ref,
                                    M.deref (| M.read (| M.deref (| M.read (| large_set |) |) |) |)
                                  |))
                              ]));
                        fun γ =>
                          ltac:(M.monadic
                        ...
                        ltac:(M.monadic
                          ...
                          M.call_closure (|
                            ...
                            M.get_associated_function (|
                              ...
                              []
                            |),
                            [ M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| answer |) |) |)
                            ]
                          |)))
                    ]
                  |)))
                              ...
                              [
                                fun γ =>
                                  ltac:(M.monadic
                                    (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                                    let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                                    let k := M.copy (| Ty.apply (Ty.path "&") [] [ K ], γ0_0 |) in
                                    M.read (| k |)))
                              ]
                            |)))
                        | _ => M.impossible "wrong number of arguments"
