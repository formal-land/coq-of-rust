  ...
  Module btree.
    Module split.
      Module Impl_alloc_collections_btree_node_NodeRef_alloc_collections_btree_node_marker_Owned_K_V_alloc_collections_btree_node_marker_LeafOrInternal.
        ...
        *)
        Definition calc_split_length (K V : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
                      ...
                      ltac:(M.monadic
                        ...
                        M.alloc (|
                          M.of_value (|
                            Value.Tuple
                              [
                                A.to_value (M.read (| length_a |));
                                A.to_value (M.read (| length_b |))
                              ]
                          |)
                        |)))
                  ]
        ...
        *)
        Definition split_off (K V : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self K V in
          match τ, α with
          | [ Q; A ], [ self; key; alloc ] =>
            ltac:(M.monadic
        ...
        *)
        Definition new_pillar (K V : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self K V in
          match τ, α with
          | [ A ], [ height; alloc ] =>
            ltac:(M.monadic
