  ...
  Module vec_deque.
    Module into_iter.
      ...
      Module Impl_alloc_collections_vec_deque_into_iter_IntoIter_T_A.
        ...
        *)
        Definition new (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self T A in
          match τ, α with
          | [], [ inner ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_traits_iterator_Iterator_where_core_alloc_Allocator_A_for_alloc_collections_vec_deque_into_iter_IntoIter_T_A.
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            (let γ :=
                              M.use
                                (M.alloc (|
                                  BinOp.Pure.lt (| M.read (| len |), M.read (| n |) |)
                                |)) in
                            let _ :=
        ...
        *)
        Definition try_fold (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self T A in
          match τ, α with
          | [ B; F; R ], [ self; init; f ] =>
            ltac:(M.monadic
                              ...
                              ("deque",
                                A.to_value
                                  (M.SubPointer.get_struct_record_field (|
                                    ...
                                    "inner"
                                  |)));
                              ("consumed", A.to_value (M.of_value (| Value.Integer 0 |)))
                            ]
                        |)
                      |) in
                    M.match_operator (|
        ...
        *)
        Definition fold (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self T A in
          match τ, α with
          | [ B; F ], [ self; init; f ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_traits_double_ended_DoubleEndedIterator_where_core_alloc_Allocator_A_for_alloc_collections_vec_deque_into_iter_IntoIter_T_A.
        ...
        *)
        Definition try_rfold (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self T A in
          match τ, α with
          | [ B; F; R ], [ self; init; f ] =>
            ltac:(M.monadic
        ...
        *)
        Definition rfold (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self T A in
          match τ, α with
          | [ B; F ], [ self; init; f ] =>
            ltac:(M.monadic
