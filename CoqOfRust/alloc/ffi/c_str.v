      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "alloc::ffi::c_str::NulError" ],
                self
              |) in
            Value.StructTuple
    ...
    Module Impl_alloc_ffi_c_str_FromVecWithNulError.
      ...
      *)
      Definition into_bytes (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "alloc::ffi::c_str::FromVecWithNulError", self |) in
            M.read (|
              M.SubPointer.get_struct_record_field (|
                self,
                "alloc::ffi::c_str::FromVecWithNulError",
    ...
    Module Impl_alloc_ffi_c_str_CString.
      ...
      *)
      Definition into_raw (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "alloc::ffi::c_str::CString", self |) in
            M.cast
              (Ty.apply (Ty.path "*mut") [] [ Ty.path "i8" ])
              (M.call_closure (|
      ...
      Definition drop (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&mut") [] [ Ty.path "alloc::ffi::c_str::CString" ],
                self
              |) in
            M.read (|
              let~ _ : Ty.tuple [] :=
    ...
    Module Impl_core_convert_From_alloc_ffi_c_str_CString_for_alloc_vec_Vec_u8_alloc_alloc_Global.
      ...
      *)
      Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ s ] =>
          ltac:(M.monadic
            (let s := M.alloc (| Ty.path "alloc::ffi::c_str::CString", s |) in
            M.call_closure (|
              Ty.apply
                (Ty.path "alloc::vec::Vec")
                []
      ...
      *)
      Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ s ] =>
          ltac:(M.monadic
            (let s :=
              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "core::ffi::c_str::CStr" ], s |) in
            M.call_closure (|
              Ty.apply
                (Ty.path "alloc::boxed::Box")
                []
              ...
              [
                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let s := M.copy (| Ty.path "alloc::ffi::c_str::CString", γ0_0 |) in
                    M.call_closure (|
                      Ty.apply
                        (Ty.path "alloc::boxed::Box")
                        []
    ...
    Module Impl_core_convert_TryFrom_alloc_ffi_c_str_CString_for_alloc_string_String.
      ...
      *)
      Definition try_from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ value ] =>
          ltac:(M.monadic
            (let value := M.alloc (| Ty.path "alloc::ffi::c_str::CString", value |) in
            M.call_closure (|
              Ty.apply
                (Ty.path "core::result::Result")
                []
      ...
      *)
      Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ s ] =>
          ltac:(M.monadic
            (let s :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "alloc::ffi::c_str::CString" ], s |) in
            Value.StructTuple
              "alloc::borrow::Cow::Borrowed"
              []
              [ Ty.path "core::ffi::c_str::CStr" ]
    ...
    Module Impl_alloc_ffi_c_str_NulError.
      ...
      *)
      Definition into_vec (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "alloc::ffi::c_str::NulError", self |) in
            M.read (|
    ...
    Module Impl_alloc_ffi_c_str_IntoStringError.
      ...
      *)
      Definition into_cstring (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "alloc::ffi::c_str::IntoStringError", self |) in
            M.read (|
              M.SubPointer.get_struct_record_field (|
                self,
                "alloc::ffi::c_str::IntoStringError",
          ...
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                ...
                self
              |) in
            let _index := M.alloc (| Ty.path "core::ops::range::RangeFull", _index |) in
            M.borrow (|
              Pointer.Kind.Ref,
              M.deref (|
                M.call_closure (|
