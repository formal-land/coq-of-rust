  ...
  Module Impl_alloc_rc_Rc_T_alloc_alloc_Global.
    ...
    *)
    Definition new_cyclic (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ F ], [ data_fn ] =>
        ltac:(M.monadic
          (let data_fn := M.alloc (| F, data_fn |) in
          M.call_closure (|
            Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; Ty.path "alloc::alloc::Global" ],
            M.get_associated_function (|
              Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; Ty.path "alloc::alloc::Global" ],
                            ...
                            (M.match_operator (|
                              ...
                              [
                                fun γ =>
                                  ltac:(M.monadic
                                    (let layout :=
                                      M.copy (| Ty.path "core::alloc::layout::Layout", γ |) in
                                    M.call_closure (|
                                      Ty.apply
                                        (Ty.path "core::result::Result")
                                        []
    ...
    *)
    Definition allocate_for_layout
      ...
      | [],
        ...
        ltac:(M.monadic
          (let value_layout := M.alloc (| Ty.path "core::alloc::layout::Layout", value_layout |) in
          let allocate :=
            M.alloc (| impl_FnOnce_Layout__arrow_Result_NonNull__u8____AllocError_, allocate |) in
          let mem_to_rc_inner :=
            M.alloc (| impl_FnOnce__mut_u8__arrow__mut_RcInner_T_, mem_to_rc_inner |) in
          M.read (|
  ...
  Module Impl_alloc_rc_Rc_T_A.
    ...
    Definition inner (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; A ] ],
              self
            |) in
          M.borrow (|
            Pointer.Kind.Ref,
    ...
    *)
    Definition into_inner_with_allocator
      ...
      | [], [], [ this ] =>
        ltac:(M.monadic
          (let this := M.alloc (| Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; A ], this |) in
          M.read (|
            let~ this :
                Ty.apply
    ...
    Definition drop_slow (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; A ] ],
              self
            |) in
          M.read (|
            let~ _weak :
          ...
          M.match_operator (|
            ...
            M.alloc (|
              Ty.apply
                (Ty.path "core::result::Result")
                []
                [ Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; A ]; Ty.path "core::alloc::AllocError"
                ],
              M.call_closure (|
                Ty.apply
                  (Ty.path "core::result::Result")
            ...
            [
              fun γ =>
                ltac:(M.monadic
                  ...
                  let m := M.copy (| Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; A ], γ0_0 |) in
                  M.read (| m |)));
              fun γ =>
                ltac:(M.monadic
                  (let γ0_0 :=
                  ...
                  M.read (|
                    ...
                    let~ weak : Ty.apply (Ty.path "alloc::rc::Weak") [] [ T; A ] :=
                      Value.mkStructRecord
                        ...
                        []
                        [ T; A ]
                        [ ("ptr", M.read (| init_ptr |)); ("alloc", M.read (| alloc |)) ] in
                    let~ data : T :=
                      M.call_closure (|
                        T,
                        M.get_trait_method (|
                        ...
                        (M.match_operator (|
                          ...
                          [
                            fun γ =>
                              ltac:(M.monadic
                                (let rc :=
                                  M.copy (| Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; A ], γ |) in
                                M.call_closure (|
                                  T,
                                  M.get_trait_method (|
                                    "core::clone::Clone",
    ...
    *)
    Definition allocate_for_ptr_in
      ...
      | [], [], [ ptr; alloc ] =>
        ltac:(M.monadic
          (let ptr := M.alloc (| Ty.apply (Ty.path "*const") [] [ T ], ptr |) in
          let alloc := M.alloc (| Ty.apply (Ty.path "&") [] [ A ], alloc |) in
          M.call_closure (|
            Ty.apply (Ty.path "*mut") [] [ Ty.apply (Ty.path "alloc::rc::RcInner") [] [ T ] ],
            M.get_associated_function (|
              Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; Ty.path "alloc::alloc::Global" ],
                        ...
                        (M.match_operator (|
                          ...
                          [
                            fun γ =>
                              ltac:(M.monadic
                                (let mem :=
                                  M.copy (| Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ], γ |) in
                                M.call_closure (|
                                  Ty.apply
                                    (Ty.path "*mut")
                                    []
    ...
    *)
    Definition from_box_in (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ src ] =>
        ltac:(M.monadic
          (let src := M.alloc (| Ty.apply (Ty.path "alloc::boxed::Box") [] [ T; A ], src |) in
          M.read (|
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                      let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                      let bptr := M.copy (| Ty.apply (Ty.path "*mut") [] [ T ], γ0_0 |) in
                      let alloc := M.copy (| A, γ0_1 |) in
                      M.read (|
                        let~ src :
                            Ty.apply
    ...
    *)
    Definition from_iter_exact
      ...
      | [], [ impl_Iterator_Item___T_ ], [ iter; len ] =>
        ltac:(M.monadic
          (let iter := M.alloc (| impl_Iterator_Item___T_, iter |) in
          let len := M.alloc (| Ty.path "usize", len |) in
          M.read (|
            let~ ptr :
                Ty.apply
  ...
  Module Impl_core_convert_From_ref__str_for_alloc_rc_Rc_str_alloc_alloc_Global.
    ...
    *)
    Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ v ] =>
        ltac:(M.monadic
          (let v := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], v |) in
          M.read (|
            let~ rc :
                Ty.apply
                  (Ty.path "alloc::rc::Rc")
  ...
  Module Impl_core_convert_From_ref_mut_str_for_alloc_rc_Rc_str_alloc_alloc_Global.
    ...
    *)
    Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ v ] =>
        ltac:(M.monadic
          (let v := M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "str" ], v |) in
          M.call_closure (|
            Ty.apply (Ty.path "alloc::rc::Rc") [] [ Ty.path "str"; Ty.path "alloc::alloc::Global" ],
            M.get_trait_method (|
              "core::convert::From",
  ...
  Module Impl_core_convert_From_alloc_string_String_for_alloc_rc_Rc_str_alloc_alloc_Global.
    ...
    *)
    Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ v ] =>
        ltac:(M.monadic
          (let v := M.alloc (| Ty.path "alloc::string::String", v |) in
          M.call_closure (|
            Ty.apply (Ty.path "alloc::rc::Rc") [] [ Ty.path "str"; Ty.path "alloc::alloc::Global" ],
            M.get_trait_method (|
              "core::convert::From",
  ...
  Module Impl_core_convert_From_where_core_marker_Sized_T_where_core_alloc_Allocator_A_alloc_boxed_Box_T_A_for_alloc_rc_Rc_T_A.
    ...
    *)
    Definition from (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ v ] =>
        ltac:(M.monadic
          (let v := M.alloc (| Ty.apply (Ty.path "alloc::boxed::Box") [] [ T; A ], v |) in
          M.call_closure (|
            Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; A ],
            M.get_associated_function (|
              Ty.apply (Ty.path "alloc::rc::Rc") [] [ T; A ],
            ...
            [
              fun γ =>
                ltac:(M.monadic
                  ...
                  let vec_ptr := M.copy (| Ty.apply (Ty.path "*mut") [] [ T ], γ0_0 |) in
  ...
  Module Impl_core_convert_From_where_alloc_borrow_ToOwned_B_where_core_marker_Sized_B_where_core_convert_From_alloc_rc_Rc_B_alloc_alloc_Global_ref__B_where_core_convert_From_alloc_rc_Rc_B_alloc_alloc_Global_associated_in_trait_alloc_borrow_ToOwned___B_Owned_alloc_borrow_Cow_B_for_alloc_rc_Rc_B_alloc_alloc_Global.
    ...
    *)
    Definition from (B : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ cow ] =>
        ltac:(M.monadic
          (let cow := M.alloc (| Ty.apply (Ty.path "alloc::borrow::Cow") [] [ B ], cow |) in
          M.match_operator (|
            Ty.apply (Ty.path "alloc::rc::Rc") [] [ B; Ty.path "alloc::alloc::Global" ],
            cow,
            [
                ...
                ltac:(M.monadic
                  (let γ0_0 :=
                    M.SubPointer.get_struct_tuple_field (|
                      ...
                      0
                    |) in
                  let s := M.copy (| Ty.apply (Ty.path "&") [] [ B ], γ0_0 |) in
                  M.call_closure (|
                    Ty.apply (Ty.path "alloc::rc::Rc") [] [ B; Ty.path "alloc::alloc::Global" ],
                    M.get_trait_method (|
                      "core::convert::From",
                        ...
                        ltac:(M.monadic
                          ...
                          let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let high := M.copy (| Ty.path "usize", γ0_0 |) in
                          M.read (|
                            let~ _ : Ty.tuple [] :=
                              M.match_operator (|
                                Ty.tuple [],
  ...
  Module Impl_alloc_rc_Weak_T_A.
    ...
    *)
    Definition into_raw (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "alloc::rc::Weak") [] [ T; A ], self |) in
          M.call_closure (|
            Ty.apply (Ty.path "*const") [] [ T ],
            M.get_associated_function (|
              Ty.apply (Ty.path "alloc::rc::Weak") [] [ T; A ],
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          ...
          M.read (|
            ...
            M.alloc (|
              Ty.tuple [ Ty.apply (Ty.path "*const") [] [ T ]; A ],
              Value.Tuple [ M.read (| result |); M.read (| alloc |) ]
            |)
          |)))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
                        ...
                        ltac:(M.monadic
                          (let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let val := M.copy (| Ty.path "alloc::rc::WeakInner", γ0_0 |) in
                          M.read (| val |)))
                    ]
                  |) in
                M.alloc (|
            ...
            [
              fun γ =>
                ltac:(M.monadic
                  ...
                  let inner := M.copy (| Ty.path "alloc::rc::WeakInner", γ0_0 |) in
                  M.call_closure (|
                    Ty.path "usize",
                    M.get_trait_method (|
                      "alloc::rc::RcInnerPtr",
    ...
    Definition drop (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "alloc::rc::Weak") [] [ T; A ] ],
              self
            |) in
                  ...
                  M.call_closure (|
                    ...
                    [
                      M.call_closure (|
                        Ty.path "bool",
                        BinOp.ne,
                        [ M.read (| weak |); Value.Integer IntegerKind.Usize 0 ]
                      |)
                    ]
                  |) in
                M.alloc (| Ty.tuple [], Value.Tuple [] |)
    ...
    *)
    Definition weak_ref (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "alloc::rc::WeakInner" ], self |) in
          M.borrow (|
            Pointer.Kind.Ref,
            M.deref (|
              M.read (|
    ...
    Definition fmt (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; f ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "alloc::rc::UniqueRc") [] [ T; A ] ],
              self
            |) in
          let f :=
            M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "core::fmt::Formatter" ], f |) in
  ...
  Module Impl_alloc_rc_UniqueRc_T_A.
    ...
    *)
    Definition into_rc (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ this ] =>
        ltac:(M.monadic
          (let this := M.alloc (| Ty.apply (Ty.path "alloc::rc::UniqueRc") [] [ T; A ], this |) in
          M.read (|
            let~ this :
                Ty.apply
                  (Ty.path "core::mem::manually_drop::ManuallyDrop")
    ...
    Definition deref_mut (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "alloc::rc::UniqueRc") [] [ T; A ] ],
              self
            |) in
          M.borrow (|
            Pointer.Kind.MutRef,
  ...
  Module Impl_alloc_rc_UniqueRcUninit_T_A.
    ...
    *)
    Definition new (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ for_value; alloc ] =>
        ltac:(M.monadic
          (let for_value := M.alloc (| Ty.apply (Ty.path "&") [] [ T ], for_value |) in
          let alloc := M.alloc (| A, alloc |) in
          M.read (|
            let~ layout : Ty.path "core::alloc::layout::Layout" :=
              M.call_closure (|
    ...
    *)
    Definition into_rc (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "alloc::rc::UniqueRcUninit") [] [ T; A ], self |) in
          M.read (|
            let~ this :
                Ty.apply
                  (Ty.path "core::mem::manually_drop::ManuallyDrop")
