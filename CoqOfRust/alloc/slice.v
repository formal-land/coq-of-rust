              ...
              let guard :=
                M.alloc (|
                  Value.StructRecord
                    ...
                    [ ("vec", vec); ("num_init", Value.Integer Integer.Usize 0) ]
                |) in
              let slots :=
                M.alloc (|
                  M.call_closure (|
            ...
            ltac:(M.monadic
              (M.read (|
                ...
                let _ :=
                  let m :=
                    M.alloc (|
                      BinOp.Panic.shr (| M.read (| n |), Value.Integer Integer.I32 1 |)
                    |) in
                  M.loop (|
                    ltac:(M.monadic
                      (M.match_operator (|
                          ...
                          fun γ =>
                            ltac:(M.monadic
                              (let γ :=
                                M.use
                                  (M.alloc (|
                                    BinOp.Pure.gt (M.read (| m |)) (Value.Integer Integer.Usize 0)
                                  |)) in
                              let _ :=
                                M.is_constant_or_break_match (|
                                  M.read (| γ |),
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          (let γ :=
                            M.use
                              (M.alloc (|
                                BinOp.Pure.gt (M.read (| rem_len |)) (Value.Integer Integer.Usize 0)
                              |)) in
                          let _ :=
                            M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                          let _ :=
