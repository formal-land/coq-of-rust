                            ...
                            [
                              ...
                              M.call_closure (|
                                ...
                                M.get_associated_function (|
                                  ...
                                  []
                                |),
                                [ M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| slots |) |) |)
                                ]
                              |)
                            ]
                          |)
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  M.loop (|
                    ...
                    ltac:(M.monadic
                                    ...
                                    M.call_closure (|
                                      ...
                                      [
                                        ...
                                        M.call_closure (|
                                          Ty.path "usize",
                                          BinOp.Wrap.mul,
                                          [ M.read (| buf_len |); Value.Integer IntegerKind.Usize 2
                                          ]
                                        |)
                                      ]
                                    |)
                      ...
                      |)))
                  |) in
                let~ rem_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "usize",
                      BinOp.Wrap.sub,
              ...
              (M.read (|
                let~ iter :
                  ...
                  M.alloc (|
                    ...
                    |)
                  |) in
                let~ first : Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "&") [] [ V ] ] :=
                  M.copy (|
                    M.match_operator (|
                      Some (Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "&") [] [ V ] ]),
                      M.alloc (|
                        M.call_closure (|
                          Ty.apply
                            (Ty.path "core::option::Option")
