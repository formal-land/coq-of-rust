...
Module slice.
  Module hack.
    ...
    *)
    Definition to_vec (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [ T; A ], [ s; alloc ] =>
        ltac:(M.monadic
          (let s := M.alloc (| s |) in
    ...
    Module Impl_alloc_slice_hack_ConvertVec_where_core_clone_Clone_T_for_T.
      ...
      *)
      Definition to_vec (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
                ...
                M.alloc (|
                  M.of_value (|
                    Value.StructRecord
                      ...
                      [
                        ("vec", A.to_value vec);
                        ("num_init", A.to_value (M.of_value (| Value.Integer 0 |)))
                      ]
                  |)
                |) in
              let slots :=
  ...
  Module Impl_slice_T.
    ...
    *)
    Definition sort (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T in
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
    ...
    *)
    Definition sort_by (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T in
      match τ, α with
      | [ F ], [ self; compare ] =>
        ltac:(M.monadic
    ...
    *)
    Definition sort_by_key (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T in
      match τ, α with
      | [ K; F ], [ self; f ] =>
        ltac:(M.monadic
    ...
    *)
    Definition sort_by_cached_key (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T in
      match τ, α with
      | [ K; F ], [ self; f ] =>
        ltac:(M.monadic
        ...
        ltac:(M.monadic
          ...
          M.call_closure (|
            M.get_associated_function (|
              ...
              [ Ty.path "alloc::alloc::Global" ]
            |),
            [ M.read (| self |); M.of_value (| Value.StructTuple "alloc::alloc::Global" [] |) ]
          |)))
      | _, _ => M.impossible
      end.
    ...
    *)
    Definition to_vec_in (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T in
      match τ, α with
      | [ A ], [ self; alloc ] =>
        ltac:(M.monadic
    ...
    *)
    Definition into_vec (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T in
      match τ, α with
      | [ A ], [ self ] =>
        ltac:(M.monadic
    ...
    *)
    Definition repeat (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T in
      match τ, α with
      | [], [ self; n ] =>
        ltac:(M.monadic
            ...
            ltac:(M.monadic
              (M.read (|
                ...
                let _ :=
                  let m :=
                    M.alloc (|
                      BinOp.Panic.shr (| M.read (| n |), M.of_value (| Value.Integer 1 |) |)
                    |) in
                  M.loop (|
                    ltac:(M.monadic
                      (M.match_operator (|
    ...
    *)
    Definition concat (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T in
      match τ, α with
      | [ Item ], [ self ] =>
        ltac:(M.monadic
    ...
    *)
    Definition join (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T in
      match τ, α with
      | [ Separator ], [ self; sep ] =>
        ltac:(M.monadic
    ...
    *)
    Definition connect (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T in
      match τ, α with
      | [ Separator ], [ self; sep ] =>
        ltac:(M.monadic
  ...
  Module Impl_alloc_slice_Concat_where_core_clone_Clone_T_where_core_borrow_Borrow_V_slice_T_T_for_slice_V.
    ...
    *)
    Definition concat (T V : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_alloc_slice_Join_where_core_clone_Clone_T_where_core_borrow_Borrow_V_slice_T_ref__T_for_slice_V.
    ...
    *)
    Definition join (T V : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T V in
      match τ, α with
      | [], [ slice; sep ] =>
        ltac:(M.monadic
        ...
        ltac:(M.monadic
          ...
          M.call_closure (|
            M.get_trait_method (|
              ...
              []
            |),
            [ M.read (| self |); M.of_value (| Value.StructTuple "core::ops::range::RangeFull" [] |)
            ]
          |)))
      | _, _ => M.impossible
      end.
  ...
  Module Impl_alloc_slice_SpecCloneIntoVec_where_core_clone_Clone_T_where_core_alloc_Allocator_A_T_A_for_slice_T.
    ...
    *)
    Definition clone_into (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self T A in
      match τ, α with
      | [], [ self; target ] =>
        ltac:(M.monadic
  ...
  *)
  Definition stable_sort (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T; F ], [ v; is_less ] =>
      ltac:(M.monadic
        (let v := M.alloc (| v |) in
