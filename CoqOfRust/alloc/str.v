...
Module str.
  Module Impl_alloc_slice_Concat_where_core_borrow_Borrow_S_str_str_for_slice_S.
    ...
    *)
    Definition concat (S : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        ...
        ltac:(M.monadic
          ...
          M.call_closure (|
            M.get_trait_method (|
              ...
              []
            |),
            [ M.read (| slice |); M.read (| M.of_value (| Value.String "" |) |) ]
          |)))
      | _, _ => M.impossible
      end.
  ...
  Module Impl_alloc_slice_Join_where_core_borrow_Borrow_S_str_ref__str_for_slice_S.
    ...
    *)
    Definition join (S : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self S in
      match τ, α with
      | [], [ slice; sep ] =>
        ltac:(M.monadic
  ...
  *)
  Definition join_generic_copy (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
  ...
  Module Impl_core_borrow_BorrowMut_str_for_alloc_string_String.
    ...
    *)
    Definition borrow_mut (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
  ...
  Module Impl_str.
    ...
    *)
    Definition into_boxed_bytes (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
          ...
          M.read (|
            let result :=
              M.alloc (|
                ...
                |)
              |) in
            let last_end := M.alloc (| M.of_value (| Value.Integer 0 |) |) in
            let _ :=
              M.use
                (M.match_operator (|
                  M.alloc (|
                      ...
                      [
                        ...
                        M.of_value (|
                          Value.StructRecord
                            "core::ops::range::Range"
                            [
                              ("start", A.to_value (M.read (| last_end |)));
                              ("end_",
                                A.to_value
                                  (M.call_closure (|
    ...
    *)
    Definition replacen (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [ P ], [ self; pat; to; count ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
                                                    ...
                                                    (let γ :=
                                                      M.use
                                                        (M.alloc (|
                                                          BinOp.Pure.eq (|
                                                            M.read (| c |),
                                                            M.of_value (| Value.UnicodeChar 931 |)
                                                          |)
                                                        |)) in
                                                    let _ :=
                                                      M.is_constant_or_break_match (|
  ...
  *)
  Definition from_boxed_utf8_unchecked (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ v ] =>
      ltac:(M.monadic
        (let v := M.alloc (| v |) in
  ...
  *)
  Definition convert_while_ascii (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ b; convert ] =>
      ltac:(M.monadic
        (let b := M.alloc (| b |) in
                        ...
                        ltac:(M.monadic
                          ...
                          let out_chunk :=
                            M.alloc (|
                              ...
                              |)
                            |) in
                          let bits := M.alloc (| M.of_value (| Value.Integer 0 |) |) in
                          let _ :=
                            M.use
                              (M.match_operator (|
                                M.alloc (|
  ...
  Module convert_while_ascii.
    ...
    Definition value_MAGIC_UNROLL : A.t :=
      M.run ltac:(M.monadic (M.alloc (| M.of_value (| Value.Integer 2 |) |))).
    
    Definition value_N : A.t :=
      M.run
        ltac:(M.monadic
          (M.alloc (|
            BinOp.Panic.mul (|
        ...
        ltac:(M.monadic
          (M.alloc (|
            M.call_closure (|
              ...
              [ repeat (| M.of_value (| Value.Integer 128 |), 8 |) ]
            |)
          |))).
