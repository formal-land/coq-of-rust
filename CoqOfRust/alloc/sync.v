    ...
    Definition allocate_for_layout
      ...
      | [],
        ...
        ltac:(M.monadic
          ...
          let mem_to_arcinner :=
            M.alloc (| impl_FnOnce__mut_u8__arrow__mut_ArcInner_T_, mem_to_arcinner |) in
          M.read (|
  ...
  Module Impl_alloc_sync_Arc_T_A.
    ...
    *)
    Definition into_inner_with_allocator
      ...
      | [], [], [ this ] =>
        ltac:(M.monadic
          (let this := M.alloc (| Ty.apply (Ty.path "alloc::sync::Arc") [] [ T; A ], this |) in
          M.read (|
            let~ this :
                Ty.apply
                ...
                ltac:(M.monadic
                  ...
                  M.read (|
                    ...
                    let~ data : T :=
                      ...
                      |) in
                    let~ strong : Ty.apply (Ty.path "alloc::sync::Arc") [] [ T; A ] :=
                      M.read (|
                        let~ inner :
                            Ty.apply
                              (Ty.path "*mut")
                                  ...
                                  ltac:(M.monadic
                                    (let γ0_0 :=
                                      M.SubPointer.get_struct_tuple_field (|
                                        ...
                                        0
                                      |) in
                                    let old := M.copy (| Ty.path "usize", γ0_0 |) in
    ...
    Definition drop_slow (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "alloc::sync::Arc") [] [ T; A ] ],
              self
            |) in
          M.read (|
            let~ _weak :
        ...
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            M.get_associated_function (|
              ...
              "unwrap_or_else",
              [],
              [ Ty.function [ Ty.apply (Ty.path "alloc::sync::Arc") [] [ T; A ] ] T ]
            |),
            [
              M.call_closure (|
                Ty.apply
                  ...
                  ltac:(M.monadic
                    ...
                    | [ α0 ] =>
                      ltac:(M.monadic
                        (M.match_operator (|
                          T,
                          M.alloc (| Ty.apply (Ty.path "alloc::sync::Arc") [] [ T; A ], α0 |),
                          [
                            fun γ =>
                              ltac:(M.monadic
                                (let arc :=
    ...
    Definition fmt (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; f ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "alloc::sync::Weak") [] [ T; A ] ],
              self
            |) in
          let f :=
  ...
  Module Impl_alloc_sync_Weak_T_A.
    ...
    *)
    Definition into_raw (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "alloc::sync::Weak") [] [ T; A ], self |) in
          M.call_closure (|
            Ty.apply (Ty.path "*const") [] [ T ],
            M.get_associated_function (|
              Ty.apply (Ty.path "alloc::sync::Weak") [] [ T; A ],
            ...
            [
              fun γ =>
                ltac:(M.monadic
                  ...
                  let inner := M.copy (| Ty.path "alloc::sync::WeakInner", γ0_0 |) in
                  M.call_closure (|
                    Ty.path "usize",
                    M.get_associated_function (|
                      Ty.path "core::sync::atomic::AtomicUsize",
    ...
    Definition drop (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "alloc::sync::Weak") [] [ T; A ] ],
              self
            |) in
          M.catch_return (Ty.tuple []) (|
            ltac:(M.monadic
              (M.read (|
                let~ inner : Ty.path "alloc::sync::WeakInner" :=
                  M.match_operator (|
                    Ty.path "alloc::sync::WeakInner",
                    M.alloc (| Ty.tuple [], Value.Tuple [] |),
                    [
                    ...
                    ltac:(M.monadic
                      ...
                      let ptr :=
                        M.copy (|
                          ...
                          γ0_0
                        |) in
                      let alloc := M.copy (| Ty.path "alloc::alloc::Global", γ0_1 |) in
                      M.call_closure (|
                        Ty.apply
                          (Ty.path "alloc::sync::Arc")
                          []
    ...
    *)
    Definition into_arc (T A : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "alloc::sync::UniqueArcUninit") [] [ T; A ], self |) in
          M.read (|
            let~ this :
                Ty.apply
                  (Ty.path "core::mem::manually_drop::ManuallyDrop")
      ...
      | [], [], [ self; req ] =>
        ltac:(M.monadic
          (let self :=
            ...
            |) in
          let req :=
            M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "core::error::Request" ], req |) in
          M.read (|
            let~ _ : Ty.tuple [] :=
              M.call_closure (|
                Ty.tuple [],
