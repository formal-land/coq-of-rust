...
Module vec.
  Module into_iter.
    ...
    Module Impl_alloc_vec_into_iter_IntoIter_T_A.
      ...
      *)
      Definition as_mut_slice (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
      ...
      *)
      Definition as_raw_mut_slice (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
      ...
      *)
      Definition forget_allocation_drop_remaining (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
      ...
      *)
      Definition forget_remaining_elements (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
      ...
      *)
      Definition into_vecdeque (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
    ...
    Module Impl_core_iter_traits_iterator_Iterator_where_core_alloc_Allocator_A_for_alloc_vec_into_iter_IntoIter_T_A.
      ...
      *)
      Definition advance_by (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self; n ] =>
          ltac:(M.monadic
      ...
      *)
      Definition count (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
      ...
      *)
      Definition next_chunk (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
      ...
      *)
      Definition __iterator_get_unchecked (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self; i ] =>
          ltac:(M.monadic
    ...
    Module Impl_core_iter_traits_double_ended_DoubleEndedIterator_where_core_alloc_Allocator_A_for_alloc_vec_into_iter_IntoIter_T_A.
      ...
      *)
      Definition advance_back_by (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self; n ] =>
          ltac:(M.monadic
    ...
    Module Impl_core_iter_adapters_zip_TrustedRandomAccessNoCoerce_where_core_alloc_Allocator_A_where_alloc_vec_into_iter_NonDrop_T_for_alloc_vec_into_iter_IntoIter_T_A.
      ...
      (* Ty.path "bool" *)
      Definition value_MAY_HAVE_SIDE_EFFECT (T A : Ty.t) : A.t :=
        let Self : Ty.t := Self T A in
    ...
    Module Impl_core_iter_traits_marker_InPlaceIterable_where_core_alloc_Allocator_A_for_alloc_vec_into_iter_IntoIter_T_A.
      ...
      Definition value_EXPAND_BY (T A : Ty.t) : A.t :=
        let Self : Ty.t := Self T A in
        M.run
          ltac:(M.monadic
            (M.alloc (|
      ...
      (* Ty.apply (Ty.path "core::option::Option") [ Ty.path "core::num::nonzero::NonZeroUsize" ] *)
      Definition value_MERGE_BY (T A : Ty.t) : A.t :=
        let Self : Ty.t := Self T A in
        M.run
          ltac:(M.monadic
            (M.alloc (|
    ...
    Module Impl_core_iter_adapters_SourceIter_where_core_alloc_Allocator_A_for_alloc_vec_into_iter_IntoIter_T_A.
      ...
      *)
      Definition as_inner (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
    ...
    Module Impl_alloc_vec_in_place_collect_AsVecIntoIter_for_alloc_vec_into_iter_IntoIter_T_alloc_alloc_Global.
      ...
      *)
      Definition as_into_iter (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
