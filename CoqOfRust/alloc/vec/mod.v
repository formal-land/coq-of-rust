            ...
            ltac:(M.monadic
              (M.read (|
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ remaining_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "usize",
                      BinOp.Wrap.sub,
          ...
          M.read (|
            ...
            let~ value : Ty.apply (Ty.path "*") [] [ T ] :=
              M.alloc (|
                ...
                |)
              |) in
            let~ base_ptr : Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "*mut") [] [ T ] ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.apply (Ty.path "*mut") [] [ T ],
                  M.get_associated_function (|
      ...
      | [], [ F ], [ self; f ] =>
        ltac:(M.monadic
          ...
          M.catch_return (Ty.tuple []) (|
            ltac:(M.monadic
              (M.read (|
                let~ original_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "usize",
                      M.get_associated_function (|
            ...
            ltac:(M.monadic
              (M.read (|
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ first_duplicate_idx : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                        ...
                        [
                          fun γ =>
                            ltac:(M.monadic
                              ...
                              let _ :=
                                is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                              let~ found_duplicate : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                                M.copy (|
                                  let~ prev :
                                      Ty.apply
                                        (Ty.path "*")
      ...
      | [], [ F ], [ self; f ] =>
        ltac:(M.monadic
          ...
          M.catch_return (Ty.apply (Ty.path "core::option::Option") [] [ T ]) (|
            ltac:(M.monadic
              (M.read (|
                let~ last : Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "&mut") [] [ T ] ] :=
                  M.copy (|
                    M.match_operator (|
        ...
        ltac:(M.monadic
          ...
          M.read (|
            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
              ...
              |) in
            let~ other_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "usize",
                  BinOp.Wrap.sub,
          ...
          M.read (|
            let~ ptr : Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "*mut") [] [ T ] ] :=
              M.alloc (|
                ...
                |)
              |) in
            let~ spare_ptr : Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "*mut") [] [ T ] ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.apply (Ty.path "*mut") [] [ T ],
                  M.get_associated_function (| Ty.apply (Ty.path "*mut") [] [ T ], "add", [], [] |),
            ...
            let~ spare_ptr :
              ...
              M.alloc (|
                ...
                |)
              |) in
            let~ spare_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "usize",
                  BinOp.Wrap.sub,
    ...
    Definition into_flattened
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          ...
          M.read (|
            M.match_operator (|
              Some (Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "alloc::vec::Vec") [] [ T; A ] ]),
              M.alloc (|
                M.call_closure (|
                  Ty.tuple
                    [
          ...
          M.read (|
            ...
            let~ buf :
              ...
              M.alloc (|
                ...
                |)
              |) in
            let~ begin : Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "*mut") [] [ T ] ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.apply (Ty.path "*mut") [] [ T ],
                  M.get_associated_function (|
              ...
              (M.read (|
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  M.alloc (|
                    ...
                    |)
                  |) in
                let~ array : Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "array") [ N ] [ T ] ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.apply (Ty.path "array") [ N ] [ T ],
                      M.get_function (|
