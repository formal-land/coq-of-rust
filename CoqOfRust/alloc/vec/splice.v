          ...
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                ...
                self
              |) in
            let replace_with := M.alloc (| Ty.apply (Ty.path "&mut") [] [ I ], replace_with |) in
          ...
          ltac:(M.monadic
            ...
            M.read (|
              ...
              let~ _ : Ty.tuple [] :=
                ...
                |) in
              let~ new_tail_start : Ty.path "usize" :=
                M.call_closure (|
                  Ty.path "usize",
                  BinOp.Wrap.add,
                  [
