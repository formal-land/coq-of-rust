...
Module vec.
  Module splice.
    ...
    Module Impl_core_fmt_Debug_where_core_fmt_Debug_I_where_core_iter_traits_iterator_Iterator_I_where_core_fmt_Debug_A_where_core_alloc_Allocator_A_where_core_fmt_Debug_associated_type_for_alloc_vec_splice_Splice_I_A.
      ...
      (* Debug *)
      Definition fmt (I A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "Splice" |) |);
                ...
                M.pointer_coercion (|
                  ...
                  |)
                |);
                M.read (| M.of_value (| Value.String "replace_with" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.alloc (|
                    M.SubPointer.get_struct_record_field (|
    ...
    Module Impl_core_ops_drop_Drop_where_core_iter_traits_iterator_Iterator_I_where_core_alloc_Allocator_A_for_alloc_vec_splice_Splice_I_A.
      ...
      *)
      Definition drop (I A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self I A in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
    ...
    Module Impl_alloc_vec_drain_Drain_T_A.
      ...
      *)
      Definition fill (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      ...
      *)
      Definition move_tail (T A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T A in
        match τ, α with
        | [], [ self; additional ] =>
          ltac:(M.monadic
