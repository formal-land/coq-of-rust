  ...
  Module units.
    ...
    *)
    Definition parse_ether (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ eth ] =>
        ltac:(M.monadic
          (let eth := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], eth |) in
          M.call_closure (|
            Ty.apply
    ...
    *)
    Definition parse_units (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ K; E ], [ amount; units ] =>
        ltac:(M.monadic
          (let amount := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], amount |) in
          let units := M.alloc (| K, units |) in
          M.catch_return
            (Ty.apply
              (Ty.path "core::result::Result")
              []
    ...
    *)
    Definition format_ether (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ T ], [ amount ] =>
        ltac:(M.monadic
          (let amount := M.alloc (| T, amount |) in
          M.call_closure (|
      ...
      Definition fmt (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; f ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "alloy_primitives::utils::units::UnitsError" ],
                self
              |) in
            let f :=
      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "alloy_primitives::utils::units::ParseUnits" ],
                self
              |) in
            M.match_operator (|
              Ty.path "alloy_primitives::utils::units::ParseUnits",
      ...
      *)
      Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ value ] =>
          ltac:(M.monadic
            (let value :=
              M.alloc (| Ty.path "alloy_primitives::utils::units::ParseUnits", value |) in
            M.call_closure (|
              Ty.apply
                (Ty.path "ruint::Uint")
                [ Value.Integer IntegerKind.Usize 256; Value.Integer IntegerKind.Usize 4 ]
    ...
    Module Impl_alloy_primitives_utils_units_ParseUnits.
      ...
      *)
      Definition parse_units (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ amount; unit_ ] =>
          ltac:(M.monadic
            (let amount := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], amount |) in
            let unit_ := M.alloc (| Ty.path "alloy_primitives::utils::units::Unit", unit_ |) in
            M.catch_return
              (Ty.apply
                (Ty.path "core::result::Result")
                []
                          ...
                          ltac:(M.monadic
                            ...
                            let γ0_0 :=
                              M.SubPointer.get_struct_tuple_field (|
                                ...
                                0
                              |) in
                            let di := M.copy (| Ty.path "usize", γ0_0 |) in
                            M.read (|
                              let~ _ : Ty.path "char" :=
                                M.call_closure (|
                                  Ty.path "char",
      ...
      *)
      Definition get_absolute (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "alloy_primitives::utils::units::ParseUnits", self |) in
            M.match_operator (|
              Ty.apply
                (Ty.path "ruint::Uint")
                [ Value.Integer IntegerKind.Usize 256; Value.Integer IntegerKind.Usize 4 ]
      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "alloy_primitives::utils::units::Unit" ],
                self
              |) in
            M.match_operator (|
              Ty.path "alloy_primitives::utils::units::Unit",
    ...
    Module Impl_alloy_primitives_utils_units_Unit.
      ...
      *)
      Definition new (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ units ] =>
          ltac:(M.monadic
            (let units := M.alloc (| Ty.path "u8", units |) in
            M.match_operator (|
              Ty.apply
                (Ty.path "core::option::Option")
                []
      ...
      *)
      Definition wei (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "alloy_primitives::utils::units::Unit", self |) in
            M.match_operator (|
              Ty.apply
                (Ty.path "ruint::Uint")
                [ Value.Integer IntegerKind.Usize 256; Value.Integer IntegerKind.Usize 4 ]
