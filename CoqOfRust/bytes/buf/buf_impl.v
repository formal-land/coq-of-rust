                                ...
                                ltac:(M.monadic
                                  ...
                                  let γ0_0 :=
                                    M.SubPointer.get_struct_tuple_field (|
                                      ...
                                      0
                                    |) in
                                  let ret := M.copy (| Ty.path "u16", γ0_0 |) in
                                  M.never_to_any (|
                                    M.read (|
                                      let~ _ : Ty.tuple [] :=
                                        M.call_closure (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  let γ0_0 :=
                                    M.SubPointer.get_struct_tuple_field (|
                                      ...
                                      0
                                    |) in
                                  let ret := M.copy (| Ty.path "i16", γ0_0 |) in
                                  M.never_to_any (|
                                    M.read (|
                                      let~ _ : Ty.tuple [] :=
                                        M.call_closure (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  let γ0_0 :=
                                    M.SubPointer.get_struct_tuple_field (|
                                      ...
                                      0
                                    |) in
                                  let ret := M.copy (| Ty.path "u32", γ0_0 |) in
                                  M.never_to_any (|
                                    M.read (|
                                      let~ _ : Ty.tuple [] :=
                                        M.call_closure (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  let γ0_0 :=
                                    M.SubPointer.get_struct_tuple_field (|
                                      ...
                                      0
                                    |) in
                                  let ret := M.copy (| Ty.path "i32", γ0_0 |) in
                                  M.never_to_any (|
                                    M.read (|
                                      let~ _ : Ty.tuple [] :=
                                        M.call_closure (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  let γ0_0 :=
                                    M.SubPointer.get_struct_tuple_field (|
                                      ...
                                      0
                                    |) in
                                  let ret := M.copy (| Ty.path "u64", γ0_0 |) in
                                  M.never_to_any (|
                                    M.read (|
                                      let~ _ : Ty.tuple [] :=
                                        M.call_closure (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  let γ0_0 :=
                                    M.SubPointer.get_struct_tuple_field (|
                                      ...
                                      0
                                    |) in
                                  let ret := M.copy (| Ty.path "i64", γ0_0 |) in
                                  M.never_to_any (|
                                    M.read (|
                                      let~ _ : Ty.tuple [] :=
                                        M.call_closure (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  let γ0_0 :=
                                    M.SubPointer.get_struct_tuple_field (|
                                      ...
                                      0
                                    |) in
                                  let ret := M.copy (| Ty.path "u128", γ0_0 |) in
                                  M.never_to_any (|
                                    M.read (|
                                      let~ _ : Ty.tuple [] :=
                                        M.call_closure (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  let γ0_0 :=
                                    M.SubPointer.get_struct_tuple_field (|
                                      ...
                                      0
                                    |) in
                                  let ret := M.copy (| Ty.path "i128", γ0_0 |) in
                                  M.never_to_any (|
                                    M.read (|
                                      let~ _ : Ty.tuple [] :=
                                        M.call_closure (|
                            ...
                            ltac:(M.monadic
                              (let γ0_0 :=
                                M.SubPointer.get_struct_tuple_field (|
                                  ...
                                  0
                                |) in
                              let slice_at := M.copy (| Ty.path "usize", γ0_0 |) in
                              M.read (| slice_at |)));
                          fun γ =>
                            ltac:(M.monadic
      ...
      Definition remaining (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "std::io::cursor::Cursor") [] [ T ] ],
                self
              |) in
            M.call_closure (|
              Ty.path "usize",
    ...
    Definition _assert_trait_object (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ _b ] =>
        ltac:(M.monadic
          (let _b :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.dyn [ ("bytes::buf::buf_impl::Buf::Trait", []) ] ],
              _b
            |) in
          Value.Tuple []))
      | _, _, _ => M.impossible "wrong number of arguments"
