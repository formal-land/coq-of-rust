  ...
  Module Impl_bytes_bytes_Bytes.
                  ...
                  M.read (|
                    ...
                    let~ _ : Ty.tuple [] :=
                      M.read (|
                        ...
                        |)
                      |) in
                    let~ ret : Ty.path "bytes::bytes::Bytes" :=
                      M.call_closure (|
                        Ty.path "bytes::bytes::Bytes",
                        M.get_trait_method (|
                          "core::clone::Clone",
    ...
    *)
    Definition split_off (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; at_ ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "bytes::bytes::Bytes" ], self |) in
    ...
    *)
    Definition try_into_mut (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.path "bytes::bytes::Bytes", self |) in
          M.read (|
            M.match_operator (|
              Ty.apply
    ...
    Definition inc_start (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; by_ ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "bytes::bytes::Bytes" ], self |) in
          let by_ := M.alloc (| Ty.path "usize", by_ |) in
          M.read (|
            let~ _ : Ty.tuple [] :=
              M.read (|
                M.match_operator (|
  ...
  Module Impl_core_convert_From_bytes_bytes_Bytes_for_bytes_bytes_mut_BytesMut.
    ...
    *)
    Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ bytes ] =>
        ltac:(M.monadic
          (let bytes := M.alloc (| Ty.path "bytes::bytes::Bytes", bytes |) in
          M.read (|
            let~ bytes :
                Ty.apply
                  (Ty.path "core::mem::manually_drop::ManuallyDrop")
    ...
    *)
    Definition fmt (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; f ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "bytes::bytes::Vtable" ], self |) in
          let f :=
      ...
      ltac:(M.monadic
        (let β0 :=
          M.alloc (|
            ...
            β0
          |) in
        let β1 := M.alloc (| Ty.apply (Ty.path "*const") [] [ Ty.path "u8" ], β1 |) in
        let β2 := M.alloc (| Ty.path "usize", β2 |) in
        M.match_operator (|
          Ty.tuple [],
          β0,
          [
  ...
  Definition free_boxed_slice (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ buf; offset; len ] =>
      ltac:(M.monadic
        ...
        let offset := M.alloc (| Ty.apply (Ty.path "*const") [] [ Ty.path "u8" ], offset |) in
        let len := M.alloc (| Ty.path "usize", len |) in
        M.read (|
          let~ cap : Ty.path "usize" :=
            M.call_closure (|
    ...
    *)
    Definition drop (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "bytes::bytes::Shared" ], self |) in
          M.call_closure (|
            Ty.tuple [],
            M.get_function (| "alloc::alloc::dealloc", [], [] |),
            [
  ...
  *)
  Definition shared_to_vec_impl (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ shared; ptr; len ] =>
      ltac:(M.monadic
        (let shared :=
          M.alloc (| Ty.apply (Ty.path "*mut") [] [ Ty.path "bytes::bytes::Shared" ], shared |) in
        let ptr := M.alloc (| Ty.apply (Ty.path "*const") [] [ Ty.path "u8" ], ptr |) in
        let len := M.alloc (| Ty.path "usize", len |) in
        M.read (|
          M.match_operator (|
                ...
                ltac:(M.monadic
                  (let γ :=
                    M.use
                      ...
                      |)) in
                  let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                  let~ shared : Ty.path "bytes::bytes::Shared" :=
                    M.read (|
                      M.deref (|
                        M.call_closure (|
                          Ty.apply
            ...
            [
              fun γ =>
                ltac:(M.monadic
                  ...
                  let actual := M.copy (| Ty.apply (Ty.path "*mut") [] [ Ty.tuple [] ], γ0_0 |) in
                  let~ _ : Ty.tuple [] :=
                    M.read (|
                      M.match_operator (|
                        Ty.tuple [],
  ...
  *)
  Definition release_shared (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ ptr ] =>
      ltac:(M.monadic
        (let ptr :=
          M.alloc (| Ty.apply (Ty.path "*mut") [] [ Ty.path "bytes::bytes::Shared" ], ptr |) in
        M.read (|
  ...
  Definition ptr_map (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [ F ], [ ptr; f ] =>
      ltac:(M.monadic
        ...
        M.read (|
          let~ old_addr : Ty.path "usize" := M.cast (Ty.path "usize") (M.read (| ptr |)) in
          let~ new_addr : Ty.path "usize" :=
            M.call_closure (|
              Ty.path "usize",
              M.get_trait_method (|
