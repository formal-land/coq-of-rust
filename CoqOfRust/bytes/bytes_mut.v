...
Module bytes_mut.
  ...
  Definition value_MIN_ORIGINAL_CAPACITY_WIDTH
      ...
      (α : list Value.t)
      : M :=
    ltac:(M.monadic (M.alloc (| Ty.path "usize", Value.Integer IntegerKind.Usize 10 |))).
  ...
  Definition value_ORIGINAL_CAPACITY_MASK
      ...
      (α : list Value.t)
      : M :=
    ltac:(M.monadic (M.alloc (| Ty.path "usize", Value.Integer IntegerKind.Usize 28 |))).
  ...
  Module Impl_bytes_bytes_mut_BytesMut.
    ...
    *)
    Definition freeze (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.path "bytes::bytes_mut::BytesMut", self |) in
          M.read (|
            let~ bytes :
                Ty.apply
                    ...
                    ltac:(M.monadic
                      ...
                      M.read (|
                        ...
                        let~ vec :
                          ...
                          |) in
                        let~ b : Ty.path "bytes::bytes::Bytes" :=
                          M.call_closure (|
                            Ty.path "bytes::bytes::Bytes",
                            M.get_trait_method (|
                              "core::convert::Into",
        ...
        ltac:(M.monadic
          ...
          M.read (|
            let~ _ : Ty.tuple [] :=
                                          ...
                                          [
                                            M.call_closure (|
                                              ...
                                              [
                                                M.borrow (|
                                                  Pointer.Kind.Ref,
                                                  M.deref (| M.borrow (| Pointer.Kind.Ref, at_ |) |)
                                                |)
                                              ]
                                            |);
                                            M.call_closure (|
              ...
              |) in
            let~ other : Ty.path "bytes::bytes_mut::BytesMut" :=
              M.call_closure (|
                Ty.path "bytes::bytes_mut::BytesMut",
                M.get_associated_function (|
                  Ty.path "bytes::bytes_mut::BytesMut",
      ...
      | [], [], [ self; additional; allocate ] =>
        ltac:(M.monadic
          (let self :=
            ...
            |) in
          let additional := M.alloc (| Ty.path "usize", additional |) in
          let allocate := M.alloc (| Ty.path "bool", allocate |) in
              ...
              (M.never_to_any (|
                M.read (|
                          ...
                          ltac:(M.monadic
                            (let γ0_0 :=
                              M.SubPointer.get_struct_tuple_field (|
                                ...
                                0
                              |) in
                            let new_cap := M.copy (| Ty.path "usize", γ0_0 |) in
                            M.read (| new_cap |)));
                        fun γ =>
                          ltac:(M.monadic
                            (let _ := M.is_struct_tuple (| γ, "core::option::Option::None" |) in
                            let γ :=
                              M.alloc (| Ty.path "bool", UnOp.not (| M.read (| allocate |) |) |) in
                            let _ :=
                              is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                                                      ...
                                                      M.write (|
                                                        ...
                                                        M.call_closure (|
                                                          ...
                                                          [
                                                            ...
                                                            M.borrow (|
                                                              Pointer.Kind.Ref,
                                                              M.deref (| mk_str (| "overflow" |) |)
                                                            |)
                                                          ]
                                                        |)
                                                      |) in
                                                    let~ double : Ty.path "usize" :=
                                                      M.call_closure (|
                                                        Ty.path "usize",
                                                        M.get_associated_function (|
                                                          Ty.apply
                  ...
                  let~ _ : Ty.tuple [] :=
                    ...
                    |) in
                  let~ original_capacity_repr : Ty.path "usize" :=
                    M.read (|
                      M.SubPointer.get_struct_record_field (|
                        M.deref (| M.read (| shared |) |),
                        "bytes::bytes_mut::Shared",
                      ...
                      |)
                    |) in
                  let~ original_capacity : Ty.path "usize" :=
                    M.call_closure (|
                      Ty.path "usize",
                      M.get_function (| "bytes::bytes_mut::original_capacity_from_repr", [], [] |),
        ...
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              ...
              self
            |) in
          let other := M.alloc (| Ty.path "bytes::bytes_mut::BytesMut", other |) in
          M.catch_return (Ty.tuple []) (|
            ltac:(M.monadic
              (M.read (|
                let~ _ : Ty.tuple [] :=
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          M.never_to_any (|
                            M.read (|
                              let~ _ : Ty.tuple [] :=
                                M.write (| M.deref (| M.read (| self |) |), M.read (| other |) |) in
                              M.return_ (| Value.Tuple [] |)
                            |)
                          |)));
                      fun γ => ltac:(M.monadic (Value.Tuple []))
                        ...
                        ltac:(M.monadic
                          ...
                          let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let other := M.copy (| Ty.path "bytes::bytes_mut::BytesMut", γ0_0 |) in
                          M.read (|
                            let~ _ : Ty.tuple [] :=
                              M.call_closure (|
                                Ty.tuple [],
        ...
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              ...
              self
            |) in
          let ref_cnt := M.alloc (| Ty.path "usize", ref_cnt |) in
          M.read (|
            let~ _ : Ty.tuple [] :=
              M.match_operator (|
                Ty.tuple [],
            ...
            let~ original_capacity_repr : Ty.path "usize" :=
              M.call_closure (|
                ...
                [
                  ...
                  |);
                  M.read (|
                    get_constant (| "bytes::bytes_mut::ORIGINAL_CAPACITY_OFFSET", Ty.path "usize" |)
                  |)
                ]
              |) in
            let~ off : Ty.path "usize" :=
            ...
            let~ shared :
              ...
              |) in
            let~ shared : Ty.apply (Ty.path "*mut") [] [ Ty.path "bytes::bytes_mut::Shared" ] :=
              M.call_closure (|
                Ty.apply (Ty.path "*mut") [] [ Ty.path "bytes::bytes_mut::Shared" ],
                M.get_associated_function (|
                  Ty.apply
  ...
  Module Impl_core_convert_From_bytes_bytes_mut_BytesMut_for_bytes_bytes_Bytes.
    ...
    *)
    Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ src ] =>
        ltac:(M.monadic
          (let src := M.alloc (| Ty.path "bytes::bytes_mut::BytesMut", src |) in
          M.call_closure (|
            Ty.path "bytes::bytes::Bytes",
            M.get_associated_function (| Ty.path "bytes::bytes_mut::BytesMut", "freeze", [], [] |),
            [ M.read (| src |) ]
    ...
    Definition hash (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ H ], [ self; state ] =>
        ltac:(M.monadic
          ...
          M.read (|
            let~ s : Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "slice") [] [ Ty.path "u8" ] ] :=
              M.borrow (|
                Pointer.Kind.Ref,
                M.deref (|
                  M.call_closure (|
                                    ...
                                    fun γ =>
                                      ltac:(M.monadic
                                        (let γ0_0 :=
                                          ...
                                          |) in
                                        let bytes :=
                                          M.copy (| Ty.path "bytes::bytes::Bytes", γ0_0 |) in
                                        M.call_closure (|
                                          Ty.tuple [],
                                          M.get_associated_function (|
                                            Ty.path "bytes::bytes_mut::BytesMut",
  ...
  *)
  Definition increment_shared (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ ptr ] =>
      ltac:(M.monadic
        (let ptr :=
          M.alloc (| Ty.apply (Ty.path "*mut") [] [ Ty.path "bytes::bytes_mut::Shared" ], ptr |) in
        M.read (|
          let~ old_size : Ty.path "usize" :=
            M.call_closure (|
              Ty.path "usize",
              M.get_associated_function (|
                Ty.path "core::sync::atomic::AtomicUsize",
                          ...
                          M.call_closure (|
                            ...
                            [
                              ...
                              M.cast
                                (Ty.path "usize")
                                (M.read (|
                                  get_constant (| "core::isize::MAX", Ty.path "isize" |)
                                |))
                            ]
                          |)
                        |)) in
    ...
    *)
    Definition is_unique (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "bytes::bytes_mut::Shared" ], self |) in
          M.call_closure (|
            Ty.path "bool",
            BinOp.eq,
            [
  ...
  *)
  Definition original_capacity_to_repr (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ cap ] =>
      ltac:(M.monadic
        (let cap := M.alloc (| Ty.path "usize", cap |) in
        M.read (|
  ...
  *)
  Definition original_capacity_from_repr
    ...
    | [], [], [ repr ] =>
      ltac:(M.monadic
        (let repr := M.alloc (| Ty.path "usize", repr |) in
      ...
      | [], [], [ self; other ] =>
        ltac:(M.monadic
          (let self :=
            ...
            |) in
          let other :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "&") [] [ T ] ], other |) in
          M.call_closure (|
            Ty.path "bool",
            M.get_trait_method (|
              "core::cmp::PartialEq",
  ...
  Module Impl_core_convert_From_bytes_bytes_mut_BytesMut_for_alloc_vec_Vec_u8_alloc_alloc_Global.
    ...
    *)
    Definition from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ bytes ] =>
        ltac:(M.monadic
          (let bytes := M.alloc (| Ty.path "bytes::bytes_mut::BytesMut", bytes |) in
          M.catch_return
            (Ty.apply
              (Ty.path "alloc::vec::Vec")
              []
        ...
        M.read (|
          ...
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
              ...
              [ M.read (| shared |) ]
            |) in
          let~ data : Ty.apply (Ty.path "core::sync::atomic::AtomicPtr") [] [ Ty.tuple [] ] :=
            M.call_closure (|
              Ty.apply (Ty.path "core::sync::atomic::AtomicPtr") [] [ Ty.tuple [] ],
              M.get_associated_function (|
                Ty.apply (Ty.path "core::sync::atomic::AtomicPtr") [] [ Ty.tuple [] ],
                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    M.read (|
                      let~ shared :
                          Ty.apply (Ty.path "&mut") [] [ Ty.path "bytes::bytes_mut::Shared" ] :=
                        M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| shared |) |) |) in
                      let~ vec :
                          Ty.apply
                            (Ty.path "alloc::vec::Vec")
                            []
                    ...
                    M.read (|
                      ...
                      let~ v_capacity : Ty.path "usize" :=
                        M.call_closure (|
                          ...
                          [ M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| v |) |) |) ]
                        |) in
                      let~ v_ptr : Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ] :=
                        M.call_closure (|
                          Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                          M.get_associated_function (|
                            Ty.apply
      ...
      ltac:(M.monadic
        (let data :=
          M.alloc (|
            ...
            data
          |) in
        let _ptr := M.alloc (| Ty.apply (Ty.path "*const") [] [ Ty.path "u8" ], _ptr |) in
        let _len := M.alloc (| Ty.path "usize", _len |) in
        M.read (|
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
              Ty.tuple [],
