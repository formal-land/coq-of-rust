...
Module array.
  ...
  *)
  Definition from_mut (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [ T ], [ s ] =>
      ltac:(M.monadic
        (let s := M.alloc (| Ty.apply (Ty.path "&mut") [] [ T ], s |) in
        M.borrow (|
          Pointer.Kind.MutRef,
          M.deref (|
            M.borrow (|
  ...
  *)
  Definition from_trusted_iterator (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [ N ], [ T; impl_UncheckedIterator_Item___T_ ], [ iter ] =>
      ltac:(M.monadic
        (let iter := M.alloc (| impl_UncheckedIterator_Item___T_, iter |) in
        M.read (|
          M.SubPointer.get_struct_tuple_field (|
            M.alloc (|
              Ty.apply
  ...
  *)
  Definition try_from_trusted_iterator (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [ N ], [ T; R; impl_UncheckedIterator_Item___R_ ], [ iter ] =>
      ltac:(M.monadic
        (let iter := M.alloc (| impl_UncheckedIterator_Item___R_, iter |) in
        M.read (|
          let~ _ : Ty.tuple [] :=
            M.match_operator (|
              Ty.tuple [],
    ...
    Definition push_unchecked
      ...
      | [], [], [ self; item ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "core::array::Guard") [] [ T ] ],
              self
            |) in
              ...
              [
                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let initialized := M.copy (| Ty.path "usize", γ0_0 |) in
                    Value.StructTuple
                                        ...
                                        M.read (|
                                          let~ _ : Ty.tuple [] :=
                                            M.call_closure (|
                                              ...
                                              |),
                                              [
                                                M.borrow (| Pointer.Kind.MutRef, guard |);
                                                M.read (| item |)
                                              ]
                                            |) in
                                          M.alloc (| Ty.tuple [], Value.Tuple [] |)
