...
Module cell.
    ...
    Definition clone (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "core::cell::Cell") [] [ T ] ],
              self
            |) in
          M.call_closure (|
  ...
  Module Impl_core_cell_Cell_T.
    ...
    *)
    Definition into_inner (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "core::cell::Cell") [] [ T ], self |) in
          M.call_closure (|
            T,
            M.get_associated_function (|
              Ty.apply (Ty.path "core::cell::UnsafeCell") [] [ T ],
    ...
    Definition get_mut (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "core::cell::Cell") [] [ T ] ],
              self
            |) in
          M.borrow (|
            Pointer.Kind.MutRef,
                    ...
                    M.borrow (|
                      ...
                      M.alloc (|
                        Ty.apply
                          ...
                          [ Value.Integer IntegerKind.Usize 1 ]
                          [ Ty.apply (Ty.path "&") [] [ Ty.path "str" ] ],
                        Value.Array [ mk_str (| "already borrowed: " |) ]
                      |)
                    |)
                  |)
                |);
  ...
  *)
                    ...
                    M.borrow (|
                      ...
                      M.alloc (|
                        Ty.apply
                          ...
                          [ Value.Integer IntegerKind.Usize 1 ]
                          [ Ty.apply (Ty.path "&") [] [ Ty.path "str" ] ],
                        Value.Array [ mk_str (| "already mutably borrowed: " |) ]
                      |)
                    |)
                  |)
                |);
  ...
  Definition value_UNUSED (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ltac:(M.monadic (M.alloc (| Ty.path "isize", Value.Integer IntegerKind.Isize 0 |))).
  ...
  *)
  Definition is_writing (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ x ] =>
      ltac:(M.monadic
        (let x := M.alloc (| Ty.path "isize", x |) in
        M.call_closure (|
          Ty.path "bool",
          BinOp.lt,
          [ M.read (| x |); M.read (| get_constant (| "core::cell::UNUSED", Ty.path "isize" |) |) ]
        |)))
    | _, _, _ => M.impossible "wrong number of arguments"
    end.
  ...
  Module Impl_core_cell_RefCell_T.
    ...
    *)
    Definition into_inner (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "core::cell::RefCell") [] [ T ], self |) in
          M.call_closure (|
            T,
            M.get_associated_function (|
              Ty.apply (Ty.path "core::cell::UnsafeCell") [] [ T ],
              ...
              [
                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let err := M.copy (| Ty.path "core::cell::BorrowError", γ0_0 |) in
                    M.alloc (|
                      Ty.apply (Ty.path "core::cell::Ref") [] [ T ],
                      M.never_to_any (|
                        M.call_closure (|
                  ...
                  ltac:(M.monadic
                    (let γ0_0 :=
                      M.SubPointer.get_struct_tuple_field (|
                        ...
                        0
                      |) in
                    let b := M.copy (| Ty.path "core::cell::BorrowRef", γ0_0 |) in
              ...
              [
                ...
                fun γ =>
                  ltac:(M.monadic
                    (let γ0_0 :=
                      M.SubPointer.get_struct_tuple_field (| γ, "core::result::Result::Err", 0 |) in
                    let err := M.copy (| Ty.path "core::cell::BorrowMutError", γ0_0 |) in
                    M.alloc (|
                      Ty.apply (Ty.path "core::cell::RefMut") [] [ T ],
                      M.never_to_any (|
                        M.call_closure (|
        ...
        ltac:(M.monadic
          ...
          M.read (|
            M.match_operator (|
              ...
              M.alloc (|
                Ty.apply (Ty.path "core::option::Option") [] [ Ty.path "core::cell::BorrowRefMut" ],
                M.call_closure (|
                  Ty.apply
                  ...
                  ltac:(M.monadic
                    (let γ0_0 :=
                      M.SubPointer.get_struct_tuple_field (|
                        ...
                        0
                      |) in
                    let b := M.copy (| Ty.path "core::cell::BorrowRefMut", γ0_0 |) in
                    let~ value : Ty.apply (Ty.path "core::ptr::non_null::NonNull") [] [ T ] :=
                      M.call_closure (|
                        Ty.apply (Ty.path "core::ptr::non_null::NonNull") [] [ T ],
                        M.get_associated_function (|
    ...
    Definition get_mut (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "core::cell::RefCell") [] [ T ] ],
              self
            |) in
          M.borrow (|
            Pointer.Kind.MutRef,
    ...
    *)
    Definition drop (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "core::cell::BorrowRef" ], self |) in
          M.read (|
    ...
    *)
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::cell::BorrowRef" ], self |) in
          M.read (|
            let~ borrow : Ty.path "isize" :=
              M.call_closure (|
                Ty.path "isize",
              ...
              [
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let a := M.copy (| Ty.apply (Ty.path "&") [] [ U ], γ0_0 |) in
                    let b := M.copy (| Ty.apply (Ty.path "&") [] [ V ], γ0_1 |) in
  ...
  Module Impl_core_cell_RefMut_T.
    ...
    *)
    Definition map (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ U; F ], [ orig; f ] =>
        ltac:(M.monadic
          (let orig := M.alloc (| Ty.apply (Ty.path "core::cell::RefMut") [] [ T ], orig |) in
          let f := M.alloc (| F, f |) in
          M.read (|
        ...
        ltac:(M.monadic
          ...
          M.read (|
            M.match_operator (|
              ...
              M.alloc (|
                Ty.apply (Ty.path "core::option::Option") [] [ Ty.apply (Ty.path "&mut") [] [ U ] ],
                M.call_closure (|
                  Ty.apply
                    (Ty.path "core::option::Option")
                    []
        ...
        ltac:(M.monadic
          ...
          M.read (|
            ...
            M.match_operator (|
              ...
              M.alloc (|
                Ty.tuple [ Ty.apply (Ty.path "&mut") [] [ U ]; Ty.apply (Ty.path "&mut") [] [ V ] ],
                M.call_closure (|
                  Ty.tuple
              ...
              [
                fun γ =>
                  ltac:(M.monadic
                    (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                    let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                    let a := M.copy (| Ty.apply (Ty.path "&mut") [] [ U ], γ0_0 |) in
                    let b := M.copy (| Ty.apply (Ty.path "&mut") [] [ V ], γ0_1 |) in
                    M.alloc (|
                      Ty.tuple
                        [
                          Ty.apply (Ty.path "core::cell::RefMut") [] [ U ];
    ...
    Definition drop (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.path "core::cell::BorrowRefMut" ],
              self
            |) in
          M.read (|
            let~ borrow : Ty.path "isize" :=
    ...
    *)
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::cell::BorrowRefMut" ], self |) in
          M.read (|
            let~ borrow : Ty.path "isize" :=
              M.call_closure (|
                Ty.path "isize",
    ...
    Definition deref (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "core::cell::RefMut") [] [ T ] ],
              self
            |) in
          M.borrow (|
            Pointer.Kind.Ref,
    ...
    Definition deref_mut (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "core::cell::RefMut") [] [ T ] ],
              self
            |) in
          M.borrow (|
            Pointer.Kind.MutRef,
  ...
  Module Impl_core_cell_UnsafeCell_T.
    ...
    *)
    Definition into_inner (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "core::cell::UnsafeCell") [] [ T ], self |) in
          M.read (|
    ...
    Definition get (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "core::cell::UnsafeCell") [] [ T ] ],
              self
            |) in
          M.cast
            (Ty.apply (Ty.path "*mut") [] [ T ])
    ...
    Definition get_mut (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "core::cell::UnsafeCell") [] [ T ] ],
              self
            |) in
          M.borrow (|
            Pointer.Kind.MutRef,
    ...
    *)
    Definition into_inner (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "core::cell::SyncUnsafeCell") [] [ T ], self |) in
          M.call_closure (|
            T,
            M.get_associated_function (|
              Ty.apply (Ty.path "core::cell::UnsafeCell") [] [ T ],
