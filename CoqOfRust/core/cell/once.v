...
Module cell.
  Module once.
    ...
    Module Impl_core_cell_once_OnceCell_T.
      ...
      *)
      Definition try_insert (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [], [ self; value ] =>
          ltac:(M.monadic
      ...
      *)
      Definition get_or_init (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [ F ], [ self; f ] =>
          ltac:(M.monadic
      ...
      *)
      Definition get_or_try_init (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [ F; E ], [ self; f ] =>
          ltac:(M.monadic
                                          ...
                                          M.of_value (|
                                            Value.Array
                                              [
                                                A.to_value
                                                  (M.read (|
                                                    M.of_value (| Value.String "reentrant init" |)
                                                  |))
                                              ]
                                          |)
                                        |)
