                      ...
                      [
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let a :=
                              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "u8" ], γ2_0 |) in
                            let~ _ : Ty.tuple [] :=
                              M.write (|
                                M.deref (| M.read (| a |) |),
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let a :=
                              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "u8" ], γ2_0 |) in
                            let b :=
                              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "u8" ], γ2_1 |) in
                            let~ _ : Ty.tuple [] :=
                              M.write (|
                                M.deref (| M.read (| a |) |),
                                M.call_closure (|
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let b :=
                              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "u8" ], γ2_1 |) in
                            let c :=
                              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "u8" ], γ2_2 |) in
                            let~ _ : Ty.tuple [] :=
                              M.write (|
                                M.deref (| M.read (| a |) |),
                                M.call_closure (|
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let c :=
                              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "u8" ], γ2_2 |) in
                            let d :=
                              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "u8" ], γ2_3 |) in
                            let~ _ : Ty.tuple [] :=
                              M.write (|
                                M.deref (| M.read (| a |) |),
                                M.call_closure (|
