                        ...
                        ltac:(M.monadic
                          (let γ :=
                            M.use
                              (M.alloc (|
                                LogicalOp.and (|
                                  BinOp.gt (| M.read (| self |), Value.UnicodeChar 57 |),
                                  ltac:(M.monadic
                                    (BinOp.gt (|
                                      M.read (| radix |),
                          ...
                          let~ lower : Ty.path "u32" :=
                            BinOp.bit_or
                              ...
                              (Value.Integer IntegerKind.U32 32) in
                          M.alloc (|
                            BinOp.Wrap.add (|
                              M.cast
                                (Ty.path "u64")
                      ...
                      (let γ :=
                        M.use
                          (M.alloc (|
                            BinOp.lt (|
                              M.read (| value |),
                              M.cast (Ty.path "u64") (M.read (| radix |))
                            |)
                          |)) in
      ...
      Definition escape_debug_ext (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; args ] =>
          ltac:(M.monadic
            ...
            M.read (|
              M.match_operator (|
                Some (Ty.path "core::char::EscapeDebug"),
                self,
                [
                  fun γ =>
                    ltac:(M.monadic
      ...
      Definition escape_default (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            ...
            M.read (|
              M.match_operator (|
                Some (Ty.path "core::char::EscapeDefault"),
                self,
                [
                  fun γ =>
                    ltac:(M.monadic
