      ...
      Definition eq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; other ] =>
          ltac:(M.monadic
            ...
            let other :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::ffi::c_str::CStr" ], other |) in
            M.call_closure (|
              Ty.path "bool",
              M.get_trait_method (|
                "core::cmp::PartialEq",
      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "core::ffi::c_str::FromBytesUntilNulError" ],
                self
              |) in
            Value.StructTuple
    ...
    Module Impl_core_ffi_c_str_CStr.
      ...
      *)
      Definition from_ptr (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ ptr ] =>
          ltac:(M.monadic
            (let ptr := M.alloc (| Ty.apply (Ty.path "*const") [] [ Ty.path "i8" ], ptr |) in
            M.read (|
    ...
    Module Impl_core_iter_traits_iterator_Iterator_for_core_ffi_c_str_Bytes.
      ...
      Definition next (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&mut") [] [ Ty.path "core::ffi::c_str::Bytes" ],
                self
              |) in
            M.read (|
              let~ ret : Ty.path "u8" :=
      ...
      *)
      Definition count (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "core::ffi::c_str::Bytes", self |) in
            M.call_closure (|
              Ty.path "usize",
              M.get_function (| "core::ffi::c_str::strlen", [], [] |),
              [
