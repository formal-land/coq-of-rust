                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let γ :=
                          ...
                          |) in
                        let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        let~ old_fill : Ty.apply (Ty.path "*") [] [ Ty.path "char" ] :=
                          M.alloc (|
                            M.call_closure (|
                              Ty.path "char",
                        ...
                        let~ post_padding :
                          ...
                          M.copy (|
                            M.match_operator (|
                              Some (Ty.apply (Ty.path "*") [] [ Ty.path "core::fmt::PostPadding" ]),
                              M.alloc (|
                                M.call_closure (|
                                  Ty.apply
                                    (Ty.path "core::ops::control_flow::ControlFlow")
                  ...
                  [
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let~ chars_count : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                          M.alloc (|
                            M.call_closure (|
                              Ty.path "usize",
                              M.get_trait_method (|
      ...
      | [], [], [ self; padding; default ] =>
        ltac:(M.monadic
          ...
          M.catch_return
            ...
            ltac:(M.monadic
              (M.read (|
                let~ align : Ty.apply (Ty.path "*") [] [ Ty.path "core::fmt::Alignment" ] :=
                  M.copy (|
                    M.match_operator (|
                      Some (Ty.apply (Ty.path "*") [] [ Ty.path "core::fmt::Alignment" ]),
                      M.SubPointer.get_struct_record_field (|
                        M.deref (| M.read (| self |) |),
                        "core::fmt::Formatter",
                        "align"
    ...
    Definition debug_tuple_field1_finish
      ...
      | [], [], [ self; name; value1 ] =>
        ltac:(M.monadic
          ...
          M.read (|
            let~ builder :
                Ty.apply (Ty.path "*") [] [ Ty.path "core::fmt::builders::DebugTuple" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "core::fmt::builders::DebugTuple",
                  M.get_function (| "core::fmt::builders::debug_tuple_new", [], [] |),
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          ...
          M.read (|
            M.match_operator (|
              Some (Ty.apply (Ty.path "*") [] [ Ty.path "core::fmt::Arguments" ]),
    ...
    Definition estimated_capacity (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
          M.read (|
            let~ pieces_length : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "usize",
                  M.get_trait_method (|
            ...
            ltac:(M.monadic
              (M.read (|
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ esc : Ty.apply (Ty.path "*") [] [ Ty.path "core::char::EscapeDebug" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "core::char::EscapeDebug",
        ...
        M.read (|
          let~ old_width :
            ...
            M.copy (|
              ...
              |)
            |) in
          let~ old_flags : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
            M.copy (|
              M.SubPointer.get_struct_record_field (|
                M.deref (| M.read (| f |) |),
                "core::fmt::Formatter",
    ...
    Definition fmt (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; f ] =>
        ltac:(M.monadic
          ...
          let f := M.alloc (| f |) in
          M.read (|
            let~ d : Ty.apply (Ty.path "*") [] [ Ty.path "core::fmt::builders::DebugStruct" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "core::fmt::builders::DebugStruct",
                  M.get_associated_function (|
