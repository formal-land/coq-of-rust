...
Module fmt.
  ...
  *)
  ...
  Module Impl_core_cmp_PartialEq_core_fmt_Alignment_for_core_fmt_Alignment.
    Definition Self : Ty.t := Ty.path "core::fmt::Alignment".
    ...
    Axiom Implements :
      M.IsTraitInstance
        "core::cmp::PartialEq"
        (* Trait polymorphic consts *) []
        (* Trait polymorphic types *) [ Ty.path "core::fmt::Alignment" ]
        Self
        (* Instance *) [ ("eq", InstanceField.Method eq) ].
  End Impl_core_cmp_PartialEq_core_fmt_Alignment_for_core_fmt_Alignment.
  ...
  Module Impl_core_cmp_PartialEq_core_fmt_Error_for_core_fmt_Error.
    Definition Self : Ty.t := Ty.path "core::fmt::Error".
    ...
    Axiom Implements :
      M.IsTraitInstance
        ...
        Self
        (* Instance *) [ ("eq", InstanceField.Method eq) ].
  End Impl_core_cmp_PartialEq_core_fmt_Error_for_core_fmt_Error.
  
  Module Impl_core_cmp_PartialOrd_core_fmt_Error_for_core_fmt_Error.
    Definition Self : Ty.t := Ty.path "core::fmt::Error".
  ...
  End Impl_core_cmp_PartialOrd_core_fmt_Error_for_core_fmt_Error.
            ...
            ltac:(M.monadic
              (M.read (|
                let~ width : Ty.path "usize" :=
                  ...
                  |) in
                let~ sign : Ty.apply (Ty.path "core::option::Option") [] [ Ty.path "char" ] :=
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let~ old_fill : Ty.path "char" :=
                          ...
                          |) in
                        let~ old_align : Ty.path "core::fmt::rt::Alignment" :=
                          M.call_closure (|
                        ...
                        let~ _ : Ty.tuple [] :=
                          M.read (|
                            ...
                            |)
                          |) in
                        let~ post_padding : Ty.path "core::fmt::PostPadding" :=
                          M.read (|
                            M.match_operator (|
                              Some (Ty.path "core::fmt::PostPadding"),
                              M.alloc (|
                                M.call_closure (|
                                  Ty.apply
                                    (Ty.path "core::ops::control_flow::ControlFlow")
                      ...
                      ltac:(M.monadic
                        ...
                        M.match_operator (|
                          ...
                          [
                            ...
                            fun γ =>
                              ltac:(M.monadic
                                (let~ align : Ty.path "core::fmt::Alignment" :=
                                  Value.StructTuple "core::fmt::Alignment::Left" [] in
                                let~ post_padding : Ty.path "core::fmt::PostPadding" :=
                                  M.read (|
                                    M.match_operator (|
                                      Some (Ty.path "core::fmt::PostPadding"),
            ...
            ltac:(M.monadic
              (M.read (|
                let~ align : Ty.path "core::fmt::Alignment" :=
                  M.read (|
                    M.match_operator (|
                      Some (Ty.path "core::fmt::Alignment"),
                      M.SubPointer.get_struct_record_field (|
                        M.deref (| M.read (| self |) |),
                        "core::fmt::Formatter",
                        "align"
    ...
    Definition debug_tuple_field1_finish
      ...
      | [], [], [ self; name; value1 ] =>
        ltac:(M.monadic
          ...
          let value1 := M.alloc (| value1 |) in
          M.read (|
            let~ builder : Ty.path "core::fmt::builders::DebugTuple" :=
              M.call_closure (|
                Ty.path "core::fmt::builders::DebugTuple",
                M.get_function (| "core::fmt::builders::debug_tuple_new", [], [] |),
                [
    ...
    Definition new_const (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [ N ], [], [ pieces ] =>
        ltac:(M.monadic
          ...
          M.read (|
            let~ _ : Ty.tuple [] :=
              M.read (| M.get_constant "core::fmt::new_const_discriminant" |) in
            M.alloc (|
              Value.StructRecord
                "core::fmt::Arguments"
                [
    ...
    Definition new_v1 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [ P; A ], [], [ pieces; args ] =>
        ltac:(M.monadic
          ...
          let args := M.alloc (| args |) in
          M.read (|
            let~ _ : Ty.tuple [] := M.read (| M.get_constant "core::fmt::new_v1_discriminant" |) in
            M.alloc (|
              Value.StructRecord
                "core::fmt::Arguments"
                [
    ...
    Definition estimated_capacity (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
          M.read (|
            let~ pieces_length : Ty.path "usize" :=
              M.call_closure (|
                Ty.path "usize",
                M.get_trait_method (|
                  "core::iter::traits::iterator::Iterator",
        ...
        M.read (|
          ...
          let~ _ : Ty.tuple [] :=
            M.read (|
              ...
              |)
            |) in
          let~ value : Ty.apply (Ty.path "&") [] [ Ty.path "core::fmt::rt::Argument" ] :=
            M.call_closure (|
              Ty.apply (Ty.path "&") [] [ Ty.path "core::fmt::rt::Argument" ],
              M.get_associated_function (|
                Ty.apply (Ty.path "slice") [] [ Ty.path "core::fmt::rt::Argument" ],
                "get_unchecked",
                [],
          ...
          M.catch_return (|
            ltac:(M.monadic
              (M.read (|
                ...
                let~ rest : Ty.apply (Ty.path "&") [] [ Ty.path "str" ] := M.read (| self |) in
                let~ _ : Ty.tuple [] :=
                  M.read (|
                    M.loop (|
                      Ty.tuple [],
                                              ...
                                              [
                                                fun γ =>
                                                  ltac:(M.monadic
                                                    ...
                                                    let~ esc : Ty.path "core::char::EscapeDebug" :=
                                                      M.call_closure (|
  ...
  Definition pointer_fmt_inner (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ ptr_addr; f ] =>
      ltac:(M.monadic
        ...
        let f := M.alloc (| f |) in
        M.read (|
          let~ old_width : Ty.apply (Ty.path "core::option::Option") [] [ Ty.path "usize" ] :=
            M.read (|
              M.SubPointer.get_struct_record_field (|
                M.deref (| M.read (| f |) |),
                "core::fmt::Formatter",
    ...
    Definition fmt (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; f ] =>
        ltac:(M.monadic
          ...
          let f := M.alloc (| f |) in
          M.read (|
            let~ d : Ty.path "core::fmt::builders::DebugStruct" :=
              M.call_closure (|
                Ty.path "core::fmt::builders::DebugStruct",
                M.get_associated_function (|
                  Ty.path "core::fmt::Formatter",
                ...
                [
                  M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| f |) |) |);
                  M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| Value.String "RefCell" |) |) |)
                ]
              |) in
            let~ _ : Ty.apply (Ty.path "&mut") [] [ Ty.path "core::fmt::builders::DebugStruct" ] :=
              M.read (|
