...
Module fmt.
  ...
  *)
                ...
                M.match_operator (|
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        M.alloc (| M.read (| M.of_value (| Value.String "Left" |) |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        M.alloc (| M.read (| M.of_value (| Value.String "Right" |) |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        M.alloc (| M.read (| M.of_value (| Value.String "Center" |) |) |)))
                  ]
                |)
              |)
            ]
    ...
    Definition fmt (τ : list Ty.t) (α : list A.t) : M :=
      ...
      | [], [ self; f ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            M.get_associated_function (| Ty.path "core::fmt::Formatter", "write_str", [] |),
            [ M.read (| f |); M.read (| M.of_value (| Value.String "Error" |) |) ]
          |)))
      | _, _ => M.impossible
      end.
  ...
  Module Impl_core_default_Default_for_core_fmt_Error.
    ...
    Definition default (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [] => ltac:(M.monadic (M.of_value (| Value.StructTuple "core::fmt::Error" [] |)))
      | _, _ => M.impossible
      end.
  ...
  (* Trait *)
  Module Write.
    Definition write_char (Self : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self; c ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    Definition write_fmt (Self : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self; args ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
  ...
  Module Impl_core_fmt_Write_where_core_fmt_Write_W_where_core_marker_Sized_W_for_ref_mut_W.
    ...
    *)
    Definition write_str (W : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    ...
    *)
    Definition write_char (W : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self W in
      match τ, α with
      | [], [ self; c ] =>
        ltac:(M.monadic
    ...
    *)
    Definition write_fmt (W : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self W in
      match τ, α with
      | [], [ self; args ] =>
        ltac:(M.monadic
  ...
  Module Impl_core_fmt_Formatter.
        ...
        ltac:(M.monadic
          ...
          M.of_value (|
            Value.StructRecord
              "core::fmt::Formatter"
              [
                ("flags", A.to_value (M.of_value (| Value.Integer 0 |)));
                ("fill", A.to_value (M.of_value (| Value.UnicodeChar 32 |)));
                ("align",
                  A.to_value
                    (M.of_value (| Value.StructTuple "core::fmt::rt::Alignment::Unknown" [] |)));
                ("width",
                  A.to_value (M.of_value (| Value.StructTuple "core::option::Option::None" [] |)));
                ("precision",
                  A.to_value (M.of_value (| Value.StructTuple "core::option::Option::None" [] |)));
                ("buf", A.to_value (* Unsize *) (M.pointer_coercion (| M.read (| buf |) |)))
              ]
          |)))
      | _, _ => M.impossible
      end.
    ...
    *)
    Definition wrap_buf (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [ F ], [ self; wrap ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition pad_integral (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
                          ...
                          let _ :=
                            M.write (|
                              ...
                              M.of_value (|
                                Value.StructTuple
                                  "core::option::Option::Some"
                                  [ A.to_value (M.of_value (| Value.UnicodeChar 45 |)) ]
                              |)
                            |) in
                          let _ :=
                            let β := width in
                                  ...
                                  let _ :=
                                    M.write (|
                                      ...
                                      M.of_value (|
                                        Value.StructTuple
                                          "core::option::Option::Some"
                                          [ A.to_value (M.of_value (| Value.UnicodeChar 43 |)) ]
                                      |)
                                    |) in
                                  let _ :=
                                    let β := width in
                            ...
                            M.call_closure (|
                              ...
                              [
                                M.SubPointer.get_struct_record_field (|
                                  ...
                                  "fill"
                                |);
                                M.of_value (| Value.UnicodeChar 48 |)
                              ]
                            |)
                          |) in
                        let old_align :=
    ...
    *)
    Definition pad (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self; s ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition padding (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
                    ...
                    M.match_operator (|
                      ...
                      [
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            (M.alloc (|
                              M.of_value (| Value.StructTuple "core::fmt::Alignment::Left" [] |)
                            |)));
                        fun γ =>
                          ltac:(M.monadic
                            (M.alloc (|
                              M.of_value (| Value.StructTuple "core::fmt::Alignment::Right" [] |)
                            |)));
                        fun γ =>
                          ltac:(M.monadic
                            (M.alloc (|
                              M.of_value (| Value.StructTuple "core::fmt::Alignment::Center" [] |)
                            |)))
                      ]
                    |)
                  |) in
                                    ...
                                    M.of_value (|
                                      Value.StructRecord
                                        ...
                                        [
                                          ...
                                          ("end_", A.to_value (M.read (| pre_pad |)))
                                        ]
                                    |)
                                  ]
                                |)
    ...
    *)
    Definition pad_formatted_parts (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self; formatted ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition write_formatted_parts (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self; formatted ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition write_fmt (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self; fmt ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition flags (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition fill (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition precision (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition sign_plus (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition sign_minus (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition alternate (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
          BinOp.Pure.ne (|
            BinOp.Pure.bit_and (|
              ...
              BinOp.Panic.shl (|
                M.of_value (| Value.Integer 1 |),
                M.rust_cast (| M.of_value (| Value.Integer 2 |) |)
              |)
            |),
            M.of_value (| Value.Integer 0 |)
          |)))
    ...
    *)
    Definition sign_aware_zero_pad (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
          BinOp.Pure.ne (|
            BinOp.Pure.bit_and (|
              ...
              BinOp.Panic.shl (|
                M.of_value (| Value.Integer 1 |),
                M.rust_cast (| M.of_value (| Value.Integer 3 |) |)
              |)
            |),
            M.of_value (| Value.Integer 0 |)
          |)))
    ...
    *)
    Definition debug_lower_hex (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
          BinOp.Pure.ne (|
            BinOp.Pure.bit_and (|
              ...
              BinOp.Panic.shl (|
                M.of_value (| Value.Integer 1 |),
                M.rust_cast (| M.of_value (| Value.Integer 4 |) |)
              |)
            |),
            M.of_value (| Value.Integer 0 |)
          |)))
    ...
    *)
    Definition debug_upper_hex (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
          BinOp.Pure.ne (|
            BinOp.Pure.bit_and (|
              ...
              BinOp.Panic.shl (|
                M.of_value (| Value.Integer 1 |),
                M.rust_cast (| M.of_value (| Value.Integer 5 |) |)
              |)
            |),
            M.of_value (| Value.Integer 0 |)
          |)))
    ...
    *)
    Definition debug_struct (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self; name ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition debug_struct_field1_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
    ...
    *)
    Definition debug_struct_field2_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
    ...
    *)
    Definition debug_struct_field3_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
    ...
    *)
    Definition debug_struct_field4_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
    ...
    *)
    Definition debug_struct_field5_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [],
    ...
    *)
    Definition debug_struct_fields_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
    ...
    *)
    Definition debug_tuple (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self; name ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition debug_tuple_field1_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self; name; value1 ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition debug_tuple_field2_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
    ...
    *)
    Definition debug_tuple_field3_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
    ...
    *)
    Definition debug_tuple_field4_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
    ...
    *)
    Definition debug_tuple_field5_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
    ...
    *)
    Definition debug_tuple_fields_finish (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self; name; values ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition debug_list (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition debug_set (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
    ...
    *)
    Definition debug_map (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
  ...
  Module Impl_core_fmt_Arguments.
    ...
    *)
    Definition new_const (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ pieces ] =>
        ltac:(M.monadic
                                      ...
                                      M.of_value (|
                                        Value.Array
                                          [
                                            A.to_value
                                              (M.read (|
                                                M.of_value (| Value.String "invalid args" |)
                                              |))
                                          ]
                                      |)
                                    |)
            ...
            M.alloc (|
              M.of_value (|
                Value.StructRecord
                  "core::fmt::Arguments"
                  [
                    ("pieces", A.to_value (M.read (| pieces |)));
                    ("fmt",
                      A.to_value
                        (M.of_value (| Value.StructTuple "core::option::Option::None" [] |)));
                    ("args",
    ...
    *)
    Definition new_v1 (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ pieces; args ] =>
        ltac:(M.monadic
          (let pieces := M.alloc (| pieces |) in
    ...
    *)
    Definition new_v1_formatted (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
    ...
    *)
    Definition estimated_capacity (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
                                ...
                                [
                                  M.call_closure (|
                                    M.get_associated_function (|
                                      ...
                                      []
                                    |),
                                    [ M.read (| pieces_length |); M.of_value (| Value.Integer 2 |) ]
                                  |);
                                  M.of_value (| Value.Integer 0 |)
                                ]
                              |)
            ...
            (M.read (|
              let formatter :=
                M.alloc (|
                  ...
                  |)
                |) in
              let idx := M.alloc (| M.of_value (| Value.Integer 0 |) |) in
              let _ :=
                M.match_operator (|
  ...
  *)
  Definition getcount (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ args; cnt ] =>
      ltac:(M.monadic
        (let args := M.alloc (| args |) in
            ...
            [
              fun γ =>
                ltac:(M.monadic
                  ...
                  M.alloc (|
                    M.of_value (|
                      Value.StructTuple "core::option::Option::Some" [ A.to_value (M.read (| n |)) ]
                    |)
                  |)));
              fun γ =>
                ltac:(M.monadic
        ...
        ltac:(M.monadic
          ...
          M.of_value (|
            Value.StructRecord
              "core::fmt::PostPadding"
              [
                ("fill", A.to_value (M.read (| fill |)));
                ("padding", A.to_value (M.read (| padding |)))
              ]
          |)))
      | _, _ => M.impossible
      end.
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        M.alloc (| M.read (| M.of_value (| Value.String "true" |) |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (M.alloc (| M.read (| M.of_value (| Value.String "false" |) |) |)))
                  ]
                |)
              |);
              M.read (| f |)
            ...
            ltac:(M.monadic
              (M.read (|
                let _ :=
                  ...
                  |) in
                let from := M.alloc (| M.of_value (| Value.Integer 0 |) |) in
                let _ :=
                  M.use
                    (M.match_operator (|
                      M.alloc (|
  ...
  *)
  Definition pointer_fmt_inner (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ ptr_addr; f ] =>
      ltac:(M.monadic
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_E_where_core_fmt_Debug_D_where_core_fmt_Debug_C_where_core_fmt_Debug_B_where_core_fmt_Debug_A_where_core_fmt_Debug_Z_where_core_fmt_Debug_Y_where_core_fmt_Debug_X_where_core_fmt_Debug_W_where_core_fmt_Debug_V_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_E_D_C_B_A_Z_Y_X_W_V_U_T_.
    ...
    *)
    Definition fmt (E D C B A Z Y X W V U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
            ...
            let builder :=
              M.alloc (|
                M.call_closure (|
                  ...
                  [ M.read (| f |); M.read (| M.of_value (| Value.String "" |) |) ]
                |)
              |) in
            M.match_operator (|
              M.read (| self |),
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_D_where_core_fmt_Debug_C_where_core_fmt_Debug_B_where_core_fmt_Debug_A_where_core_fmt_Debug_Z_where_core_fmt_Debug_Y_where_core_fmt_Debug_X_where_core_fmt_Debug_W_where_core_fmt_Debug_V_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_D_C_B_A_Z_Y_X_W_V_U_T_.
    ...
    *)
    Definition fmt (D C B A Z Y X W V U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_C_where_core_fmt_Debug_B_where_core_fmt_Debug_A_where_core_fmt_Debug_Z_where_core_fmt_Debug_Y_where_core_fmt_Debug_X_where_core_fmt_Debug_W_where_core_fmt_Debug_V_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_C_B_A_Z_Y_X_W_V_U_T_.
    ...
    *)
    Definition fmt (C B A Z Y X W V U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_B_where_core_fmt_Debug_A_where_core_fmt_Debug_Z_where_core_fmt_Debug_Y_where_core_fmt_Debug_X_where_core_fmt_Debug_W_where_core_fmt_Debug_V_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_B_A_Z_Y_X_W_V_U_T_.
    ...
    *)
    Definition fmt (B A Z Y X W V U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_A_where_core_fmt_Debug_Z_where_core_fmt_Debug_Y_where_core_fmt_Debug_X_where_core_fmt_Debug_W_where_core_fmt_Debug_V_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_A_Z_Y_X_W_V_U_T_.
    ...
    *)
    Definition fmt (A Z Y X W V U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_Z_where_core_fmt_Debug_Y_where_core_fmt_Debug_X_where_core_fmt_Debug_W_where_core_fmt_Debug_V_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_Z_Y_X_W_V_U_T_.
    ...
    *)
    Definition fmt (Z Y X W V U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_Y_where_core_fmt_Debug_X_where_core_fmt_Debug_W_where_core_fmt_Debug_V_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_Y_X_W_V_U_T_.
    ...
    *)
    Definition fmt (Y X W V U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_X_where_core_fmt_Debug_W_where_core_fmt_Debug_V_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_X_W_V_U_T_.
    ...
    *)
    Definition fmt (X W V U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_W_where_core_fmt_Debug_V_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_W_V_U_T_.
    ...
    *)
    Definition fmt (W V U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_V_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_V_U_T_.
    ...
    *)
    Definition fmt (V U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_core_fmt_Debug_where_core_fmt_Debug_U_where_core_fmt_Debug_T_where_core_marker_Sized_T_for_Tuple_U_T_.
    ...
    *)
    Definition fmt (U T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
                  ...
                  M.pointer_coercion (|
                    M.alloc (|
                      M.of_value (|
                        Value.Array
                          [
                            A.to_value (M.read (| M.of_value (| Value.String "PhantomData<" |) |));
                            A.to_value (M.read (| M.of_value (| Value.String ">" |) |))
                          ]
                      |)
                    |)
              ...
              M.alloc (|
                M.call_closure (|
                  M.get_associated_function (|
                    ...
                    []
                  |),
                  [ M.read (| f |); M.read (| M.of_value (| Value.String "RefCell" |) |) ]
                |)
              |) in
            let _ :=
              M.match_operator (|
                                        ...
                                        M.of_value (|
                                          Value.Array
                                            [
                                              A.to_value
                                                (M.read (|
                                                  M.of_value (| Value.String "<borrowed>" |)
                                                |))
                                            ]
                                        |)
                                      |)
              ...
              M.alloc (|
                M.call_closure (|
                  M.get_associated_function (|
                    ...
                    []
                  |),
                  [ M.read (| f |); M.read (| M.of_value (| Value.String "UnsafeCell" |) |) ]
                |)
              |)
            ]
          |)))
              ...
              M.alloc (|
                M.call_closure (|
                  M.get_associated_function (|
                    ...
                    []
                  |),
                  [ M.read (| f |); M.read (| M.of_value (| Value.String "SyncUnsafeCell" |) |) ]
                |)
              |)
            ]
          |)))
