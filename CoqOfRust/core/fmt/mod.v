      ...
      | [], [ buf ] =>
        ltac:(M.monadic
          ...
          Value.StructRecord
            "core::fmt::Formatter"
            [
              ("flags", Value.Integer Integer.U32 0);
                                ...
                                M.call_closure (|
                                  ...
                                  [
                                    M.call_closure (|
                                      ...
                                      [
                                        M.read (| self |);
                                        BinOp.Panic.sub (| M.read (| min |), M.read (| width |) |);
                  ...
                  M.match_operator (|
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          (M.alloc (|
                            Value.Tuple [ Value.Integer Integer.Usize 0; M.read (| padding |) ]
                          |)));
                      fun γ =>
                        ltac:(M.monadic
                          (M.alloc (|
                            Value.Tuple [ M.read (| padding |); Value.Integer Integer.Usize 0 ]
                          |)));
                      fun γ =>
                        ltac:(M.monadic
                          (M.alloc (|
                                            ...
                                            [
                                              ...
                                              fun γ =>
                                                ltac:(M.monadic
                                                  ...
                                                  let s :=
                                                    M.alloc (|
                                                      repeat (Value.Integer Integer.U8 0) 5
                                                    |) in
                                                  let len :=
                                                    M.alloc (|
                                                      M.call_closure (|
        ...
        ltac:(M.monadic
          ...
          BinOp.Pure.ne
            (BinOp.Pure.bit_and
              ...
              (BinOp.Panic.shl (|
                Value.Integer Integer.U32 1,
                M.rust_cast (Value.Integer Integer.Isize 4)
              |)))
            (Value.Integer Integer.U32 0)))
      | _, _ => M.impossible
      end.
        ...
        ltac:(M.monadic
          ...
          BinOp.Pure.ne
            (BinOp.Pure.bit_and
              ...
              (BinOp.Panic.shl (|
                Value.Integer Integer.U32 1,
                M.rust_cast (Value.Integer Integer.Isize 5)
              |)))
            (Value.Integer Integer.U32 0)))
      | _, _ => M.impossible
      end.
                                ...
                                [
                                  M.call_closure (|
                                    M.get_associated_function (|
                                      ...
                                      []
                                    |),
                                    [ M.read (| pieces_length |); Value.Integer Integer.Usize 2 ]
                                  |);
                                  Value.Integer Integer.Usize 0
                                ]
                              |)
            ...
            ltac:(M.monadic
              (M.read (|
                let _ :=
                  ...
                  |) in
                let from := M.alloc (| Value.Integer Integer.Usize 0 |) in
                let _ :=
                  M.use
                    (M.match_operator (|
                      M.alloc (|
