...
Module fmt.
  Module num.
    ...
    Module Impl_core_fmt_num_DisplayInt_for_i8.
      ...
      Definition to_u128 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        match ε, τ, α with
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "i8" ], self |) in
    ...
    (* Trait *)
    Module GenericRadix.
      Definition fmt_int (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        match ε, τ, α with
        | [], [ T ], [ self; x; f ] =>
          ltac:(M.monadic
            ...
            M.read (|
              let~ zero : T :=
                M.call_closure (|
                  ...
                  []
                |) in
              let~ is_nonnegative : Ty.path "bool" :=
                M.call_closure (|
                  Ty.path "bool",
                  M.get_trait_method (| "core::cmp::PartialOrd", T, [], [ T ], "ge", [], [] |),
                  [ M.borrow (| Pointer.Kind.Ref, x |); M.borrow (| Pointer.Kind.Ref, zero |) ]
                |) in
              let~ buf :
                  Ty.apply
                    (Ty.path "array")
                              ...
                              let~ _ : Ty.apply (Ty.path "&mut") [] [ Ty.path "u8" ] :=
                                M.call_closure (|
                                  ...
                                  [
                                    M.borrow (|
                                      Pointer.Kind.MutRef,
                                      M.SubPointer.get_array_field (| buf, M.read (| curr |) |)
                                    |);
                                    M.call_closure (|
                                      Ty.path "u8",
                                      M.get_trait_method (|
              ...
              let~ buf :
                ...
                |) in
              let~ buf : Ty.apply (Ty.path "&") [] [ Ty.path "str" ] :=
                M.call_closure (|
    ...
    Module Impl_core_clone_Clone_for_core_fmt_num_Binary.
      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::fmt::num::Binary" ], self |) in
        ...
        | [], [], [ self; other ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::fmt::num::Binary" ], self |) in
            let other :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::fmt::num::Binary" ], other |) in
            Value.Bool true))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
    ...
    Module Impl_core_clone_Clone_for_core_fmt_num_Octal.
      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::fmt::num::Octal" ], self |) in
        ...
        | [], [], [ self; other ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::fmt::num::Octal" ], self |) in
            let other :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::fmt::num::Octal" ], other |) in
            Value.Bool true))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "core::fmt::num::LowerHex" ],
                self
              |) in
      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "core::fmt::num::UpperHex" ],
                self
              |) in
                    ...
                    ltac:(M.monadic
                      ...
                      M.alloc (|
                        ...
                        M.call_closure (|
                          Ty.path "u8",
                          BinOp.Wrap.add,
                          [ M.read (| UnsupportedLiteral |); M.read (| x |) ]
                        |)
                      |)));
                  fun γ =>
                    ltac:(M.monadic
                        ...
                        M.call_closure (|
                          ...
                          [
                            ...
                            M.call_closure (|
                              Ty.path "u8",
                              BinOp.Wrap.sub,
                              [ M.read (| x |); Value.Integer IntegerKind.U8 10 ]
                            |)
                          ]
                        |)
                      |)));
    ...
    Module imp.
            ...
            ltac:(M.monadic
              ...
              M.call_closure (|
                Ty.apply
                  ...
                  []
                  [ Ty.tuple []; Ty.path "core::fmt::Error" ],
                M.get_associated_function (| Ty.path "u8", "_fmt", [], [] |),
                [
                                              ...
                                              M.use
                                                (M.alloc (|
                                                  ...
                                                  M.call_closure (|
                                                    ...
                                                    [
                                                      M.read (| self |);
                                                      Value.Integer IntegerKind.U8 10000
                                                    ]
                                                  |)
                                                |)) in
                                            let _ :=
                                                ...
                                                [
                                                  M.call_closure (|
                                                    ...
                                                    M.get_associated_function (|
                                                      ...
                                                      []
                                                    |),
                                                    [ M.read (| lut_ptr |); M.read (| M.use d1 |) ]
                                                  |);
                                                  M.call_closure (|
                                                    Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                                                    M.get_associated_function (|
                                                ...
                                                [
                                                  M.call_closure (|
                                                    ...
                                                    M.get_associated_function (|
                                                      ...
                                                      []
                                                    |),
                                                    [ M.read (| lut_ptr |); M.read (| M.use d2 |) ]
                                                  |);
                                                  M.call_closure (|
                                                    Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                                                    M.get_associated_function (|
                                ...
                                let~ _ : Ty.tuple [] :=
                                  ...
                                  M.write (|
                                    ...
                                    M.call_closure (|
                                      Ty.path "usize",
                                      BinOp.Wrap.div,
                                      [ M.read (| β |); Value.Integer IntegerKind.Usize 100 ]
                                    |)
                                  |) in
                                let~ _ : Ty.tuple [] :=
                                  let β := curr in
                              ...
                              M.use
                                (M.alloc (|
                                  ...
                                  M.call_closure (|
                                    Ty.path "bool",
                                    BinOp.lt,
                                    [ M.read (| n |); Value.Integer IntegerKind.Usize 10 ]
                                  |)
                                |)) in
                            let _ :=
                              is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
            ...
            ltac:(M.monadic
              ...
              M.call_closure (|
                Ty.apply
                  ...
                  []
                  [ Ty.tuple []; Ty.path "core::fmt::Error" ],
                M.get_associated_function (| Ty.path "u16", "_fmt", [], [] |),
                [
                  M.read (| M.deref (| M.read (| self |) |) |);
                  Value.Bool true;
                  M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| f |) |) |)
            ...
            ltac:(M.monadic
              ...
              M.call_closure (|
                Ty.apply
                  ...
                  []
                  [ Ty.tuple []; Ty.path "core::fmt::Error" ],
                M.get_associated_function (| Ty.path "u32", "_fmt", [], [] |),
                [
                  M.read (| M.deref (| M.read (| self |) |) |);
                  Value.Bool true;
                  M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| f |) |) |)
            ...
            ltac:(M.monadic
              ...
              M.call_closure (|
                Ty.apply
                  ...
                  []
                  [ Ty.tuple []; Ty.path "core::fmt::Error" ],
                M.get_associated_function (| Ty.path "u64", "_fmt", [], [] |),
                [
                  M.read (| M.deref (| M.read (| self |) |) |);
                  Value.Bool true;
                  M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| f |) |) |)
            ...
            ltac:(M.monadic
              ...
              M.call_closure (|
                Ty.apply
                  ...
                  []
                  [ Ty.tuple []; Ty.path "core::fmt::Error" ],
                M.get_associated_function (| Ty.path "usize", "_fmt", [], [] |),
                [
                  M.read (| M.deref (| M.read (| self |) |) |);
                  Value.Bool true;
                  M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| f |) |) |)
      ...
      *)
      Definition exp_u64 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        match ε, τ, α with
            ...
            M.read (|
              M.match_operator (|
                Ty.apply
                  ...
                  []
                  [ Ty.tuple []; Ty.path "core::fmt::Error" ],
                let~ exponent : Ty.path "usize" := Value.Integer IntegerKind.Usize 0 in
                let~ _ : Ty.tuple [] :=
                  M.read (|
                    M.loop (|
                      Ty.tuple [],
                                        ...
                                        M.call_closure (|
                                          ...
                                          [
                                            M.call_closure (|
                                              Ty.path "u64",
                                              BinOp.Wrap.rem,
                                              [ M.read (| n |); Value.Integer IntegerKind.U64 10 ]
                                            |);
                                ...
                                let~ _ : Ty.tuple [] :=
                                  ...
                                  M.write (|
                                    ...
                                    M.call_closure (|
                                      Ty.path "u64",
                                      BinOp.Wrap.div,
                                      [ M.read (| β |); Value.Integer IntegerKind.U64 10 ]
                                    |)
                                  |) in
                                let~ _ : Ty.tuple [] :=
                                  let β := exponent in
                  ...
                  |) in
                M.match_operator (|
                  Ty.tuple [ Ty.path "u64"; Ty.path "usize"; Ty.path "usize"; Ty.path "usize" ],
                  M.match_operator (|
                        ...
                        ltac:(M.monadic
                          (let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let fmt_prec := M.copy (| Ty.path "usize", γ0_0 |) in
                          let~ tmp : Ty.path "u64" := M.read (| n |) in
                          let~ prec : Ty.path "usize" := Value.Integer IntegerKind.Usize 0 in
                          let~ _ : Ty.tuple [] :=
                            M.read (|
                              M.loop (|
                                Ty.tuple [],
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let added_precision := M.copy (| Ty.path "usize", γ0_0 |) in
                        let subtracted_precision := M.copy (| Ty.path "usize", γ0_1 |) in
                        let~ _ : Ty.tuple [] :=
                          M.read (|
                            M.use
                              (M.match_operator (|
                        ...
                        M.alloc (|
                          Ty.tuple
                            [ Ty.path "u64"; Ty.path "usize"; Ty.path "usize"; Ty.path "usize" ],
                          Value.Tuple
                            [
                              M.read (| n |);
                              M.read (| exponent |);
                    ...
                    ltac:(M.monadic
                      ...
                      let~ _ : Ty.tuple [] :=
                        M.read (|
                                        ...
                                        M.use
                                          (M.alloc (|
                                            ...
                                            M.call_closure (|
                                              Ty.path "bool",
                                              BinOp.ge,
                                              [ M.read (| n |); Value.Integer IntegerKind.U64 100 ]
                                            |)
                                          |)) in
                                      let _ :=
                                        is_constant_or_break_match (|
                                      ...
                                      let~ _ : Ty.tuple [] :=
                                        ...
                                        M.write (|
                                          ...
                                          M.call_closure (|
                                            Ty.path "u64",
                                            BinOp.Wrap.div,
                                            [ M.read (| β |); Value.Integer IntegerKind.U64 100 ]
                                          |)
                                        |) in
                                      let~ _ : Ty.tuple [] :=
                                        let β := exponent in
                          ...
                          |)
                        |) in
                      let~ n : Ty.path "isize" := M.cast (Ty.path "isize") (M.read (| n |)) in
                      let~ _ : Ty.tuple [] :=
                        M.read (|
                          M.match_operator (|
                            Ty.tuple [],
                                    ...
                                    M.use
                                      (M.alloc (|
                                        ...
                                        M.call_closure (|
                                          Ty.path "bool",
                                          BinOp.ge,
                                          [ M.read (| n |); Value.Integer IntegerKind.Isize 10 ]
                                        |)
                                      |)) in
                                  let _ :=
                                    is_constant_or_break_match (|
                                  ...
                                  let~ _ : Ty.tuple [] :=
                                    ...
                                    M.write (|
                                      ...
                                      M.call_closure (|
                                        Ty.path "isize",
                                        BinOp.Wrap.div,
                                        [ M.read (| β |); Value.Integer IntegerKind.Isize 10 ]
                                      |)
                                    |) in
                                  let~ _ : Ty.tuple [] :=
                                    let β := exponent in
                                      ...
                                      (M.alloc (|
                                        ...
                                        LogicalOp.or (|
                                          M.call_closure (|
                                            Ty.path "bool",
                                            BinOp.ne,
                                            [ M.read (| exponent |); M.read (| trailing_zeros |) ]
                                          |),
                                          ltac:(M.monadic
                                            (M.call_closure (|
                                              Ty.path "bool",
                                      ...
                                      let~ _ : Ty.tuple [] :=
                                        M.write (|
                                          ...
                                          M.call_closure (|
                                            ...
                                            BinOp.Wrap.add,
                                            [
                                              M.cast (Ty.path "u8") (M.read (| exponent |));
                                              M.read (| UnsupportedLiteral |)
                                            ]
                                          |)
                                        |) in
                                    ...
                                    ltac:(M.monadic
                                      (let~ off : Ty.path "usize" :=
                                        M.call_closure (|
                                          Ty.path "usize",
                                          BinOp.Wrap.shl,
                                          [ M.read (| exponent |); Value.Integer IntegerKind.I32 1 ]
                                        |) in
                                      let~ _ : Ty.tuple [] :=
                                        M.call_closure (|
                                          Ty.tuple [],
              ...
              M.read (|
                let~ is_nonnegative : Ty.path "bool" :=
                  M.call_closure (|
                    Ty.path "bool",
                    BinOp.ge,
                    [ M.read (| M.deref (| M.read (| self |) |) |); Value.Integer IntegerKind.U8 0 ]
                  |) in
                let~ n : Ty.path "u64" :=
                  M.read (|
                    M.match_operator (|
              ...
              M.read (|
                let~ is_nonnegative : Ty.path "bool" :=
                  M.call_closure (|
                    Ty.path "bool",
                    BinOp.ge,
                    [ M.read (| M.deref (| M.read (| self |) |) |); Value.Integer IntegerKind.U16 0
                    ]
                  |) in
                let~ n : Ty.path "u64" :=
                  M.read (|
              ...
              M.read (|
                let~ is_nonnegative : Ty.path "bool" :=
                  M.call_closure (|
                    Ty.path "bool",
                    BinOp.ge,
                    [ M.read (| M.deref (| M.read (| self |) |) |); Value.Integer IntegerKind.U32 0
                    ]
                  |) in
                let~ n : Ty.path "u64" :=
                  M.read (|
              ...
              M.read (|
                let~ is_nonnegative : Ty.path "bool" :=
                  M.call_closure (|
                    Ty.path "bool",
                    BinOp.ge,
                    [ M.read (| M.deref (| M.read (| self |) |) |); Value.Integer IntegerKind.U64 0
                    ]
                  |) in
                let~ n : Ty.path "u64" :=
                  M.read (|
    ...
    *)
    Definition exp_u128 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      match ε, τ, α with
      | [], [], [ n; is_nonnegative; upper; f ] =>
        ltac:(M.monadic
          ...
          M.read (|
            M.match_operator (|
              ...
              let~ _ : Ty.tuple [] :=
                                      ...
                                      M.call_closure (|
                                        ...
                                        [
                                          M.call_closure (|
                                            Ty.path "u128",
                                            BinOp.Wrap.rem,
                                            [ M.read (| n |); Value.Integer IntegerKind.U128 10 ]
                                          |);
                              ...
                              let~ _ : Ty.tuple [] :=
                                ...
                                M.write (|
                                  ...
                                  M.call_closure (|
                                    Ty.path "u128",
                                    BinOp.Wrap.div,
                                    [ M.read (| β |); Value.Integer IntegerKind.U128 10 ]
                                  |)
                                |) in
                              let~ _ : Ty.tuple [] :=
                                let β := exponent in
                ...
                |) in
              M.match_operator (|
                Ty.tuple [ Ty.path "u128"; Ty.path "usize"; Ty.path "usize"; Ty.path "usize" ],
                M.match_operator (|
                  Ty.tuple [ Ty.path "usize"; Ty.path "usize" ],
                  M.alloc (|
                    Ty.apply (Ty.path "core::option::Option") [] [ Ty.path "usize" ],
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        (let γ0_0 :=
                          ...
                          |) in
                        let fmt_prec := M.copy (| Ty.path "usize", γ0_0 |) in
                        let~ tmp : Ty.path "u128" := M.read (| n |) in
                        let~ prec : Ty.path "usize" := Value.Integer IntegerKind.Usize 0 in
                        let~ _ : Ty.tuple [] :=
                          M.read (|
                            M.loop (|
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      M.alloc (|
                        Ty.tuple
                          [ Ty.path "u128"; Ty.path "usize"; Ty.path "usize"; Ty.path "usize" ],
                        Value.Tuple
                          [
                            M.read (| n |);
                            M.read (| exponent |);
                                      ...
                                      M.use
                                        (M.alloc (|
                                          ...
                                          M.call_closure (|
                                            Ty.path "bool",
                                            BinOp.ge,
                                            [ M.read (| n |); Value.Integer IntegerKind.U128 100 ]
                                          |)
                                        |)) in
                                    let _ :=
                                      is_constant_or_break_match (|
                                    ...
                                    let~ _ : Ty.tuple [] :=
                                      ...
                                      M.write (|
                                        ...
                                        M.call_closure (|
                                          Ty.path "u128",
                                          BinOp.Wrap.div,
                                          [ M.read (| β |); Value.Integer IntegerKind.U128 100 ]
                                        |)
                                      |) in
                                    let~ _ : Ty.tuple [] :=
                                      let β := exponent in
            ...
            M.read (|
              let~ is_nonnegative : Ty.path "bool" :=
                M.call_closure (|
                  Ty.path "bool",
                  BinOp.ge,
                  [ M.read (| M.deref (| M.read (| self |) |) |); Value.Integer IntegerKind.U128 0 ]
                |) in
              let~ n : Ty.path "u128" :=
                M.read (|
                  M.match_operator (|
    ...
    *)
    Definition parse_u64_into (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      match ε, τ, α with
      | [ N ], [], [ n; buf; curr ] =>
        ltac:(M.monadic
          (let n := M.alloc (| Ty.path "u64", n |) in
          let buf :=
            M.alloc (|
              ...
              buf
            |) in
          let curr := M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "usize" ], curr |) in
          M.read (|
            let~ buf_ptr : Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ] :=
              M.call_closure (|
                Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                    ...
                    fun γ =>
                      ltac:(M.monadic
                          ...
                          M.use
                            (M.alloc (|
                              ...
                              M.call_closure (|
                                ...
                                [
                                  M.read (| n |);
                                  M.cast (Ty.path "u64") (M.read (| UnsupportedLiteral |))
                                ]
                              |)
                            |)) in
                        let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        let~ to_parse : Ty.path "u64" :=
                          M.call_closure (|
                            Ty.path "u64",
                            BinOp.Wrap.rem,
                            [
                        ...
                        let~ d8 : Ty.path "u64" :=
                          ...
                          |) in
                        let~ _ : Ty.tuple [] :=
                          let β := M.deref (| M.read (| curr |) |) in
                          M.write (|
                            β,
                            M.call_closure (|
                              Ty.path "usize",
                              BinOp.Wrap.sub,
                              [ M.read (| β |); Value.Integer IntegerKind.Usize 16 ]
                            |)
                          |) in
                        let~ _ : Ty.tuple [] :=
                          M.call_closure (|
                            ...
                            [
                              M.call_closure (|
                                ...
                                M.get_associated_function (|
                                  ...
                                  []
                                |),
                                [ M.read (| lut_ptr |); M.cast (Ty.path "usize") (M.read (| d1 |)) ]
                              |);
                              M.call_closure (|
                                Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                                M.get_associated_function (|
                            ...
                            [
                              M.call_closure (|
                                ...
                                M.get_associated_function (|
                                  ...
                                  []
                                |),
                                [ M.read (| lut_ptr |); M.cast (Ty.path "usize") (M.read (| d2 |)) ]
                              |);
                              M.call_closure (|
                                Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                                M.get_associated_function (|
                            ...
                            [
                              M.call_closure (|
                                ...
                                M.get_associated_function (|
                                  ...
                                  []
                                |),
                                [ M.read (| lut_ptr |); M.cast (Ty.path "usize") (M.read (| d3 |)) ]
                              |);
                              M.call_closure (|
                                Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                                M.get_associated_function (|
                            ...
                            [
                              M.call_closure (|
                                ...
                                M.get_associated_function (|
                                  ...
                                  []
                                |),
                                [ M.read (| lut_ptr |); M.cast (Ty.path "usize") (M.read (| d4 |)) ]
                              |);
                              M.call_closure (|
                                Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                                M.get_associated_function (|
                            ...
                            [
                              M.call_closure (|
                                ...
                                M.get_associated_function (|
                                  ...
                                  []
                                |),
                                [ M.read (| lut_ptr |); M.cast (Ty.path "usize") (M.read (| d5 |)) ]
                              |);
                              M.call_closure (|
                                Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                                M.get_associated_function (|
                            ...
                            [
                              M.call_closure (|
                                ...
                                M.get_associated_function (|
                                  ...
                                  []
                                |),
                                [ M.read (| lut_ptr |); M.cast (Ty.path "usize") (M.read (| d6 |)) ]
                              |);
                              M.call_closure (|
                                Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                                M.get_associated_function (|
                            ...
                            [
                              M.call_closure (|
                                ...
                                M.get_associated_function (|
                                  ...
                                  []
                                |),
                                [ M.read (| lut_ptr |); M.cast (Ty.path "usize") (M.read (| d7 |)) ]
                              |);
                              M.call_closure (|
                                Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                                M.get_associated_function (|
                            ...
                            [
                              M.call_closure (|
                                ...
                                M.get_associated_function (|
                                  ...
                                  []
                                |),
                                [ M.read (| lut_ptr |); M.cast (Ty.path "usize") (M.read (| d8 |)) ]
                              |);
                              M.call_closure (|
                                Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ],
                                M.get_associated_function (|
            ...
            let~ _ : Ty.tuple [] :=
              M.read (|
                ...
                |)
              |) in
            let~ n : Ty.path "u32" := M.cast (Ty.path "u32") (M.read (| n |)) in
            let~ _ : Ty.tuple [] :=
              M.read (|
                M.match_operator (|
                  Ty.tuple [],
                          ...
                          M.use
                            (M.alloc (|
                              ...
                              M.call_closure (|
                                ...
                                [
                                  M.read (| n |);
                                  M.cast (Ty.path "u32") (M.read (| UnsupportedLiteral |))
                                ]
                              |)
                            |)) in
                        let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        let~ to_parse : Ty.path "u32" :=
                          M.call_closure (|
                            Ty.path "u32",
                            BinOp.Wrap.rem,
                            [
                          ...
                          M.call_closure (|
                            ...
                            [
                              M.call_closure (|
                                Ty.path "u32",
                                BinOp.Wrap.div,
                                [ M.read (| to_parse |); Value.Integer IntegerKind.U32 100 ]
                              |);
                              Value.Integer IntegerKind.I32 1
                            ]
                          |) in
                ...
                |)
              |) in
            let~ n : Ty.path "u16" := M.cast (Ty.path "u16") (M.read (| n |)) in
            let~ _ : Ty.tuple [] :=
              M.read (|
                M.match_operator (|
                  Ty.tuple [],
                          ...
                          M.use
                            (M.alloc (|
                              ...
                              M.call_closure (|
                                Ty.path "bool",
                                BinOp.ge,
                                [ M.read (| n |); Value.Integer IntegerKind.U16 100 ]
                              |)
                            |)) in
                        let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        let~ d1 : Ty.path "u16" :=
                        ...
                        let~ _ : Ty.tuple [] :=
                          ...
                          M.write (|
                            ...
                            M.call_closure (|
                              Ty.path "u16",
                              BinOp.Wrap.div,
                              [ M.read (| β |); Value.Integer IntegerKind.U16 100 ]
                            |)
                          |) in
                        let~ _ : Ty.tuple [] :=
                          let β := M.deref (| M.read (| curr |) |) in
                            ...
                            [
                              ...
                              M.call_closure (|
                                ...
                                M.get_associated_function (|
                                  ...
                                  []
                                |),
                                [ M.read (| buf_ptr |); M.read (| M.deref (| M.read (| curr |) |) |)
                                ]
                              |);
                              Value.Integer IntegerKind.Usize 2
                            ]
                      ...
                      M.use
                        (M.alloc (|
                          ...
                          M.call_closure (|
                            Ty.path "bool",
                            BinOp.lt,
                            [ M.read (| n |); Value.Integer IntegerKind.U16 10 ]
                          |)
                        |)) in
                    let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                    let~ _ : Ty.tuple [] :=
                    ...
                    let~ _ : Ty.tuple [] :=
                      M.write (|
                        ...
                        M.call_closure (|
                          Ty.path "u8",
                          BinOp.Wrap.add,
                          [ M.cast (Ty.path "u8") (M.read (| n |)); M.read (| UnsupportedLiteral |)
                          ]
                        |)
                      |) in
                    M.alloc (| Ty.tuple [], Value.Tuple [] |)));
    ...
    *)
    Definition fmt_u128 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      match ε, τ, α with
      | [], [], [ n; is_nonnegative; f ] =>
        ltac:(M.monadic
          (let n := M.alloc (| Ty.path "u128", n |) in
              ...
              [
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                    let n := M.copy (| Ty.path "u128", γ0_0 |) in
                    let rem := M.copy (| Ty.path "u64", γ0_1 |) in
                    let~ _ : Ty.tuple [] :=
                      M.call_closure (|
                        Ty.tuple [],
                        M.get_function (|
                        ...
                        [
                          ...
                          M.borrow (|
                            Pointer.Kind.MutRef,
                            M.deref (| M.borrow (| Pointer.Kind.MutRef, curr |) |)
                          |)
                        ]
                      |) in
                    let~ _ : Ty.tuple [] :=
                                      ...
                                      M.call_closure (|
                                        ...
                                        [
                                          ...
                                          M.call_closure (|
                                            Ty.path "usize",
                                            BinOp.Wrap.sub,
                                            [ M.read (| curr |); M.read (| target |) ]
                                          |)
                                        ]
                                      |) in
                                    M.alloc (| Ty.tuple [], Value.Tuple [] |)
                                  |) in
                                let~ _ : Ty.tuple [] := M.write (| curr, M.read (| target |) |) in
                                M.match_operator (|
                                  Ty.tuple [],
                                  M.alloc (|
                                    Ty.tuple [ Ty.path "u128"; Ty.path "u64" ],
                                          ...
                                          M.call_closure (|
                                            ...
                                            [
                                              ...
                                              M.borrow (|
                                                Pointer.Kind.MutRef,
                                                M.deref (|
                                                  M.borrow (| Pointer.Kind.MutRef, curr |)
                                                |)
                                              |)
                                            ]
                                          |) in
    ...
    *)
    Definition udiv_1e19 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      match ε, τ, α with
      | [], [], [ n ] =>
        ltac:(M.monadic
          (let n := M.alloc (| Ty.path "u128", n |) in
          M.read (|
            let~ quot : Ty.path "u128" :=
              M.read (|
                M.match_operator (|
                  Ty.path "u128",
                  M.alloc (| Ty.tuple [], Value.Tuple [] |),
                              ...
                              [
                                M.cast
                                  ...
                                  (M.call_closure (|
                                    Ty.path "u128",
                                    BinOp.Wrap.shr,
                                    [ M.read (| n |); Value.Integer IntegerKind.I32 19 ]
                                  |));
                                M.call_closure (|
                                  Ty.path "u64",
                                  BinOp.Wrap.shr,
            ...
            M.alloc (|
              Ty.tuple [ Ty.path "u128"; Ty.path "u64" ],
              Value.Tuple [ M.read (| quot |); M.read (| rem |) ]
            |)
          |)))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
    ...
    Module udiv_1e19.
      Definition value_DIV (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ltac:(M.monadic
          (M.alloc (| Ty.path "u64", M.cast (Ty.path "u64") (M.read (| UnsupportedLiteral |)) |))).
      ...
      Definition value_FACTOR (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ltac:(M.monadic
          (M.alloc (|
            Ty.path "u128",
            Value.Integer IntegerKind.U128 156927543384667019095894735580191660403
          |))).
    ...
    *)
    Definition u128_mulhi (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      match ε, τ, α with
      | [], [], [ x; y ] =>
        ltac:(M.monadic
          (let x := M.alloc (| Ty.path "u128", x |) in
          let y := M.alloc (| Ty.path "u128", y |) in
          M.read (|
            let~ x_lo : Ty.path "u64" := M.cast (Ty.path "u64") (M.read (| x |)) in
            let~ x_hi : Ty.path "u64" :=
              M.cast
                (Ty.path "u64")
                (M.call_closure (|
                  Ty.path "u128",
                ...
                |)) in
            let~ y_lo : Ty.path "u64" := M.cast (Ty.path "u64") (M.read (| y |)) in
            let~ y_hi : Ty.path "u64" :=
              M.cast
                (Ty.path "u64")
                (M.call_closure (|
                  Ty.path "u128",
                  BinOp.Wrap.shr,
                  [ M.read (| y |); Value.Integer IntegerKind.I32 64 ]
                |)) in
              ...
              M.call_closure (|
                ...
                [
                  M.call_closure (|
                    ...
                    BinOp.Wrap.mul,
                    [
                      M.cast (Ty.path "u128") (M.read (| x_lo |));
                      M.cast (Ty.path "u128") (M.read (| y_lo |))
                    ]
                  |);
              ...
              M.call_closure (|
                ...
                [
                  M.call_closure (|
                    ...
                    [
                      M.cast (Ty.path "u128") (M.read (| x_lo |));
                      M.cast (Ty.path "u128") (M.read (| y_hi |))
                    ]
                  |);
                  M.read (| carry |)
                ]
              |) in
            let~ high1 : Ty.path "u128" :=
              M.call_closure (|
                Ty.path "u128",
                BinOp.Wrap.shr,
                [ M.read (| m |); Value.Integer IntegerKind.I32 64 ]
              |) in
            let~ m_lo : Ty.path "u64" := M.cast (Ty.path "u64") (M.read (| m |)) in
            let~ high2 : Ty.path "u128" :=
              M.call_closure (|
                Ty.path "u128",
                BinOp.Wrap.shr,
                [
                  M.call_closure (|
                    ...
                    [
                      M.call_closure (|
                        ...
                        BinOp.Wrap.mul,
                        [
                          M.cast (Ty.path "u128") (M.read (| x_hi |));
                          M.cast (Ty.path "u128") (M.read (| y_lo |))
                        ]
                      |);
                      M.cast (Ty.path "u128") (M.read (| m_lo |))
                    ]
                  |);
                  Value.Integer IntegerKind.I32 64
                ]
