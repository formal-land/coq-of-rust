            ...
            M.read (|
              let~ zero : Ty.apply (Ty.path "*") [] [ T ] :=
                M.alloc (|
                  ...
                  |)
                |) in
              let~ is_nonnegative : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "bool",
              ...
              let~ buf :
                ...
                M.alloc (|
                  ...
                  |)
                |) in
              let~ curr : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
                    M.get_associated_function (|
              ...
              M.read (|
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                          ...
                                          M.alloc (|
                                            ...
                                            M.write (|
                                              ...
                                              M.call_closure (|
                                                Ty.path "u8",
                                                BinOp.Wrap.div,
                                                [ M.read (| β |); Value.Integer IntegerKind.U8 10000
                                                ]
                                              |)
                                            |)
                                          |) in
                                        let~ d1 : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                          M.alloc (|
                                            M.call_closure (|
                                              Ty.path "usize",
                                              BinOp.Wrap.shl,
                                            ...
                                            |)
                                          |) in
                                        let~ d2 : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                          M.alloc (|
                                            M.call_closure (|
                                              Ty.path "usize",
                                              BinOp.Wrap.shl,
                  ...
                  let~ n : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (| M.cast (Ty.path "usize") (M.read (| self |)) |) in
                  let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                    M.match_operator (|
                      Ty.apply (Ty.path "*") [] [ Ty.tuple [] ],
                      M.alloc (| Value.Tuple [] |),
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          let~ tmp : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                            M.copy (| n |) in
                          let~ prec : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                            M.alloc (| Value.Integer IntegerKind.Usize 0 |) in
                          let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                            M.loop (|
                              Ty.apply (Ty.path "*") [] [ Ty.tuple [] ],
                                          ...
                                          M.use
                                            (M.alloc (|
                                              M.call_closure (|
                                                Ty.path "bool",
                                                BinOp.ge,
                                                [ M.read (| tmp |); Value.Integer IntegerKind.U64 10
                                                ]
                                              |)
                                            |)) in
                                        let _ :=
                      ...
                      let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                        M.loop (|
                          ...
                          ltac:(M.monadic
                            ...
                            |)))
                        |) in
                      let~ n : Ty.apply (Ty.path "*") [] [ Ty.path "isize" ] :=
                        M.alloc (| M.cast (Ty.path "isize") (M.read (| n |)) |) in
                      let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                        M.match_operator (|
                          Ty.apply (Ty.path "*") [] [ Ty.tuple [] ],
                          M.alloc (| Value.Tuple [] |),
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        (let γ0_0 :=
                          ...
                          |) in
                        let fmt_prec := M.copy (| γ0_0 |) in
                        let~ tmp : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] := M.copy (| n |) in
                        let~ prec : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                          M.alloc (| Value.Integer IntegerKind.Usize 0 |) in
                        let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                          M.loop (|
                                        ...
                                        M.use
                                          (M.alloc (|
                                            M.call_closure (|
                                              Ty.path "bool",
                                              BinOp.ge,
                                              [ M.read (| tmp |); Value.Integer IntegerKind.U128 10
                                              ]
                                            |)
                                          |)) in
                                      let _ :=
        ...
        ltac:(M.monadic
          ...
          M.read (|
                    ...
                    ltac:(M.monadic
                      (let γ :=
                        M.use
                          ...
                          |)) in
                      let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                      let~ to_parse : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u64",
                            BinOp.Wrap.rem,
                      ...
                      let~ d1 : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                        M.alloc (|
                          ...
                          |)
                        |) in
                      let~ d2 : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u64",
                            BinOp.Wrap.shl,
                          ...
                          |)
                        |) in
                      let~ d3 : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u64",
                            BinOp.Wrap.shl,
                          ...
                          |)
                        |) in
                      let~ d4 : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u64",
                            BinOp.Wrap.shl,
                          ...
                          |)
                        |) in
                      let~ d5 : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u64",
                            BinOp.Wrap.shl,
                          ...
                          |)
                        |) in
                      let~ d6 : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u64",
                            BinOp.Wrap.shl,
                          ...
                          |)
                        |) in
                      let~ d7 : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u64",
                            BinOp.Wrap.shl,
                          ...
                          |)
                        |) in
                      let~ d8 : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u64",
                            BinOp.Wrap.shl,
            ...
            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
              ...
              |) in
            let~ n : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
              M.alloc (| M.cast (Ty.path "u32") (M.read (| n |)) |) in
            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
              M.match_operator (|
                Ty.apply (Ty.path "*") [] [ Ty.tuple [] ],
                M.alloc (| Value.Tuple [] |),
                    ...
                    ltac:(M.monadic
                      (let γ :=
                        M.use
                          ...
                          |)) in
                      let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                      let~ to_parse : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u32",
                            BinOp.Wrap.rem,
                      ...
                      let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                        M.alloc (|
                          ...
                          |)
                        |) in
                      let~ d1 : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u32",
                            BinOp.Wrap.shl,
                          ...
                          |)
                        |) in
                      let~ d2 : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u32",
                            BinOp.Wrap.shl,
              ...
              |) in
            let~ n : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
              M.alloc (| M.cast (Ty.path "u16") (M.read (| n |)) |) in
            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
              M.match_operator (|
                Ty.apply (Ty.path "*") [] [ Ty.tuple [] ],
                M.alloc (| Value.Tuple [] |),
                    ...
                    ltac:(M.monadic
                      (let γ :=
                        M.use
                          ...
                          |)) in
                      let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                      let~ d1 : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u16",
                            BinOp.Wrap.shl,
                          ...
                          fun γ =>
                            ltac:(M.monadic
                              ...
                              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                ...
                                M.alloc (| Value.Tuple [] |) in
                              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                M.alloc (| M.write (| curr, M.read (| target |) |) |) in
                              M.match_operator (|
                                Ty.apply (Ty.path "*") [] [ Ty.tuple [] ],
                                M.alloc (|
                                  M.call_closure (|
    ...
    Definition udiv_1e19 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ n ] =>
        ltac:(M.monadic
          (let n := M.alloc (| n |) in
          M.read (|
            let~ quot : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
              M.copy (|
                M.match_operator (|
                  Ty.apply (Ty.path "*") [] [ Ty.path "u128" ],
                  M.alloc (| Value.Tuple [] |),
    ...
    Definition u128_mulhi (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ x; y ] =>
        ltac:(M.monadic
          ...
          let y := M.alloc (| y |) in
          M.read (|
            let~ x_lo : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.alloc (| M.cast (Ty.path "u64") (M.read (| x |)) |) in
            let~ x_hi : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.alloc (|
                M.cast
                  (Ty.path "u64")
                  (M.call_closure (|
                  ...
                  |))
              |) in
            let~ y_lo : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.alloc (| M.cast (Ty.path "u64") (M.read (| y |)) |) in
            let~ y_hi : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.alloc (|
                M.cast
                  (Ty.path "u64")
                  (M.call_closure (|
            ...
            let~ carry : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
              M.alloc (|
                ...
                |)
              |) in
            let~ m : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "u128",
                  BinOp.Wrap.add,
                ...
                |)
              |) in
            let~ high1 : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "u128",
                  BinOp.Wrap.shr,
                ...
                |)
              |) in
            let~ m_lo : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.alloc (| M.cast (Ty.path "u64") (M.read (| m |)) |) in
            let~ high2 : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "u128",
                  BinOp.Wrap.shr,
