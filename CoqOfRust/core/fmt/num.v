                ...
                let~ _ :=
                  M.loop (|
                    ltac:(M.monadic
                      ...
                      |)))
                  |) in
                let~ n := M.alloc (| M.cast (Ty.path "usize") (M.read (| n |)) |) in
                let~ _ :=
                  M.match_operator (|
                    M.alloc (| Value.Tuple [] |),
                    [
                      ...
                      let~ _ :=
                        M.loop (|
                          ltac:(M.monadic
                            ...
                            |)))
                        |) in
                      let~ n := M.alloc (| M.cast (Ty.path "isize") (M.read (| n |)) |) in
                      let~ _ :=
                        M.match_operator (|
                          M.alloc (| Value.Tuple [] |),
                          [
        ...
        ltac:(M.monadic
          ...
          M.read (|
            ...
            let~ _ :=
              ...
              |) in
            let~ n := M.alloc (| M.cast (Ty.path "u32") (M.read (| n |)) |) in
            let~ _ :=
              M.match_operator (|
                M.alloc (| Value.Tuple [] |),
                [
              ...
              |) in
            let~ n := M.alloc (| M.cast (Ty.path "u16") (M.read (| n |)) |) in
            let~ _ :=
              M.match_operator (|
                M.alloc (| Value.Tuple [] |),
                [
    ...
    Definition u128_mulhi (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ x; y ] =>
        ltac:(M.monadic
          ...
          let y := M.alloc (| y |) in
          M.read (|
            let~ x_lo := M.alloc (| M.cast (Ty.path "u64") (M.read (| x |)) |) in
            let~ x_hi :=
              M.alloc (|
                M.cast
                  (Ty.path "u64")
              ...
              |) in
            let~ y_lo := M.alloc (| M.cast (Ty.path "u64") (M.read (| y |)) |) in
            let~ y_hi :=
              M.alloc (|
                M.cast
                  (Ty.path "u64")
            ...
            let~ m_lo := M.alloc (| M.cast (Ty.path "u64") (M.read (| m |)) |) in
            let~ high2 :=
              M.alloc (|
                BinOp.Wrap.shr (|
                  BinOp.Wrap.add (|
