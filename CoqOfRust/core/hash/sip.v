    ...
    Module Impl_core_fmt_Debug_for_core_hash_sip_State.
      ...
      Definition fmt (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; f ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::hash::sip::State" ], self |) in
            let f :=
              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "core::fmt::Formatter" ], f |) in
            M.call_closure (|
              Ty.apply
      ...
      Definition write (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; msg ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&mut") [] [ Ty.path "core::hash::sip::SipHasher" ],
                self
              |) in
            let msg :=
              M.alloc (|
      ...
      Definition write (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; msg ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&mut") [] [ Ty.path "core::hash::sip::SipHasher13" ],
                self
              |) in
            let msg :=
              M.alloc (|
