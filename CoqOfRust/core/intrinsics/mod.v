    ...
    Definition runtime (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ src; dst; size; count ] =>
        ltac:(M.monadic
          ...
          let count := M.alloc (| count |) in
          M.read (|
            let~ src_usize : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "usize",
                  M.get_associated_function (|
                ...
                |)
              |) in
            let~ dst_usize : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "usize",
                  M.get_associated_function (|
              ...
              [
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let~ diff : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "usize",
              ...
              ltac:(M.monadic
                (M.read (|
                  ...
                  let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                    ...
                    |) in
                  let~ repeated_x : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.call_closure (|
                        Ty.path "usize",
                            ...
                            fun γ =>
                              ltac:(M.monadic
                                ...
                                let _ :=
                                  ...
                                  |) in
                                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                  let~ u : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                    M.copy (|
                                      M.deref (|
                                        M.cast
                                  ...
                                  let~ v : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                    M.copy (|
                                      ...
                                      |)
                                    |) in
                                  let~ zu : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                                    M.alloc (|
                                      M.call_closure (|
                                        Ty.path "bool",
                                        M.get_function (|
                                      ...
                                      |)
                                    |) in
                                  let~ zv : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                                    M.alloc (|
                                      M.call_closure (|
                                        Ty.path "bool",
                                        M.get_function (|
                ...
                (M.read (|
                  let~ len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      ...
                      |)
                    |) in
                  let~ align_offset : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.call_closure (|
                        Ty.path "usize",
                        M.get_associated_function (|
                  ...
                  let~ start :
                    ...
                    M.alloc (|
                      ...
                      |)
                    |) in
                  let~ first_word : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.call_closure (|
                        Ty.path "usize",
                        M.get_associated_function (|
                  ...
                  let~ word_ptr :
                    ...
                    M.alloc (|
                      M.cast
                        ...
                        |))
                    |) in
                  let~ byte_pos : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                            ...
                            fun γ =>
                              ltac:(M.monadic
                                ...
                                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                  ...
                                  |) in
                                let~ word : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                  M.alloc (|
                                    M.call_closure (|
                                      Ty.path "usize",
                                      M.get_associated_function (|
                  ...
                  let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                    ...
                    |) in
                  let~ last_word : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.call_closure (|
                        Ty.path "usize",
                        M.get_associated_function (|
