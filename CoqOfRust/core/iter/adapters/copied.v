...
Module iter.
  Module adapters.
    Module copied.
          ...
          | [], [ self; f ] =>
            ltac:(M.monadic
              ...
              M.call_closure (|
                ...
                [
                  M.read (| f |);
                  M.read (| M.of_value (| Value.String "Copied" |) |);
      ...
      *)
      Definition copy_fold (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
      ...
      *)
      Definition copy_try_fold (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
      ...
      Module Impl_core_iter_traits_iterator_Iterator_where_core_iter_traits_iterator_Iterator_I_where_core_marker_Copy_T_for_core_iter_adapters_copied_Copied_I.
        ...
        *)
        Definition next_chunk (I T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I T in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition nth (I T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I T in
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
        ...
        *)
        Definition last (I T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I T in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition count (I T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I T in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition advance_by (I T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I T in
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_traits_double_ended_DoubleEndedIterator_where_core_iter_traits_double_ended_DoubleEndedIterator_I_where_core_marker_Copy_T_for_core_iter_adapters_copied_Copied_I.
        ...
        *)
        Definition advance_back_by (I T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I T in
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_adapters_copied_SpecNextChunk_where_core_iter_traits_iterator_Iterator_I_where_core_marker_Copy_T_T_for_I.
        ...
        *)
        Definition spec_next_chunk (I T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I T in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_adapters_copied_SpecNextChunk_where_core_marker_Copy_T_T_for_core_slice_iter_Iter_T.
        ...
        *)
        Definition spec_next_chunk (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
