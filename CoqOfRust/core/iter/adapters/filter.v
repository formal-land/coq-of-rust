...
Module iter.
  Module adapters.
    Module filter.
                      ...
                      M.alloc (|
                        M.call_closure (|
                          M.get_associated_function (|
                            ...
                            []
                          |),
                          [ M.read (| f |); M.read (| M.of_value (| Value.String "Filter" |) |) ]
                        |)
                      |);
      ...
      *)
      Definition filter_fold (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
      ...
      *)
      Definition filter_try_fold (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
      ...
      Module Impl_core_iter_traits_iterator_Iterator_where_core_iter_traits_iterator_Iterator_I_where_core_ops_function_FnMut_P_Tuple_ref__associated_type__for_core_iter_adapters_filter_Filter_I_P.
        ...
        *)
        Definition next_chunk (I P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I P in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
                  ...
                  M.alloc (|
                    M.of_value (|
                      Value.StructRecord
                        ...
                        [
                          ("array", A.to_value (* Unsize *) (M.pointer_coercion (| array |)));
                                                ...
                                                M.rust_cast (|
                                                  M.call_closure (|
                                                    ...
                                                    [
                                                      ...
                                                      |);
                                                      M.of_value (|
                                                        Value.Tuple [ A.to_value element ]
                                                      |)
                                                    ]
                                                  |)
                                                |)
                                      ...
                                      M.of_value (|
                                        Value.StructRecord
                                          ...
                                          [
                                            ...
                                            ("end_", A.to_value (M.read (| initialized |)))
                                          ]
                                      |)
                                    ]
                                  |))
        ...
        *)
        Definition count (I P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I P in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_traits_double_ended_DoubleEndedIterator_where_core_iter_traits_double_ended_DoubleEndedIterator_I_where_core_ops_function_FnMut_P_Tuple_ref__associated_type__for_core_iter_adapters_filter_Filter_I_P.
        ...
        *)
        Definition next_back (I P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I P in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition try_rfold (I P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I P in
          match τ, α with
          | [ Acc; Fold; R ], [ self; init; fold ] =>
            ltac:(M.monadic
        ...
        *)
        Definition rfold (I P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I P in
          match τ, α with
          | [ Acc; Fold ], [ self; init; fold ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_traits_marker_InPlaceIterable_where_core_iter_traits_marker_InPlaceIterable_I_for_core_iter_adapters_filter_Filter_I_P.
        ...
        Definition value_EXPAND_BY (I P : Ty.t) : A.t :=
          let Self : Ty.t := Self I P in
          M.run
            ltac:(M.monadic
        ...
        (* Ty.apply
          (Ty.path "core::option::Option")
          [ Ty.path "core::num::nonzero::NonZeroUsize" ] *)
        Definition value_MERGE_BY (I P : Ty.t) : A.t :=
          let Self : Ty.t := Self I P in
          M.run
            ltac:(M.monadic
