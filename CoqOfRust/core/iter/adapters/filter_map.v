...
Module iter.
  Module adapters.
    Module filter_map.
                      ...
                      M.alloc (|
                        M.call_closure (|
                          M.get_associated_function (|
                            ...
                            []
                          |),
                          [ M.read (| f |); M.read (| M.of_value (| Value.String "FilterMap" |) |) ]
                        |)
                      |);
      ...
      *)
      Definition filter_map_fold (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
                                        ...
                                        M.alloc (|
                                          M.call_closure (|
                                            ...
                                            [
                                              f;
                                              M.of_value (|
                                                Value.Tuple [ A.to_value (M.read (| item |)) ]
                                              |)
                                            ]
                                          |)
                                        |),
      ...
      *)
      Definition filter_map_try_fold (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
      ...
      Module Impl_core_iter_traits_iterator_Iterator_where_core_iter_traits_iterator_Iterator_I_where_core_ops_function_FnMut_F_Tuple_associated_type__for_core_iter_adapters_filter_map_FilterMap_I_F.
        ...
        *)
        Definition next_chunk (B I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self B I F in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
