                        ...
                        | [ α0 ] =>
                          ltac:(M.monadic
                            (M.match_operator (|
                              ...
                              M.alloc (| Ty.apply (Ty.path "&mut") [] [ I ], α0 |),
                              [
                                fun γ =>
                                  ltac:(M.monadic
                                    (let iter :=
                                      M.copy (| Ty.apply (Ty.path "&mut") [] [ I ], γ |) in
                                    M.call_closure (|
                                      Ty.apply
                                        (Ty.path "core::option::Option")
                                        []
                                ...
                                fun γ =>
                                  ltac:(M.monadic
                                    ...
                                    let γ0_0 :=
                                      ...
                                      |) in
                                    let iter :=
                                      M.alloc (| Ty.apply (Ty.path "&mut") [] [ I ], γ0_0 |) in
                                    let~ _ : Ty.tuple [] :=
                                      M.write (|
                                        acc,
                                        M.read (|
                                    ...
                                    fun γ =>
                                      ltac:(M.monadic
                                        (let γ0_0 :=
                                          ...
                                          |) in
                                        let val :=
                                          M.copy (| Ty.apply (Ty.path "&mut") [] [ I ], γ0_0 |) in
                                        val))
                                  ]
                                |)
                              |)
