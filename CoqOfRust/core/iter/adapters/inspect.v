  ...
  Module adapters.
    Module inspect.
      ...
      Module Impl_core_clone_Clone_where_core_clone_Clone_I_where_core_clone_Clone_F_for_core_iter_adapters_inspect_Inspect_I_F.
        ...
        (* Clone *)
        Definition clone (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      ...
      Module Impl_core_iter_adapters_inspect_Inspect_I_F.
        ...
        *)
        Definition new (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [], [ iter; f ] =>
            ltac:(M.monadic
              ...
              M.of_value (|
                Value.StructRecord
                  "core::iter::adapters::inspect::Inspect"
                  [ ("iter", A.to_value (M.read (| iter |))); ("f", A.to_value (M.read (| f |))) ]
              |)))
          | _, _ => M.impossible
          end.
        ...
        *)
        Definition do_inspect (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [], [ self; elt ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_fmt_Debug_where_core_fmt_Debug_I_for_core_iter_adapters_inspect_Inspect_I_F.
        ...
        *)
        Definition fmt (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [], [ self; f ] =>
            ltac:(M.monadic
                      ...
                      M.alloc (|
                        M.call_closure (|
                          M.get_associated_function (|
                            ...
                            []
                          |),
                          [ M.read (| f |); M.read (| M.of_value (| Value.String "Inspect" |) |) ]
                        |)
                      |);
      ...
      *)
      Definition inspect_fold (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
                                        ...
                                        M.alloc (|
                                          M.call_closure (|
                                            M.get_trait_method (|
                                              ...
                                              []
                                            |),
                                            [ f; M.of_value (| Value.Tuple [ A.to_value item ] |) ]
                                          |)
                                        |) in
                                      M.alloc (|
                                        M.call_closure (|
      ...
      *)
      Definition inspect_try_fold (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
      ...
      Module Impl_core_iter_traits_iterator_Iterator_where_core_iter_traits_iterator_Iterator_I_where_core_ops_function_FnMut_F_Tuple_ref__associated_type__for_core_iter_adapters_inspect_Inspect_I_F.
        ...
        *)
        Definition next (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition size_hint (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition try_fold (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
        ...
        *)
        Definition fold (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
      ...
      Module Impl_core_iter_traits_double_ended_DoubleEndedIterator_where_core_iter_traits_double_ended_DoubleEndedIterator_I_where_core_ops_function_FnMut_F_Tuple_ref__associated_type__for_core_iter_adapters_inspect_Inspect_I_F.
        ...
        *)
        Definition next_back (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition try_rfold (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [ Acc; Fold; R ], [ self; init; fold ] =>
            ltac:(M.monadic
        ...
        *)
        Definition rfold (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [ Acc; Fold ], [ self; init; fold ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_traits_exact_size_ExactSizeIterator_where_core_iter_traits_exact_size_ExactSizeIterator_I_where_core_ops_function_FnMut_F_Tuple_ref__associated_type__for_core_iter_adapters_inspect_Inspect_I_F.
        ...
        *)
        Definition len (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition is_empty (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_adapters_SourceIter_where_core_iter_adapters_SourceIter_I_for_core_iter_adapters_inspect_Inspect_I_F.
        ...
        *)
        Definition as_inner (I F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I F in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
