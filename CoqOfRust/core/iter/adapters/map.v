      ...
      *)
      Definition map_fold (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [ T; B; Acc; impl_FnMut_T__arrow_B; impl_FnMut_Acc__B__arrow_Acc ], [ f; g ] =>
          ltac:(M.monadic
            (let f := M.alloc (| impl_FnMut_T__arrow_B, f |) in
            let g := M.alloc (| impl_FnMut_Acc__B__arrow_Acc, g |) in
            M.closure
              (fun γ =>
                ltac:(M.monadic
                  match γ with
      ...
      *)
      Definition map_try_fold (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [],
            ...
            [ f; g ] =>
          ltac:(M.monadic
            (let f := M.alloc (| Ty.apply (Ty.path "&mut") [] [ impl_FnMut_T__arrow_B ], f |) in
            let g := M.alloc (| impl_FnMut_Acc__B__arrow_R__plus__'a, g |) in
            M.closure
              (fun γ =>
                ltac:(M.monadic
                  match γ with
      ...
      Module Impl_core_iter_adapters_zip_TrustedRandomAccessNoCoerce_where_core_iter_adapters_zip_TrustedRandomAccessNoCoerce_I_for_core_iter_adapters_map_Map_I_F.
        ...
        Axiom Implements :
          ...
          M.IsTraitInstance
            ...
            (Self I F)
            (* Instance *)
            [ ("value_MAY_HAVE_SIDE_EFFECT", InstanceField.Method (value_MAY_HAVE_SIDE_EFFECT I F))
            ].
