  ...
  Module adapters.
    Module map_while.
                      ...
                      M.alloc (|
                        M.call_closure (|
                          M.get_associated_function (|
                            ...
                            []
                          |),
                          [ M.read (| f |); M.read (| M.of_value (| Value.String "MapWhile" |) |) ]
                        |)
                      |);
      ...
      Module Impl_core_iter_traits_iterator_Iterator_where_core_iter_traits_iterator_Iterator_I_where_core_ops_function_FnMut_P_Tuple_associated_type__for_core_iter_adapters_map_while_MapWhile_I_P.
        ...
        *)
        Definition next (B I P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        ...
        *)
        Definition size_hint (B I P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self B I P in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition try_fold (B I P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self B I P in
          match τ, α with
        ...
        *)
        Definition fold (B I P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self B I P in
          match τ, α with
      ...
      Module Impl_core_iter_adapters_SourceIter_where_core_iter_adapters_SourceIter_I_for_core_iter_adapters_map_while_MapWhile_I_P.
        ...
        *)
        Definition as_inner (I P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I P in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
