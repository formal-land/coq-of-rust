          ...
          | [], [ self; f ] =>
            ltac:(M.monadic
              ...
              M.call_closure (|
                ...
                [
                  M.read (| f |);
                  M.read (| M.of_value (| Value.String "Skip" |) |);
                  ...
                  M.pointer_coercion (|
                    ...
                    |)
                  |);
                  M.read (| M.of_value (| Value.String "n" |) |);
                  (* Unsize *)
                  M.pointer_coercion (|
                    M.alloc (|
                      M.SubPointer.get_struct_record_field (|
          ...
          | [], [ iter; n ] =>
            ltac:(M.monadic
              ...
              M.of_value (|
                Value.StructRecord
                  "core::iter::adapters::skip::Skip"
                  [ ("iter", A.to_value (M.read (| iter |))); ("n", A.to_value (M.read (| n |))) ]
              |)))
          | _, _ => M.impossible
          end.
                                  ...
                                  fun γ =>
                                    ltac:(M.monadic
                                      ...
                                      M.alloc (|
                                        M.never_to_any (|
                                          M.read (|
                                            M.return_ (| M.of_value (| Value.Integer 0 |) |)
                                          |)
                                        |)
                                      |)));
                                  fun γ =>
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        M.alloc (|
                          M.of_value (|
                            Value.Tuple
                              [ A.to_value (M.read (| lower |)); A.to_value (M.read (| upper |)) ]
                          |)
                        |)))
                  ]
                |)
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        (let γ :=
                          M.use
                            (M.alloc (| BinOp.Pure.lt (| M.read (| n |), M.read (| len |) |) |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        M.alloc (|
                          M.call_closure (|
