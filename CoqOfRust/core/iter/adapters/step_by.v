  ...
  Module adapters.
    Module step_by.
      ...
      Module Impl_core_iter_adapters_step_by_StepBy_I.
                ...
                M.alloc (|
                  Value.StructRecord
                    ...
                    [
                      ("iter", M.read (| iter |));
                      ("step",
                        BinOp.Panic.sub (| M.read (| step |), Value.Integer Integer.Usize 1 |));
        ...
        *)
        Definition next_back_index (I : Ty.t) (τ : list Ty.t) (α : list Value.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_adapters_step_by_SpecRangeSetup_T_for_T.
        ...
        *)
        Definition setup (T : Ty.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      Module Impl_core_iter_adapters_step_by_StepByImpl_where_core_iter_traits_iterator_Iterator_I_I_for_core_iter_adapters_step_by_StepBy_I.
        ...
        *)
        Definition spec_next (I : Ty.t) (τ : list Ty.t) (α : list Value.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition spec_size_hint (I : Ty.t) (τ : list Ty.t) (α : list Value.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition spec_nth (I : Ty.t) (τ : list Ty.t) (α : list Value.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
                        ...
                        M.read (|
                          M.loop (|
                            ltac:(M.monadic
                              ...
                              let nth_n :=
                                M.alloc (|
                                  BinOp.Panic.mul (| M.read (| div_n |), M.read (| n |) |)
                                |) in
                              let nth_step :=
                                M.alloc (|
                                  BinOp.Panic.mul (| M.read (| div_step |), M.read (| step |) |)
                                |) in
                              let nth :=
                                M.copy (|
                                  M.match_operator (|
      ...
      Module Impl_core_iter_adapters_step_by_StepByBackImpl_where_core_iter_traits_double_ended_DoubleEndedIterator_I_where_core_iter_traits_exact_size_ExactSizeIterator_I_I_for_core_iter_adapters_step_by_StepBy_I.
        ...
        *)
        Definition spec_next_back (I : Ty.t) (τ : list Ty.t) (α : list Value.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition spec_nth_back (I : Ty.t) (τ : list Ty.t) (α : list Value.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_adapters_step_by_SpecRangeSetup_core_ops_range_Range_u8_for_core_ops_range_Range_u8.
        ...
        *)
        Definition setup (τ : list Ty.t) (α : list Value.t) : M :=
          match τ, α with
          | [], [ r; step ] =>
            ltac:(M.monadic
              (let r := M.alloc (| r |) in
      ...
      Module Impl_core_iter_adapters_step_by_StepByImpl_core_ops_range_Range_u8_for_core_iter_adapters_step_by_StepBy_core_ops_range_Range_u8.
        ...
        *)
        Definition spec_next (τ : list Ty.t) (α : list Value.t) : M :=
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        (let γ :=
                          M.use
                            (M.alloc (|
                              BinOp.Pure.gt (M.read (| remaining |)) (Value.Integer Integer.U8 0)
                            |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        let val :=
        ...
        *)
        Definition spec_size_hint (τ : list Ty.t) (α : list Value.t) : M :=
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_nth (τ : list Ty.t) (α : list Value.t) : M :=
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_try_fold (τ : list Ty.t) (α : list Value.t) : M :=
          match τ, α with
          | [ Acc; F; R ], [ self; init; f ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_fold (τ : list Ty.t) (α : list Value.t) : M :=
          match τ, α with
          | [ Acc; F ], [ self; init; f ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        (let γ :=
                          M.use
                            (M.alloc (|
                              BinOp.Pure.gt (M.read (| remaining |)) (Value.Integer Integer.U16 0)
                            |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        let val :=
                        ...
                        M.call_closure (|
                          ...
                          [
                            Value.StructRecord
                              "core::ops::range::Range"
                              [
                                ("start", Value.Integer Integer.U16 0);
                                ("end_", M.read (| remaining |))
                              ]
                          ]
                        |)
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        (let γ :=
                          M.use
                            (M.alloc (|
                              BinOp.Pure.gt (M.read (| remaining |)) (Value.Integer Integer.U32 0)
                            |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        let val :=
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        (let γ :=
                          M.use
                            (M.alloc (|
                              BinOp.Pure.gt (M.read (| remaining |)) (Value.Integer Integer.U64 0)
                            |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        let val :=
                        ...
                        M.call_closure (|
                          ...
                          [
                            Value.StructRecord
                              "core::ops::range::Range"
                              [
                                ("start", Value.Integer Integer.U64 0);
                                ("end_", M.read (| remaining |))
                              ]
                          ]
                        |)
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        (let γ :=
                          M.use
                            (M.alloc (|
                              BinOp.Pure.gt (M.read (| remaining |)) (Value.Integer Integer.Usize 0)
                            |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        let val :=
      ...
      Module Impl_core_iter_adapters_step_by_StepByBackImpl_core_ops_range_Range_u8_for_core_iter_adapters_step_by_StepBy_core_ops_range_Range_u8.
        ...
        *)
        Definition spec_next_back (τ : list Ty.t) (α : list Value.t) : M :=
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_nth_back (τ : list Ty.t) (α : list Value.t) : M :=
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_try_rfold (τ : list Ty.t) (α : list Value.t) : M :=
          match τ, α with
          | [ Acc; F; R ], [ self; init; f ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_rfold (τ : list Ty.t) (α : list Value.t) : M :=
          match τ, α with
          | [ Acc; F ], [ self; init; f ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
