                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          |)));
                      fun γ => ltac:(M.monadic (M.read (| rem |)))
                    ]
                  |)
                |)
              |)))
        ...
        Definition setup (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [], [ inner; _step ] =>
            ltac:(M.monadic
              ...
              let _step := M.alloc (| Ty.path "usize", _step |) in
              M.read (| inner |)))
          | _, _, _ => M.impossible "wrong number of arguments"
          end.
        ...
        *)
        Definition setup (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [], [ r; step ] =>
            ltac:(M.monadic
              (let r :=
                M.alloc (| Ty.apply (Ty.path "core::ops::range::Range") [] [ Ty.path "u8" ], r |) in
              let step := M.alloc (| Ty.path "usize", step |) in
              M.read (|
