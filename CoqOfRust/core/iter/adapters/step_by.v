  ...
  Module adapters.
    Module step_by.
          ...
          | [], [ self; f ] =>
            ltac:(M.monadic
              ...
              M.call_closure (|
                ...
                [
                  M.read (| f |);
                  M.read (| M.of_value (| Value.String "StepBy" |) |);
                  ...
                  M.pointer_coercion (|
                    ...
                    |)
                  |);
                  M.read (| M.of_value (| Value.String "step" |) |);
                  (* Unsize *)
                  M.pointer_coercion (|
                    M.SubPointer.get_struct_record_field (|
                      M.read (| self |),
                    ...
                    |)
                  |);
                  M.read (| M.of_value (| Value.String "first_take" |) |);
                  (* Unsize *)
                  M.pointer_coercion (|
                    M.alloc (|
                      M.SubPointer.get_struct_record_field (|
      ...
      Module Impl_core_iter_adapters_step_by_StepBy_I.
                          ...
                          M.alloc (|
                            M.never_to_any (|
                              M.call_closure (|
                                ...
                                [
                                  M.read (|
                                    M.of_value (| Value.String "assertion failed: step != 0" |)
                                  |)
                                ]
                              |)
                            |)
                      ...
                      [
                        ...
                        ("step",
                          A.to_value
                            ...
                            |)));
                        ("first_take", A.to_value (M.of_value (| Value.Bool true |)))
                      ]
                  |)
                |)
              |)))
        ...
        *)
        Definition next_back_index (I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_adapters_step_by_SpecRangeSetup_T_for_T.
        ...
        *)
        Definition setup (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      ...
      Module Impl_core_iter_adapters_step_by_StepByImpl_where_core_iter_traits_iterator_Iterator_I_I_for_core_iter_adapters_step_by_StepBy_I.
        ...
        *)
        Definition spec_next (I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition spec_size_hint (I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
                                        ...
                                        A.to_value
                                          (M.call_closure (|
                                            ...
                                            [
                                              f;
                                              M.of_value (|
                                                Value.Tuple [ A.to_value (M.read (| low |)) ]
                                              |)
                                            ]
                                          |));
                                        A.to_value
        ...
        *)
        Definition spec_nth (I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_adapters_step_by_StepByBackImpl_where_core_iter_traits_double_ended_DoubleEndedIterator_I_where_core_iter_traits_exact_size_ExactSizeIterator_I_I_for_core_iter_adapters_step_by_StepBy_I.
        ...
        *)
        Definition spec_next_back (I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition spec_nth_back (I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
                          ...
                          M.alloc (|
                            M.call_closure (|
                              ...
                              [
                                ...
                                M.of_value (|
                                  Value.Tuple
                                    [ A.to_value (M.read (| init |)); A.to_value (M.read (| x |)) ]
                                |)
                              ]
                            |)
                          |) in
      ...
      Module Impl_core_iter_adapters_step_by_SpecRangeSetup_core_ops_range_Range_u8_for_core_ops_range_Range_u8.
        ...
        *)
        Definition setup (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [], [ r; step ] =>
            ltac:(M.monadic
              (let r := M.alloc (| r |) in
      ...
      Module Impl_core_iter_adapters_step_by_StepByImpl_core_ops_range_Range_u8_for_core_iter_adapters_step_by_StepBy_core_ops_range_Range_u8.
        ...
        *)
        Definition spec_next (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_size_hint (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_nth (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_try_fold (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [ Acc; F; R ], [ self; init; f ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_fold (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [ Acc; F ], [ self; init; f ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
                            ...
                            M.of_value (|
                              Value.StructRecord
                                ...
                                [
                                  ...
                                  ("end_", A.to_value (M.read (| remaining |)))
                                ]
                            |)
                          ]
                        |)
      ...
      Module Impl_core_iter_adapters_step_by_StepByBackImpl_core_ops_range_Range_u8_for_core_iter_adapters_step_by_StepBy_core_ops_range_Range_u8.
        ...
        *)
        Definition spec_next_back (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_nth_back (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_try_rfold (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [ Acc; F; R ], [ self; init; f ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
        ...
        *)
        Definition spec_rfold (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [ Acc; F ], [ self; init; f ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
