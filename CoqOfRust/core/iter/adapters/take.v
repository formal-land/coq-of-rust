  ...
  Module adapters.
    Module take.
          ...
          | [], [ self; f ] =>
            ltac:(M.monadic
              ...
              M.call_closure (|
                ...
                [
                  M.read (| f |);
                  M.read (| M.of_value (| Value.String "Take" |) |);
      ...
      Module Impl_core_iter_traits_iterator_Iterator_where_core_iter_traits_iterator_Iterator_I_for_core_iter_adapters_take_Take_I.
        ...
        *)
        Definition for_each (I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [ F ], [ self; f ] =>
            ltac:(M.monadic
          ...
          | [], [ self; n ] =>
            ltac:(M.monadic
              ...
              M.read (|
                ...
                let advanced :=
                  M.alloc (|
                    BinOp.Panic.sub (| Integer.Usize, M.read (| min |), M.read (| rem |) |)
                  |) in
                let _ :=
                  let β :=
                    M.SubPointer.get_struct_record_field (|
                  ...
                  M.write (|
                    β,
                    BinOp.Panic.sub (| Integer.Usize, M.read (| β |), M.read (| advanced |) |)
                  |) in
                M.alloc (|
                  M.call_closure (|
                    M.get_associated_function (|
                    ...
                    [
                      M.call_closure (|
                        M.get_associated_function (|
                          ...
                          []
                        |),
                        [ BinOp.Panic.sub (| Integer.Usize, M.read (| n |), M.read (| advanced |) |)
                        ]
                      |);
                      M.of_value (|
                        Value.StructTuple
            ...
            ltac:(M.monadic
              ...
              M.read (|
                ...
                let _ :=
                  ...
                  M.write (|
                    β,
                    BinOp.Panic.sub (| Integer.Usize, M.read (| β |), M.read (| advanced_by |) |)
                  |) in
                M.alloc (|
                  M.call_closure (|
                    M.get_associated_function (|
      ...
      Module Impl_core_iter_adapters_take_SpecTake_where_core_iter_traits_iterator_Iterator_I_for_core_iter_adapters_take_Take_I.
        ...
        *)
        Definition spec_for_each (I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self I in
          match τ, α with
          | [ F ], [ self; f ] =>
            ltac:(M.monadic
                                          ...
                                          M.alloc (|
                                            M.call_closure (|
                                              ...
                                              [
                                                f;
                                                M.of_value (|
                                                  Value.Tuple [ A.to_value (M.read (| val |)) ]
                                                |)
                                              ]
                                            |)
                                          |) in
