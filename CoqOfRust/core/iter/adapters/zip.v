...
Module iter.
  Module adapters.
    Module zip.
      ...
      *)
      Definition zip (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        match ε, τ, α with
        | [], [ A; B ], [ a; b ] =>
          ltac:(M.monadic
            (let a := M.alloc (| A, a |) in
            ...
            ltac:(M.monadic
              ...
              Value.mkStructRecord
                ...
                [
                  ...
                  ("a_len", Value.Integer IntegerKind.Usize 0)
                ]))
          | _, _, _ => M.impossible "wrong number of arguments"
          end.
      ...
      Module Impl_core_iter_adapters_SourceIter_where_core_iter_adapters_SourceIter_A_for_core_iter_adapters_zip_Zip_A_B.
        ...
        Definition _Source (A B : Ty.t) : Ty.t :=
          Ty.associated_in_trait "core::iter::adapters::SourceIter" [] [] A "Source".
      ...
      Module TrustedRandomAccessNoCoerce.
        Definition size (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          match ε, τ, α with
          | [], [], [ self ] =>
            ltac:(M.monadic
      ...
      *)
      Definition try_get_unchecked (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        match ε, τ, α with
        | [], [ _ as I ], [ it; idx ] =>
          ltac:(M.monadic
            (let it := M.alloc (| Ty.apply (Ty.path "&mut") [] [ I ], it |) in
            let idx := M.alloc (| Ty.path "usize", idx |) in
            M.call_closure (|
                                    ...
                                    ltac:(M.monadic
                                      ...
                                      let γ0_0 :=
                                        M.SubPointer.get_struct_tuple_field (|
                                          ...
                                          0
                                        |) in
                                      let upper := M.copy (| Ty.path "usize", γ0_0 |) in
                            ...
                            [
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                                  let upper := M.copy (| Ty.path "usize", γ0_0 |) in
                                  let more := M.copy (| Ty.path "bool", γ0_1 |) in
                                  M.read (|
                                    let~ _ : Ty.tuple [] :=
                                      M.read (|
                                        M.use
