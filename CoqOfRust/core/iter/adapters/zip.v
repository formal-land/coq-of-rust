  ...
  Module adapters.
    Module zip.
      ...
      Module Impl_core_clone_Clone_where_core_clone_Clone_A_where_core_clone_Clone_B_for_core_iter_adapters_zip_Zip_A_B.
        ...
        (* Clone *)
        Definition clone (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      ...
      Module Impl_core_iter_adapters_zip_Zip_A_B.
        ...
        *)
        Definition new (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [], [ a; b ] =>
            ltac:(M.monadic
        ...
        *)
        Definition super_nth (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
      ...
      *)
      Definition zip (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
        | [ A; B ], [ a; b ] =>
          ltac:(M.monadic
            (let a := M.alloc (| a |) in
      ...
      Module Impl_core_iter_traits_iterator_Iterator_where_core_iter_traits_iterator_Iterator_A_where_core_iter_traits_iterator_Iterator_B_for_core_iter_adapters_zip_Zip_A_B.
        ...
        *)
        Definition next (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition size_hint (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
        ...
        *)
        Definition nth (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [], [ self; n ] =>
            ltac:(M.monadic
        ...
        *)
        Definition fold (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [ Acc; F ], [ self; init; f ] =>
            ltac:(M.monadic
        ...
        *)
        Definition __iterator_get_unchecked (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [], [ self; idx ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_traits_double_ended_DoubleEndedIterator_where_core_iter_traits_double_ended_DoubleEndedIterator_A_where_core_iter_traits_exact_size_ExactSizeIterator_A_where_core_iter_traits_double_ended_DoubleEndedIterator_B_where_core_iter_traits_exact_size_ExactSizeIterator_B_for_core_iter_adapters_zip_Zip_A_B.
        ...
        *)
        Definition next_back (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_adapters_zip_ZipImpl_where_core_iter_traits_iterator_Iterator_A_where_core_iter_traits_iterator_Iterator_B_A_B_for_core_iter_adapters_zip_Zip_A_B.
              ...
              M.of_value (|
                Value.StructRecord
                  ...
                  [
                    ...
                    ("a_len", A.to_value (M.of_value (| Value.Integer 0 |)))
                  ]
              |)))
          | _, _ => M.impossible
          end.
                        ...
                        Value.StructTuple
                          ...
                          [
                            A.to_value
                              (M.of_value (|
                                Value.Tuple
                                  [ A.to_value (M.read (| x |)); A.to_value (M.read (| y |)) ]
                              |))
                          ]
                      |)
                    |)
                                    ...
                                    M.match_operator (|
                                      M.alloc (|
                                        M.of_value (|
                                          Value.Tuple
                                            [
                                              A.to_value (M.read (| a_upper |));
                                              A.to_value (M.read (| b_upper |))
                                            ]
                                        |)
                                      |),
                                      [
        ...
        *)
        Definition get_unchecked (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [], [ self; _idx ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_adapters_zip_TrustedRandomAccessNoCoerce_where_core_iter_adapters_zip_TrustedRandomAccessNoCoerce_A_where_core_iter_adapters_zip_TrustedRandomAccessNoCoerce_B_for_core_iter_adapters_zip_Zip_A_B.
        ...
        (* Ty.path "bool" *)
        Definition value_MAY_HAVE_SIDE_EFFECT (A B : Ty.t) : A.t :=
          let Self : Ty.t := Self A B in
          M.run
            ltac:(M.monadic
              (M.alloc (|
      ...
      Module Impl_core_iter_adapters_SourceIter_where_core_iter_adapters_SourceIter_A_for_core_iter_adapters_zip_Zip_A_B.
        ...
        *)
        Definition as_inner (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_iter_traits_marker_InPlaceIterable_where_core_iter_traits_marker_InPlaceIterable_A_for_core_iter_adapters_zip_Zip_A_B.
        ...
        Definition value_EXPAND_BY (A B : Ty.t) : A.t :=
          let Self : Ty.t := Self A B in
          M.run
            ltac:(M.monadic
        ...
        (* Ty.apply
          (Ty.path "core::option::Option")
          [ Ty.path "core::num::nonzero::NonZeroUsize" ] *)
        Definition value_MERGE_BY (A B : Ty.t) : A.t :=
          let Self : Ty.t := Self A B in
          M.run
            ltac:(M.monadic
      ...
      Module Impl_core_fmt_Debug_where_core_fmt_Debug_A_where_core_fmt_Debug_B_for_core_iter_adapters_zip_Zip_A_B.
        ...
        *)
        Definition fmt (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [], [ self; f ] =>
            ltac:(M.monadic
                          ...
                          M.alloc (|
                            M.call_closure (|
                              M.get_associated_function (|
                                ...
                                []
                              |),
                              [ M.read (| f |); M.read (| M.of_value (| Value.String "Zip" |) |) ]
                            |)
                          |);
      ...
      Module TrustedRandomAccessNoCoerce.
        Definition size (Self : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
      ...
      *)
      Definition try_get_unchecked (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
        | [ _ as I ], [ it; idx ] =>
          ltac:(M.monadic
      ...
      Module Impl_core_iter_adapters_zip_SpecTrustedRandomAccess_where_core_iter_traits_iterator_Iterator_I_for_I.
        ...
        *)
        Definition try_get_unchecked (I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      ...
      Module Impl_core_iter_adapters_zip_SpecFold_where_core_iter_traits_iterator_Iterator_A_where_core_iter_traits_iterator_Iterator_B_for_core_iter_adapters_zip_Zip_A_B.
        ...
        *)
        Definition spec_fold (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A B in
          match τ, α with
          | [ Acc; F ], [ self; init; f ] =>
            ltac:(M.monadic
                                ...
                                [
                                  fun γ =>
                                    ltac:(M.monadic
                                      (let γ :=
                                        M.use
                                          (M.alloc (| UnOp.Pure.not (| M.read (| more |) |) |)) in
                                      let _ :=
                                        M.is_constant_or_break_match (|
                                          M.read (| γ |),
                                          Value.Bool true
