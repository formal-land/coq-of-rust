...
Module iter.
  Module sources.
    Module repeat_n.
      ...
      *)
      Definition repeat_n (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
        | [ T ], [ element; count ] =>
          ltac:(M.monadic
          ...
          | [], [ self; f ] =>
            ltac:(M.monadic
              ...
              M.call_closure (|
                ...
                [
                  M.read (| f |);
                  M.read (| M.of_value (| Value.String "RepeatN" |) |);
      ...
      Module Impl_core_iter_sources_repeat_n_RepeatN_A.
        ...
        *)
        Definition take_element (A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
      ...
      Module Impl_core_ops_drop_Drop_for_core_iter_sources_repeat_n_RepeatN_A.
        ...
        *)
        Definition drop (A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        (let γ :=
                          M.use
                            (M.alloc (|
                              BinOp.Pure.gt (| M.read (| skip |), M.read (| len |) |)
                            |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        M.alloc (|
      ...
      Module Impl_core_iter_traits_exact_size_ExactSizeIterator_where_core_clone_Clone_A_for_core_iter_sources_repeat_n_RepeatN_A.
        ...
        *)
        Definition len (A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A in
          match τ, α with
          | [], [ self ] =>
            ltac:(M.monadic
