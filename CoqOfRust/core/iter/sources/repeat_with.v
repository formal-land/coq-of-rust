...
Module iter.
  Module sources.
    Module repeat_with.
      ...
      *)
      Definition repeat_with (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
        | [ A; F ], [ repeater ] =>
          ltac:(M.monadic
            ...
            M.of_value (|
              Value.StructRecord
                ...
                [ ("repeater", A.to_value (M.read (| repeater |))) ]
            |)))
        | _, _ => M.impossible
        end.
                  ...
                  M.alloc (|
                    M.call_closure (|
                      M.get_associated_function (|
                        ...
                        []
                      |),
                      [ M.read (| f |); M.read (| M.of_value (| Value.String "RepeatWith" |) |) ]
                    |)
                  |)
                ]
              |)))
      ...
      Module Impl_core_iter_traits_iterator_Iterator_where_core_ops_function_FnMut_F_Tuple__for_core_iter_sources_repeat_with_RepeatWith_F.
        ...
        *)
        Definition try_fold (A F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          let Self : Ty.t := Self A F in
          match τ, α with
