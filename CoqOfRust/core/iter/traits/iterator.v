      ...
      Definition _assert_is_dyn_compatible
        ...
        | [], [], [ β0 ] =>
          ltac:(M.monadic
            ...
            M.match_operator (| None, β0, [ fun γ => ltac:(M.monadic (Value.Tuple [])) ] |)))
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      M.read (|
                        let~ true_count : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                              ...
                                              M.call_closure (|
                                                ...
                                                [
                                                  ...
                                                  M.borrow (|
                                                    Pointer.Kind.MutRef,
                                                    M.deref (|
                                                      M.borrow (| Pointer.Kind.MutRef, true_count |)
                                                    |)
                                                  |)
                                                ]
                                              |)
        ...
        Definition position
          ...
          | [], [ P ], [ self; predicate ] =>
            ltac:(M.monadic
              ...
              let predicate := M.alloc (| predicate |) in
              M.read (|
                let~ acc : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.alloc (| Value.Integer IntegerKind.Usize 0 |) in
                M.alloc (|
                  M.call_closure (|
        ...
        Definition unzip (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [ A; B; FromA; FromB ], [ self ] =>
            ltac:(M.monadic
              (let self := M.alloc (| self |) in
              M.read (|
                let~ unzipped : Ty.apply (Ty.path "*") [] [ Ty.tuple [ FromA; FromB ] ] :=
                  M.alloc (|
                    M.call_closure (|
