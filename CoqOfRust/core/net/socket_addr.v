      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            ...
            M.read (|
              M.match_operator (|
                Some (Ty.apply (Ty.path "*") [] [ Ty.path "core::net::socket_addr::SocketAddr" ]),
      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            ...
            M.read (|
              M.match_operator (|
                Some (Ty.apply (Ty.path "*") [] [ Ty.path "core::net::socket_addr::SocketAddrV4" ]),
                Value.DeclaredButUndefined,
                [
                  fun γ =>
                    ltac:(M.monadic
      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            ...
            M.read (|
              M.match_operator (|
                Some (Ty.apply (Ty.path "*") [] [ Ty.path "core::net::socket_addr::SocketAddrV6" ]),
                Value.DeclaredButUndefined,
                [
                  fun γ =>
                    ltac:(M.monadic
      ...
      Definition ip (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            ...
            M.read (|
              M.match_operator (|
                Some (Ty.apply (Ty.path "*") [] [ Ty.path "core::net::ip_addr::IpAddr" ]),
                M.deref (| M.read (| self |) |),
                [
                  fun γ =>
                    ltac:(M.monadic
