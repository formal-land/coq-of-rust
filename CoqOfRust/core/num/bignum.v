      ...
      Definition from_small (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [ v ] =>
          ltac:(M.monadic
            (let v := M.alloc (| v |) in
            M.read (|
              let~ base := M.alloc (| repeat (Value.Integer IntegerKind.U32 0) 40 |) in
              let~ _ :=
                M.write (|
      ...
      Definition mul_digits (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [ self; other ] =>
          ltac:(M.monadic
            ...
            let other := M.alloc (| other |) in
            M.read (|
              let~ ret := M.alloc (| repeat (Value.Integer IntegerKind.U32 0) 40 |) in
              let~ retsz :=
                M.copy (|
                  M.match_operator (|
                    M.alloc (| Value.Tuple [] |),
        ...
        Definition from_small (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [ v ] =>
            ltac:(M.monadic
              (let v := M.alloc (| v |) in
              M.read (|
                let~ base := M.alloc (| repeat (Value.Integer IntegerKind.U8 0) 3 |) in
                let~ _ :=
                  M.write (|
                    M.SubPointer.get_array_field (|
                      base,
        ...
        Definition mul_digits (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [ self; other ] =>
            ltac:(M.monadic
              ...
              let other := M.alloc (| other |) in
              M.read (|
                let~ ret := M.alloc (| repeat (Value.Integer IntegerKind.U8 0) 3 |) in
                let~ retsz :=
                  M.copy (|
                    M.match_operator (|
                      M.alloc (| Value.Tuple [] |),
