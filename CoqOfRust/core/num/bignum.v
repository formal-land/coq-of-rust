          ...
          ltac:(M.monadic
            ...
            M.read (|
                                ...
                                ltac:(M.monadic
                                  (let γ :=
                                    M.use
                                      (M.alloc (|
                                        UnOp.not (|
                                          BinOp.lt (| M.read (| borrow |), M.read (| other |) |)
                                        |)
                                      |)) in
                                  let _ :=
              ...
              M.alloc (|
                Value.Tuple
                  [
                    M.cast (Ty.path "u8") (BinOp.Wrap.div (| M.read (| lhs |), M.read (| rhs |) |));
                    M.cast (Ty.path "u8") (BinOp.Wrap.rem (| M.read (| lhs |), M.read (| rhs |) |))
                  ]
              |)
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
              ...
              M.alloc (|
                Value.Tuple
                  [
                    M.cast
                      (Ty.path "u16")
                      (BinOp.Wrap.div (| M.read (| lhs |), M.read (| rhs |) |));
                    M.cast (Ty.path "u16") (BinOp.Wrap.rem (| M.read (| lhs |), M.read (| rhs |) |))
                  ]
              |)
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
                ...
                Value.Tuple
                  [
                    M.cast
                      (Ty.path "u32")
                      (BinOp.Wrap.div (| M.read (| lhs |), M.read (| rhs |) |));
                    M.cast (Ty.path "u32") (BinOp.Wrap.rem (| M.read (| lhs |), M.read (| rhs |) |))
                  ]
              |)
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            (let γ :=
                              M.use
                                (M.alloc (|
                                  BinOp.gt (| M.read (| v |), Value.Integer IntegerKind.U64 0 |)
                                |)) in
                            let _ :=
                              M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                            let~ _ : Ty.tuple [] :=
        ...
        | [], [], [ self; i ] =>
          ltac:(M.monadic
            ...
            M.read (|
              ...
              let~ b : Ty.path "usize" :=
                M.alloc (| BinOp.Wrap.rem (| M.read (| i |), M.read (| digitbits |) |) |) in
              M.alloc (|
                M.cast
                  (Ty.path "u8")
                  (BinOp.bit_and
                            ...
                            [
                              fun γ =>
                                ltac:(M.monadic
                                  (let γ := M.read (| γ |) in
                                  let v := M.copy (| γ |) in
                                  BinOp.eq (| M.read (| v |), Value.Integer IntegerKind.U32 0 |)))
                            ]
                          |)))
                  ...
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      M.alloc (|
                        BinOp.Wrap.add (|
                          BinOp.Wrap.add (|
                            BinOp.Wrap.mul (| M.read (| msd |), M.read (| digitbits |) |),
                            M.cast
                              (Ty.path "usize")
                              (M.call_closure (|
                                Ty.path "u32",
                ...
                M.read (|
                  let~ sz : Ty.path "usize" :=
                    M.alloc (|
                      ...
                      |)
                    |) in
                  let~ carry : Ty.path "bool" := M.alloc (| Value.Bool false |) in
                  let~ _ : Ty.tuple [] :=
                    M.use
                      (M.match_operator (|
                        M.alloc (|
                ...
                M.read (|
                  let~ sz : Ty.path "usize" :=
                    M.alloc (|
                      ...
                      |)
                    |) in
                  let~ noborrow : Ty.path "bool" := M.alloc (| Value.Bool true |) in
                  let~ _ : Ty.tuple [] :=
                    M.use
                      (M.match_operator (|
                        M.alloc (|
                ...
                M.read (|
                  let~ sz : Ty.path "usize" :=
                    M.copy (|
                      ...
                      |)
                    |) in
                  let~ carry : Ty.path "u32" := M.alloc (| Value.Integer IntegerKind.U32 0 |) in
                  let~ _ : Ty.tuple [] :=
                    M.use
                      (M.match_operator (|
                        M.alloc (|
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            (let γ :=
                              M.use
                                (M.alloc (|
                                  BinOp.gt (| M.read (| carry |), Value.Integer IntegerKind.U32 0 |)
                                |)) in
                            let _ :=
                              M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                            let~ _ : Ty.tuple [] :=
              ...
              M.deref (|
                M.read (|
                  ...
                  let~ bits : Ty.path "usize" :=
                    M.alloc (| BinOp.Wrap.rem (| M.read (| bits |), M.read (| digitbits |) |) |) in
                  let~ _ : Ty.tuple [] :=
                    M.match_operator (|
                      M.alloc (| Value.Tuple [] |),
                      [
                      ...
                      [
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let _ :=
                              M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                            let~ last : Ty.path "usize" := M.copy (| sz |) in
                              ...
                              M.alloc (|
                                BinOp.Wrap.shr (|
                                  M.read (|
                                    ...
                                    |)
                                  |),
                                  BinOp.Wrap.sub (| M.read (| digitbits |), M.read (| bits |) |)
                                |)
                              |) in
                            let~ _ : Ty.tuple [] :=
                              M.match_operator (|
                            ...
                            let~ _ : Ty.tuple [] :=
                              M.alloc (|
                                ...
                                M.write (|
                                  β,
                                  BinOp.Wrap.shl (| M.read (| β |), M.read (| bits |) |)
                                |)
                              |) in
                            M.alloc (| Value.Tuple [] |)));
                        fun γ => ltac:(M.monadic (M.alloc (| Value.Tuple [] |)))
                                    ...
                                    fun γ =>
                                      ltac:(M.monadic
                                        (let γ :=
                                          M.use
                                            (M.alloc (|
                                              BinOp.ge (| M.read (| e |), M.read (| small_e |) |)
                                            |)) in
                                        let _ :=
                                          M.is_constant_or_break_match (|
                                            M.read (| γ |),
            ...
            M.read (|
                      ...
                      ltac:(M.monadic
                        (let γ :=
                          M.use
                            (M.alloc (|
                              UnOp.not (|
                                BinOp.gt (| M.read (| other |), Value.Integer IntegerKind.U32 0 |)
                              |)
                            |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
              ...
              let~ sz : Ty.path "usize" :=
                M.copy (|
                  ...
                  |)
                |) in
              let~ borrow : Ty.path "u32" := M.alloc (| Value.Integer IntegerKind.U32 0 |) in
              let~ _ : Ty.tuple [] :=
                M.use
                  (M.match_operator (|
                    M.alloc (|
            ...
            M.read (|
              ...
              let~ _ : Ty.tuple [] :=
                M.alloc (|
                  ...
                  |)
                |) in
              let~ q_is_zero : Ty.path "bool" := M.alloc (| Value.Bool true |) in
                              ...
                              [
                                fun γ =>
                                  ltac:(M.monadic
                                    (let γ := M.read (| γ |) in
                                    let v := M.copy (| γ |) in
                                    BinOp.eq (| M.read (| v |), Value.Integer IntegerKind.U8 0 |)))
                              ]
                            |)))
                        | _ => M.impossible "wrong number of arguments"
                        end))
                  ...
                  M.read (|
                    let~ sz : Ty.path "usize" :=
                      M.copy (|
                        ...
                        |)
                      |) in
                    let~ carry : Ty.path "u8" := M.alloc (| Value.Integer IntegerKind.U8 0 |) in
                    let~ _ : Ty.tuple [] :=
                      M.use
                        (M.match_operator (|
                          M.alloc (|
              ...
              M.borrow (|
                ...
                M.deref (|
                  M.read (|
                    ...
                    let~ digits : Ty.path "usize" :=
                      M.alloc (|
                        BinOp.Wrap.div (| M.read (| bits |), M.read (| digitbits |) |)
                      |) in
                    let~ bits : Ty.path "usize" :=
                      M.alloc (|
                        BinOp.Wrap.rem (| M.read (| bits |), M.read (| digitbits |) |)
                      |) in
                    let~ _ : Ty.tuple [] :=
                      M.match_operator (|
                        M.alloc (| Value.Tuple [] |),
              ...
              M.read (|
                        ...
                        ltac:(M.monadic
                          (let γ :=
                            M.use
                              (M.alloc (|
                                UnOp.not (|
                                  BinOp.gt (| M.read (| other |), Value.Integer IntegerKind.U8 0 |)
                                |)
                              |)) in
                          let _ :=
                            M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                ...
                let~ sz : Ty.path "usize" :=
                  M.copy (|
                    ...
                    |)
                  |) in
                let~ borrow : Ty.path "u8" := M.alloc (| Value.Integer IntegerKind.U8 0 |) in
                let~ _ : Ty.tuple [] :=
                  M.use
                    (M.match_operator (|
                      M.alloc (|
