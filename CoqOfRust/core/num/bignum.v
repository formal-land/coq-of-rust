          ...
          ltac:(M.monadic
            ...
            M.read (|
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                ...
                |) in
              let~ lhs : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u16",
                    BinOp.Wrap.bit_or,
                  ...
                  |)
                |) in
              let~ rhs : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                M.alloc (| M.cast (Ty.path "u16") (M.read (| other |)) |) in
              M.alloc (|
                Value.Tuple
                  [
                    M.cast
          ...
          ltac:(M.monadic
            ...
            M.read (|
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                ...
                |) in
              let~ lhs : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u32",
                    BinOp.Wrap.bit_or,
                  ...
                  |)
                |) in
              let~ rhs : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                M.alloc (| M.cast (Ty.path "u32") (M.read (| other |)) |) in
              M.alloc (|
                Value.Tuple
                  [
                    M.cast
          ...
          ltac:(M.monadic
            ...
            M.read (|
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                ...
                |) in
              let~ lhs : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u64",
                    BinOp.Wrap.bit_or,
                  ...
                  |)
                |) in
              let~ rhs : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (| M.cast (Ty.path "u64") (M.read (| other |)) |) in
              M.alloc (|
                Value.Tuple
                  [
                    M.cast
          ...
          ltac:(M.monadic
            ...
            M.read (|
              let~ base :
                ...
                M.alloc (|
                  repeat (| Value.Integer IntegerKind.U32 0, Value.Integer IntegerKind.Usize 40 |)
                |) in
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                M.alloc (|
                  M.write (|
            ...
            M.read (|
              let~ base :
                ...
                M.alloc (|
                  repeat (| Value.Integer IntegerKind.U32 0, Value.Integer IntegerKind.Usize 40 |)
                |) in
              let~ sz : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
      ...
      Definition get_bit (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; i ] =>
          ltac:(M.monadic
            ...
            let i := M.alloc (| i |) in
            M.read (|
              let~ digitbits : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.cast
                    (Ty.path "usize")
                    (M.read (|
                    ...
                    |))
                |) in
              let~ d : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
                    BinOp.Wrap.div,
                ...
                M.read (|
                  let~ sz : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      ...
                      |)
                    |) in
                  let~ noborrow : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                  ...
                  let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                    M.match_operator (|
                      ...
                      [
                        fun γ =>
                          ltac:(M.monadic
                            (let γ := M.use (M.alloc (| UnOp.not (| M.read (| noborrow |) |) |)) in
                            let _ :=
                              is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                            M.alloc (|
                              M.never_to_any (|
                ...
                M.read (|
                  let~ sz : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.copy (|
                      ...
                      |)
                    |) in
                  let~ carry : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                  ...
                  let~ digitbits : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.cast
                        ...
                        |))
                    |) in
                  let~ digits : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.call_closure (|
                        Ty.path "usize",
                        BinOp.Wrap.div,
                      ...
                      [
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let _ :=
                              is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                            let~ last : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                              M.copy (| sz |) in
                            let~ overflow : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                              M.alloc (|
                                M.call_closure (|
                                  Ty.path "u32",
                                  BinOp.Wrap.shr,
        ...
        | [], [], [ self; e ] =>
          ltac:(M.monadic
            ...
            M.borrow (|
              ...
              M.deref (|
                M.read (|
                  let~ table_index : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.cast
                        (Ty.path "usize")
                        (M.call_closure (|
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          let~ small_power : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                          ...
                          let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                            M.loop (|
                              ...
                              ltac:(M.monadic
                                ...
                                |)))
                            |) in
                          let~ rest_power : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                ...
                M.read (|
                  let~ ret :
                    ...
                    M.alloc (|
                      ...
                      |)
                    |) in
                  let~ retsz : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.copy (|
                      M.match_operator (|
                        Some (Ty.apply (Ty.path "*") [] [ Ty.path "usize" ]),
                        M.alloc (| Value.Tuple [] |),
            ...
            M.read (|
              ...
              let~ sz : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.copy (|
                  ...
                  |)
                |) in
              let~ borrow : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                M.alloc (| Value.Integer IntegerKind.U32 0 |) in
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                M.use
                  (M.match_operator (|
            ...
            M.read (|
              ...
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                M.alloc (|
                  ...
                  |)
                |) in
              let~ q_is_zero : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                M.alloc (| Value.Bool true |) in
                ...
                (M.read (|
                  let~ sz : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.copy (|
                      ...
                      |)
                    |) in
                  let~ digitlen : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.call_closure (|
                        Ty.path "usize",
                        BinOp.Wrap.div,
            ...
            ltac:(M.monadic
              ...
              M.read (|
                let~ base :
                  ...
                  M.alloc (|
                    repeat (| Value.Integer IntegerKind.U8 0, Value.Integer IntegerKind.Usize 3 |)
                  |) in
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  M.alloc (|
                    M.write (|
                      ...
                      M.match_operator (|
                        ...
                        [
                          fun γ =>
                            ltac:(M.monadic
                              (let γ :=
                                M.use (M.alloc (| UnOp.not (| M.read (| noborrow |) |) |)) in
                              let _ :=
                                is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                              M.alloc (|
                                M.never_to_any (|
                  ...
                  M.read (|
                    let~ sz : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.copy (|
                        ...
                        |)
                      |) in
                    let~ carry : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                        ...
                        [
                          fun γ =>
                            ltac:(M.monadic
                              ...
                              let~ last : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                M.copy (| sz |) in
                              let~ overflow : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                                M.alloc (|
                                  M.call_closure (|
                                    Ty.path "u8",
                                    BinOp.Wrap.shr,
                      ...
                      [
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let small_power := M.copy (| γ0_0 |) in
                            let small_e := M.copy (| γ0_1 |) in
                            let~ small_power : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                            ...
                            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                              M.loop (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  |)))
                              |) in
                            let~ rest_power : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
              ...
              M.read (|
                ...
                let~ sz : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.copy (|
                    ...
                    |)
                  |) in
                let~ borrow : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                  M.alloc (| Value.Integer IntegerKind.U8 0 |) in
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  M.use
                    (M.match_operator (|
