              ...
              let~ lhs : Ty.path "u16" :=
                BinOp.bit_or
                  (BinOp.Wrap.shl (|
                    ...
                    M.read (| M.get_constant "core::num::BITS" |)
                  |))
                  (M.cast (Ty.path "u16") (M.read (| self |))) in
              ...
              let~ lhs : Ty.path "u32" :=
                BinOp.bit_or
                  (BinOp.Wrap.shl (|
                    ...
                    M.read (| M.get_constant "core::num::BITS" |)
                  |))
                  (M.cast (Ty.path "u32") (M.read (| self |))) in
              ...
              let~ lhs : Ty.path "u64" :=
                BinOp.bit_or
                  (BinOp.Wrap.shl (|
                    ...
                    M.read (| M.get_constant "core::num::BITS" |)
                  |))
                  (M.cast (Ty.path "u64") (M.read (| self |))) in
          ...
          ltac:(M.monadic
            ...
            M.read (|
              let~ digitbits : Ty.path "usize" :=
                M.cast (Ty.path "usize") (M.read (| M.get_constant "core::num::BITS" |)) in
              let~ d : Ty.path "usize" :=
                BinOp.Wrap.div (| M.read (| i |), M.read (| digitbits |) |) in
              let~ b : Ty.path "usize" :=
                BinOp.Wrap.rem (| M.read (| i |), M.read (| digitbits |) |) in
              M.alloc (|
                M.cast
                  (Ty.path "u8")
                  (BinOp.bit_and
              ...
              M.deref (|
                M.read (|
                  ...
                  let~ digits : Ty.path "usize" :=
                    BinOp.Wrap.div (| M.read (| bits |), M.read (| digitbits |) |) in
                  let~ bits : Ty.path "usize" :=
                    BinOp.Wrap.rem (| M.read (| bits |), M.read (| digitbits |) |) in
                  let~ _ : Ty.tuple [] :=
                    M.read (|
                      M.match_operator (|
                        Some (Ty.tuple []),
