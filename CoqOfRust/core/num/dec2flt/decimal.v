    ...
    Module decimal.
      ...
      Module Impl_core_num_dec2flt_decimal_Decimal.
        ...
        Definition value_MAX_DIGITS (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ltac:(M.monadic (M.alloc (| Value.Integer IntegerKind.Usize 768 |))).
                ...
                ltac:(M.monadic
                  (M.read (|
                    let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                      ...
                      |) in
                    let~ dp : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.alloc (|
                        M.cast
                          (Ty.path "usize")
                          (M.read (|
                    ...
                    let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                      M.use
                        ...
                        |)) in
                    let~ round_up : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                ...
                ltac:(M.monadic
                  (M.read (|
                    let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                      ...
                      |) in
                    let~ num_new_digits : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "usize",
                          M.get_function (|
                        ...
                        |)
                      |) in
                    let~ read_index : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.copy (|
                        M.SubPointer.get_struct_record_field (|
                          M.deref (| M.read (| self |) |),
                          "core::num::dec2flt::decimal::Decimal",
                        ...
                        |)
                      |) in
                    let~ write_index : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "usize",
                          BinOp.Wrap.add,
                                ...
                                ltac:(M.monadic
                                  ...
                                  let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                    M.alloc (|
                                      ...
                                      |)
                                    |) in
                                  let~ quotient : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                                    M.alloc (|
                                      M.call_closure (|
                                        Ty.path "u64",
                                        BinOp.Wrap.div,
                                  ...
                                  let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                    ...
                                    |) in
                                  let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                    M.alloc (| M.write (| n, M.read (| quotient |) |) |) in
                                  M.alloc (| Value.Tuple [] |)));
                              fun γ =>
                                ltac:(M.monadic
                                  (M.alloc (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  let _ :=
                                    is_constant_or_break_match (|
                                      ...
                                      Value.Bool true
                                    |) in
                                  let~ new_digit : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                                    M.alloc (|
                                      M.cast
                                        (Ty.path "u8")
                                        (M.call_closure (|
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let~ n_trailing_zeros : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                          M.alloc (| Value.Integer IntegerKind.Usize 0 |) in
                        let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                          M.use
                            (M.match_operator (|
                              ...
                              ltac:(M.monadic
                                ...
                                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                  M.alloc (|
                                    ...
                                    |)
                                  |) in
                                let~ neg_exp : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                                  M.alloc (| Value.Bool false |) in
                                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                  M.match_operator (|
                                    Ty.apply (Ty.path "*") [] [ Ty.tuple [] ],
                                  ...
                                  |) in
                                let~ exp_num : Ty.apply (Ty.path "*") [] [ Ty.path "i32" ] :=
                ...
                (M.read (|
                  let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                    M.alloc (|
                      ...
                      |)
                    |) in
                  let~ x_a : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                    M.copy (|
                      M.SubPointer.get_array_field (|
                        get_constant (|
                      ...
                      |)
                    |) in
                  let~ x_b : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                    M.copy (|
                      M.SubPointer.get_array_field (|
                        get_constant (|
                          "core::num::dec2flt::decimal::number_of_digits_decimal_left_shift::TABLE",
                  ...
                  let~ num_new_digits : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.cast
                        ...
                        |))
                    |) in
                  let~ pow5_a : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.cast
                        (Ty.path "usize")
                        (M.call_closure (|
                        ...
                        |))
                    |) in
                  let~ pow5_b : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    M.alloc (|
                      M.cast
                        (Ty.path "usize")
                        (M.call_closure (|
