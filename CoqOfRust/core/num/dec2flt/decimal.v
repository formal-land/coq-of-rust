  ...
  Module dec2flt.
    Module decimal.
            ...
            [
              ...
              ("digits",
                Ty.apply
                  ...
                  [
                    M.unevaluated_const
                      (mk_str (| "core_num_dec2flt_decimal_Decimal_digits_discriminant" |))
                  ]
                  [ Ty.path "u8" ])
            ];
        } *)
      ...
      Module Impl_core_num_dec2flt_decimal_Decimal.
        ...
        (* Ty.path "usize" *)
        Definition value_MAX_DIGITS (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ltac:(M.monadic (M.alloc (| Ty.path "usize", Value.Integer IntegerKind.Usize 768 |))).
        ...
        (* Ty.path "usize" *)
        Definition value_MAX_DIGITS_WITHOUT_OVERFLOW
            (ε : list Value.t)
            (τ : list Ty.t)
            (α : list Value.t)
            : M :=
        ...
        (* Ty.path "i32" *)
        Definition value_DECIMAL_POINT_RANGE
            (ε : list Value.t)
            (τ : list Ty.t)
            (α : list Value.t)
            : M :=
        ...
        Definition try_add_digit (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [], [ self; digit ] =>
            ltac:(M.monadic
              (let self :=
                M.alloc (|
                  Ty.apply (Ty.path "&mut") [] [ Ty.path "core::num::dec2flt::decimal::Decimal" ],
                  self
                |) in
              let digit := M.alloc (| Ty.path "u8", digit |) in
              M.read (|
                let~ _ : Ty.tuple [] :=
                  M.read (|
                    M.match_operator (|
                        ...
                        let~ dp : Ty.path "usize" :=
                          M.cast
                            ...
                            (M.read (|
                              ...
                              |)
                            |)) in
                        let~ n : Ty.path "u64" := Value.Integer IntegerKind.U64 0 in
                        let~ _ : Ty.tuple [] :=
                          M.read (|
                            M.use
                              (M.match_operator (|
                              ...
                              |))
                          |) in
                        let~ round_up : Ty.path "bool" := Value.Bool false in
                        let~ _ : Ty.tuple [] :=
                          M.read (|
                            M.match_operator (|
                              Ty.tuple [],
                        ...
                        let~ _ : Ty.tuple [] :=
                          ...
                          M.write (|
                            ...
                            M.call_closure (|
                              Ty.path "usize",
                              BinOp.Wrap.add,
                              [ M.read (| β |); M.read (| num_new_digits |) ]
                            |)
                          |) in
                        let~ _ : Ty.tuple [] :=
                          M.read (|
                        ...
                        let~ _ : Ty.tuple [] :=
                          ...
                          M.write (|
                            ...
                            M.call_closure (|
                              Ty.path "i32",
                              BinOp.Wrap.add,
                              [ M.read (| β |); M.cast (Ty.path "i32") (M.read (| num_new_digits |))
                              ]
                            |)
                          |) in
                        let~ _ : Ty.tuple [] :=
                ...
                M.catch_return (Ty.tuple []) (|
                  ltac:(M.monadic
                    (M.alloc (|
                      Ty.tuple [],
                      M.read (|
                        let~ read_index : Ty.path "usize" := Value.Integer IntegerKind.Usize 0 in
                        let~ write_index : Ty.path "usize" := Value.Integer IntegerKind.Usize 0 in
                        let~ n : Ty.path "u64" := Value.Integer IntegerKind.U64 0 in
                        let~ _ : Ty.tuple [] :=
                          M.read (|
                            M.loop (|
      ...
      *)
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          let _ :=
                            is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                          let~ n_trailing_zeros : Ty.path "usize" :=
                          ...
                          let~ _ : Ty.tuple [] :=
                            ...
                            M.write (|
                              ...
                              M.call_closure (|
                                Ty.path "usize",
                                BinOp.Wrap.sub,
                                [ M.read (| β |); M.read (| n_trailing_zeros |) ]
                              |)
                            |) in
                          let~ _ : Ty.tuple [] :=
                            let β :=
                                ...
                                ltac:(M.monadic
                                  ...
                                  let~ _ : Ty.tuple [] :=
                                    M.write (|
                                      ...
                                      |)
                                    |) in
                                  let~ neg_exp : Ty.path "bool" := Value.Bool false in
                                  let~ _ : Ty.tuple [] :=
                                    M.read (|
                                      M.match_operator (|
                                        Ty.tuple [],
                                      ...
                                      |)
                                    |) in
                                  let~ exp_num : Ty.path "i32" := Value.Integer IntegerKind.I32 0 in
                                  let~ _ :
                                      Ty.apply
                                        (Ty.path "&")
                                        []
      ...
      Global Instance Instance_IsFunction_parse_decimal :
        M.IsFunction.C "core::num::dec2flt::decimal::parse_decimal" parse_decimal.
      Admitted.
      ...
      *)
                      ...
                      let~ _ : Ty.tuple [] :=
                        ...
                        M.write (|
                          ...
                          M.call_closure (|
                            Ty.path "usize",
                            BinOp.Wrap.bit_and,
                            [ M.read (| β |); Value.Integer IntegerKind.Usize 63 ]
                          |)
                        |) in
                      let~ x_a : Ty.path "u16" :=
                        M.read (|
                        ...
                        M.read (|
                          M.SubPointer.get_array_field (|
                            ...
                            M.call_closure (|
                              Ty.path "usize",
                              BinOp.Wrap.add,
                              [ M.read (| shift |); Value.Integer IntegerKind.Usize 1 ]
                            |)
                          |)
                        |) in
                      let~ num_new_digits : Ty.path "usize" :=
                        M.cast
                          ...
                          (M.call_closure (|
                            Ty.path "u16",
                            BinOp.Wrap.shr,
                            [ M.read (| x_a |); Value.Integer IntegerKind.I32 11 ]
                          |)) in
                      let~ pow5_a : Ty.path "usize" :=
                        M.cast
                          (Ty.path "usize")
                          (M.call_closure (|
                            Ty.path "u16",
                            BinOp.Wrap.bit_and,
                            [ Value.Integer IntegerKind.U16 2047; M.read (| x_a |) ]
                          |)) in
                      let~ pow5_b : Ty.path "usize" :=
                        M.cast
                          (Ty.path "usize")
                          (M.call_closure (|
                            Ty.path "u16",
                            BinOp.Wrap.bit_and,
                            [ Value.Integer IntegerKind.U16 2047; M.read (| x_b |) ]
                          |)) in
                      let~ pow5 :
                          Ty.apply
                            (Ty.path "&")
      ...
      Module number_of_digits_decimal_left_shift.
        Definition value_TABLE (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ltac:(M.monadic
            (M.alloc (|
              Ty.apply (Ty.path "array") [ Value.Integer IntegerKind.Usize 65 ] [ Ty.path "u16" ],
              Value.Array
                [
        ...
        Definition value_TABLE_POW5 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ltac:(M.monadic
            (M.alloc (|
              Ty.apply (Ty.path "array") [ Value.Integer IntegerKind.Usize 1308 ] [ Ty.path "u8" ],
              Value.Array
                [
                  Value.Integer IntegerKind.U8 5;
        ...
        Global Instance Instance_IsConstant_value_TABLE_POW5 :
          M.IsFunction.C
            "core::num::dec2flt::decimal::number_of_digits_decimal_left_shift::TABLE_POW5"
            value_TABLE_POW5.
        Admitted.
