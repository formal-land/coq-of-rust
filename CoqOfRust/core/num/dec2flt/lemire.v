...
Module num.
  Module dec2flt.
    Module lemire.
      ...
      *)
      Definition compute_float (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
        | [ F ], [ q; w ] =>
          ltac:(M.monadic
            (let q := M.alloc (| q |) in
                      ...
                      fun γ =>
                        ltac:(M.monadic
                                    ...
                                    let inside_safe_exponent :=
                                      M.alloc (|
                                        LogicalOp.and (|
                                          BinOp.Pure.ge (|
                                            M.read (| q |),
                                            M.of_value (| Value.Integer (-27) |)
                                          |),
                                          ltac:(M.monadic
                                            (BinOp.Pure.le (|
                                              M.read (| q |),
                                              M.of_value (| Value.Integer 55 |)
                                            |)))
                                        |)
                                      |) in
                                    M.match_operator (|
                                  ...
                                  ltac:(M.monadic
                                    ...
                                    let _ :=
                                      ...
                                      M.write (|
                                        ...
                                        BinOp.Pure.bit_and (|
                                          M.read (| β |),
                                          UnOp.Pure.not (| M.of_value (| Value.Integer 1 |) |)
                                        |)
                                      |) in
                                    M.alloc (| M.of_value (| Value.Tuple [] |) |)));
                                fun γ =>
                          ...
                          let _ :=
                            ...
                            M.write (|
                              β,
                              BinOp.Panic.shr (| M.read (| β |), M.of_value (| Value.Integer 1 |) |)
                            |) in
                          let _ :=
                            M.match_operator (|
                              M.alloc (| M.of_value (| Value.Tuple [] |) |),
      ...
      *)
      Definition power (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
        | [], [ q ] =>
          ltac:(M.monadic
            (let q := M.alloc (| q |) in
              ...
              BinOp.Panic.shr (|
                M.call_closure (|
                  ...
                  [
                    ...
                    BinOp.Panic.add (|
                      Integer.I32,
                      M.of_value (| Value.Integer 152170 |),
      ...
      *)
      Definition full_multiplication (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
        | [], [ a; b ] =>
          ltac:(M.monadic
            (let a := M.alloc (| a |) in
            ...
            M.read (|
              ...
              M.alloc (|
                M.of_value (|
                  Value.Tuple
                    [
                      A.to_value (M.rust_cast (| M.read (| r |) |));
                      A.to_value
                        (M.rust_cast (|
                          BinOp.Panic.shr (| M.read (| r |), M.of_value (| Value.Integer 64 |) |)
                        |))
                    ]
                |)
              |)
      ...
      *)
      Definition compute_product_approx (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
        | [], [ q; w; precision ] =>
          ltac:(M.monadic
            (let q := M.alloc (| q |) in
                ...
                M.copy (|
                  M.match_operator (|
                    ...
                    [
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          (M.alloc (| M.of_value (| Value.Integer 18446744073709551615 |) |)))
                    ]
                  |)
                |) in
              let index :=
                            ...
                            ltac:(M.monadic
                              ...
                              M.alloc (|
                                M.of_value (|
                                  Value.Tuple
                                    [
                                      A.to_value (M.read (| first_lo |));
                                      A.to_value (M.read (| first_hi |))
                                    ]
                                |)
                              |)))
                        ]
