    ...
    Module lemire.
      ...
      *)
      Definition compute_float (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [ F ], [ q; w ] =>
          ltac:(M.monadic
            (let q := M.alloc (| Ty.path "i64", q |) in
            let w := M.alloc (| Ty.path "u64", w |) in
      ...
      *)
      Definition power (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ q ] =>
          ltac:(M.monadic
            (let q := M.alloc (| Ty.path "i32", q |) in
            M.call_closure (|
              Ty.path "i32",
              BinOp.Wrap.add,
              [
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        |)));
                    fun γ => ltac:(M.monadic (Value.Integer IntegerKind.U64 18446744073709551615))
                  ]
                |) in
                ...
                M.match_operator (|
                  ...
                  M.SubPointer.get_array_field (|
                    M.deref (|
                      M.read (|
                        get_constant (|
                          "core::num::dec2flt::table::POWER_OF_FIVE_128",
                          Ty.apply
                            (Ty.path "&")
                            []
                            [
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                        let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                        let lo5 := M.copy (| Ty.path "u64", γ0_0 |) in
                        let hi5 := M.copy (| Ty.path "u64", γ0_1 |) in
                        M.match_operator (|
                          Ty.tuple [ Ty.path "u64"; Ty.path "u64" ],
                          M.alloc (|
                            Ty.tuple [ Ty.path "u64"; Ty.path "u64" ],
