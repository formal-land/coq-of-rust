                          ...
                          ltac:(M.monadic
                            (let γ :=
                              M.use
                                (M.alloc (|
                                  LogicalOp.or (|
                                    BinOp.Pure.eq (M.read (| w |)) (Value.Integer Integer.U64 0),
                                    ltac:(M.monadic
                                      (BinOp.Pure.lt
                                        (M.read (| q |))
                                        (M.rust_cast
                      ...
                      fun γ =>
                        ltac:(M.monadic
                                  ...
                                  ltac:(M.monadic
                                    ...
                                    let _ :=
                                      ...
                                      M.write (|
                                        ...
                                        BinOp.Pure.bit_and
                                          (M.read (| β |))
                                          (UnOp.Pure.not (Value.Integer Integer.U64 1))
                                      |) in
                                    M.alloc (| Value.Tuple [] |)));
                                fun γ => ltac:(M.monadic (M.alloc (| Value.Tuple [] |)))
                              ]
                          ...
                          let _ :=
                            ...
                            M.write (|
                              β,
                              BinOp.Panic.shr (| M.read (| β |), Value.Integer Integer.I32 1 |)
                            |) in
                          let _ :=
                            M.match_operator (|
                              M.alloc (| Value.Tuple [] |),
              ...
              BinOp.Panic.shr (|
                M.call_closure (|
                  ...
                  [
                    M.read (| q |);
                    BinOp.Panic.add (|
                      Value.Integer Integer.I32 152170,
                      Value.Integer Integer.I32 65536
                    |)
                  ]
                |),
        ...
        | [], [ a; b ] =>
          ltac:(M.monadic
            ...
            M.read (|
              let r :=
                M.alloc (|
                  BinOp.Panic.mul (| M.rust_cast (M.read (| a |)), M.rust_cast (M.read (| b |)) |)
                |) in
              M.alloc (|
                Value.Tuple
                  [
                    M.rust_cast (M.read (| r |));
                    M.rust_cast (BinOp.Panic.shr (| M.read (| r |), Value.Integer Integer.I32 64 |))
                  ]
              |)
            |)))
        | _, _ => M.impossible
                ...
                M.copy (|
                  M.match_operator (|
                    ...
                    [
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          (M.alloc (| Value.Integer Integer.U64 18446744073709551615 |)))
                    ]
                  |)
                |) in
              let index :=
