      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            ...
            M.read (|
              M.match_operator (|
                Some (Ty.apply (Ty.path "*") [] [ Ty.path "core::num::diy_float::Fp" ]),
            ...
            M.read (|
              ...
              let~ c : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  ...
                  |)
                |) in
              let~ d : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u64",
                    BinOp.Wrap.bit_and,
                  ...
                  |)
                |) in
              let~ ac : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u64",
                    BinOp.Wrap.mul,
                  ...
                  |)
                |) in
              let~ bc : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u64",
                    BinOp.Wrap.mul,
                  ...
                  |)
                |) in
              let~ ad : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u64",
                    BinOp.Wrap.mul,
                  ...
                  |)
                |) in
              let~ bd : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u64",
                    BinOp.Wrap.mul,
                  ...
                  |)
                |) in
              let~ tmp : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u64",
                    BinOp.Wrap.add,
                  ...
                  |)
                |) in
              let~ f : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u64",
                    BinOp.Wrap.add,
                  ...
                  |)
                |) in
              let~ e : Ty.apply (Ty.path "*") [] [ Ty.path "i16" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "i16",
                    BinOp.Wrap.add,
      ...
      Definition normalize_to (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; e ] =>
          ltac:(M.monadic
            ...
            let e := M.alloc (| e |) in
            M.read (|
              let~ edelta : Ty.apply (Ty.path "*") [] [ Ty.path "i16" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "i16",
                    BinOp.Wrap.sub,
              ...
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                ...
                |) in
              let~ edelta : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
