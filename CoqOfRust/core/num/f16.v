    ...
    Definition classify (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
          M.read (|
            let~ b : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "u16",
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          ...
          M.catch_return (Ty.path "f16") (|
            ltac:(M.monadic
              (M.read (|
                let~ bits : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "u16",
                      M.get_associated_function (| Ty.path "f16", "to_bits", [], [] |),
                ...
                let~ abs : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                  M.alloc (|
                    ...
                    |)
                  |) in
                let~ next_bits : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                  M.copy (|
                    M.match_operator (|
              ...
              [
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let~ abs_a : Ty.apply (Ty.path "*") [] [ Ty.path "f16" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "f16",
                          M.get_associated_function (| Ty.path "f16", "abs", [], [] |),
                        ...
                        |)
                      |) in
                    let~ abs_b : Ty.apply (Ty.path "*") [] [ Ty.path "f16" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "f16",
                          M.get_associated_function (| Ty.path "f16", "abs", [], [] |),
    ...
    Definition total_cmp (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; other ] =>
        ltac:(M.monadic
          ...
          let other := M.alloc (| other |) in
          M.read (|
            let~ left : Ty.apply (Ty.path "*") [] [ Ty.path "i16" ] :=
              M.alloc (|
                M.cast
                  (Ty.path "i16")
                  (M.call_closure (|
                  ...
                  |))
              |) in
            let~ right : Ty.apply (Ty.path "*") [] [ Ty.path "i16" ] :=
              M.alloc (|
                M.cast
                  (Ty.path "i16")
                  (M.call_closure (|
