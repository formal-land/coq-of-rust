                  ...
                  ltac:(M.monadic
                    (let γ :=
                      M.use
                        ...
                        |)) in
                    let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                    let~ minus_exp : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.alloc (|
                        M.cast
                          (Ty.path "usize")
        ...
        ltac:(M.monadic
          ...
          M.read (|
            ...
            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
              ...
              |) in
            let~ exp : Ty.apply (Ty.path "*") [] [ Ty.path "i32" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "i32",
                  BinOp.Wrap.sub,
                              ...
                              [
                                fun γ =>
                                  ltac:(M.monadic
                                    ...
                                    let buf := M.copy (| γ0_0 |) in
                                    let exp := M.copy (| γ0_1 |) in
                                    let~ vis_exp : Ty.apply (Ty.path "*") [] [ Ty.path "i32" ] :=
                                      M.alloc (|
                                        M.call_closure (|
                                          Ty.path "i32",
                                          BinOp.Wrap.sub,
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            (let γ0_0 :=
                              ...
                              |) in
                            let decoded := M.alloc (| γ0_0 |) in
                            let~ maxlen : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                              M.alloc (|
                                M.call_closure (|
                                  Ty.path "usize",
                                  M.get_function (|
                            ...
                            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                              ...
                              |) in
                            let~ trunc : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                              M.copy (|
                                M.match_operator (|
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                              ...
                              |) in
                            let~ limit : Ty.apply (Ty.path "*") [] [ Ty.path "i16" ] :=
                              M.copy (|
                                M.match_operator (|
