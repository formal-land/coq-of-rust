    ...
    Module strategy.
      Module dragon.
        ...
        Definition value_POW5TO64 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ltac:(M.monadic
            (M.alloc (|
              Ty.apply (Ty.path "array") [ Value.Integer IntegerKind.Usize 5 ] [ Ty.path "u32" ],
              M.alloc (|
                Ty.apply (Ty.path "array") [ Value.Integer IntegerKind.Usize 5 ] [ Ty.path "u32" ],
                Value.Array
                  [
        ...
        Definition value_POW5TO256 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ltac:(M.monadic
            (M.alloc (|
              Ty.apply (Ty.path "array") [ Value.Integer IntegerKind.Usize 19 ] [ Ty.path "u32" ],
              M.alloc (|
                Ty.apply (Ty.path "array") [ Value.Integer IntegerKind.Usize 19 ] [ Ty.path "u32" ],
                Value.Array
                  [
          ...
          | [], [], [ x; scale; scale2; scale4; scale8 ] =>
            ltac:(M.monadic
              ...
              let scale8 :=
                ...
                |) in
              M.read (|
                let~ d : Ty.path "u8" := Value.Integer IntegerKind.U8 0 in
                let~ _ : Ty.tuple [] :=
                  M.match_operator (|
                    Ty.tuple [],
                    M.alloc (| Ty.tuple [], Value.Tuple [] |),
                ...
                let~ _ : Ty.apply (Ty.path "&mut") [] [ Ty.path "core::num::bignum::Big32x40" ] :=
                  M.call_closure (|
                    ...
                    M.get_associated_function (|
                      ...
                      []
                    |),
                    [ M.borrow (| Pointer.Kind.MutRef, scale2 |); Value.Integer IntegerKind.Usize 1
                    ]
                  |) in
                ...
                let~ _ : Ty.apply (Ty.path "&mut") [] [ Ty.path "core::num::bignum::Big32x40" ] :=
                  M.call_closure (|
                    ...
                    M.get_associated_function (|
                      ...
                      []
                    |),
                    [ M.borrow (| Pointer.Kind.MutRef, scale4 |); Value.Integer IntegerKind.Usize 2
                    ]
                  |) in
                ...
                let~ _ : Ty.apply (Ty.path "&mut") [] [ Ty.path "core::num::bignum::Big32x40" ] :=
                  M.call_closure (|
                    ...
                    M.get_associated_function (|
                      ...
                      []
                    |),
                    [ M.borrow (| Pointer.Kind.MutRef, scale8 |); Value.Integer IntegerKind.Usize 3
                    ]
                  |) in
                let down := M.read (| Value.DeclaredButUndefined |) in
                let up := M.read (| Value.DeclaredButUndefined |) in
                            ...
                            [
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  let d := M.copy (| Ty.path "u8", γ0_0 |) in
                                  M.read (|
                                    let~ _ : Ty.tuple [] :=
                                      M.match_operator (|
                                        Ty.tuple [],
                                                          ...
                                                          ltac:(M.monadic
                                                            ...
                                                            M.read (|
                                                              let~ _ : Ty.tuple [] :=
                                                                ...
                                                                |) in
                                                              let~ d : Ty.path "u8" :=
                                                                Value.Integer IntegerKind.U8 0 in
                                                              let~ _ : Ty.tuple [] :=
                                                                M.match_operator (|
                                                                  Ty.tuple [],
                                                                  M.alloc (|
