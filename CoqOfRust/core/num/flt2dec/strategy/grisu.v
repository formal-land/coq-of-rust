    ...
    Module strategy.
      Module grisu.
        ...
        *)
        ...
        Admitted.
        Global Opaque max_pow10_no_more_than.
        ...
        *)
                                      ...
                                      let~ _ : Ty.tuple [] :=
                                        M.loop (|
                                          ...
                                          ltac:(M.monadic
                                            ...
                                            M.alloc (| Value.Tuple [] |)))
                                        |) in
                                      let~ remainder : Ty.path "u64" := M.copy (| plus1frac |) in
                                      let~ threshold : Ty.path "u64" := M.copy (| delta1frac |) in
                                      let~ ulp : Ty.path "u64" :=
        ...
        Global Instance Instance_IsFunction_format_shortest_opt :
          M.IsFunction.Trait
            ...
            format_shortest_opt.
        Admitted.
        Global Opaque format_shortest_opt.
                  ...
                  ltac:(M.monadic
                    (M.read (|
                      ...
                      let~ plus1v_down : Ty.path "u64" :=
                        M.alloc (| BinOp.Wrap.add (| M.read (| plus1v |), M.read (| ulp |) |) |) in
                      let~ plus1v_up : Ty.path "u64" :=
                        M.alloc (| BinOp.Wrap.sub (| M.read (| plus1v |), M.read (| ulp |) |) |) in
                      let~ plus1w : Ty.path "u64" := M.copy (| remainder |) in
                      let~ _ : Ty.tuple [] :=
        ...
        *)
                                      ...
                                      let~ _ : Ty.tuple [] :=
                                        M.loop (|
                                          ...
                                          ltac:(M.monadic
                                            ...
                                            M.alloc (| Value.Tuple [] |)))
                                        |) in
                                      let~ remainder : Ty.path "u64" := M.copy (| vfrac |) in
        ...
        Global Instance Instance_IsFunction_format_exact_opt :
          M.IsFunction.Trait
            ...
            format_exact_opt.
        Admitted.
        Global Opaque format_exact_opt.
