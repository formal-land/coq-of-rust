  ...
  Module int_sqrt.
    Definition value_U8_ISQRT_WITH_REMAINDER
      ...
      ltac:(M.monadic
        ...
        let~ isqrt_n : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
          M.alloc (| Value.Integer IntegerKind.Usize 0 |) in
          ...
          M.read (|
            M.match_operator (|
              ...
              let~ n : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                ...
                |) in
              M.match_operator (|
                Ty.apply (Ty.path "*") [] [ Ty.tuple [ Ty.path "u8"; Ty.path "u8" ] ],
                M.SubPointer.get_array_field (|
                  get_constant (|
                    "core::num::int_sqrt::U8_ISQRT_WITH_REMAINDER",
                    Ty.apply
                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                      ...
                      |) in
                    let~ lo : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "u16",
                          BinOp.Wrap.bit_and,
                        ...
                        |)
                      |) in
                    let~ numerator : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "u16",
                          BinOp.Wrap.bit_or,
                        ...
                        |)
                      |) in
                    let~ denominator : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "u16",
                          BinOp.Wrap.shl,
                        ...
                        |)
                      |) in
                    let~ q : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "u16",
                          BinOp.Wrap.div,
                        ...
                        |)
                      |) in
                    let~ s : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "u16",
                          BinOp.Wrap.add,
                    ...
                    M.match_operator (|
                      ...
                      let~ q : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                        M.alloc (|
                          ...
                          |)
                        |) in
                      let~ u : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                        M.alloc (|
                          M.call_closure (|
                            Ty.path "u16",
                            BinOp.Wrap.rem,
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                              ...
                              |) in
                            let~ lo : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                              M.alloc (|
                                M.call_closure (|
                                  Ty.path "u32",
                                  BinOp.Wrap.bit_and,
                                ...
                                |)
                              |) in
                            let~ numerator : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                              M.alloc (|
                                M.call_closure (|
                                  Ty.path "u32",
                                  BinOp.Wrap.bit_or,
                                ...
                                |)
                              |) in
                            let~ denominator : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                              M.alloc (|
                                M.call_closure (|
                                  Ty.path "u32",
                                  BinOp.Wrap.shl,
                            ...
                            M.match_operator (|
                              ...
                              let~ q : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                                M.alloc (|
                                  ...
                                  |)
                                |) in
                              let~ u : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                                M.alloc (|
                                  M.call_closure (|
                                    Ty.path "u32",
                                    BinOp.Wrap.rem,
                                  ...
                                  ltac:(M.monadic
                                    ...
                                    let~ lo : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                                      M.alloc (|
                                        ...
                                        |)
                                      |) in
                                    let~ numerator : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                                      M.alloc (|
                                        M.call_closure (|
                                          Ty.path "u64",
                                          BinOp.Wrap.bit_or,
                                    ...
                                    let~ q : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                                      M.alloc (|
                                        ...
                                        |)
                                      |) in
                                    let~ s : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                                      M.alloc (|
                                        M.call_closure (|
                                          Ty.path "u64",
                                          BinOp.Wrap.add,
                                          ...
                                          ltac:(M.monadic
                                            ...
                                            let~ q : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
                                              M.alloc (|
                                                ...
                                                |)
                                              |) in
                                            let~ s : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
                                              M.alloc (|
                                                M.call_closure (|
                                                  Ty.path "u128",
                                                  BinOp.Wrap.add,
          ...
          M.read (|
            M.match_operator (|
              ...
              [
                ...
                fun γ =>
                  ltac:(M.monadic
                    (let~ normalization_shift : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "u32",
                          BinOp.Wrap.bit_and,
                    ...
                    let~ s : Ty.apply (Ty.path "*") [] [ Ty.path "u16" ] :=
                      M.alloc (|
                        ...
                        |)
                      |) in
                    let~ denormalization_shift : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "u32",
                          BinOp.Wrap.shr,
