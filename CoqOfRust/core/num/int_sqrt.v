                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let~ denominator : Ty.path "u16" :=
                      ...
                      |) in
                    let~ q : Ty.path "u16" :=
                      BinOp.Wrap.div (| M.read (| numerator |), M.read (| denominator |) |) in
                    let~ s : Ty.path "u16" :=
                      BinOp.Wrap.add (|
                        M.cast
                          (Ty.path "u16")
                    ...
                    M.match_operator (|
                      ...
                      let~ n : Ty.path "u16" :=
                        M.cast
                          ...
                          (BinOp.Wrap.shr (|
                            M.read (| n |),
                            M.read (| M.get_constant "core::num::int_sqrt::u32_stages::N_SHIFT'1" |)
                          |)) in
                      let~ lo : Ty.path "u16" :=
                        BinOp.bit_and
                          (M.read (| n |))
                      ...
                      let~ q : Ty.path "u16" :=
                        BinOp.Wrap.div (| M.read (| numerator |), M.read (| denominator |) |) in
                      let~ u : Ty.path "u16" :=
                        BinOp.Wrap.rem (| M.read (| numerator |), M.read (| denominator |) |) in
                      let~ s : Ty.path "u16" :=
                        BinOp.Wrap.add (|
                          M.cast
                            (Ty.path "u16")
                            ...
                            let~ numerator : Ty.path "u32" :=
                              BinOp.bit_or
                                (BinOp.Wrap.shl (|
                                  ...
                                  M.read (|
                                    M.get_constant "core::num::int_sqrt::u32_stages::QUARTER_BITS'1"
                                  |)
                                |))
                                (BinOp.Wrap.shr (|
                                  M.read (| lo |),
                    ...
                    M.match_operator (|
                      ...
                      let~ n : Ty.path "u16" :=
                        M.cast
                          ...
                          (BinOp.Wrap.shr (|
                            M.read (| n |),
                            M.read (| M.get_constant "core::num::int_sqrt::u64_stages::N_SHIFT'1" |)
                          |)) in
                      let~ lo : Ty.path "u16" :=
                        BinOp.bit_and
                          (M.read (| n |))
