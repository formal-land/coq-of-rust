      ...
      Definition clone (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "core::ops::range::Bound") [] [ T ] ],
                self
              |) in
            M.match_operator (|
      ...
      *)
      Definition map (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [ U; F ], [ self; f ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (| Ty.apply (Ty.path "core::ops::range::Bound") [] [ T ], self |) in
                    ...
                    ltac:(M.monadic
                      (let γ0_0 :=
                        M.SubPointer.get_struct_tuple_field (|
                          ...
                          0
                        |) in
                      let start := M.copy (| Ty.apply (Ty.path "&") [] [ T ], γ0_0 |) in
                      M.call_closure (|
                        Ty.path "bool",
                        M.get_trait_method (|
                          "core::cmp::PartialOrd",
                      ...
                      ltac:(M.monadic
                        (let γ0_0 :=
                          M.SubPointer.get_struct_tuple_field (|
                            ...
                            0
                          |) in
                        let end_ := M.copy (| Ty.apply (Ty.path "&") [] [ T ], γ0_0 |) in
                        M.call_closure (|
                          Ty.path "bool",
                          M.get_trait_method (|
                            "core::cmp::PartialOrd",
