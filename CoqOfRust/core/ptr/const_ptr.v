      ...
      Definition with_addr (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; addr ] =>
          ltac:(M.monadic
            ...
            M.read (|
              let~ self_addr : Ty.apply (Ty.path "*") [] [ Ty.path "isize" ] :=
                M.alloc (|
                  M.cast
                    (Ty.path "isize")
                    (M.call_closure (|
                    ...
                    |))
                |) in
              let~ dest_addr : Ty.apply (Ty.path "*") [] [ Ty.path "isize" ] :=
      ...
      Definition offset_from (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; origin ] =>
          ltac:(M.monadic
            ...
            M.read (|
              let~ pointee_size : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
                    M.get_function (| "core::mem::size_of", [], [ T ] |),
          ...
          ltac:(M.monadic
            ...
            M.read (|
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                ...
                |) in
              let~ ret : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
