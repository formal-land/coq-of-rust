...
Module ptr.
  ...
  *)
  Definition null (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [] =>
      ltac:(M.monadic
        (M.call_closure (|
  ...
  *)
  Definition null_mut (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [] =>
      ltac:(M.monadic
        (M.call_closure (|
  ...
  *)
  Definition invalid_mut (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ addr ] =>
      ltac:(M.monadic
        (let addr := M.alloc (| addr |) in
  ...
  *)
  Definition from_exposed_addr (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ addr ] =>
      ltac:(M.monadic
        (let addr := M.alloc (| addr |) in
  ...
  *)
  Definition from_exposed_addr_mut (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ addr ] =>
      ltac:(M.monadic
        (let addr := M.alloc (| addr |) in
  ...
  *)
  Definition slice_from_raw_parts (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ data; len ] =>
      ltac:(M.monadic
  ...
  *)
  Definition slice_from_raw_parts_mut (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ data; len ] =>
      ltac:(M.monadic
        (let data := M.alloc (| data |) in
  ...
  *)
  Definition swap_nonoverlapping (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ x; y; count ] =>
      ltac:(M.monadic
        (let x := M.alloc (| x |) in
  ...
  *)
  Definition swap_nonoverlapping_simple_untyped (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ x; y; count ] =>
      ltac:(M.monadic
        (let x := M.alloc (| x |) in
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      (let γ :=
                        M.use
                          (M.alloc (| BinOp.Pure.lt (| M.read (| i |), M.read (| count |) |) |)) in
  ...
  *)
  Definition read (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ src ] =>
      ltac:(M.monadic
        (let src := M.alloc (| src |) in
                    ...
                    let _ :=
                      M.alloc (|
                        M.call_closure (|
                          ...
                          |),
                          [
                            M.of_value (| Value.Tuple [ A.to_value (M.read (| src |)) ] |);
  ...
  *)
  Definition read_unaligned (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ src ] =>
      ltac:(M.monadic
        (let src := M.alloc (| src |) in
  ...
  *)
  Definition write_unaligned (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ dst; src ] =>
      ltac:(M.monadic
        (let dst := M.alloc (| dst |) in
  ...
  *)
  Definition read_volatile (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ src ] =>
      ltac:(M.monadic
        (let src := M.alloc (| src |) in
  ...
  *)
  Definition write_volatile (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ dst; src ] =>
      ltac:(M.monadic
        (let dst := M.alloc (| dst |) in
  ...
  *)
  Definition align_offset (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T ], [ p; a ] =>
      ltac:(M.monadic
        (let p := M.alloc (| p |) in
              ...
              let a_minus_one :=
                M.alloc (|
                  M.call_closure (|
                    ...
                    [ M.read (| a |); M.of_value (| Value.Integer 1 |) ]
                  |)
                |) in
              let _ :=
                M.match_operator (|
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          (let γ :=
                            M.use
                              (M.alloc (| BinOp.Pure.lt (| M.read (| x |), M.read (| y |) |) |)) in
                          let _ :=
                            M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                          x));
              ...
              let gcd :=
                M.alloc (|
                  M.call_closure (|
                    ...
                    [ M.of_value (| Value.Integer 1 |); M.read (| gcdpow |) ]
                  |)
                |) in
              let _ :=
                M.match_operator (|
                                ...
                                BinOp.Pure.bit_and (|
                                  ...
                                  M.call_closure (|
                                    M.get_function (|
                                      ...
                                      [ Ty.path "usize" ]
                                    |),
                                    [ M.read (| gcd |); M.of_value (| Value.Integer 1 |) ]
                                  |)
                                |),
                                M.of_value (| Value.Integer 0 |)
                              |)
                                ...
                                M.alloc (|
                                  M.call_closure (|
                                    M.get_function (|
                                      ...
                                      [ Ty.path "usize" ]
                                    |),
                                    [ M.read (| a2 |); M.of_value (| Value.Integer 1 |) ]
                                  |)
                                |) in
                              let s2 :=
                                M.alloc (|
  ...
  Module align_offset.
    ...
    *)
    Definition mod_inv (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [], [ x; m ] =>
        ltac:(M.monadic
          (let x := M.alloc (| x |) in
          ...
          M.read (|
            let m_minus_one :=
              M.alloc (|
                M.call_closure (|
                  M.get_function (| "core::intrinsics::unchecked_sub", [ Ty.path "usize" ] |),
                  [ M.read (| m |); M.of_value (| Value.Integer 1 |) ]
                |)
              |) in
            let inverse :=
              M.alloc (|
    ...
    Module mod_inv.
      Definition value_INV_TABLE_MOD_16 : A.t :=
        M.run
          ltac:(M.monadic
            (M.alloc (|
              M.of_value (|
      ...
      Definition value_INV_TABLE_MOD : A.t :=
  ...
  *)
  Definition addr_eq (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [ T; U ], [ p; q ] =>
      ltac:(M.monadic
        (let p := M.alloc (| p |) in
  ...
  *)
  ...
  Module Impl_core_cmp_PartialEq_where_core_marker_FnPtr_F_for_F.
    ...
    *)
    Definition eq (F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
  ...
  Module Impl_core_cmp_PartialOrd_where_core_marker_FnPtr_F_for_F.
    ...
    *)
    Definition partial_cmp (F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self F in
      match τ, α with
      | [], [ self; other ] =>
        ltac:(M.monadic
  ...
  Module Impl_core_cmp_Ord_where_core_marker_FnPtr_F_for_F.
    ...
    *)
    Definition cmp (F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self F in
      match τ, α with
      | [], [ self; other ] =>
        ltac:(M.monadic
  ...
  Module Impl_core_hash_Hash_where_core_marker_FnPtr_F_for_F.
    ...
    *)
    Definition hash (F : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      let Self : Ty.t := Self F in
      match τ, α with
      | [ HH ], [ self; state ] =>
        ltac:(M.monadic
