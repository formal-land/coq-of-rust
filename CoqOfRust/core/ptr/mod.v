    ...
    | [], [ T ], [ p; a ] =>
      ltac:(M.monadic
        ...
        M.catch_return (Ty.path "usize") (|
          ltac:(M.monadic
            (M.read (|
              let~ stride : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
                    M.get_function (| "core::mem::size_of", [], [ T ] |),
                  ...
                  |)
                |) in
              let~ addr : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
                    M.get_associated_function (|
                  ...
                  |)
                |) in
              let~ a_minus_one : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
              ...
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        M.alloc (|
                          M.never_to_any (|
                            M.read (|
                              let~ p_mod_a : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                M.alloc (|
                                  M.call_closure (|
                                    Ty.path "usize",
                                    BinOp.Wrap.bit_and,
                ...
                |) in
              let~ a_mod_stride : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
              ...
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                ...
                |) in
              let~ gcdpow : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                M.copy (|
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        M.alloc (|
                          M.never_to_any (|
                            M.read (|
                              let~ a2 : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                M.alloc (|
                                  M.call_closure (|
                                    Ty.path "usize",
                                    M.get_function (|
                                  ...
                                  |)
                                |) in
                              let~ a2minus1 : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                M.alloc (|
                                  M.call_closure (|
                                    Ty.path "usize",
                                    M.get_function (|
                                  ...
                                  |)
                                |) in
                              let~ s2 : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                M.alloc (|
                                  M.call_closure (|
                                    Ty.path "usize",
                                    M.get_function (|
                                  ...
                                  |)
                                |) in
                              let~ minusp2 : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                M.alloc (|
                                  M.call_closure (|
                                    Ty.path "usize",
                                    M.get_function (|
    ...
    Definition mod_inv (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ x; m ] =>
        ltac:(M.monadic
          ...
          let m := M.alloc (| m |) in
          M.read (|
            let~ m_minus_one : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "usize",
                  M.get_function (| "core::intrinsics::unchecked_sub", [], [ Ty.path "usize" ] |),
                ...
                |)
              |) in
            let~ inverse : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.alloc (|
                M.cast
                  (Ty.path "usize")
                  (M.read (|
                  ...
                  |))
              |) in
            let~ mod_gate : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.copy (|
                get_constant (|
                  "core::ptr::align_offset::mod_inv::INV_TABLE_MOD",
                  Ty.path "usize"
