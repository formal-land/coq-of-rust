...
Module ptr.
  ...
  *)
  ...
  Admitted.
  Global Opaque without_provenance.
  ...
  *)
  ...
  Admitted.
  Global Opaque without_provenance_mut.
  ...
  *)
  ...
  Admitted.
  Global Opaque with_exposed_provenance.
  ...
  *)
  ...
  Admitted.
  Global Opaque with_exposed_provenance_mut.
  ...
  *)
  ...
  Admitted.
  Global Opaque slice_from_raw_parts.
  ...
  *)
  ...
  Admitted.
  Global Opaque slice_from_raw_parts_mut.
  ...
  *)
                              ...
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  M.alloc (|
                                    M.never_to_any (|
                                      M.read (|
                                        let~ x : Ty.apply (Ty.path "*mut") [] [ Ty.path "usize" ] :=
                                          M.alloc (|
                                            M.call_closure (|
                              ...
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  M.alloc (|
                                    M.never_to_any (|
                                      M.read (|
                                        let~ x : Ty.apply (Ty.path "*mut") [] [ Ty.path "u8" ] :=
                                          M.alloc (|
                                            M.call_closure (|
  ...
  Admitted.
  Global Opaque swap_nonoverlapping.
  ...
  *)
  ...
  Admitted.
  Global Opaque swap_nonoverlapping_simple_untyped.
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          let~ _ : Ty.tuple [] :=
                            ...
                            |) in
                          let~ _ : Ty.tuple [] :=
                            M.alloc (| M.write (| mod_gate, M.read (| new_gate |) |) |) in
                          M.alloc (| Value.Tuple [] |)))
                    ]
                  |)))
              |) in
