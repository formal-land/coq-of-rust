                  ...
                  M.never_to_any (|
                    M.call_closure (|
                      ...
                      [
                        M.borrow (|
                          Pointer.Kind.Ref,
                          M.deref (| mk_str (| "called `Result::unwrap()` on an `Err` value" |) |)
                        |);
                        (* Unsize *)
                        M.pointer_coercion
                          (M.borrow (|
    ...
    *)
    Definition and (T E : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ U ], [ self; res ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "core::result::Result") [] [ T; E ], self |) in
          let res := M.alloc (| Ty.apply (Ty.path "core::result::Result") [] [ U; E ], res |) in
          M.match_operator (|
            Ty.apply (Ty.path "core::result::Result") [] [ U; E ],
            self,
            [
    ...
    *)
    Definition or (T E : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ F ], [ self; res ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "core::result::Result") [] [ T; E ], self |) in
          let res := M.alloc (| Ty.apply (Ty.path "core::result::Result") [] [ T; F ], res |) in
          M.match_operator (|
            Ty.apply (Ty.path "core::result::Result") [] [ T; F ],
            self,
            [
                ...
                (fun γ =>
                  ltac:(M.monadic
                    ...
                    | [ α0 ] =>
                      ltac:(M.monadic
                        (M.match_operator (|
                          Ty.function [ Ty.tuple [ Ty.apply (Ty.path "&mut") [] [ T ] ] ] T,
                          M.alloc (| Ty.apply (Ty.path "&mut") [] [ T ], α0 |),
                          [
                            fun γ =>
                              ltac:(M.monadic
              ...
              fun γ =>
                ltac:(M.monadic
                  ...
                  Value.StructTuple
                    ...
                    []
                    [ Ty.apply (Ty.path "core::result::Result") [] [ T; E ] ]
                    [ Value.StructTuple "core::result::Result::Ok" [] [ T; E ] [ M.read (| x |) ]
                    ]));
              fun γ =>
                ltac:(M.monadic
                  (let γ0_0 :=
              ...
              fun γ =>
                ltac:(M.monadic
                  (let γ0_0 :=
                    M.SubPointer.get_struct_tuple_field (| γ, "core::result::Result::Ok", 0 |) in
                  let inner :=
                    M.copy (| Ty.apply (Ty.path "core::result::Result") [] [ T; E ], γ0_0 |) in
                  M.read (| inner |)));
              fun γ =>
                ltac:(M.monadic
                  (let γ0_0 :=
    ...
    Definition next (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "core::result::Iter") [] [ T ] ],
              self
            |) in
          M.call_closure (|
            Ty.apply (Ty.path "core::option::Option") [] [ Ty.apply (Ty.path "&") [] [ T ] ],
    ...
    Definition fmt (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; f ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "core::result::IterMut") [] [ T ] ],
              self
            |) in
          let f :=
            M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "core::fmt::Formatter" ], f |) in
    ...
    Definition next (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "core::result::IterMut") [] [ T ] ],
              self
            |) in
          M.call_closure (|
            Ty.apply (Ty.path "core::option::Option") [] [ Ty.apply (Ty.path "&mut") [] [ T ] ],
    ...
    Definition next (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "core::result::IntoIter") [] [ T ] ],
              self
            |) in
          M.call_closure (|
            Ty.apply (Ty.path "core::option::Option") [] [ T ],
  ...
  Module Impl_core_ops_try_trait_FromResidual_where_core_convert_From_F_E_core_ops_try_trait_Yeet_E_for_core_result_Result_T_F.
    ...
    *)
    Definition from_residual
      ...
      | [], [], [ β0 ] =>
        ltac:(M.monadic
          (let β0 := M.alloc (| Ty.apply (Ty.path "core::ops::try_trait::Yeet") [] [ E ], β0 |) in
          M.match_operator (|
            Ty.apply (Ty.path "core::result::Result") [] [ T; F ],
            β0,
            [
