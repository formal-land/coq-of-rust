                          ...
                          let~ _ : Ty.tuple [] :=
                            M.call_closure (|
                              ...
                              M.get_associated_function (|
                                ...
                                []
                              |),
                              [ M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| byte |) |) |)
                              ]
                            |) in
                          let~ _ : Ty.tuple [] :=
                            let β := i in
      ...
      Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "core::slice::ascii::EscapeByte" ],
                self
              |) in
            Value.StructTuple "core::slice::ascii::EscapeByte" [] [] []))
        | _, _, _ => M.impossible "wrong number of arguments"
      ...
      Definition next (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&mut") [] [ Ty.path "core::slice::ascii::EscapeAscii" ],
                self
              |) in
            M.call_closure (|
      ...
      *)
      Definition fold (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [ Acc; Fold ], [ self; init; fold ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "core::slice::ascii::EscapeAscii", self |) in
            let init := M.alloc (| Acc, init |) in
            let fold := M.alloc (| Fold, fold |) in
            M.call_closure (|
              Acc,
