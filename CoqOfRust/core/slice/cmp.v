                  ...
                  [
                    ...
                    M.borrow (|
                      ...
                      M.deref (|
                        M.borrow (|
                          Pointer.Kind.Ref,
                          M.alloc (| Ty.path "isize", Value.Integer IntegerKind.Isize 0 |)
                        |)
                      |)
                    |)
                  ]
      ...
      Definition slice_contains
        ...
        | [], [], [ self; x ] =>
          ltac:(M.monadic
            ...
            let x :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "slice") [] [ T ] ], x |) in
            M.call_closure (|
              Ty.path "bool",
              M.get_trait_method (|
                "core::iter::traits::iterator::Iterator",
                        ...
                        ltac:(M.monadic
                          (M.match_operator (|
                            ...
                            [
                              fun γ =>
                                ltac:(M.monadic
                                  (let y := M.copy (| Ty.apply (Ty.path "&") [] [ T ], γ |) in
                                  M.call_closure (|
                                    Ty.path "bool",
                                    M.get_trait_method (|
                                      "core::cmp::PartialEq",
                                  ...
                                  ltac:(M.monadic
                                    (M.match_operator (|
                                      Ty.function
                                        [ Ty.tuple [ Ty.apply (Ty.path "&") [] [ Ty.path "i16" ] ] ]
                                        (Ty.path "bool"),
                                      M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "i16" ], α0 |),
                                      [
                                        fun γ =>
                                          ltac:(M.monadic
                                            (let x :=
                                  ...
                                  ltac:(M.monadic
                                    (M.match_operator (|
                                      Ty.function
                                        [ Ty.tuple [ Ty.apply (Ty.path "&") [] [ Ty.path "i64" ] ] ]
                                        (Ty.path "bool"),
                                      M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "i64" ], α0 |),
                                      [
                                        fun γ =>
                                          ltac:(M.monadic
                                            (let x :=
      ...
      Definition slice_contains (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; arr ] =>
          ltac:(M.monadic
            ...
            let arr :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "slice") [] [ Ty.path "f32" ] ],
                arr
              |) in
            M.catch_return (Ty.path "bool") (|
              ltac:(M.monadic
                                  ...
                                  ltac:(M.monadic
                                    (M.match_operator (|
                                      Ty.function
                                        [ Ty.tuple [ Ty.apply (Ty.path "&") [] [ Ty.path "f32" ] ] ]
                                        (Ty.path "bool"),
                                      M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "f32" ], α0 |),
                                      [
                                        fun γ =>
                                          ltac:(M.monadic
                                            (let x :=
      ...
      Definition slice_contains (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; arr ] =>
          ltac:(M.monadic
            ...
            let arr :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "slice") [] [ Ty.path "f64" ] ],
                arr
              |) in
            M.catch_return (Ty.path "bool") (|
              ltac:(M.monadic
                                  ...
                                  ltac:(M.monadic
                                    (M.match_operator (|
                                      Ty.function
                                        [ Ty.tuple [ Ty.apply (Ty.path "&") [] [ Ty.path "f64" ] ] ]
                                        (Ty.path "bool"),
                                      M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "f64" ], α0 |),
                                      [
                                        fun γ =>
                                          ltac:(M.monadic
                                            (let x :=
