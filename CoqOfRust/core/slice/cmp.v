...
Module slice.
  Module cmp.
    ...
    Module SlicePartialEq.
      Definition not_equal (B Self : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
        | [], [ self; other ] =>
          ltac:(M.monadic
            (let self := M.alloc (| self |) in
    ...
    Module Impl_core_slice_cmp_SlicePartialEq_where_core_cmp_PartialEq_A_B_B_for_slice_A.
      ...
      *)
      Definition equal (A B : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self A B in
        match τ, α with
        | [], [ self; other ] =>
          ltac:(M.monadic
    ...
    Module Impl_core_slice_cmp_SlicePartialOrd_where_core_cmp_PartialOrd_A_for_A.
      ...
      *)
      Definition partial_compare (A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    ...
    Module Impl_core_slice_cmp_SliceOrd_where_core_cmp_Ord_A_for_A.
      ...
      *)
      Definition compare (A : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self A in
        match τ, α with
        | [], [ _ as left; _ as right ] =>
          ltac:(M.monadic
            ...
            M.read (|
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [ order; M.alloc (| M.of_value (| Value.Integer 0 |) |) ]
                |)
              |)
            |)))
        | _, _ => M.impossible
    ...
    Module Impl_core_slice_cmp_SliceContains_where_core_cmp_PartialEq_T_for_T.
      ...
      *)
      Definition slice_contains (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [], [ self; x ] =>
          ltac:(M.monadic
    ...
    Module Impl_core_slice_cmp_SliceContains_for_u8.
      ...
      *)
      Definition slice_contains (τ : list Ty.t) (α : list A.t) : M :=
        match τ, α with
        | [], [ self; x ] =>
          ltac:(M.monadic
            (let self := M.alloc (| self |) in
