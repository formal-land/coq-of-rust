...
Module slice.
  Module iter.
                    ...
                    [
                      ("ptr",
                        A.to_value
                          ...
                          |)));
                      ("end_or_len", A.to_value (M.read (| end_or_len |)));
                      ("_marker",
                        A.to_value
    ...
    Module Impl_core_slice_iter_IterMut_T.
      ...
      *)
      Definition into_slice (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
    ...
    Module Impl_core_slice_iter_Split_T_P.
      ...
      *)
      Definition new (T P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
          ...
          ltac:(M.monadic
            ...
            M.of_value (|
              Value.StructRecord
                ...
                [
                  ("v", A.to_value (M.read (| slice |)));
                  ("pred", A.to_value (M.read (| pred |)));
                  ("finished", A.to_value (M.of_value (| Value.Bool false |)))
                ]
            |)))
        | _, _ => M.impossible
        end.
      ...
      *)
      Definition as_slice (T P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T P in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      M.alloc (|
                        (* Unsize *)
                        M.pointer_coercion (| M.alloc (| M.of_value (| Value.Array [] |) |) |)
                      |)));
                  fun γ =>
                    ltac:(M.monadic
                      (M.alloc (|
    ...
    Module Impl_core_fmt_Debug_where_core_fmt_Debug_T_where_core_ops_function_FnMut_P_Tuple_ref__T__for_core_slice_iter_Split_T_P.
      ...
      *)
      Definition fmt (T P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T P in
        match τ, α with
        | [], [ self; f ] =>
          ltac:(M.monadic
                    ...
                    M.call_closure (|
                      ...
                      [
                        M.alloc (|
                          ...
                          |)
                        |);
                        M.read (| M.of_value (| Value.String "v" |) |);
                        (* Unsize *)
                        M.pointer_coercion (|
                          M.SubPointer.get_struct_record_field (|
                            M.read (| self |),
    ...
    Module Impl_core_clone_Clone_where_core_clone_Clone_P_where_core_ops_function_FnMut_P_Tuple_ref__T__for_core_slice_iter_Split_T_P.
      ...
      *)
      Definition clone (T P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T P in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
    ...
    Module Impl_core_iter_traits_iterator_Iterator_where_core_ops_function_FnMut_P_Tuple_ref__T__for_core_slice_iter_Split_T_P.
      ...
      *)
      Definition next (T P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T P in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
      ...
      *)
      Definition size_hint (T P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T P in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
    ...
    Module Impl_core_iter_traits_double_ended_DoubleEndedIterator_where_core_ops_function_FnMut_P_Tuple_ref__T__for_core_slice_iter_Split_T_P.
      ...
      *)
      Definition next_back (T P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T P in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
    ...
    Module Impl_core_slice_iter_SplitIter_where_core_ops_function_FnMut_P_Tuple_ref__T__for_core_slice_iter_Split_T_P.
      ...
      *)
      Definition finish (T P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T P in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
                ...
                M.of_value (|
                  Value.StructRecord
                    ...
                    [
                      ("v", A.to_value (M.read (| slice |)));
                      ("pred", A.to_value (M.read (| pred |)));
                      ("finished", A.to_value (M.read (| finished |)))
                    ]
                |)
              |)
            |)))
                        ...
                        M.alloc (|
                          M.call_closure (|
                            M.get_associated_function (|
                              ...
                              []
                            |),
                            [ M.read (| f |); M.read (| M.of_value (| Value.String "SplitMut" |) |)
                            ]
                          |)
                        |);
                        M.read (| M.of_value (| Value.String "v" |) |);
                      ...
                      [
                        M.alloc (|
                          M.call_closure (|
                            ...
                            [
                              M.read (| f |);
                              M.read (| M.of_value (| Value.String "SplitInclusiveMut" |) |)
                            ]
                          |)
                        |);
                        M.read (| M.of_value (| Value.String "v" |) |);
                        ...
                        M.alloc (|
                          M.call_closure (|
                            M.get_associated_function (|
                              ...
                              []
                            |),
                            [ M.read (| f |); M.read (| M.of_value (| Value.String "RSplitMut" |) |)
                            ]
                          |)
                        |);
                        M.read (| M.of_value (| Value.String "v" |) |);
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "GenericSplitN" |) |);
    ...
    Module Impl_core_iter_traits_iterator_Iterator_where_core_slice_iter_SplitIter_I_for_core_slice_iter_GenericSplitN_I.
      ...
      *)
      Definition next (T I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      ...
      *)
      Definition size_hint (T I : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T I in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
                    ...
                    A.to_value
                      (M.of_value (|
                        Value.StructRecord
                          "core::slice::iter::GenericSplitN"
                          [
                            ("iter", A.to_value (M.read (| s |)));
                            ("count", A.to_value (M.read (| n |)))
                          ]
                      |)))
                ]
            |)))
                    ...
                    M.alloc (|
                      M.call_closure (|
                        M.get_associated_function (|
                          ...
                          []
                        |),
                        [ M.read (| f |); M.read (| M.of_value (| Value.String "SplitNMut" |) |) ]
                      |)
                    |);
                    M.read (| M.of_value (| Value.String "inner" |) |);
                    (* Unsize *)
                    ...
                    M.alloc (|
                      M.call_closure (|
                        M.get_associated_function (|
                          ...
                          []
                        |),
                        [ M.read (| f |); M.read (| M.of_value (| Value.String "RSplitNMut" |) |) ]
                      |)
                    |);
                    M.read (| M.of_value (| Value.String "inner" |) |);
                    (* Unsize *)
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "Windows" |) |);
                M.read (| M.of_value (| Value.String "v" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
                  ...
                  |)
                |);
                M.read (| M.of_value (| Value.String "size" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.alloc (|
                    M.SubPointer.get_struct_record_field (|
        ...
        | [], [ slice; size ] =>
          ltac:(M.monadic
            ...
            M.of_value (|
              Value.StructRecord
                "core::slice::iter::Windows"
                [ ("v", A.to_value (M.read (| slice |))); ("size", A.to_value (M.read (| size |))) ]
            |)))
        | _, _ => M.impossible
        end.
    ...
    Module Impl_core_iter_traits_iterator_Iterator_for_core_slice_iter_Windows_T.
      ...
      *)
      Definition nth (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [], [ self; n ] =>
          ltac:(M.monadic
    ...
    Module Impl_core_iter_traits_double_ended_DoubleEndedIterator_for_core_slice_iter_Windows_T.
      ...
      *)
      Definition nth_back (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [], [ self; n ] =>
          ltac:(M.monadic
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "Chunks" |) |);
                M.read (| M.of_value (| Value.String "v" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
          ...
          ltac:(M.monadic
            ...
            M.of_value (|
              Value.StructRecord
                ...
                [
                  ("v", A.to_value (M.read (| slice |)));
                  ("chunk_size", A.to_value (M.read (| size |)))
                ]
            |)))
        | _, _ => M.impossible
        end.
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      (let γ :=
                        M.use
                          (M.alloc (| BinOp.Pure.ge (| M.read (| n |), M.read (| len |) |) |)) in
                      let _ := M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                      let _ :=
                        M.write (|
                          M.SubPointer.get_struct_record_field (|
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "ChunksMut" |) |);
                M.read (| M.of_value (| Value.String "v" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "ChunksExact" |) |);
                M.read (| M.of_value (| Value.String "v" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
                  ...
                  |)
                |);
                M.read (| M.of_value (| Value.String "rem" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
                    M.read (| self |),
    ...
    Module Impl_core_slice_iter_ChunksExact_T.
                      ...
                      M.alloc (|
                        M.of_value (|
                          Value.StructRecord
                            "core::slice::iter::ChunksExact"
                            [
                              ("v", A.to_value (M.read (| fst |)));
                              ("rem", A.to_value (M.read (| snd |)));
                              ("chunk_size", A.to_value (M.read (| chunk_size |)))
                            ]
                        |)
                      |)))
                ]
      ...
      *)
      Definition remainder (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "ChunksExactMut" |) |);
                M.read (| M.of_value (| Value.String "v" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
    ...
    Module Impl_core_slice_iter_ChunksExactMut_T.
      ...
      *)
      Definition into_remainder (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "ArrayWindows" |) |);
                M.read (| M.of_value (| Value.String "slice_head" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
                    M.read (| self |),
                  ...
                  |)
                |);
                M.read (| M.of_value (| Value.String "num" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
                    M.read (| self |),
                  ...
                  |)
                |);
                M.read (| M.of_value (| Value.String "marker" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.alloc (|
                    M.SubPointer.get_struct_record_field (|
                      ...
                      ("slice_head",
                        A.to_value
                          (M.call_closure (|
                            ...
                            [ M.read (| slice |) ]
                          |)));
                      ("num", A.to_value (M.read (| num_windows |)));
                      ("marker",
                        A.to_value
                          (M.of_value (| Value.StructTuple "core::marker::PhantomData" [] |)))
                    ]
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "ArrayChunks" |) |);
                M.read (| M.of_value (| Value.String "iter" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "ArrayChunksMut" |) |);
                M.read (| M.of_value (| Value.String "iter" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "RChunks" |) |);
                M.read (| M.of_value (| Value.String "v" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "RChunksMut" |) |);
                M.read (| M.of_value (| Value.String "v" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "RChunksExact" |) |);
                M.read (| M.of_value (| Value.String "v" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
                      ...
                      M.alloc (|
                        M.of_value (|
                          Value.StructRecord
                            "core::slice::iter::RChunksExact"
                            [
                              ("v", A.to_value (M.read (| snd |)));
                              ("rem", A.to_value (M.read (| fst |)));
                              ("chunk_size", A.to_value (M.read (| chunk_size |)))
                            ]
                        |)
                      |)))
        ...
        | [], [ self; f ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              ...
              [
                M.read (| f |);
                M.read (| M.of_value (| Value.String "RChunksExactMut" |) |);
                M.read (| M.of_value (| Value.String "v" |) |);
                (* Unsize *)
                M.pointer_coercion (|
                  M.SubPointer.get_struct_record_field (|
    ...
    Module Impl_core_iter_traits_iterator_Iterator_where_core_ops_function_FnMut_P_Tuple_ref__T_ref__T__for_core_slice_iter_GroupBy_T_P.
            ...
            M.read (|
              M.match_operator (|
                ...
                [
                  ...
                  fun γ =>
                    ltac:(M.monadic
                      (let len := M.alloc (| M.of_value (| Value.Integer 1 |) |) in
                      let iter :=
                        M.alloc (|
                          M.call_closure (|
                            M.get_associated_function (|
      ...
      *)
      Definition last (T P : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T P in
        match τ, α with
        | [], [ self ] =>
          ltac:(M.monadic
                    ...
                    M.alloc (|
                      M.call_closure (|
                        M.get_associated_function (|
                          ...
                          []
                        |),
                        [ M.read (| f |); M.read (| M.of_value (| Value.String "GroupBy" |) |) ]
                      |)
                    |);
                    M.read (| M.of_value (| Value.String "slice" |) |);
                    (* Unsize *)
                    M.pointer_coercion (|
                      M.SubPointer.get_struct_record_field (|
                        M.read (| self |),
                    ...
                    M.alloc (|
                      M.call_closure (|
                        M.get_associated_function (|
                          ...
                          []
                        |),
                        [ M.read (| f |); M.read (| M.of_value (| Value.String "GroupByMut" |) |) ]
                      |)
                    |);
                    M.read (| M.of_value (| Value.String "slice" |) |);
                    (* Unsize *)
