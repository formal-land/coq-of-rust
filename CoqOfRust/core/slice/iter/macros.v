...
Module slice.
  Module iter.
    Module Impl_core_slice_iter_Iter_T.
      ...
      *)
      Definition make_slice (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
      ...
      *)
      Definition post_inc_start (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [], [ self; offset ] =>
          ltac:(M.monadic
      ...
      *)
      Definition pre_dec_end (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [], [ self; offset ] =>
          ltac:(M.monadic
                  ...
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      let len :=
                        ...
                        |) in
                      M.alloc (|
                        BinOp.Pure.eq (| M.read (| len |), M.of_value (| Value.Integer 0 |) |)
                      |)));
                  fun γ =>
                    ltac:(M.monadic
                      (let end_ :=
    ...
    Module Impl_core_iter_traits_iterator_Iterator_for_core_slice_iter_Iter_T.
                        ...
                        let _ :=
                          M.write (|
                            ...
                            M.call_closure (|
                              ...
                              [ M.read (| i |); M.of_value (| Value.Integer 1 |) ]
                            |)
                          |) in
                        M.match_operator (|
                          M.alloc (| M.of_value (| Value.Tuple [] |) |),
      ...
      *)
      Definition for_each (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [ F ], [ self; f ] =>
          ltac:(M.monadic
                            ...
                            M.alloc (|
                              M.call_closure (|
                                M.get_trait_method (|
                                  ...
                                  []
                                |),
                                [ f; M.of_value (| Value.Tuple [ A.to_value (M.read (| x |)) ] |) ]
                              |)
                            |) in
                          M.alloc (| M.of_value (| Value.Tuple [] |) |)));
                      fun γ =>
      ...
      *)
      Definition all (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [ F ], [ self; f ] =>
          ltac:(M.monadic
      ...
      *)
      Definition any (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [ F ], [ self; f ] =>
          ltac:(M.monadic
      ...
      *)
      Definition find (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [ P ], [ self; predicate ] =>
          ltac:(M.monadic
      ...
      *)
      Definition find_map (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [ B; F ], [ self; f ] =>
          ltac:(M.monadic
      ...
      *)
      Definition position (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [ P ], [ self; predicate ] =>
          ltac:(M.monadic
      ...
      *)
      Definition rposition (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
        let Self : Ty.t := Self T in
        match τ, α with
        | [ P ], [ self; predicate ] =>
          ltac:(M.monadic
                                      ...
                                      ltac:(M.monadic
                                        ...
                                        M.call_closure (|
                                          ...
                                          [
                                            compare;
                                            M.of_value (|
                                              Value.Tuple [ A.to_value a; A.to_value b ]
                                            |)
                                          ]
                                        |)))
                                  ]
