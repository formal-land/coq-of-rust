                              ...
                              ltac:(M.monadic
                                ...
                                let _ :=
                                  is_constant_or_break_match (|
                                    ...
                                    Value.Bool true
                                  |) in
                                let~ max_idx : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                  M.alloc (|
                                    M.call_closure (|
                                      Ty.path "usize",
                                      M.get_associated_function (|
        ...
        | [], [ T; F ], [ v; index; ancestor_pivot; is_less ] =>
          ltac:(M.monadic
            ...
            M.catch_return (Ty.tuple []) (|
              ltac:(M.monadic
                (M.read (|
                  let~ limit : Ty.apply (Ty.path "*") [] [ Ty.path "i32" ] :=
                    M.alloc (| Value.Integer IntegerKind.I32 16 |) in
                  M.alloc (|
                    M.never_to_any (|
                      M.read (|
                        M.loop (|
                        ...
                        M.loop (|
                          ...
                          ltac:(M.monadic
                            ...
                            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                              ...
                              |) in
                            let~ p : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                              M.alloc (|
                                M.call_closure (|
                                  Ty.path "usize",
                                  M.get_function (|
      ...
      Definition median_of_ninthers (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [ T; F ], [ v; is_less ] =>
          ltac:(M.monadic
            ...
            let is_less := M.alloc (| is_less |) in
            M.read (|
              let~ frac : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.copy (|
                  M.match_operator (|
                  ...
                  |)
                |) in
              let~ pivot : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
                    BinOp.Wrap.div,
              ...
              let~ lo : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  ...
                  |)
                |) in
              let~ hi : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
                    BinOp.Wrap.add,
                  ...
                  |)
                |) in
              let~ gap : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
                    BinOp.Wrap.div,
                  ...
                  |)
                |) in
              let~ a : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
                    BinOp.Wrap.sub,
                  ...
                  |)
                |) in
              let~ b : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "usize",
                    BinOp.Wrap.add,
