  ...
  Module sort.
    Module select.
      ...
      *)
      ...
      Admitted.
      Global Opaque partition_at_index.
      ...
      *)
      ...
      Admitted.
      Global Opaque partition_at_index_loop.
      ...
      *)
      ...
      Admitted.
      Global Opaque median_of_medians.
      ...
      *)
          ...
          ltac:(M.monadic
            ...
            M.read (|
              ...
              let~ hi : Ty.path "usize" :=
                M.alloc (| BinOp.Wrap.add (| M.read (| frac |), M.read (| lo |) |) |) in
              ...
              let~ a : Ty.path "usize" :=
                ...
                |) in
              let~ b : Ty.path "usize" :=
                M.alloc (| BinOp.Wrap.add (| M.read (| hi |), M.read (| gap |) |) |) in
              let~ _ : Ty.tuple [] :=
                M.use
                  (M.match_operator (|
                    M.alloc (|
      ...
      Admitted.
      Global Opaque median_of_ninthers.
