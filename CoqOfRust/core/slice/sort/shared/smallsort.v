    ...
    Module shared.
      Module smallsort.
        ...
        Definition value_MAX_STACK_ARRAY_SIZE
            ...
            (α : list Value.t)
            : M :=
          ltac:(M.monadic (M.alloc (| Ty.path "usize", Value.Integer IntegerKind.Usize 4096 |))).
                          ...
                          fun γ =>
                            ltac:(M.monadic
                              ...
                              let _ :=
                                is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                              M.read (| len |)));
                          fun γ => ltac:(M.monadic (M.read (| len_div_2 |)))
                        ]
                      |) in
                    let~ region :
                        Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "slice") [] [ T ] ] :=
        ...
        *)
        Definition swap_if_less (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [ T; F ], [ v_base; a_pos; b_pos; is_less ] =>
            ltac:(M.monadic
              (let v_base := M.alloc (| Ty.apply (Ty.path "*mut") [] [ T ], v_base |) in
              let a_pos := M.alloc (| Ty.path "usize", a_pos |) in
              let b_pos := M.alloc (| Ty.path "usize", b_pos |) in
              let is_less := M.alloc (| Ty.apply (Ty.path "&mut") [] [ F ], is_less |) in
              M.read (|
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          let _ :=
                            is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                          M.read (| v_b |)));
                      fun γ => ltac:(M.monadic (M.read (| v_a |)))
                    ]
                  |) in
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          let _ :=
                            is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                          M.read (| v_a |)));
                      fun γ => ltac:(M.monadic (M.read (| v_b |)))
                    ]
                  |) in
                let~ right_swap_tmp :
        ...
        *)
        Definition insert_tail (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [ T; F ], [ begin; tail; is_less ] =>
            ltac:(M.monadic
              (let begin := M.alloc (| Ty.apply (Ty.path "*mut") [] [ T ], begin |) in
              let tail := M.alloc (| Ty.apply (Ty.path "*mut") [] [ T ], tail |) in
              let is_less := M.alloc (| Ty.apply (Ty.path "&mut") [] [ F ], is_less |) in
              M.catch_return (Ty.tuple []) (|
                ltac:(M.monadic
                  (M.read (|
        ...
        *)
        Definition sort4_stable (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [ T; F ], [ v_base; dst; is_less ] =>
            ltac:(M.monadic
              (let v_base := M.alloc (| Ty.apply (Ty.path "*const") [] [ T ], v_base |) in
          ...
          Definition select (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
            ...
            | [], [ T ], [ cond; if_true; if_false ] =>
              ltac:(M.monadic
                ...
                let if_true := M.alloc (| Ty.apply (Ty.path "*const") [] [ T ], if_true |) in
                let if_false := M.alloc (| Ty.apply (Ty.path "*const") [] [ T ], if_false |) in
                M.match_operator (|
                  Ty.apply (Ty.path "*const") [] [ T ],
                  M.alloc (| Ty.tuple [], Value.Tuple [] |),
                  [
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        M.read (| if_true |)));
                    fun γ => ltac:(M.monadic (M.read (| if_false |)))
                  ]
                |)))
            | _, _, _ => M.impossible "wrong number of arguments"
            end.
        ...
        Definition sort8_stable (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [ T; F ], [ v_base; dst; scratch_base; is_less ] =>
            ltac:(M.monadic
              (let v_base := M.alloc (| Ty.apply (Ty.path "*mut") [] [ T ], v_base |) in
              let dst := M.alloc (| Ty.apply (Ty.path "*mut") [] [ T ], dst |) in
              let scratch_base := M.alloc (| Ty.apply (Ty.path "*mut") [] [ T ], scratch_base |) in
              let is_less := M.alloc (| Ty.apply (Ty.path "&mut") [] [ F ], is_less |) in
              M.read (|
                let~ _ : Ty.tuple [] :=
                  M.read (|
        ...
        *)
        Definition merge_up (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [ T; F ], [ left_src; right_src; dst; is_less ] =>
            ltac:(M.monadic
              (let left_src := M.alloc (| Ty.apply (Ty.path "*const") [] [ T ], left_src |) in
              let right_src := M.alloc (| Ty.apply (Ty.path "*const") [] [ T ], right_src |) in
              let dst := M.alloc (| Ty.apply (Ty.path "*mut") [] [ T ], dst |) in
              let is_less := M.alloc (| Ty.apply (Ty.path "&mut") [] [ F ], is_less |) in
              M.read (|
                let~ _ : Ty.tuple [] :=
                          ...
                          fun γ =>
                            ltac:(M.monadic
                              ...
                              let _ :=
                                is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                              M.read (| left_src |)));
                          fun γ => ltac:(M.monadic (M.read (| right_src |)))
                        ]
                      |) in
                    let~ _ : Ty.tuple [] :=
                      M.call_closure (|
                          ...
                          fun γ =>
                            ltac:(M.monadic
                              ...
                              let _ :=
                                is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                              M.read (| right_src |)));
                          fun γ => ltac:(M.monadic (M.read (| left_src |)))
                        ]
                      |) in
                    let~ _ : Ty.tuple [] :=
                      M.call_closure (|
