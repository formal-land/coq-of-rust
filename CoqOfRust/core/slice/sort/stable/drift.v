            ...
            ltac:(M.monadic
              ...
              let scratch :=
                M.alloc (|
                  ...
                  scratch
                |) in
              let eager_sort := M.alloc (| Ty.path "bool", eager_sort |) in
                                      ...
                                      ltac:(M.monadic
                                        ...
                                        let next_run :=
                                          M.copy (|
                                            ...
                                            γ0_0
                                          |) in
                                        let desired_depth := M.copy (| Ty.path "u8", γ0_1 |) in
                                        let~ _ : Ty.tuple [] :=
                                          M.read (|
                                            M.match_operator (|
                                              Ty.tuple [],
                          ...
                          M.call_closure (|
                            ...
                            [
                              M.call_closure (|
                                Ty.path "u64",
                                BinOp.Wrap.shl,
                                [ Value.Integer IntegerKind.U64 1; Value.Integer IntegerKind.I32 62
                                ]
                              |);
        ...
        *)
        Definition merge_tree_depth (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [], [ _ as left; mid; _ as right; scale_factor ] =>
            ltac:(M.monadic
              (let left := M.alloc (| Ty.path "usize", left |) in
              let mid := M.alloc (| Ty.path "usize", mid |) in
              let right := M.alloc (| Ty.path "usize", right |) in
              let scale_factor := M.alloc (| Ty.path "u64", scale_factor |) in
              M.read (|
                let~ x : Ty.path "u64" :=
                  M.call_closure (|
                    Ty.path "u64",
                        ...
                        M.call_closure (|
                          ...
                          [
                            M.call_closure (|
                              Ty.path "u64",
                              BinOp.Wrap.mul,
                              [ M.read (| scale_factor |); M.read (| x |) ]
                            |);
                            M.call_closure (|
                              Ty.path "u64",
                              BinOp.Wrap.mul,
                              [ M.read (| scale_factor |); M.read (| y |) ]
                            |)
                          ]
                        |)
                      ]
                  ...
                  M.call_closure (|
                    ...
                    [
                      M.call_closure (|
                        Ty.path "u32",
                        BinOp.Wrap.add,
                        [ Value.Integer IntegerKind.U32 1; M.read (| ilog |) ]
                      |);
                      ...
                      M.call_closure (|
                        ...
                        [
                          M.call_closure (|
                            Ty.path "usize",
                            BinOp.Wrap.shl,
                            [ Value.Integer IntegerKind.Usize 1; M.read (| shift |) ]
                          |);
                          M.call_closure (|
                            Ty.path "usize",
                            BinOp.Wrap.shr,
                            [ M.read (| n |); M.read (| shift |) ]
                          |)
                        ]
                      |);
                      Value.Integer IntegerKind.Usize 2
          ...
          | [], [ T; F ], [ v; scratch; _ as left; _ as right; is_less ] =>
            ltac:(M.monadic
              ...
              let scratch :=
                ...
                |) in
              let left :=
                M.alloc (| Ty.path "core::slice::sort::stable::drift::DriftsortRun", left |) in
              let right :=
                M.alloc (| Ty.path "core::slice::sort::stable::drift::DriftsortRun", right |) in
              let is_less := M.alloc (| Ty.apply (Ty.path "&mut") [] [ F ], is_less |) in
              M.read (|
                let~ len : Ty.path "usize" :=
                  M.call_closure (|
            ...
            ltac:(M.monadic
              ...
              let scratch :=
                M.alloc (|
                  ...
                  scratch
                |) in
              let min_good_run_len := M.alloc (| Ty.path "usize", min_good_run_len |) in
              let eager_sort := M.alloc (| Ty.path "bool", eager_sort |) in
              let is_less := M.alloc (| Ty.apply (Ty.path "&mut") [] [ F ], is_less |) in
              M.read (|
                M.catch_return (Ty.path "core::slice::sort::stable::drift::DriftsortRun") (|
                  ltac:(M.monadic
                    (M.alloc (|
                      Ty.path "core::slice::sort::stable::drift::DriftsortRun",
                      M.read (|
                                      ...
                                      M.use
                                        (M.alloc (|
                                          ...
                                          M.call_closure (|
                                            Ty.path "bool",
                                            BinOp.ge,
                                            [ M.read (| len |); M.read (| min_good_run_len |) ]
                                          |)
                                        |)) in
                                    let _ :=
                                      is_constant_or_break_match (|
                                      ...
                                      [
                                        fun γ =>
                                          ltac:(M.monadic
                                            (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                                            let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                                            let run_len := M.copy (| Ty.path "usize", γ0_0 |) in
                                            let was_reversed := M.copy (| Ty.path "bool", γ0_1 |) in
                                            let~ _ : Ty.tuple [] :=
                                              M.call_closure (|
                                                Ty.tuple [],
                                                M.get_function (|
                    ...
                    M.call_closure (|
                      ...
                      [
                        M.call_closure (|
                          Ty.path "usize",
                          BinOp.Wrap.shl,
                          [ M.read (| length |); Value.Integer IntegerKind.I32 1 ]
                        |);
                        Value.Integer IntegerKind.Usize 1
                      ]
                    |)
          ...
          *)
          Definition sorted (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
            ...
            | [], [], [ self ] =>
              ltac:(M.monadic
                (let self :=
                  M.alloc (| Ty.path "core::slice::sort::stable::drift::DriftsortRun", self |) in
                M.call_closure (|
                  Ty.path "bool",
                  BinOp.eq,
                  [
