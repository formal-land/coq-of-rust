                ...
                ltac:(M.monadic
                  (M.read (|
                    ...
                    let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                      ...
                      |) in
                    let~ scale_factor : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "u64",
                          M.get_function (|
                        ...
                        |)
                      |) in
                    let~ min_good_run_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.copy (|
                        M.match_operator (|
                        ...
                        |)
                      |) in
                    let~ stack_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                    ...
                    let~ desired_depths :
                      ...
                      M.alloc (|
                        ...
                        |)
                      |) in
                    let~ scan_idx : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.alloc (| Value.Integer IntegerKind.Usize 0 |) in
                    let~ prev_run :
                        Ty.apply
                          (Ty.path "*")
        ...
        Definition sqrt_approx (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ...
          | [], [], [ n ] =>
            ltac:(M.monadic
              (let n := M.alloc (| n |) in
              M.read (|
                let~ ilog : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "u32",
              ...
              M.read (|
                let~ len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.alloc (|
                    ...
                    |)
                  |) in
                let~ can_fit_in_scratch : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "bool",
                      BinOp.le,
                      ...
                      [
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let _ :=
                              is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                            let~ eager_run_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                              M.alloc (|
                                M.call_closure (|
                                  Ty.path "usize",
                                  M.get_function (| "core::cmp::min", [], [ Ty.path "usize" ] |),
