                  ...
                  (M.read (|
                    ...
                    let~ min_good_run_len :=
                      M.copy (|
                        ...
                        |)
                      |) in
                    let~ stack_len := M.alloc (| Value.Integer 0 |) in
                    let~ run_storage :=
                      M.alloc (|
                        M.call_closure (|
                          M.get_associated_function (|
                        ...
                        M.call_closure (|
                          M.get_associated_function (|
                            Ty.apply
                              (Ty.path "core::mem::maybe_uninit::MaybeUninit")
                              []
                              [ Ty.apply (Ty.path "array") [ Value.Integer 66 ] [ Ty.path "u8" ] ],
                            "uninit",
                            []
                          |),
                          []
                    ...
                    let~ desired_depths :=
                      M.alloc (|
                        ...
                        |)
                      |) in
                    let~ scan_idx := M.alloc (| Value.Integer 0 |) in
                    let~ prev_run :=
                      M.alloc (|
                        M.call_closure (|
                          M.get_associated_function (|
                                        ...
                                        fun γ =>
                                          ltac:(M.monadic
                                            (let~ _ :=
                                              ...
                                              |) in
                                            let~ _ :=
                                              M.write (| desired_depth, Value.Integer 0 |) in
                                            M.alloc (| Value.Tuple [] |)))
                                      ]
                                    |) in
                                  let~ _ :=
                                  ...
                                  let~ _ :=
                                    ...
                                    M.write (|
                                      ...
                                      BinOp.Wrap.add
                                        ...
                                        |))
                                    |) in
                                  let~ _ := M.write (| prev_run, M.read (| next_run |) |) in
                                  M.alloc (| Value.Tuple [] |)))
                            ]
                          |)))
                      |) in
                ...
                M.alloc (|
                  BinOp.Wrap.div
                    ...
                    (BinOp.Wrap.sub
                      ...
                      (BinOp.Wrap.add
                        Integer.U64
                        (BinOp.Wrap.shl (Value.Integer 1) (Value.Integer 62))
                ...
                M.alloc (|
                  M.rust_cast
                    (M.call_closure (|
                      ...
                      [
                        BinOp.Pure.bit_xor
                          (BinOp.Wrap.mul Integer.U64 (M.read (| scale_factor |)) (M.read (| x |)))
                          (BinOp.Wrap.mul Integer.U64 (M.read (| scale_factor |)) (M.read (| y |)))
                      ]
                    |))
                |)
              |)))
                ...
                let~ ilog :=
                  M.alloc (|
                    M.call_closure (|
                      ...
                      [ BinOp.Pure.bit_or (M.read (| n |)) (Value.Integer 1) ]
                    |)
                  |) in
                let~ shift :=
                  M.alloc (|
                    BinOp.Wrap.div
                      Integer.U32
                      (BinOp.Wrap.add Integer.U32 (Value.Integer 1) (M.read (| ilog |)))
                      (Value.Integer 2)
                  |) in
                M.alloc (|
                  BinOp.Wrap.div
                    ...
                    (BinOp.Wrap.add
                      Integer.Usize
                      (BinOp.Wrap.shl (Value.Integer 1) (M.read (| shift |)))
                        ...
                        (let γ :=
                          M.use
                            (M.alloc (|
                              LogicalOp.or (|
                                LogicalOp.or (|
                                  UnOp.Pure.not (M.read (| can_fit_in_scratch |)),
                                  ltac:(M.monadic
                                    (M.call_closure (|
                                      M.get_associated_function (|
                                        Ty.path "core::slice::sort::stable::drift::DriftsortRun",
                          ...
                          fun γ =>
                            ltac:(M.monadic
                              (let γ :=
                                M.use
                                  (M.alloc (|
                                    BinOp.Pure.ge (M.read (| len |)) (M.read (| min_good_run_len |))
                                  |)) in
                              let _ :=
                                M.is_constant_or_break_match (|
                                  M.read (| γ |),
            ...
            | [], [], [ length ] =>
              ltac:(M.monadic
                ...
                Value.StructTuple
                  ...
                  [
                    BinOp.Pure.bit_or
                      (BinOp.Wrap.shl (M.read (| length |)) (Value.Integer 1))
                      (Value.Integer 1)
                  ]))
            | _, _, _ => M.impossible
            end.
