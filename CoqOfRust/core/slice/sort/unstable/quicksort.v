                      ...
                      M.loop (|
                        ...
                        ltac:(M.monadic
                          ...
                          let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                            ...
                            |) in
                          let~ num_lt : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                            M.alloc (|
                              M.call_closure (|
                                Ty.path "usize",
                                M.get_function (|
                  ...
                  (M.read (|
                    ...
                    let~ v_base :
                      ...
                      M.alloc (|
                        ...
                        |)
                      |) in
                    let~ left : Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "*mut") [] [ T ] ] :=
                      M.copy (| v_base |) in
                    let~ right : Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "*mut") [] [ T ] ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.apply (Ty.path "*mut") [] [ T ],
                          M.get_associated_function (|
                      ...
                      M.loop (|
                        ...
                        ltac:(M.monadic
                          ...
                          let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                            ...
                            |) in
                          let~ is_first_swap_pair : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                            M.alloc (|
                              M.call_closure (|
                                Ty.path "bool",
                                M.get_associated_function (|
                ...
                ltac:(M.monadic
                  (M.read (|
                    ...
                    let~ state :
                      ...
                      |) in
                    let~ unroll_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.copy (|
                        get_constant (|
                    ...
                    let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                      M.loop (|
                        Ty.tuple [],
                        ltac:(M.monadic
                          (let~ is_done : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                            M.alloc (|
                              M.call_closure (|
                                Ty.path "bool",
                                BinOp.eq,
