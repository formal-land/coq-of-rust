                                        ...
                                        ltac:(M.monadic
                                          ...
                                          let~ _ :=
                                            M.alloc (|
                                              ...
                                              |)
                                            |) in
                                          let~ _ := M.write (| v, M.read (| right |) |) in
                                          let~ _ :=
                                            M.write (|
                                              ancestor_pivot,
                                              Value.StructTuple
                          ...
                          fun γ =>
                            ltac:(M.monadic
                              (let γ :=
                                M.use
                                  (M.alloc (|
                                    BinOp.Pure.ge (M.read (| pivot |)) (M.read (| len |))
                                  |)) in
                              let _ :=
                                M.is_constant_or_break_match (|
                                  M.read (| γ |),
                              ...
                              M.alloc (|
                                M.call_closure (|
                                  M.get_associated_function (|
                                    ...
                                    []
                                  |),
                                  [ M.read (| v |); Value.Integer 0; M.read (| num_lt |) ]
                                |)
                              |) in
                            num_lt))
                      ]
                                ...
                                fun γ =>
                                  ltac:(M.monadic
                                    (let γ :=
                                      M.use
                                        (M.alloc (|
                                          BinOp.Pure.ge (M.read (| left |)) (M.read (| right |))
                                        |)) in
                                    let _ :=
                                      M.is_constant_or_break_match (|
                                        M.read (| γ |),
                                ...
                                fun γ =>
                                  ltac:(M.monadic
                                    (let γ :=
                                      M.use
                                        (M.alloc (|
                                          UnOp.Pure.not (M.read (| is_first_swap_pair |))
                                        |)) in
                                    let _ :=
                                      M.is_constant_or_break_match (|
                                        M.read (| γ |),
