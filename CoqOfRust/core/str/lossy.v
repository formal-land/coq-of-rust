      ...
      *)
      Definition fmt (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; f ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::str::lossy::Debug" ], self |) in
            let f :=
              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "core::fmt::Formatter" ], f |) in
            M.catch_return
              (Ty.apply
      ...
      Definition next (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&mut") [] [ Ty.path "core::str::lossy::Utf8Chunks" ],
                self
              |) in
            M.catch_return
              (Ty.apply
              ...
              ltac:(M.monadic
                (M.read (|
                  ...
                  let~ valid_up_to : Ty.path "usize" := Value.Integer IntegerKind.Usize 0 in
                  let~ _ : Ty.tuple [] :=
                    M.read (|
                      M.loop (|
                        Ty.tuple [],
                                  ...
                                  ltac:(M.monadic
                                    ...
                                    M.read (|
                                      ...
                                      let~ _ : Ty.tuple [] :=
                                        ...
                                        |) in
                                      let~ _ : Ty.tuple [] :=
                                        M.write (| valid_up_to, M.read (| i |) |) in
                                      M.alloc (| Ty.tuple [], Value.Tuple [] |)
                                    |)));
                                fun γ =>
                                  ltac:(M.monadic
                    ...
                    M.call_closure (|
                      ...
                      [
                        ...
                        M.call_closure (|
                          ...
                          M.pointer_coercion
                            M.PointerCoercion.Unsize
                            (Ty.apply (Ty.path "&") [] [ Ty.path "core::str::lossy::Debug" ])
                            (Ty.apply
                              (Ty.path "&")
                              []
