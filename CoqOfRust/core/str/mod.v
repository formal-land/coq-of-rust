  ...
  Definition slice_error_fail_rt (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ s; begin; end_ ] =>
      ltac:(M.monadic
        ...
        let end_ := M.alloc (| end_ |) in
        M.read (|
          let~ trunc_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
            M.alloc (|
              M.call_closure (|
                Ty.path "usize",
                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    M.alloc (|
                      M.never_to_any (|
                        M.read (|
                          let~ oob_index : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                            M.copy (|
                              M.match_operator (|
          ...
          let~ index : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
            M.copy (|
              ...
              |)
            |) in
          let~ char_start : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
            M.alloc (|
              M.call_closure (|
                Ty.path "usize",
                M.get_associated_function (| Ty.path "str", "floor_char_boundary", [], [] |),
          ...
          M.read (|
            M.match_operator (|
              ...
              [
                ...
                fun γ =>
                  ltac:(M.monadic
                    (let~ lower_bound : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "usize",
          ...
          M.read (|
            M.match_operator (|
              ...
              [
                ...
                fun γ =>
                  ltac:(M.monadic
                    (let~ upper_bound : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "usize",
                          M.get_trait_method (|
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                        M.alloc (| M.write (| i, M.read (| a |) |) |) in
                      let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                        M.alloc (| M.write (| j, M.read (| b |) |) |) in
                      M.alloc (| Value.Tuple [] |)));
                  fun γ => ltac:(M.monadic (M.alloc (| Value.Tuple [] |)))
                ]
              |) in
    ...
    Definition escape_debug (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
          M.read (|
            let~ chars : Ty.apply (Ty.path "*") [] [ Ty.path "core::str::iter::Chars" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "core::str::iter::Chars",
                  M.get_associated_function (| Ty.path "str", "chars", [], [] |),
