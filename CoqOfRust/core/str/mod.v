...
Module str.
  ...
  *)
  Definition slice_error_fail_ct (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ β0; β1; β2 ] =>
      ltac:(M.monadic
        (let β0 := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], β0 |) in
                              ...
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  let _ :=
                                    ...
                                    |) in
                                  M.read (| begin |)));
                              fun γ => ltac:(M.monadic (M.read (| end_ |)))
                            ]
                          |) in
                        M.alloc (|
                          Ty.path "never",
                      ...
                      M.call_closure (|
                        ...
                        [
                          M.call_closure (|
                            Ty.path "usize",
                            BinOp.Wrap.add,
                            [ M.read (| index |); Value.Integer IntegerKind.Usize 4 ]
                          |);
                          M.call_closure (|
                            Ty.path "usize",
                            M.get_associated_function (| Ty.path "str", "len", [], [] |),
                                  ...
                                  ltac:(M.monadic
                                    (M.match_operator (|
                                      ...
                                      [
                                        fun γ =>
                                          ltac:(M.monadic
                                            (let pos := M.copy (| Ty.path "usize", γ |) in
                                            M.call_closure (|
                                              Ty.path "usize",
                                              BinOp.Wrap.add,
                                              [ M.read (| pos |); M.read (| index |) ]
                                            |)))
                                      ]
                                    |)))
                                | _ => M.impossible "wrong number of arguments"
                  ...
                  Value.StructTuple
                    ...
                    [
                      M.call_closure (|
                        ...
                        M.get_associated_function (| Ty.path "str", "split_at_unchecked", [], [] |),
                        [
                          M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| self |) |) |);
                          M.read (| mid |)
                        ]
    ...
    *)
    Definition split_once (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ P ], [ self; delimiter ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], self |) in
          let delimiter := M.alloc (| P, delimiter |) in
          M.catch_return
            (Ty.apply
              (Ty.path "core::option::Option")
              []
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          (let γ0_0 :=
                            ...
                            |) in
                          let val :=
                            M.copy (| Ty.tuple [ Ty.path "usize"; Ty.path "usize" ], γ0_0 |) in
                          M.read (| val |)))
                    ]
                  |)
                |),
      ...
      | [], [ P ], [ self; pat ] =>
        ltac:(M.monadic
          ...
          M.read (|
            ...
            let~ j : Ty.path "usize" := Value.Integer IntegerKind.Usize 0 in
            let~ matcher :
                Ty.associated_in_trait "core::str::pattern::Pattern" [] [] P "Searcher" :=
              M.call_closure (|
                Ty.associated_in_trait "core::str::pattern::Pattern" [] [] P "Searcher",
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      M.read (|
                        let~ _ : Ty.tuple [] := M.write (| i, M.read (| a |) |) in
                        let~ _ : Ty.tuple [] := M.write (| j, M.read (| b |) |) in
                        M.alloc (| Ty.tuple [], Value.Tuple [] |)
                      |)));
                  fun γ => ltac:(M.monadic (Value.Tuple []))
                ]
    ...
    *)
    Definition strip_prefix (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ P ], [ self; prefix ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], self |) in
          let prefix := M.alloc (| P, prefix |) in
          M.call_closure (|
            Ty.apply
              (Ty.path "core::option::Option")
              []
    ...
    *)
    Definition strip_suffix (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ P ], [ self; suffix ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], self |) in
          let suffix := M.alloc (| P, suffix |) in
          M.call_closure (|
            Ty.apply
              (Ty.path "core::option::Option")
              []
    ...
    *)
    Definition substr_range (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; substr ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], self |) in
          let substr := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], substr |) in
          M.call_closure (|
            Ty.apply
              (Ty.path "core::option::Option")
              []
  ...
  Module Impl_core_clone_Clone_for_core_str_LinesMap.
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::str::LinesMap" ], self |) in
          Value.StructTuple "core::str::LinesMap" [] [] []))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.path "core::str::CharEscapeDebugContinue" ],
              self
            |) in
          Value.StructTuple "core::str::CharEscapeDebugContinue" [] [] []))
      | _, _, _ => M.impossible "wrong number of arguments"
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.path "core::str::CharEscapeUnicode" ],
              self
            |) in
          Value.StructTuple "core::str::CharEscapeUnicode" [] [] []))
      | _, _, _ => M.impossible "wrong number of arguments"
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.path "core::str::CharEscapeDefault" ],
              self
            |) in
          Value.StructTuple "core::str::CharEscapeDefault" [] [] []))
      | _, _, _ => M.impossible "wrong number of arguments"
  ...
  Module Impl_core_clone_Clone_for_core_str_IsWhitespace.
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::str::IsWhitespace" ], self |) in
          Value.StructTuple "core::str::IsWhitespace" [] [] []))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.path "core::str::IsAsciiWhitespace" ],
              self
            |) in
          Value.StructTuple "core::str::IsAsciiWhitespace" [] [] []))
      | _, _, _ => M.impossible "wrong number of arguments"
  ...
  Module Impl_core_clone_Clone_for_core_str_IsNotEmpty.
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "core::str::IsNotEmpty" ], self |) in
          Value.StructTuple "core::str::IsNotEmpty" [] [] []))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.path "core::str::BytesIsNotEmpty" ],
              self
            |) in
          Value.StructTuple "core::str::BytesIsNotEmpty" [] [] []))
      | _, _, _ => M.impossible "wrong number of arguments"
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.path "core::str::UnsafeBytesToStr" ],
              self
            |) in
          Value.StructTuple "core::str::UnsafeBytesToStr" [] [] []))
      | _, _, _ => M.impossible "wrong number of arguments"
