  ...
  Module validations.
    ...
    Definition utf8_first_byte (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ byte; width ] =>
        ltac:(M.monadic
          ...
          let width := M.alloc (| Ty.path "u32", width |) in
          M.cast
            (Ty.path "u32")
            (M.call_closure (|
              Ty.path "u8",
    ...
    *)
    Definition utf8_acc_cont_byte (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ ch; byte ] =>
        ltac:(M.monadic
          (let ch := M.alloc (| Ty.path "u32", ch |) in
          let byte := M.alloc (| Ty.path "u8", byte |) in
          M.call_closure (|
            Ty.path "u32",
            BinOp.Wrap.bit_or,
    ...
    *)
    Definition next_code_point (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ _ as I ], [ bytes ] =>
        ltac:(M.monadic
          (let bytes := M.alloc (| Ty.apply (Ty.path "&mut") [] [ I ], bytes |) in
                ...
                let~ w : Ty.path "u8" :=
                  M.match_operator (|
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          (let next_byte := M.copy (| Ty.path "u8", γ |) in
                          let γ :=
                            M.alloc (|
                              Ty.path "bool",
                              M.call_closure (|
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          (let back_byte := M.copy (| Ty.path "u8", γ |) in
                          M.read (| back_byte |)))
                    ]
                  |) in
                let ch := M.read (| Value.DeclaredButUndefined |) in
                let~ z : Ty.path "u8" :=
                  M.read (|
                    M.deref (|
                      M.call_closure (|
                              ...
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  let _ :=
                                    ...
                                    |) in
                                  M.read (|
                                    let~ old_offset : Ty.path "usize" := M.read (| index |) in
