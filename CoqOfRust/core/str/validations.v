            ...
            (M.call_closure (|
              ...
              [
                ...
                M.call_closure (|
                  Ty.path "u8",
                  BinOp.Wrap.shr,
                  [ Value.Integer IntegerKind.U8 127; M.read (| width |) ]
                |)
              ]
            |))))
          ...
          M.call_closure (|
            ...
            [
              M.call_closure (|
                Ty.path "u32",
                BinOp.Wrap.shl,
                [ M.read (| ch |); Value.Integer IntegerKind.I32 6 ]
              |);
              M.cast
                (Ty.path "u32")
                (M.call_closure (|
      ...
      | [], [], [ byte ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            Ty.path "bool",
            BinOp.lt,
            [ M.cast (Ty.path "i8") (M.read (| byte |)); Value.Integer IntegerKind.I8 (-64) ]
          |)))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
            ...
            ltac:(M.monadic
              (M.read (|
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                            ...
                            M.use
                              (M.alloc (|
                                M.call_closure (|
                                  Ty.path "bool",
                                  BinOp.lt,
                                  [ M.read (| x |); Value.Integer IntegerKind.U8 128 ]
                                |)
                              |)) in
                          let _ :=
                  ...
                  |) in
                let~ init : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "u32",
                ...
                let~ y : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                  M.copy (|
                    ...
                    |)
                  |) in
                let~ ch : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "u32",
                            ...
                            M.use
                              (M.alloc (|
                                M.call_closure (|
                                  Ty.path "bool",
                                  BinOp.ge,
                                  [ M.read (| x |); Value.Integer IntegerKind.U8 224 ]
                                |)
                              |)) in
                          let _ :=
                            is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                          let~ z : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                            M.copy (|
                              M.deref (|
                                M.call_closure (|
                                  Ty.apply (Ty.path "&") [] [ Ty.path "u8" ],
                              ...
                              |)
                            |) in
                          let~ y_z : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                            M.alloc (|
                              M.call_closure (|
                                Ty.path "u32",
                                M.get_function (|
                                ...
                                M.call_closure (|
                                  ...
                                  [
                                    M.call_closure (|
                                      Ty.path "u32",
                                      BinOp.Wrap.shl,
                                      [ M.read (| init |); Value.Integer IntegerKind.I32 12 ]
                                    |);
                                    M.read (| y_z |)
                                  ]
                                |)
                                    ...
                                    M.use
                                      (M.alloc (|
                                        M.call_closure (|
                                          Ty.path "bool",
                                          BinOp.ge,
                                          [ M.read (| x |); Value.Integer IntegerKind.U8 240 ]
                                        |)
                                      |)) in
                                  let _ :=
                                    is_constant_or_break_match (|
                                      ...
                                      Value.Bool true
                                    |) in
                                  let~ w : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                                    M.copy (|
                                      M.deref (|
                                        M.call_closure (|
                                          Ty.apply (Ty.path "&") [] [ Ty.path "u8" ],
                            ...
                            let γ :=
                              M.alloc (|
                                M.call_closure (|
                                  Ty.path "bool",
                                  BinOp.lt,
                                  [ M.read (| next_byte |); Value.Integer IntegerKind.U8 128 ]
                                |)
                              |) in
                            let _ :=
                              is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
              ...
              (M.read (|
                ...
                let~ len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.alloc (|
                    ...
                    |)
                  |) in
                let~ ascii_block_size : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "usize",
                      BinOp.Wrap.mul,
                    ...
                    |)
                  |) in
                let~ blocks_end : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.copy (|
                    M.match_operator (|
                              ...
                              M.use
                                (M.alloc (|
                                  M.call_closure (|
                                    Ty.path "bool",
                                    BinOp.ge,
                                    [ M.read (| len |); M.read (| ascii_block_size |) ]
                                  |)
                                |)) in
                            let _ :=
                              is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                    ...
                    |)
                  |) in
                let~ align : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "usize",
                      M.get_function (|
                        ...
                        [
                          fun γ =>
                            ltac:(M.monadic
                              ...
                              let _ :=
                                is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                              let~ old_offset : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                M.copy (| index |) in
                              let~ first : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                                M.copy (|
                                        ...
                                        M.use
                                          (M.alloc (|
                                            M.call_closure (|
                                              Ty.path "bool",
                                              BinOp.ge,
                                              [ M.read (| first |); Value.Integer IntegerKind.U8 128
                                              ]
                                            |)
                                          |)) in
                                      let _ :=
