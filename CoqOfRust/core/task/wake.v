      ...
      Definition eq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; other ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "core::task::wake::RawWaker" ],
                self
              |) in
            let other :=
              M.alloc (|
    ...
    Module Impl_core_task_wake_RawWaker.
      ...
      *)
      Definition new (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ data; vtable ] =>
          ltac:(M.monadic
            (let data := M.alloc (| Ty.apply (Ty.path "*const") [] [ Ty.tuple [] ], data |) in
            let vtable :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "core::task::wake::RawWakerVTable" ],
                vtable
                  ...
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      let γ1_0 :=
                        ...
                        |) in
                      let __self_0 :=
                        M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.tuple [] ], γ1_0 |) in
                      M.alloc (|
                        Ty.apply
                          (Ty.path "core::result::Result")
                          []
                        ...
                        M.read (|
                          M.match_operator (|
                            Ty.apply
                              ...
                              [ Ty.dyn [ ("core::any::Any::Trait", []) ] ],
                            M.alloc (|
                              Ty.apply (Ty.path "&mut") [] [ Ty.path "core::task::wake::ExtData" ],
                              M.borrow (|
                                Pointer.Kind.MutRef,
                                M.SubPointer.get_struct_tuple_field (|
                                  M.SubPointer.get_struct_record_field (|
      ...
      Definition fmt (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; f ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "core::task::wake::ContextBuilder" ],
                self
              |) in
            let f :=
              M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "core::fmt::Formatter" ], f |) in
    ...
    Module Impl_core_task_wake_ContextBuilder.
      ...
      *)
      Definition waker (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; waker ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "core::task::wake::ContextBuilder", self |) in
            let waker :=
              M.alloc (|
                Ty.apply (Ty.path "&") [] [ Ty.path "core::task::wake::Waker" ],
                waker
                    ...
                    ltac:(M.monadic
                      ...
                      let local_waker :=
                        M.copy (|
                          ...
                          γ0_1
                        |) in
                      let ext := M.copy (| Ty.path "core::task::wake::ExtData", γ0_2 |) in
                      let _marker :=
                        M.copy (|
                          Ty.apply
                            (Ty.path "core::marker::PhantomData")
    ...
    Module Impl_core_task_wake_Waker.
      ...
      *)
      Definition wake (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "core::task::wake::Waker", self |) in
            M.read (|
              let~ this :
                  Ty.apply
      ...
      Definition clone_from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; source ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&mut") [] [ Ty.path "core::task::wake::Waker" ],
                self
              |) in
            let source :=
              M.alloc (|
    ...
    Module Impl_core_task_wake_LocalWaker.
      ...
      *)
      Definition wake (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self ] =>
          ltac:(M.monadic
            (let self := M.alloc (| Ty.path "core::task::wake::LocalWaker", self |) in
            M.read (|
              let~ this :
                  Ty.apply
                    (Ty.path "core::mem::manually_drop::ManuallyDrop")
      ...
      Definition clone_from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; source ] =>
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                Ty.apply (Ty.path "&mut") [] [ Ty.path "core::task::wake::LocalWaker" ],
                self
              |) in
            let source :=
              M.alloc (|
