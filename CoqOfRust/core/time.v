    ...
    Definition new (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ secs; nanos ] =>
        ltac:(M.monadic
          ...
          M.read (|
            M.match_operator (|
              Some (Ty.path "core::time::Duration"),
              M.alloc (| Value.Tuple [] |),
              [
                fun γ =>
                  ltac:(M.monadic
              ...
              BinOp.Wrap.add (|
                BinOp.Wrap.mul (|
                  M.cast
                    (Ty.path "f64")
                    (M.read (|
                      M.SubPointer.get_struct_record_field (| rhs, "core::time::Duration", "secs" |)
                    |)),
                  M.cast (Ty.path "f64") (M.read (| M.get_constant "core::time::NANOS_PER_SEC" |))
                |),
                M.cast
            ...
            ltac:(M.monadic
              (M.read (|
                ...
                M.match_operator (|
                  None,
                  M.match_operator (|
                    Some (Ty.tuple [ Ty.path "u64"; Ty.path "u32" ]),
                    M.alloc (| Value.Tuple [] |),
                    [
                      fun γ =>
                        ltac:(M.monadic
                              ...
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  let~ is_tie : Ty.path "bool" :=
                                    BinOp.eq (| M.read (| rem |), M.read (| rem_msb_mask |) |) in
    ...
    Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          ...
          M.read (|
            M.match_operator (|
              Some (Ty.path "core::time::TryFromFloatSecsErrorKind"),
              self,
              [
                fun γ =>
                  ltac:(M.monadic
