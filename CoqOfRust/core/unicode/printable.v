  ...
  Module printable.
    ...
    *)
    Definition check (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ x; singletonuppers; singletonlowers; normal ] =>
        ltac:(M.monadic
          (let x := M.alloc (| Ty.path "u16", x |) in
          let singletonuppers :=
            M.alloc (|
              Ty.apply
                (Ty.path "&")
                []
                [ Ty.apply (Ty.path "slice") [] [ Ty.tuple [ Ty.path "u8"; Ty.path "u8" ] ] ],
              singletonuppers
            |) in
          let singletonlowers :=
            M.alloc (|
              ...
              (M.read (|
                let~ xupper : Ty.path "u8" :=
                  M.cast
                    ...
                    |)) in
                let~ lowerstart : Ty.path "usize" := Value.Integer IntegerKind.Usize 0 in
                let~ _ : Ty.tuple [] :=
                  M.read (|
                    M.use
                      (M.alloc (|
                                          ...
                                          [
                                            ...
                                            fun γ =>
                                              ltac:(M.monadic
                                                ...
                                                let upper := M.copy (| Ty.path "u8", γ2_0 |) in
                                                let lowercount := M.copy (| Ty.path "u8", γ2_1 |) in
                                                M.read (|
                      ...
                      |))
                  |) in
                let~ x : Ty.path "i32" := M.cast (Ty.path "i32") (M.read (| x |)) in
                let~ normal :
                    Ty.apply
    ...
    *)
    Definition is_printable (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ x ] =>
        ltac:(M.monadic
          (let x := M.alloc (| Ty.path "char", x |) in
          M.catch_return (Ty.path "bool") (|
            ltac:(M.monadic
              (M.read (|
                let~ x : Ty.path "u32" := M.cast (Ty.path "u32") (M.read (| x |)) in
                let~ lower : Ty.path "u16" := M.cast (Ty.path "u16") (M.read (| x |)) in
                M.alloc (|
                  Ty.path "bool",
                  M.match_operator (|
                    Ty.path "bool",
            ...
            M.pointer_coercion
              ...
              (Ty.apply
                ...
                [
                  Ty.apply
                    (Ty.path "array")
                    [ Value.Integer IntegerKind.Usize 290 ]
                    [ Ty.path "u8" ]
                ])
              (Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "slice") [] [ Ty.path "u8" ] ]),
            [
            ...
            M.pointer_coercion
              ...
              (Ty.apply
                ...
                [
                  Ty.apply
                    (Ty.path "array")
                    [ Value.Integer IntegerKind.Usize 208 ]
                    [ Ty.path "u8" ]
                ])
              (Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "slice") [] [ Ty.path "u8" ] ]),
            [
            ...
            M.pointer_coercion
              ...
              (Ty.apply
                ...
                [
                  Ty.apply
                    (Ty.path "array")
                    [ Value.Integer IntegerKind.Usize 297 ]
                    [ Ty.path "u8" ]
                ])
              (Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "slice") [] [ Ty.path "u8" ] ]),
            [
            ...
            M.pointer_coercion
              ...
              (Ty.apply
                ...
                [
                  Ty.apply
                    (Ty.path "array")
                    [ Value.Integer IntegerKind.Usize 486 ]
                    [ Ty.path "u8" ]
                ])
              (Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "slice") [] [ Ty.path "u8" ] ]),
            [
