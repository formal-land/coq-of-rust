...
Section Impl_traits_Sheep_t.
  ...
  *)
  Parameter is_naked : (M.Val (ref ltac:(Self))) -> M bool.t.
...
Section Impl_traits_Animal_for_traits_Sheep_t.
  ...
  *)
  Parameter new : (M.Val (ref str.t)) -> M traits.Sheep.t.
  ...
  *)
  Parameter name : (M.Val (ref ltac:(Self))) -> M (ref str.t).
  ...
  *)
  Parameter talk : (M.Val (ref ltac:(Self))) -> M unit.
...
Section Impl_traits_Sheep_t_2.
  ...
  *)
  Parameter shear : (M.Val (mut_ref ltac:(Self))) -> M unit.
