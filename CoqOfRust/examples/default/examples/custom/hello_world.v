...
Definition message : A.t := M.run ltac:(M.monadic (M.of_value (| Value.String "Hello, World!" |))).
                                  ...
                                  M.alloc (|
                                    M.of_value (|
                                      Value.Array
                                        [
                                          A.to_value
                                            (M.read (| M.of_value (| Value.String "Matched " |) |));
                                          A.to_value
...
"
          ...
          |) in
        let i_like_letters := M.alloc (| M.of_value (| Value.Bool false |) |) in
        M.match_operator (|
          M.alloc (| M.of_value (| Value.Tuple [] |) |),
          [
            fun γ =>
