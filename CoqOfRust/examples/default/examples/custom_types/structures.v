...
Section Impl_core_fmt_Debug_for_structures_Person_t.
  ...
  *)
  Definition fmt
    ...
    let* α4 : M.Val structures.Person.t := deref α3 in
    ...
    let* α10 : ref structures.Person.t := M.read self in
    let* α11 : M.Val structures.Person.t := deref α10 in
    let* α12 : ref u8.t := borrow α11.["age"] in
    let* α13 : M.Val (ref u8.t) := M.alloc α12 in
    let* α14 : ref (ref u8.t) := borrow α13 in
    let* α15 : M.Val (ref (ref u8.t)) := M.alloc α14 in
