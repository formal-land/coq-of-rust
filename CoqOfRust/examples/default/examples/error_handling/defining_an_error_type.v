  ...
  *)
  Definition fmt
    ...
    M.function_body
      ...
      let* α2 : M.Val str.t := deref (mk_str "DoubleError") in
...
Definition double_first
  ...
  M.function_body
    ...
    let* α7 : M.Val defining_an_error_type.DoubleError.t :=
...
" ] in
        ...
        let* α2 : M.Val (ref (slice (ref str.t))) :=
          pointer_coercion "Unsize" α1 in
        let* α3 : M.Val (ref defining_an_error_type.DoubleError.t) :=
          borrow e in
        let* α4 := core.fmt.rt.Argument.t::["new_display"] α3 in
        let* α5 : M.Val core.fmt.rt.Argument.t := M.alloc α4 in
        let* α6 : M.Val (array core.fmt.rt.Argument.t) := M.alloc [ α5 ] in
  ...
  M.function_body
    ...
    let* _ : M.Val unit :=
      ...
      let* α1 :
        ...
        M.alloc α0 in
      let* α2 := defining_an_error_type.print α1 in
      M.alloc α2 in
    let* _ : M.Val unit :=
