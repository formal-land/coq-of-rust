  ...
  M.function_body
    (let* first : ltac:(refine (M.Val (ref (ref str.t)))) :=
      ...
      let* α6 :
        ...
        M.alloc α5 in
      let* α7 := (core.option.Option.t (ref (ref str.t)))::["unwrap"] α6 in
      M.alloc α7 in
...
" ] in
        ...
        let* α3 := multiple_error_types.double_first numbers in
...
" ] in
        ...
        let* α2 : ltac:(refine (M.Val (ref (slice (ref str.t))))) :=
          pointer_coercion "Unsize" α1 in
        let* α3 := multiple_error_types.double_first empty in
        let* α4 : ltac:(refine (M.Val i32.t)) := M.alloc α3 in
        let* α5 : ltac:(refine (M.Val (ref i32.t))) := borrow α4 in
        let* α6 := core.fmt.rt.Argument.t::["new_display"] α5 in
        let* α7 : ltac:(refine (M.Val core.fmt.rt.Argument.t)) := M.alloc α6 in
...
" ] in
        ...
        let* α2 : ltac:(refine (M.Val (ref (slice (ref str.t))))) :=
          pointer_coercion "Unsize" α1 in
        let* α3 := multiple_error_types.double_first strings in
        let* α4 : ltac:(refine (M.Val i32.t)) := M.alloc α3 in
        let* α5 : ltac:(refine (M.Val (ref i32.t))) := borrow α4 in
        let* α6 := core.fmt.rt.Argument.t::["new_display"] α5 in
        let* α7 : ltac:(refine (M.Val core.fmt.rt.Argument.t)) := M.alloc α6 in
