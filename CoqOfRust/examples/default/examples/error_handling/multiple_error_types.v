...
Definition double_first
  ...
  M.function_body
    (let* first : M.Val (ref (ref str.t)) :=
      ...
      let* α8 := (core.option.Option.t (ref (ref str.t)))::["unwrap"] α7 in
      M.alloc α8 in
...
" ] in
        ...
        let* α3 := M.read α2 in
        let* α4 := M.read numbers in
        let* α5 := multiple_error_types.double_first α4 in
