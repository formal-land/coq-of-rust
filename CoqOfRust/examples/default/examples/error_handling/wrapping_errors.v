      ...
      let* α1 : M.Val (core.result.Result.t unit core.fmt.Error.t) :=
        ...
        | wrapping_errors.DoubleError.Parse __self_0 =>
          ...
          let* α6 : ref (ref core.num.error.ParseIntError.t) :=
            borrow __self_0 in
          let* α7 : M.Val (ref (ref core.num.error.ParseIntError.t)) :=
            M.alloc α6 in
    ...
    M.function_body
      ...
      let* α3 : M.Val (core.result.Result.t unit core.fmt.Error.t) :=
        ...
        | wrapping_errors.DoubleError.EmptyVec  =>
          ...
          let* α9 : core.result.Result.t unit core.fmt.Error.t :=
            core.fmt.Formatter.t::["write_fmt"] α2 α8 in
          M.alloc α9
...
" ] in
            ...
            let* α3 : M.Val (ref (slice (ref str.t))) :=
              pointer_coercion "Unsize" α2 in
            let* α4 : ref (slice (ref str.t)) := M.read α3 in
            let* α5 : ref wrapping_errors.DoubleError.t := borrow e in
            let* α6 : core.fmt.rt.Argument.t :=
              core.fmt.rt.Argument.t::["new_display"] α5 in
            let* α7 : M.Val core.fmt.rt.Argument.t := M.alloc α6 in
            let* α8 : M.Val (array core.fmt.rt.Argument.t) := M.alloc [ α7 ] in
...
" ] in
              ...
              let* α3 : M.Val (ref (slice (ref str.t))) :=
                pointer_coercion "Unsize" α2 in
              let* α4 : ref (slice (ref str.t)) := M.read α3 in
              let* α5 : ref (ref type not implemented) := borrow source in
              let* α6 : core.fmt.rt.Argument.t :=
                core.fmt.rt.Argument.t::["new_display"] α5 in
              let* α7 : M.Val core.fmt.rt.Argument.t := M.alloc α6 in
