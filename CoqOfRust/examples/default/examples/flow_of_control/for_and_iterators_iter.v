...
Definition main : M unit :=
  M.function_body
    ...
    let* _ : ltac:(refine (M.Val unit)) :=
      ...
      let* α5 := (slice (ref str.t))::["iter"] α4 in
      let* α6 : ltac:(refine (M.Val (core.slice.iter.Iter.t (ref str.t)))) :=
        M.alloc α5 in
      let* α7 :=
        (core.iter.traits.collect.IntoIterator.into_iter
            ...
            (Trait := ltac:(refine _)))
          α6 in
      let* α8 : ltac:(refine (M.Val (core.slice.iter.Iter.t (ref str.t)))) :=
        M.alloc α7 in
      let* α9 := M.read α8 in
        ...
        | iter =>
          ...
          loop
            (let* _ : ltac:(refine (M.Val unit)) :=
              let* α0 :
                  ltac:(refine
                    (M.Val (mut_ref (core.slice.iter.Iter.t (ref str.t))))) :=
                borrow_mut iter in
              let* α1 :=
              ...
              let* α2 :
                  ltac:(refine
                    (M.Val (core.option.Option.t (ref (ref str.t))))) :=
                M.alloc α1 in
              let* α3 := M.read α2 in
              match α3 with
