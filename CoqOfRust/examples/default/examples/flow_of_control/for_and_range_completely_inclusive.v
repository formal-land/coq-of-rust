...
Definition main : M unit :=
  M.function_body
    ...
    let* α4 : core.ops.range.RangeInclusive.t i32.t :=
      (core.ops.range.RangeInclusive.t i32.t)::["new"] α1 α3 in
    let* α5 : core.ops.range.RangeInclusive.t i32.t :=
    ...
    let* α8 : M.Val unit :=
      ...
      | iter =>
        ...
        loop
          (let* _ : M.Val unit :=
            let* α0 : mut_ref (core.ops.range.RangeInclusive.t i32.t) :=
              borrow_mut iter in
            let* α1 : M.Val (core.ops.range.RangeInclusive.t i32.t) :=
              deref α0 in
            let* α2 : mut_ref (core.ops.range.RangeInclusive.t i32.t) :=
              borrow_mut α1 in
