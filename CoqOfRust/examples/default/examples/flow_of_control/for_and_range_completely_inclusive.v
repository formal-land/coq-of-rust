...
Definition main : M unit :=
  M.function_body
    ...
    let* α1 : ltac:(refine (M.Val i32.t)) := M.alloc 100 in
    let* α2 := (core.ops.range.RangeInclusive.t i32.t)::["new"] α0 α1 in
    let* α3 : ltac:(refine (M.Val (core.ops.range.RangeInclusive.t i32.t))) :=
      M.alloc α2 in
    let* α4 :=
      (core.iter.traits.collect.IntoIterator.into_iter
          ...
          (Trait := ltac:(refine _)))
        α3 in
    let* α5 : ltac:(refine (M.Val (core.ops.range.RangeInclusive.t i32.t))) :=
      M.alloc α4 in
    let* α6 := M.read α5 in
      ...
      | iter =>
        ...
        loop
          (let* _ : ltac:(refine (M.Val unit)) :=
            let* α0 :
                ltac:(refine
                  (M.Val (mut_ref (core.ops.range.RangeInclusive.t i32.t)))) :=
              borrow_mut iter in
            let* α1 :=
