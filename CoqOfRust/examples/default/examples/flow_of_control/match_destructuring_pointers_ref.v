...
" ] in
          ...
          let* α3 : M.Val (ref i32.t) := borrow val in
    ...
    let* _ : M.Val unit :=
      let* α0 : M.Val i32.t := deref reference in
      let* α1 := M.read α0 in
      match α1 with
      | val =>
        let* val := M.alloc val in
...
" ] in
          ...
          let* α2 : M.Val (ref (slice (ref str.t))) :=
            pointer_coercion "Unsize" α1 in
          let* α3 : M.Val (ref (ref i32.t)) := borrow r in
          let* α4 := core.fmt.rt.Argument.t::["new_debug"] α3 in
          let* α5 : M.Val core.fmt.rt.Argument.t := M.alloc α4 in
          let* α6 : M.Val (array core.fmt.rt.Argument.t) := M.alloc [ α5 ] in
          let* α7 : M.Val (ref (array core.fmt.rt.Argument.t)) := borrow α6 in
    ...
    | m =>
      let* m := M.alloc m in
      let* _ : M.Val unit :=
        let* α0 : M.Val i32.t := deref m in
        let* α1 : M.Val i32.t := M.alloc 10 in
...
" ] in
          ...
          let* α2 : M.Val (ref (slice (ref str.t))) :=
            pointer_coercion "Unsize" α1 in
          let* α3 : M.Val (ref (mut_ref i32.t)) := borrow m in
          let* α4 := core.fmt.rt.Argument.t::["new_debug"] α3 in
          let* α5 : M.Val core.fmt.rt.Argument.t := M.alloc α4 in
          let* α6 : M.Val (array core.fmt.rt.Argument.t) := M.alloc [ α5 ] in
          let* α7 : M.Val (ref (array core.fmt.rt.Argument.t)) := borrow α6 in
