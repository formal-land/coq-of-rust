...
Definition main : M unit :=
  M.function_body
    (let* _ : M.Val unit :=
      ...
      let* α1 := M.read α0 in
      let* α2 := functions.fizzbuzz_to α1 in
      M.alloc α2 in
    M.alloc tt).
...
Definition fizzbuzz (n : u32.t) : M unit :=
  ...
  M.function_body
    ...
    let* α2 := M.read α1 in
    let* α3 := functions.is_divisible_by α0 α2 in
...
Definition fizzbuzz_to (n : u32.t) : M unit :=
  ...
  M.function_body
    ...
    let* α1 := M.read α0 in
    let* α2 := M.read n in
    let* α3 := (core.ops.range.RangeInclusive.t u32.t)::["new"] α1 α2 in
    let* α4 :=
        ...
        loop
          (let* _ : M.Val unit :=
            ...
            | core.option.Option.Some n =>
              ...
              let* _ : M.Val unit :=
                let* α0 := M.read n in
                let* α1 := functions.fizzbuzz α0 in
                M.alloc α1 in
              M.alloc tt
            end in
          M.alloc tt)
