...
" ] in
        ...
        let* α4 :=
          (core.ops.deref.Deref.deref
              ...
              (Trait := ltac:(refine _)))
            α3 in
        let* α5 : M.Val (ref (slice i32.t)) := M.alloc α4 in
        let* α6 : M.Val (slice i32.t) := deref α5 in
        let* α7 : M.Val (ref (slice i32.t)) := borrow α6 in
        let* α8 := (slice i32.t)::["iter"] α7 in
        let* α9 : M.Val (core.slice.iter.Iter.t i32.t) := M.alloc α8 in
        let* α10 : M.Val (mut_ref (core.slice.iter.Iter.t i32.t)) :=
          borrow_mut α9 in
        let* α11 :=
        ...
        let* α20 : M.Val core.fmt.Arguments.t := M.alloc α19 in
...
" ] in
        ...
        let* α9 : M.Val (ref bool.t) := borrow α8 in
