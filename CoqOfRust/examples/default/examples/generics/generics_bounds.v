  ...
  *)
  Definition fmt
    ...
    M.function_body
      ...
      let* α15 : ref str.t := M.read (mk_str "height") in
      let* α16 : M.Val str.t := deref α15 in
      let* α17 : ref str.t := borrow α16 in
      let* α18 : ref generics_bounds.Rectangle.t := M.read self in
      let* α19 : M.Val generics_bounds.Rectangle.t := deref α18 in
      let* α20 : ref f64.t := borrow α19.["height"] in
