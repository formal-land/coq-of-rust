...
" ] in
        ...
        let* α4 :
          ...
          borrow cardinal in
        let* α5 := M.read α4 in
        let* α6 := generics_bounds_test_case_empty_bounds.red α5 in
        let* α7 : M.Val (ref str.t) := M.alloc α6 in
        let* α8 : M.Val (ref (ref str.t)) := borrow α7 in
        let* α9 := M.read α8 in
...
" ] in
        ...
        let* α4 :
          ...
          borrow blue_jay in
        let* α5 := M.read α4 in
        let* α6 := generics_bounds_test_case_empty_bounds.blue α5 in
        let* α7 : M.Val (ref str.t) := M.alloc α6 in
        let* α8 : M.Val (ref (ref str.t)) := borrow α7 in
        let* α9 := M.read α8 in
        let* α10 := core.fmt.rt.Argument.t::["new_display"] α9 in
