      ...
      let* α13 :
          M.Val
            (generics_phantom_type_test_case_unit_clarification.Length.t
              Unit) :=
        deref α12 in
      let* α14 : ref (core.marker.PhantomData.t Unit) := borrow α13.["1"] in
      let* α15 : M.Val (ref (core.marker.PhantomData.t Unit)) := M.alloc α14 in
      let* α16 : ref (ref (core.marker.PhantomData.t Unit)) := borrow α15 in
      let* α17 : M.Val (ref (ref (core.marker.PhantomData.t Unit))) :=
        M.alloc α16 in
