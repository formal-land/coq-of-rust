...
Module Impl_conditional_compilation_ConditionalCompilation.
  ...
  *)
  Definition new_foo (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ value ] =>
      ltac:(M.monadic
  ...
  *)
  Definition new_bar (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ value ] =>
      ltac:(M.monadic
        (let value := M.alloc (| value |) in
  ...
  *)
  Definition new_foo_bar (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ value ] =>
      ltac:(M.monadic
        (let value := M.alloc (| value |) in
  ...
  *)
  Definition inherent_flip_foo (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| self |) in
  ...
  *)
  Definition inherent_flip_bar (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| self |) in
                              ...
                              [
                                ("new_value",
                                  A.to_value
                                    ...
                                    |)));
                                ("by_", A.to_value (M.read (| caller |)));
                                ("when", A.to_value (M.read (| block_number |)))
                              ]
                          |))
                      ]
                  |)
...
Module Impl_conditional_compilation_Flip_for_conditional_compilation_ConditionalCompilation.
  ...
  *)
  Definition push_foo (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ self; value ] =>
      ltac:(M.monadic
        (let self := M.alloc (| self |) in
