  ...
  Definition contains (K V : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _key ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "dns::Mapping") [] [ K; V ] ],
            self
          |) in
  ...
  Definition insert (K V : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _key; _value ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "dns::Mapping") [] [ K; V ] ],
            self
          |) in
...
Module Impl_core_clone_Clone_for_dns_AccountId.
  ...
  Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "dns::AccountId" ], self |) in
        M.read (|
          M.match_operator (|
...
Module Impl_core_cmp_PartialEq_dns_AccountId_for_dns_AccountId.
  ...
  Definition eq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; other ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "dns::AccountId" ], self |) in
        let other := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "dns::AccountId" ], other |) in
        M.call_closure (|
          Ty.path "bool",
          BinOp.eq,
          [
...
Module Impl_dns_Env.
  ...
  *)
  Definition caller (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "dns::Env" ], self |) in
        M.read (|
  ...
  *)
  Definition emit_event (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _event ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "dns::Env" ], self |) in
        let _event := M.alloc (| Ty.path "dns::Event", _event |) in
        M.never_to_any (|
          M.call_closure (|
            Ty.path "never",
            M.get_function (| "core::panicking::panic", [], [] |),
...
Module Impl_core_cmp_PartialEq_dns_Error_for_dns_Error.
  ...
  Definition eq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; other ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "dns::Error" ], self |) in
        let other := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "dns::Error" ], other |) in
        M.read (|
  ...
  *)
  Definition env (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "dns::DomainNameService" ], self |) in
        M.call_closure (|
          Ty.path "dns::Env",
  ...
  *)
  Definition register (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; name ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "dns::DomainNameService" ], self |) in
        let name :=
          M.alloc (|
            Ty.apply (Ty.path "array") [ Value.Integer IntegerKind.Usize 32 ] [ Ty.path "u8" ],
            name
      ...
      ltac:(M.monadic
        ...
        let name :=
          M.alloc (|
            ...
            name
          |) in
        let new_address := M.alloc (| Ty.path "dns::AccountId", new_address |) in
        M.read (|
          M.catch_return
            (Ty.apply (Ty.path "core::result::Result") [] [ Ty.tuple []; Ty.path "dns::Error" ]) (|
            ltac:(M.monadic
      ...
      ltac:(M.monadic
        ...
        let name :=
          M.alloc (|
            ...
            name
          |) in
        let to := M.alloc (| Ty.path "dns::AccountId", to |) in
        M.read (|
          M.catch_return
            (Ty.apply (Ty.path "core::result::Result") [] [ Ty.tuple []; Ty.path "dns::Error" ]) (|
            ltac:(M.monadic
