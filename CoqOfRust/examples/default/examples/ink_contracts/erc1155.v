  ...
  Definition contains (K V : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _key ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "erc1155::Mapping") [] [ K; V ] ],
            self
          |) in
  ...
  Definition insert (K V : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _key; _value ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "erc1155::Mapping") [] [ K; V ] ],
            self
          |) in
...
Module Impl_core_clone_Clone_for_erc1155_AccountId.
  ...
  Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc1155::AccountId" ], self |) in
        M.match_operator (|
    ...
    | [], [], [ self; other ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc1155::AccountId" ], self |) in
        let other :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc1155::AccountId" ], other |) in
        M.call_closure (|
          Ty.path "bool",
          BinOp.eq,
          [
...
Module Impl_core_cmp_PartialEq_erc1155_Error_for_erc1155_Error.
  ...
  Definition eq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; other ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc1155::Error" ], self |) in
        let other := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc1155::Error" ], other |) in
        M.read (|
...
Module Impl_erc1155_Env.
  ...
  *)
  Definition caller (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc1155::Env" ], self |) in
        M.read (|
  ...
  *)
  Definition emit_event (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _event ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc1155::Env" ], self |) in
        let _event := M.alloc (| Ty.path "erc1155::Event", _event |) in
        M.never_to_any (|
          M.call_closure (|
            Ty.path "never",
            M.get_function (| "core::panicking::panic", [], [] |),
  ...
  *)
  Definition env (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc1155::Contract" ], self |) in
        M.call_closure (|
          Ty.path "erc1155::Env",
  ...
  *)
  Definition create (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; value ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc1155::Contract" ], self |) in
  ...
  Definition mint (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; token_id; value ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc1155::Contract" ], self |) in
        let token_id := M.alloc (| Ty.path "u128", token_id |) in
        let value := M.alloc (| Ty.path "u128", value |) in
        M.catch_return
          (Ty.apply
  ...
  Definition perform_transfer (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; from; to; token_id; value ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc1155::Contract" ], self |) in
        let from := M.alloc (| Ty.path "erc1155::AccountId", from |) in
        let to := M.alloc (| Ty.path "erc1155::AccountId", to |) in
        let token_id := M.alloc (| Ty.path "u128", token_id |) in
        let value := M.alloc (| Ty.path "u128", value |) in
        M.read (|
          ...
          let~ recipient_balance : Ty.path "u128" :=
            M.call_closure (|
              ...
              [
                ...
                |);
                M.read (| M.use (M.alloc (| Ty.path "u128", Value.Integer IntegerKind.U128 0 |)) |)
              ]
            |) in
          let~ _ : Ty.tuple [] :=
  ...
  Definition transfer_acceptance_check (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; caller; from; to; token_id; value; data ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc1155::Contract" ], self |) in
        let caller := M.alloc (| Ty.path "erc1155::AccountId", caller |) in
        let from := M.alloc (| Ty.path "erc1155::AccountId", from |) in
        let to := M.alloc (| Ty.path "erc1155::AccountId", to |) in
        let token_id := M.alloc (| Ty.path "u128", token_id |) in
        let value := M.alloc (| Ty.path "u128", value |) in
  ...
  Definition is_approved_for_all (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; owner; operator ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc1155::Contract" ], self |) in
        let owner := M.alloc (| Ty.path "erc1155::AccountId", owner |) in
        let operator := M.alloc (| Ty.path "erc1155::AccountId", operator |) in
        M.call_closure (|
          Ty.path "bool",
          M.get_associated_function (|
            Ty.apply
            ...
            M.borrow (|
              ...
              M.deref (|
                M.borrow (|
                  ...
                  M.alloc (|
                    Ty.tuple [ Ty.path "erc1155::AccountId"; Ty.path "erc1155::AccountId" ],
                    Value.Tuple [ M.read (| owner |); M.read (| operator |) ]
                  |)
                |)
              |)
            |)
                ...
                M.borrow (|
                  ...
                  M.deref (|
                    M.borrow (|
                      ...
                      M.alloc (|
                        Ty.tuple [ Ty.path "erc1155::AccountId"; Ty.path "u128" ],
                        Value.Tuple [ M.read (| owner |); M.read (| token_id |) ]
                      |)
                    |)
                  |)
                |)
    ...
    | [], [], [ self; operator; approved ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc1155::Contract" ], self |) in
        let operator := M.alloc (| Ty.path "erc1155::AccountId", operator |) in
        let approved := M.alloc (| Ty.path "bool", approved |) in
        M.catch_return
          (Ty.apply
            (Ty.path "core::result::Result")
            []
  ...
  Definition on_received (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _operator; _from; _token_id; _value; _data ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc1155::Contract" ], self |) in
        let _operator := M.alloc (| Ty.path "erc1155::AccountId", _operator |) in
        let _from := M.alloc (| Ty.path "erc1155::AccountId", _from |) in
        let _token_id := M.alloc (| Ty.path "u128", _token_id |) in
        let _value := M.alloc (| Ty.path "u128", _value |) in
        let _data :=
          M.alloc (|
            Ty.apply
              (Ty.path "alloc::vec::Vec")
