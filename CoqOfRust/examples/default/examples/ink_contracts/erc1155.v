    ...
    | [ Self ], [ self; from; to; token_ids; values; data ] =>
      ...
      M.catch_return
        ...
        let* _ :=
          ...
          let* α5 :=
            M.call α4 [ token_ids; (Integer.of_Z 0) : Ty.path "usize" ] in
          let* α6 := M.read α5 in
          let* α7 :=
            M.get_method
              "core::ops::index::Index"
          ...
          let* α8 := M.call α7 [ values; (Integer.of_Z 0) : Ty.path "usize" ] in
          let* α9 := M.read α8 in
    ...
    | [ Self ], [ self; operator; approved ] =>
      ...
      M.catch_return
        ...
        let* _ :=
          ...
          let* α2 := M.call α1 [ operator; caller ] in
    ...
    | [ Self ], [ self; _operator; _from; _token_id; _value; _data ] =>
      ...
      let* α5 :=
        M.call
          ...
          [ pointer_coercion "Unsize" α2; pointer_coercion "Unsize" α4 ] in
