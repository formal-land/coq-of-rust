  ...
  Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        ...
        M.read (|
          M.match_operator (|
            Some (Ty.apply (Ty.path "*") [] [ Ty.path "erc1155::AccountId" ]),
  ...
  Definition create (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; value ] =>
      ltac:(M.monadic
        ...
        M.read (|
          let~ caller : Ty.apply (Ty.path "*") [] [ Ty.path "erc1155::AccountId" ] :=
            M.alloc (|
              M.call_closure (|
                Ty.path "erc1155::AccountId",
  ...
  Definition perform_transfer (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; from; to; token_id; value ] =>
      ltac:(M.monadic
        ...
        let value := M.alloc (| value |) in
        M.read (|
          let~ sender_balance : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
            M.alloc (|
              M.call_closure (|
                Ty.path "u128",
                M.get_associated_function (|
          ...
          let~ _ :
            ...
            M.alloc (|
              ...
              |)
            |) in
          let~ recipient_balance : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
            M.alloc (|
              M.call_closure (|
                Ty.path "u128",
                M.get_associated_function (|
          ...
          ltac:(M.monadic
            (M.read (|
              ...
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                ...
                |) in
              let~ balance : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u128",
                    M.get_trait_method (|
