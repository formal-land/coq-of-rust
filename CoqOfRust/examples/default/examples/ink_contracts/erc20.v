  ...
  Definition caller (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [ self ] =>
      ltac:(M.monadic
        ...
        M.read (|
          M.call_closure (|
            M.get_struct_record_field "erc20::Env" "caller",
            [ M.read (| self |) ]
          |)
        |)))
    | _, _ => M.impossible
  ...
  Definition total_supply (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [ self ] =>
      ltac:(M.monadic
        ...
        M.read (|
          M.call_closure (|
            M.get_struct_record_field "erc20::Erc20" "total_supply",
            [ M.read (| self |) ]
          |)
        |)))
    | _, _ => M.impossible
        ...
        M.call_closure (|
          ...
          [
            M.call_closure (|
              ...
              [
                M.call_closure (|
                  M.get_struct_record_field "erc20::Erc20" "balances",
                  [ M.read (| self |) ]
                |);
                M.read (| owner |)
              ]
        ...
        M.call_closure (|
          ...
          [
            M.call_closure (|
              ...
              [
                M.call_closure (|
                  M.get_struct_record_field "erc20::Erc20" "allowances",
                  [ M.read (| self |) ]
                |);
                M.alloc (|
