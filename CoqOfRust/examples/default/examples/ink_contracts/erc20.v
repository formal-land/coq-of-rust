  ...
  Definition get (K V : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _key ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "erc20::Mapping") [] [ K; V ] ],
            self
          |) in
  ...
  Definition insert (K V : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _key; _value ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "erc20::Mapping") [] [ K; V ] ],
            self
          |) in
...
Module Impl_core_clone_Clone_for_erc20_AccountId.
  ...
  Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::AccountId" ], self |) in
        M.read (|
          M.match_operator (|
...
Module Impl_erc20_Env.
  ...
  *)
  Definition caller (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::Env" ], self |) in
        M.read (|
  ...
  *)
  Definition emit_event (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _event ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::Env" ], self |) in
        let _event := M.alloc (| Ty.path "erc20::Event", _event |) in
        M.never_to_any (|
          M.call_closure (|
            Ty.path "never",
            M.get_function (| "core::panicking::panic", [], [] |),
...
Module Impl_erc20_Erc20.
  ...
  *)
  Definition env (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::Erc20" ], self |) in
        M.call_closure (|
          Ty.path "erc20::Env",
  ...
  Definition balance_of_impl (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; owner ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::Erc20" ], self |) in
        let owner :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::AccountId" ], owner |) in
        M.call_closure (|
          Ty.path "u128",
          M.get_associated_function (|
  ...
  *)
  Definition balance_of (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; owner ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::Erc20" ], self |) in
        let owner := M.alloc (| Ty.path "erc20::AccountId", owner |) in
        M.call_closure (|
          Ty.path "u128",
    ...
    | [], [], [ self; owner; spender ] =>
      ltac:(M.monadic
        ...
        let owner :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::AccountId" ], owner |) in
        let spender :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::AccountId" ], spender |) in
        M.call_closure (|
          Ty.path "u128",
          M.get_associated_function (|
            Ty.apply (Ty.path "core::option::Option") [] [ Ty.path "u128" ],
  ...
  Definition allowance (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; owner; spender ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::Erc20" ], self |) in
        let owner := M.alloc (| Ty.path "erc20::AccountId", owner |) in
        let spender := M.alloc (| Ty.path "erc20::AccountId", spender |) in
        M.call_closure (|
          Ty.path "u128",
  ...
  *)
  Definition transfer_from_to (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; from; to; value ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc20::Erc20" ], self |) in
        let from := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::AccountId" ], from |) in
        let to := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc20::AccountId" ], to |) in
  ...
  *)
  Definition transfer (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; to; value ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc20::Erc20" ], self |) in
        let to := M.alloc (| Ty.path "erc20::AccountId", to |) in
        let value := M.alloc (| Ty.path "u128", value |) in
        M.read (|
  ...
  *)
  Definition transfer_from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; from; to; value ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc20::Erc20" ], self |) in
        let from := M.alloc (| Ty.path "erc20::AccountId", from |) in
        let to := M.alloc (| Ty.path "erc20::AccountId", to |) in
        let value := M.alloc (| Ty.path "u128", value |) in
        M.read (|
          M.catch_return
