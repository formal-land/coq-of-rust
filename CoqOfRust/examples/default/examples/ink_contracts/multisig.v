  ...
  *)
  Definition cmp (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self; other] =>
      ...
      let* α0 :=
        ltac:(M.get_method (fun ℐ =>
          core.cmp.Ord.cmp (Self := Ty.path "u128") (Trait := ℐ))) in
      let* α1 := M.read self in
      let* α2 := M.read other in
      M.call
        (α0
  ...
  *)
  Definition default (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [] =>
      ...
      let* α8 :=
        ltac:(M.get_method (fun ℐ =>
          core.default.Default.default (Self := Ty.path "u64") (Trait := ℐ))) in
      let* α9 := M.call α8 in
      let* α10 :=
        ltac:(M.get_method (fun ℐ =>
          core.default.Default.default
        ...
        let* α0 :=
          M.call
            ((Ty.apply
                  (Ty.path "alloc::vec::Vec")
                  [Ty.path "multisig::AccountId";
                    Ty.path "alloc::alloc::Global"])::["dedup"]
        ...
        let* α2 :=
          M.call
            ((Ty.apply
              ...
              (borrow ((M.var "multisig::Multisig::Get_is_owner") (deref α0)))
              α1) in
  ...
  Definition ensure_caller_is_owner (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self] =>
      ...
      let* _ :=
        ...
        let* α6 :=
          M.call
            ((Ty.path "multisig::Multisig")::["ensure_owner"] α0 (borrow α5)) in
        M.alloc α6 in
      let* α0 := M.alloc tt in
      M.read α0
    | _, _ => M.impossible
  ...
  Definition add_owner (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self; new_owner] =>
        ...
        let* α2 :=
          M.call
            ((Ty.apply
                  (Ty.path "alloc::vec::Vec")
                  [Ty.path "multisig::AccountId";
                    Ty.path "alloc::alloc::Global"])::["push"]
      ...
      let* _ :=
        ...
        let* α1 :=
          M.call
            ((Ty.path "multisig::Multisig")::["env"] (borrow (deref α0))) in
        let* α2 := M.alloc α1 in
  ...
  *)
  Definition owner_index (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self; owner] =>
      ...
      let* α3 :=
        M.call
          (α1 (borrow ((M.var "multisig::Multisig::Get_owners") (deref α2)))) in
      let* α4 :=
        M.call
          ((Ty.apply
                (Ty.path "slice")
  ...
  Definition remove_owner (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self; owner] =>
      ...
      let* requirement :=
        let* α0 :=
          ltac:(M.get_method (fun ℐ =>
            core.cmp.Ord.min (Self := Ty.path "u32") (Trait := ℐ))) in
        ...
        let* α2 :=
          M.call
            ((Ty.apply
                  (Ty.path "alloc::vec::Vec")
                  [Ty.path "multisig::AccountId";
                    Ty.path "alloc::alloc::Global"])::["swap_remove"]
              (borrow_mut ((M.var "multisig::Multisig::Get_owners") (deref α0)))
              α1) in
        M.alloc α2 in
      let* _ :=
  ...
  *)
  Definition submit_transaction (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self; transaction] =>
      ...
      let* α7 :=
        M.call
          ((Ty.path "multisig::Multisig")::["confirm_by_caller"] α1 α5 α6) in
      ...
      let* _ :=
        ...
        if α2 then
            ...
            let* α2 :=
              M.call
                ((Ty.apply
                      (Ty.path "multisig::Mapping")
                      [Ty.path "u32";
                        Ty.path "multisig::Transaction"])::["remove"]
                  (borrow
                    ((M.var "multisig::Multisig::Get_transactions") (deref α0)))
                  α1) in
            M.alloc α2 in
          let* pos :=
            ...
            let* α4 :=
              M.call
                ((Ty.apply (Ty.path "slice") [Ty.path "u32"])::["iter"] α3) in
            let* α5 := M.alloc α4 in
            let* α6 :=
              M.call
                (α0
          ...
          let* _ :=
            ...
            let* α3 :=
              M.call
                (α1
                  (borrow
                    ((M.var "multisig::Multisig::Get_owners") (deref α2)))) in
            let* α4 :=
              M.call
                ((Ty.apply
                      (Ty.path "slice")
  ...
  *)
  Definition cancel_transaction (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self; trans_id] =>
      ...
      let* α1 := M.read trans_id in
      let* α2 :=
        M.call ((Ty.path "multisig::Multisig")::["take_transaction"] α0 α1) in
      let* α3 := M.alloc α2 in
      let* α4 :=
        M.call
          ((Ty.apply
  ...
  *)
  Definition confirm_transaction (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self; trans_id] =>
      ...
      let* α6 :=
        M.call
          ((Ty.path "multisig::Multisig")::["confirm_by_caller"] α0 α4 α5) in
  ...
  Definition invoke_transaction (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self; trans_id] =>
      ...
      let* _ :=
        ...
        let* α3 :=
          M.call
            ((Ty.path "multisig::Env")::["transferred_value"] (borrow α2)) in
        let* α4 :=
            ...
            ((Ty.apply
              ...
              (fun (α0 : Ty.tuple []) =>
                ...
                Ty.apply
                  ...
                  [Ty.apply
                      (Ty.path "alloc::vec::Vec")
                      [Ty.path "u8"; Ty.path "alloc::alloc::Global"]])) in
        let* α6 :=
          M.call
            ((Ty.path "multisig::Env")::["emit_event"]
              (borrow α2)
