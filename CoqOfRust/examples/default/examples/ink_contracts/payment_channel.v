...
Module Impl_core_clone_Clone_for_payment_channel_AccountId.
  ...
  Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "payment_channel::AccountId" ], self |) in
        M.read (|
          M.match_operator (|
    ...
    | [], [], [ self; other ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "payment_channel::AccountId" ], self |) in
        let other :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "payment_channel::AccountId" ], other |) in
        M.call_closure (|
          Ty.path "bool",
          BinOp.eq,
          [
...
Module Impl_core_cmp_PartialEq_payment_channel_Error_for_payment_channel_Error.
  ...
  Definition eq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; other ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "payment_channel::Error" ], self |) in
        let other :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "payment_channel::Error" ], other |) in
        M.read (|
  ...
  *)
  Definition caller (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "payment_channel::Env" ], self |) in
        M.read (|
  ...
  Definition emit_event (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _event ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "payment_channel::Env" ], self |) in
        let _event := M.alloc (| Ty.path "payment_channel::Event", _event |) in
        M.never_to_any (|
          M.call_closure (|
            Ty.path "never",
            M.get_function (| "core::panicking::panic", [], [] |),
  ...
  Definition terminate_contract (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; sender ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "payment_channel::Env" ], self |) in
        let sender := M.alloc (| Ty.path "payment_channel::AccountId", sender |) in
        M.never_to_any (|
          M.call_closure (|
            Ty.path "never",
            M.get_function (| "core::panicking::panic", [], [] |),
  ...
  Definition transfer (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; recipient; amount ] =>
      ltac:(M.monadic
        ...
        let amount := M.alloc (| Ty.path "u128", amount |) in
        M.never_to_any (|
          M.call_closure (|
            Ty.path "never",
            M.get_function (| "core::panicking::panic", [], [] |),
...
Definition hash_encoded (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [ H; T ], [ input; output ] =>
    ltac:(M.monadic
      (let input := M.alloc (| Ty.apply (Ty.path "&") [] [ T ], input |) in
      let output :=
        M.alloc (|
          Ty.apply
            (Ty.path "&mut")
            []
            [ Ty.associated_in_trait "payment_channel::HashOutput" [] [] H "Type" ],
          output
        |) in
      M.never_to_any (|
        M.call_closure (|
    ...
    | [], [], [ self; amount; signature ] =>
      ltac:(M.monadic
        ...
        M.read (|
          ...
          let~ pub_key :
              Ty.apply (Ty.path "array") [ Value.Integer IntegerKind.Usize 33 ] [ Ty.path "u8" ] :=
            lib.repeat (| Value.Integer IntegerKind.U8 0, Value.Integer IntegerKind.Usize 33 |) in
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
              Ty.tuple [],
              M.get_associated_function (|
  ...
  Definition close_inner (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; amount; signature ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&mut") [] [ Ty.path "payment_channel::PaymentChannel" ],
            self
          |) in
        let amount := M.alloc (| Ty.path "u128", amount |) in
        let signature :=
                        ...
                        ltac:(M.monadic
                          (let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let expiration := M.copy (| Ty.path "u64", γ0_0 |) in
                          let~ now : Ty.path "u64" :=
                            M.call_closure (|
                              Ty.path "u64",
                              M.get_associated_function (|
