  ...
  *)
  Definition clone (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self] =>
      ...
      let* α0 : Ty.apply (Ty.path "updated_incrementer::AccountId") [] :=
        match_operator
  ...
  *)
  Definition env (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self] =>
      let* self := M.alloc self in
      M.call
        (Ty.apply (Ty.path "updated_incrementer::Incrementer") [])::["init_env"]
    | _, _ => M.impossible
    end.
  ...
  Definition inc (𝜏 : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [self] =>
      ...
      let* _ : Ty.tuple :=
        ...
        let* α0 := M.read β in
        let* α1 := BinOp.Panic.add α0 ((Integer.of_Z 4) : Ty.path "u32") in
        assign β α1 in
      let* _ : Ty.tuple :=
        let* _ : Ty.tuple :=
          let* α0 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
      ...
      let* _ : Ty.tuple :=
        let* α0 :
            Ty.apply
              ...
              [Ty.apply (Ty.path "updated_incrementer::Incrementer") []] :=
          M.read self in
        let* α1 : Ty.apply (Ty.path "updated_incrementer::Env") [] :=
          M.call
            ((Ty.apply (Ty.path "updated_incrementer::Incrementer") [])::["env"]
              (borrow (deref α0))) in
        let* α2 : Ty.apply (Ty.path "updated_incrementer::Env") [] :=
          M.alloc α1 in
        let* α3 :
            Ty.apply
        ...
        let* α4 : Ty.tuple :=
          M.call
            ((Ty.apply
                  ...
                  [Ty.tuple;
                    Ty.apply
                      (Ty.path "updated_incrementer::Error")
                      []])::["unwrap_or_else"]
              α3
              (fun (α0 : Ty.apply (Ty.path "updated_incrementer::Error") []) =>
