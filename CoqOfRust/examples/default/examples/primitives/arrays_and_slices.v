...
" ] in
        ...
        let* α3 : M.Val (slice i32.t) := deref slice in
        let* α4 : M.Val (ref i32.t) := borrow α3[M.alloc 0] in
...
" ] in
        ...
        let* α7 : M.Val (ref usize.t) := borrow α6 in
...
" ] in
        ...
        let* α2 : M.Val (ref (slice (ref str.t))) :=
          pointer_coercion "Unsize" α1 in
        let* α3 : M.Val (ref i32.t) := borrow xs[M.alloc 0] in
...
" ] in
        ...
        let* α2 : M.Val (ref (slice (ref str.t))) :=
          pointer_coercion "Unsize" α1 in
        let* α3 : M.Val (ref i32.t) := borrow xs[M.alloc 1] in
        let* α4 := core.fmt.rt.Argument.t::["new_display"] α3 in
        let* α5 : M.Val core.fmt.rt.Argument.t := M.alloc α4 in
        let* α6 : M.Val (array core.fmt.rt.Argument.t) := M.alloc [ α5 ] in
        let* α7 : M.Val (ref (array core.fmt.rt.Argument.t)) := borrow α6 in
...
" ] in
        ...
        let* α2 : M.Val (ref (slice (ref str.t))) :=
          pointer_coercion "Unsize" α1 in
        let* α3 : M.Val (ref (array i32.t)) := borrow xs in
...
" ] in
    ...
    let* _ : M.Val unit :=
      ...
      let* α4 := M.read α3 in
      let* α5 : M.Val (core.ops.range.Range.t usize.t) :=
        M.alloc
    ...
    let* _ : M.Val unit :=
      ...
      | (left_val, right_val) =>
        ...
        let* α1 : M.Val (ref (ref (array u32.t))) := borrow α0 in
        let* α2 : M.Val (ref (array u32.t)) := deref right_val in
        let* α3 : M.Val (ref (ref (array u32.t))) := borrow α2 in
        let* α4 :=
    ...
    let* _ : M.Val unit :=
      ...
      let* α3 : M.Val (array u32.t) := M.alloc [ ] in
      let* α4 : M.Val (ref (array u32.t)) := borrow α3 in
      let* α5 : M.Val core.ops.range.RangeFull.t :=
    ...
    let* α7 : M.Val usize.t := BinOp.add α5 α6 in
    let* α8 := M.read α7 in
    let* α9 : M.Val (core.ops.range.Range.t usize.t) :=
      M.alloc
        ...
        loop
          (let* _ : M.Val unit :=
            ...
            | core.option.Option.Some i =>
              ...
              let* α3 : M.Val (core.option.Option.t (ref i32.t)) :=
                M.alloc α2 in
              let* α4 := M.read α3 in
              match α4 with
...
" ] in
                  ...
                  let* α4 := core.fmt.rt.Argument.t::["new_display"] α3 in
                  let* α5 : M.Val core.fmt.rt.Argument.t := M.alloc α4 in
                  let* α6 : M.Val (ref (ref i32.t)) := borrow xval in
                  let* α7 := core.fmt.rt.Argument.t::["new_display"] α6 in
                  let* α8 : M.Val core.fmt.rt.Argument.t := M.alloc α7 in
