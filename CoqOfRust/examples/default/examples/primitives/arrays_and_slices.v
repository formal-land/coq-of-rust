...
" ] in
        ...
        let* α3 := M.read α2 in
        let* α4 : M.Val (slice i32.t) := deref slice in
        let* α5 : M.Val (ref i32.t) := borrow α4[M.alloc 0] in
        let* α6 := M.read α5 in
...
" ] in
        ...
        let* α6 := M.read α5 in
        let* α7 := (slice i32.t)::["len"] α6 in
        let* α8 : M.Val usize.t := M.alloc α7 in
        let* α9 : M.Val (ref usize.t) := borrow α8 in
...
" ] in
        ...
        let* α2 : M.Val (ref (slice (ref str.t))) :=
          pointer_coercion "Unsize" α1 in
        let* α3 := M.read α2 in
        let* α4 : M.Val (ref i32.t) := borrow xs[M.alloc 0] in
        let* α5 := M.read α4 in
...
" ] in
        ...
        let* α2 : M.Val (ref (slice (ref str.t))) :=
          pointer_coercion "Unsize" α1 in
        let* α3 := M.read α2 in
        let* α4 : M.Val (ref i32.t) := borrow xs[M.alloc 1] in
        let* α5 := M.read α4 in
        let* α6 := core.fmt.rt.Argument.t::["new_display"] α5 in
        let* α7 : M.Val core.fmt.rt.Argument.t := M.alloc α6 in
        let* α8 : M.Val (array core.fmt.rt.Argument.t) := M.alloc [ α7 ] in
...
" ] in
        ...
        let* α2 : M.Val (ref (slice (ref str.t))) :=
          pointer_coercion "Unsize" α1 in
        let* α3 := M.read α2 in
        let* α4 : M.Val (ref (array i32.t)) := borrow xs in
...
" ] in
        ...
        let* α4 : M.Val (ref (array i32.t)) := borrow xs in
        let* α5 := M.read α4 in
        let* α6 := core.mem.size_of_val α5 in
...
" ] in
      ...
      M.alloc tt in
    let* _ : M.Val unit :=
      let* α0 : M.Val (ref (array i32.t)) := borrow xs in
      let* α1 : M.Val (ref (slice i32.t)) := pointer_coercion "Unsize" α0 in
      let* α2 := M.read α1 in
      let* α3 := arrays_and_slices.analyze_slice α2 in
      M.alloc α3 in
    let* _ : M.Val unit :=
      let* _ : M.Val unit :=
        let* α0 : M.Val (array (ref str.t)) :=
...
" ] in
      ...
      M.alloc tt in
    let* _ : M.Val unit :=
      let* α0 : M.Val (ref (array i32.t)) := borrow ys in
      let* α1 := M.read α0 in
      let* α2 : M.Val usize.t := M.alloc 1 in
      let* α3 := M.read α2 in
      ...
      let* α6 :=
        (core.ops.index.Index.index
            ...
            (Trait := ltac:(refine _)))
          α1
          {| core.ops.range.Range.start := α3; core.ops.range.Range.end := α5;
          |} in
      let* α7 : M.Val (ref (slice i32.t)) := M.alloc α6 in
      let* α8 : M.Val (slice i32.t) := deref α7 in
      let* α9 : M.Val (ref (slice i32.t)) := borrow α8 in
      let* α10 := M.read α9 in
      let* α11 := arrays_and_slices.analyze_slice α10 in
      M.alloc α11 in
    let* empty_array : M.Val (array u32.t) := M.alloc [ ] in
    let* _ : M.Val unit :=
      let* α0 : M.Val (ref (array u32.t)) := borrow empty_array in
      let* α1 : M.Val (ref (ref (array u32.t))) := borrow α0 in
      let* α2 := M.read α1 in
      let* α3 : M.Val (array u32.t) := M.alloc [ ] in
      let* α4 : M.Val (ref (array u32.t)) := borrow α3 in
      let* α5 : M.Val (ref (ref (array u32.t))) := borrow α4 in
      let* α6 := M.read α5 in
      ...
      | (left_val, right_val) =>
        ...
        let* α0 : M.Val (ref (array u32.t)) := deref left_val in
        let* α1 : M.Val (ref (ref (array u32.t))) := borrow α0 in
        let* α2 := M.read α1 in
        let* α3 : M.Val (ref (array u32.t)) := deref right_val in
        let* α4 : M.Val (ref (ref (array u32.t))) := borrow α3 in
        let* α5 := M.read α4 in
        let* α6 :=
        ...
        if (α10 : bool) then
          ...
          let* _ : M.Val never.t :=
            ...
            let* α1 : M.Val (ref (array u32.t)) := deref left_val in
            let* α2 : M.Val (ref (ref (array u32.t))) := borrow α1 in
            let* α3 := M.read α2 in
            let* α4 : M.Val (ref (array u32.t)) := deref right_val in
            let* α5 : M.Val (ref (ref (array u32.t))) := borrow α4 in
            let* α6 := M.read α5 in
            let* α7 :=
    ...
    let* _ : M.Val unit :=
      ...
      let* α7 : M.Val (ref (slice u32.t)) := M.alloc α6 in
      let* α8 : M.Val (slice u32.t) := deref α7 in
      let* α9 : M.Val (ref (slice u32.t)) := borrow α8 in
      let* α10 : M.Val (ref (ref (slice u32.t))) := borrow α9 in
      let* α11 := M.read α10 in
      let* α12 :
    ...
    let* α1 := M.read α0 in
    let* α2 : M.Val (ref (array i32.t)) := borrow xs in
    let* α3 : M.Val (ref (slice i32.t)) := pointer_coercion "Unsize" α2 in
    let* α4 := M.read α3 in
    let* α5 := (slice i32.t)::["len"] α4 in
    let* α6 : M.Val usize.t := M.alloc α5 in
    let* α7 : M.Val usize.t := M.alloc 1 in
    let* α8 : M.Val usize.t := BinOp.add α6 α7 in
    let* α9 := M.read α8 in
    let* α10 :=
      (core.iter.traits.collect.IntoIterator.into_iter
          (Self := core.ops.range.Range.t usize.t)
          (Trait := ltac:(refine _)))
        {| core.ops.range.Range.start := α1; core.ops.range.Range.end := α9;
        |} in
    let* α11 : M.Val (core.ops.range.Range.t usize.t) := M.alloc α10 in
    let* α12 := M.read α11 in
    let* α13 : M.Val unit :=
      match α12 with
      | iter =>
        ...
        loop
          (let* _ : M.Val unit :=
            let* α0 : M.Val (mut_ref (core.ops.range.Range.t usize.t)) :=
              borrow_mut iter in
            let* α1 := M.read α0 in
            let* α2 :=
              (core.iter.traits.iterator.Iterator.next
                  ...
                  (Trait := ltac:(refine _)))
                α1 in
            let* α3 : M.Val (core.option.Option.t usize.t) := M.alloc α2 in
            let* α4 := M.read α3 in
            match α4 with
            ...
            | core.option.Option.Some i =>
              let* i := M.alloc i in
              let* α0 : M.Val (ref (array i32.t)) := borrow xs in
              let* α1 : M.Val (ref (slice i32.t)) :=
                pointer_coercion "Unsize" α0 in
              let* α2 := M.read α1 in
              let* α3 := M.read i in
              let* α4 := (slice i32.t)::["get"] α2 α3 in
              let* α5 : M.Val (core.option.Option.t (ref i32.t)) :=
                M.alloc α4 in
              let* α6 := M.read α5 in
              match α6 with
...
" ] in
                  ...
                  let* α2 : M.Val (ref (slice (ref str.t))) :=
                    pointer_coercion "Unsize" α1 in
                  let* α3 := M.read α2 in
                  let* α4 : M.Val (ref usize.t) := borrow i in
                  let* α5 := M.read α4 in
                  let* α6 := core.fmt.rt.Argument.t::["new_display"] α5 in
                  let* α7 : M.Val core.fmt.rt.Argument.t := M.alloc α6 in
                  let* α8 : M.Val (ref (ref i32.t)) := borrow xval in
                  let* α9 := M.read α8 in
                  let* α10 := core.fmt.rt.Argument.t::["new_display"] α9 in
                  let* α11 : M.Val core.fmt.rt.Argument.t := M.alloc α10 in
