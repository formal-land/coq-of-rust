...
Definition value_LANGUAGE : Value.t := M.run ltac:(M.monadic (M.alloc (| mk_str "Rust" |))).
                ...
                [
                  M.call_closure (|
                    ...
                    [
                      ...
                      M.pointer_coercion
                        (M.alloc (|
                          Value.Array [ M.read (| mk_str "This is " |); M.read (| mk_str "
" |) ]
                        |));
                      (* Unsize *)
                      M.pointer_coercion
                  ...
                  M.call_closure (|
                    ...
                    [
                      ...
                      M.pointer_coercion
                        (M.alloc (|
                          Value.Array
                            [ M.read (| mk_str "The threshold is " |); M.read (| mk_str "
" |) ]
                        |));
                      (* Unsize *)
                      M.pointer_coercion
                                    ...
                                    [
                                      fun γ =>
                                        ltac:(M.monadic
                                          ...
                                          mk_str "big"));
                                      fun γ =>
                                        ltac:(M.monadic (M.alloc (| M.read (| mk_str "small" |) |)))
                                    ]
                                  |)
                                ]
                              |)
