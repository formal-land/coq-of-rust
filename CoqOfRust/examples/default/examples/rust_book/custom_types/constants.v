...
Definition is_big (τ : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [ n ] =>
    ...
    let* α2 := M.read α1 in M.pure (BinOp.Pure.gt α0 α2)
  | _, _ => M.impossible
  end.
              ...
              M.match_operator
                ...
                [
                  fun γ =>
                    ...
                    M.pure (mk_str "big");
                  fun γ => let* α0 := M.read (mk_str "small") in M.alloc α0
                ] in
            let* α12 := M.call_closure α9 [ α11 ] in
            let* α13 := M.alloc (Value.Array [ α8; α12 ]) in M.pure (M.pointer_coercion α13) in
