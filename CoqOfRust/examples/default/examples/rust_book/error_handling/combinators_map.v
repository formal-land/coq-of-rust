        ...
        [
          fun γ =>
            ...
            | core.option.Option.Some _ =>
              ...
              let* α0 : Ty.apply (Ty.path "combinators_map::Food") [] :=
                M.read food in
              M.alloc
  ...
  | [], [chopped] =>
    ...
    M.call
      ((Ty.apply
        ...
        α0
        (fun (α0 : Ty.apply (Ty.path "combinators_map::Chopped") []) =>
    ...
    let* α1 :
      ...
      M.call
        ((Ty.apply
          ...
          α0
          (fun (α0 : Ty.apply (Ty.path "combinators_map::Food") []) =>
            (let* α0 := M.alloc α0 in
            match_operator
              α0
              [
    ...
    let* α2 :
      ...
      M.call
        ((Ty.apply
          ...
          α1
          (fun (α0 : Ty.apply (Ty.path "combinators_map::Peeled") []) =>
            (let* α0 := M.alloc α0 in
            match_operator
              α0
              [
...
Definition main (𝜏 : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [] =>
    ...
    let* _ : Ty.tuple :=
      ...
      let* α1 : Ty.tuple := M.call (combinators_map.eat α0) in
      M.alloc α1 in
    let* _ : Ty.tuple :=
      let* α0 :
          Ty.apply
