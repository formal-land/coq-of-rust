              ...
              M.match_operator (|
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      (let γ := M.read (| γ |) in
                      M.alloc (| M.read (| M.of_value (| Value.String "Apple" |) |) |)));
                  fun γ =>
                    ltac:(M.monadic
                      (let γ := M.read (| γ |) in
                      M.alloc (| M.read (| M.of_value (| Value.String "Carrot" |) |) |)));
                  fun γ =>
                    ltac:(M.monadic
                      (let γ := M.read (| γ |) in
                      M.alloc (| M.read (| M.of_value (| Value.String "Potato" |) |) |)))
                ]
              |)
            |)
          ]
    ...
    | [], [ self; f ] =>
      ltac:(M.monadic
        ...
        M.call_closure (|
          ...
          [
            M.read (| f |);
            M.read (| M.of_value (| Value.String "Peeled" |) |);
            (* Unsize *)
            M.pointer_coercion (|
              M.alloc (|
    ...
    | [], [ self; f ] =>
      ltac:(M.monadic
        ...
        M.call_closure (|
          ...
          [
            M.read (| f |);
            M.read (| M.of_value (| Value.String "Chopped" |) |);
            (* Unsize *)
            M.pointer_coercion (|
              M.alloc (|
                M.SubPointer.get_struct_tuple_field (|
    ...
    | [], [ self; f ] =>
      ltac:(M.monadic
        ...
        M.call_closure (|
          ...
          [
            M.read (| f |);
            M.read (| M.of_value (| Value.String "Cooked" |) |);
            (* Unsize *)
            M.pointer_coercion (|
              M.alloc (|
                M.SubPointer.get_struct_tuple_field (|
...
*)
Definition peel (τ : list Ty.t) (α : list A.t) : M :=
  match τ, α with
  | [], [ food ] =>
    ltac:(M.monadic
...
*)
Definition chop (τ : list Ty.t) (α : list A.t) : M :=
  match τ, α with
  | [], [ peeled ] =>
    ltac:(M.monadic
...
*)
Definition cook (τ : list Ty.t) (α : list A.t) : M :=
  match τ, α with
  | [], [ chopped ] =>
    ltac:(M.monadic
...
*)
Definition process (τ : list Ty.t) (α : list A.t) : M :=
  match τ, α with
  | [], [ food ] =>
    ltac:(M.monadic
      (let food := M.alloc (| food |) in
                              ...
                              M.alloc (|
                                M.of_value (|
                                  Value.Array
                                    [
                                      A.to_value
                                        (M.read (| M.of_value (| Value.String "Mmm. I love " |) |));
                                ...
                                M.of_value (|
                                  Value.Array
                                    [
                                      A.to_value
                                        (M.read (|
                                          M.of_value (| Value.String "Oh no! It wasn't edible.
" |)
                                        |))
                                    ]
                                |)
        ...
        let apple :=
          M.alloc (|
            M.of_value (|
              Value.StructTuple
                "core::option::Option::Some"
                [ A.to_value (M.of_value (| Value.StructTuple "combinators_map::Food::Apple" [] |))
                ]
            |)
          |) in
        let carrot :=
          M.alloc (|
            M.of_value (|
              Value.StructTuple
                "core::option::Option::Some"
                [ A.to_value (M.of_value (| Value.StructTuple "combinators_map::Food::Carrot" [] |))
                ]
            |)
          |) in
        let potato :=
