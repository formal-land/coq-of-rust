...
Definition main : M unit :=
  ltac:(M.monadic ((
    M.read (|
      let _ : M.Val unit :=
        M.alloc (|
          M.call (|(introducing_question_mark_is_an_replacement_for_deprecated_try.print
            (M.call (|(introducing_question_mark_is_an_replacement_for_deprecated_try.multiply
              (M.read (| mk_str "10" |))
              (M.read (| mk_str "2" |)))
            |)))
          |)
