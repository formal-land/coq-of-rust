      ...
      M.match_operator
        ...
        [
          ...
          fun γ =>
            ...
            let* e := M.copy γ0_0 in
            let* α0 := M.read e in M.alloc (Value.StructTuple "core::result::Result::Err" [ α0 ])
        ] in
    M.read α4
  | _, _ => M.impossible
  end.
...
Definition main (τ : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [] =>
    let* twenty :=
      ...
      let* α2 := M.read (mk_str "2") in let* α3 := M.call_closure α0 [ α1; α2 ] in M.alloc α3 in
    let* _ :=
      let* α0 := M.get_function "map_in_result_via_match::print" [] in
      let* α1 := M.read twenty in let* α2 := M.call_closure α0 [ α1 ] in M.alloc α2 in
    let* tt_ :=
      let* α0 := M.get_function "map_in_result_via_match::multiply" [] in
    ...
    let* _ :=
      let* α0 := M.get_function "map_in_result_via_match::print" [] in
      let* α1 := M.read tt_ in let* α2 := M.call_closure α0 [ α1 ] in M.alloc α2 in
