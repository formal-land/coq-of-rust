  ...
  | [], [ vec ] =>
    ...
    let* α3 :=
      M.call
        ...
        [ α2 ] in
    let* α4 := BinOp.Panic.mul (Value.Integer Integer.I32 2) α3 in
...
") in
        ...
        let* α4 := M.var "multiple_error_types::double_first" in
        let* α5 := M.read numbers in
