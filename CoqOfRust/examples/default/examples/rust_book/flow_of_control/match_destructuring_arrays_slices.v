...
") in
              ...
              let* α6 :=
                M.get_associated_function
                  ...
                  "new_display" in
              let* α7 := M.call α6 [ second ] in
              let* α8 :=
                M.get_associated_function
                  (Ty.path "core::fmt::rt::Argument")
                  "new_display" in
              let* α9 := M.call α8 [ third ] in
...
") in
              ...
              let* α7 :=
                M.get_associated_function
                  (Ty.path "core::fmt::rt::Argument")
                  "new_display" in
              let* α8 := M.call α7 [ first ] in
              let* α9 :=
                M.get_associated_function
                  (Ty.path "core::fmt::rt::Argument")
                  "new_debug" in
              let* α10 := M.call α9 [ middle ] in
              let* α11 :=
                M.get_associated_function
                  (Ty.path "core::fmt::rt::Argument")
                  "new_display" in
              let* α12 := M.call α11 [ last ] in
