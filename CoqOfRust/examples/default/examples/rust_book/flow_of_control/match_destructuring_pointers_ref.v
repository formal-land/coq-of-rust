...
Definition main (τ : list Ty.t) (α : list A.t) : M :=
  ...
  | [], [] =>
    ltac:(M.monadic
      (M.read (|
        let reference := M.alloc (| M.alloc (| M.of_value (| Value.Integer 4 |) |) |) in
        let _ :=
          M.match_operator (|
            reference,
            [
...
" |) |))
          ...
          |) in
        let _not_a_reference := M.alloc (| M.of_value (| Value.Integer 3 |) |) in
        M.match_operator (|
          ...
          [
            fun γ =>
              ltac:(M.monadic
                ...
                let value := M.alloc (| M.of_value (| Value.Integer 5 |) |) in
                let mut_value := M.alloc (| M.of_value (| Value.Integer 6 |) |) in
                let _ :=
                  M.match_operator (|
                    value,
                    [
