...
Definition main (𝜏 : list Ty.t) (α : list Value.t) : M :=
  match 𝜏, α with
  | [], [] =>
    let* reference : Ty.apply (Ty.path "ref") [Ty.path "i32"] :=
...
") in
    ...
    let* _ : Ty.tuple :=
      let* α0 : Ty.apply (Ty.path "ref") [Ty.path "i32"] := M.read reference in
      match_operator
        (deref α0)
        [
          fun γ =>
...
") in
    ...
    let* _not_a_reference : Ty.path "i32" :=
      ...
      match_operator
        ...
        [
          fun γ =>
            ...
            let* value : Ty.path "i32" :=
              M.alloc ((Integer.of_Z 5) : Ty.path "i32") in
            let* mut_value : Ty.path "i32" :=
              M.alloc ((Integer.of_Z 6) : Ty.path "i32") in
            let* _ : Ty.tuple :=
              match_operator
                value
                [
              ...
              [
                fun γ =>
                  ...
                  let* _ : Ty.tuple :=
                    ...
                    let* α0 := M.read β in
                    let* α1 :=
                      BinOp.Panic.add α0 ((Integer.of_Z 10) : Ty.path "i32") in
                    assign β α1 in
                  let* _ : Ty.tuple :=
                    let* _ : Ty.tuple :=
                      let* α0 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
