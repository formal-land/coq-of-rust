                                            ...
                                            (|
                                              (M.get_associated_function
                                                (|
                                                  ...
                                                  [
                                                    Ty.tuple
                                                      [ Ty.path "i32"; Ty.path "i32"; Ty.path "i32"
                                                      ]
                                                  ]
                                                |)),
                                              [ triple ]
...
") |)
                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let _ :=
                      M.is_constant_or_break_match
                        (| (M.read (| γ0_0 |)), (Value.Integer Integer.I32 1)
                        |) in
                    let _ :=
                      M.alloc
                        (|
...
")
                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let _ :=
                      M.is_constant_or_break_match
                        (| (M.read (| γ0_2 |)), (Value.Integer Integer.I32 2)
                        |) in
                    let _ :=
                      M.alloc
                        (|
...
")
                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let _ :=
                      M.is_constant_or_break_match
                        (| (M.read (| γ0_0 |)), (Value.Integer Integer.I32 3)
                        |) in
                    let _ :=
                      M.is_constant_or_break_match
                        (| (M.read (| γ0_2 |)), (Value.Integer Integer.I32 4)
                        |) in
                    let _ :=
                      M.alloc
                        (|
