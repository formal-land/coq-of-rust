      ...
      M.match_operator
        ...
        [
          fun γ =>
            ...
            let* γ :=
              let* α0 := M.read t in M.alloc (BinOp.Pure.gt α0 (Value.Integer Integer.I32 30)) in
...
") in
          ...
          fun γ =>
            ...
            let* t := M.copy γ0_0 in
            let* γ :=
              let* α0 := M.read t in M.alloc (BinOp.Pure.gt α0 (Value.Integer Integer.I32 86)) in
            let* _ := let* α0 := M.read γ in M.is_constant_or_break_match α0 (Value.Bool true) in
            let* _ :=
              let* α0 := M.get_function "std::io::stdio::_print" [] in
              let* α1 := M.get_associated_function (Ty.path "core::fmt::Arguments") "new_v1" [] in
