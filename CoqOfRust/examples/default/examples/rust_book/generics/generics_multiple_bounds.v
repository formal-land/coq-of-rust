...
") in
    ...
    let* _ :=
      let* _ :=
        let* α0 := M.var "std::io::stdio::_print" in
        let* α1 := M.read (mk_str "Display: `") in
        let* α2 := M.read (mk_str "`
") in
        let* α3 := M.alloc [ α1; α2 ] in
        let* α4 :=
          M.call (Ty.path "core::fmt::rt::Argument")::["new_display"] [ t ] in
        let* α5 := M.alloc [ α4 ] in
        let* α6 :=
          M.call
            (Ty.path "core::fmt::Arguments")::["new_v1"]
...
") in
    ...
    let* _ :=
      let* _ :=
        let* α0 := M.var "std::io::stdio::_print" in
        let* α1 := M.read (mk_str "u: `") in
        let* α2 := M.read (mk_str "`
") in
        let* α3 := M.alloc [ α1; α2 ] in
        let* α4 :=
          M.call (Ty.path "core::fmt::rt::Argument")::["new_debug"] [ u ] in
        let* α5 := M.alloc [ α4 ] in
        let* α6 :=
          M.call
            (Ty.path "core::fmt::Arguments")::["new_v1"]
...
Definition main (𝜏 : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [] =>
    ...
    let* vec :=
      ...
      M.alloc α3 in
    let* _ :=
      let* α0 := M.var "generics_multiple_bounds::compare_prints" in
      let* α1 := M.call α0 [ string ] in
      M.alloc α1 in
    let* _ :=
      let* α0 := M.var "generics_multiple_bounds::compare_types" in
