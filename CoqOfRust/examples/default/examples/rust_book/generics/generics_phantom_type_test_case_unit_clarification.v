...
Module Impl_core_fmt_Debug_where_core_fmt_Debug_Unit_for_generics_phantom_type_test_case_unit_clarification_Length_Unit.
  ...
  (* Debug *)
  Definition fmt (Unit : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
...
Module Impl_core_clone_Clone_where_core_clone_Clone_Unit_for_generics_phantom_type_test_case_unit_clarification_Length_Unit.
  ...
  (* Clone *)
  Definition clone (Unit : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self Unit in
    match τ, α with
    | [], [ self ] =>
      ltac:(M.monadic
...
Module Impl_core_ops_arith_Add_for_generics_phantom_type_test_case_unit_clarification_Length_Unit.
  ...
  *)
  Definition add (Unit : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self Unit in
    match τ, α with
    | [], [ self; rhs ] =>
      ltac:(M.monadic
                          ...
                          M.of_value (|
                            Value.Array
                              [
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String "one foot + one_foot = " |)
                                  |));
                                A.to_value (M.read (| M.of_value (| Value.String " in
" |) |))
                              ]
                          |)
                        |)
                          ...
                          M.of_value (|
                            Value.Array
                              [
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String "one meter + one_meter = " |)
                                  |));
                                A.to_value (M.read (| M.of_value (| Value.String " mm
" |) |))
                              ]
                          |)
                        |)
