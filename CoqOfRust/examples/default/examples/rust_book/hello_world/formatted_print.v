                ...
                [
                  M.call_closure (|
                    ...
                    [
                      ...
                      M.pointer_coercion
                        (M.alloc (|
                          Value.Array [ M.read (| mk_str "Base 10:               69420
" |) ]
                        |));
                      (* Unsize *)
                      M.pointer_coercion
                  ...
                  M.call_closure (|
                    ...
                    [
                      ...
                      M.pointer_coercion
                        (M.alloc (|
                          Value.Array
                            [ M.read (| mk_str "Base 2 (binary):       " |); M.read (| mk_str "
" |)
                            ]
                        |));
                      (* Unsize *)
                  ...
                  M.call_closure (|
                    ...
                    [
                      ...
                      M.pointer_coercion
                        (M.alloc (|
                          Value.Array
                            [ M.read (| mk_str "Base 8 (octal):        " |); M.read (| mk_str "
" |)
                            ]
                        |));
                      (* Unsize *)
                  ...
                  M.call_closure (|
                    ...
                    [
                      ...
                      M.pointer_coercion
                        (M.alloc (|
                          Value.Array
                            [ M.read (| mk_str "Base 16 (hexadecimal): " |); M.read (| mk_str "
" |)
                            ]
                        |));
                      (* Unsize *)
                ...
                [
                  M.call_closure (|
                    ...
                    [
                      ...
                      M.pointer_coercion
                        (M.alloc (|
                          Value.Array [ M.read (| mk_str "My name is Bond, James Bond
" |) ]
                        |));
                      (* Unsize *)
                      M.pointer_coercion
