                            ...
                            M.of_value (|
                              Value.Array
                                [
                                  A.to_value
                                    (M.read (|
                                      M.of_value (| Value.String "called `cool::function()`
" |)
                                    |))
                                ]
                            |)
                            ...
                            M.of_value (|
                              Value.Array
                                [
                                  A.to_value
                                    (M.read (|
                                      M.of_value (| Value.String "called `my::function()`
" |)
                                    |))
                                ]
                            |)
                                ...
                                Value.Array
                                  [
                                    A.to_value
                                      (M.read (|
                                        M.of_value (|
                                          Value.String "called `my::cool::function()`
"
                                        |)
                                      |))
                                  ]
  ...
  *)
  Definition indirect_call (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [] =>
      ltac:(M.monadic
        (M.read (|
