...
") in
        ...
        let* α5 :=
          M.call
            ...
            [ borrow (deref α4)[M.alloc ((Integer.of_Z 0) : Ty.path "usize")]
            ] in
...
") in
    ...
    let* _ :=
      ...
      let* α1 := M.call α0 [ pointer_coercion "Unsize" (borrow xs) ] in
      M.alloc α1 in
    let* _ :=
      let* _ :=
        let* α0 := M.var "std::io::stdio::_print" in
                        ...
                        let* α1 :=
                          M.call
                            (Ty.apply
                                (Ty.path "slice")
                                [ Ty.path "i32" ])::["get"]
                            [ pointer_coercion "Unsize" (borrow xs); α0 ] in
                        let* α2 := M.alloc α1 in
                        match_operator
                          α2
                          [
