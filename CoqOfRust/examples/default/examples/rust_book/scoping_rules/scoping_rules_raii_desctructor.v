                            ...
                            M.of_value (|
                              Value.Array
                                [
                                  A.to_value
                                    (M.read (|
                                      M.of_value (| Value.String "ToDrop is being dropped
" |)
                                    |))
                                ]
                            |)
  ...
  | [], [] =>
    ltac:(M.monadic
      (M.read (|
        let x :=
          M.alloc (|
            M.of_value (| Value.StructTuple "scoping_rules_raii_desctructor::ToDrop" [] |)
          |) in
        let _ :=
          let _ :=
            M.alloc (|
                        ...
                        M.alloc (|
                          M.of_value (|
                            Value.Array
                              [
                                A.to_value
                                  (M.read (| M.of_value (| Value.String "Made a ToDrop!
" |) |))
                              ]
                          |)
                        |)
