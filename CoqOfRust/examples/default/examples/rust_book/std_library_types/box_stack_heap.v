    ...
    | [], [ self; f ] =>
      ltac:(M.monadic
        ...
        M.call_closure (|
          ...
          [
            M.read (| f |);
            M.read (| M.of_value (| Value.String "Point" |) |);
...
*)
Definition boxed_origin (τ : list Ty.t) (α : list A.t) : M :=
  match τ, α with
  | [], [] =>
    ltac:(M.monadic
      (M.call_closure (|
                        ...
                        M.alloc (|
                          M.of_value (|
                            Value.Array
                              [
                                A.to_value
                                  (M.read (| M.of_value (| Value.String "Point occupies " |) |));
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String " bytes on the stack
" |)
                                  |))
                              ]
                          |)
                          ...
                          M.of_value (|
                            Value.Array
                              [
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String "Rectangle occupies " |)
                                  |));
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String " bytes on the stack
                          ...
                          M.of_value (|
                            Value.Array
                              [
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String "Boxed point occupies " |)
                                  |));
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String " bytes on the stack
                          ...
                          M.of_value (|
                            Value.Array
                              [
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String "Boxed rectangle occupies " |)
                                  |));
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String " bytes on the stack
                          ...
                          M.of_value (|
                            Value.Array
                              [
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String "Boxed box occupies " |)
                                  |));
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String " bytes on the stack
                          ...
                          M.of_value (|
                            Value.Array
                              [
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String "Unboxed point occupies " |)
                                  |));
                                A.to_value
                                  (M.read (|
                                    M.of_value (| Value.String " bytes on the stack
