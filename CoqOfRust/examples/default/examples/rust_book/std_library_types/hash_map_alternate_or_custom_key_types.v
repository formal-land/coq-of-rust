        ...
        let~ _ : Ty.tuple [] :=
          M.call_closure (|
            ...
            [
              ...
              |);
              M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| Value.String "j.everyman" |) |) |);
              M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| Value.String "psasword123" |) |) |)
            ]
          |) in
        let~ _ : Ty.tuple [] :=
          M.call_closure (|
            ...
            [
              ...
              |);
              M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| Value.String "j.everyman" |) |) |);
              M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| Value.String "password123" |) |) |)
            ]
          |) in
        M.alloc (| Value.Tuple [] |)
      |)))
