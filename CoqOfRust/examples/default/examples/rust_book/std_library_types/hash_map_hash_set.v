    ...
    let* a :=
      ...
      let* α5 :=
        M.call
          ...
          [ M.pointer_coercion "Unsize" α4 ] in
    ...
    let* _ :=
      let* α0 :=
        M.call
          ...
          [ a; Value.Integer Integer.I32 4 ] in
      let* α1 := M.alloc (UnOp.not α0) in
    ...
    let* _ :=
      let* α0 :=
        M.call
          ...
          [ b; Value.Integer Integer.I32 5 ] in
      M.alloc α0 in
    let* _ :=
      let* _ :=
...
") in
        ...
        let* α4 :=
          M.call (Ty.path "core::fmt::rt::Argument")::["new_debug"] [ a ] in
