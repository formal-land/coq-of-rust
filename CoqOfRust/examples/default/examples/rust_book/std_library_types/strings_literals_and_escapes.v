...
Definition main (𝜏 : list Ty.t) (α : list Value.t) : M :=
  match 𝜏, α with
  | [], [] =>
    let* byte_escape : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
...
") in
        ...
        M.alloc α6 in
      M.alloc tt in
    let* unicode_codepoint : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
      M.copy (mk_str (String.String "029" "")) in
    let* character_name : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
      M.copy (mk_str """DOUBLE-STRUCK CAPITAL R""") in
    let* _ : Ty.tuple :=
      let* _ : Ty.tuple :=
        let* α0 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "Unicode character ") in
        let* α1 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str " (U+211D) is called ") in
...
") in
        ...
        M.alloc α8 in
      M.alloc tt in
    let* long_string : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
      M.copy
        (mk_str
          "String literals
                        can span multiple lines.
