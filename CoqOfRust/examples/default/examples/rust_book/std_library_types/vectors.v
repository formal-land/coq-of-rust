    ...
    let* _ : Ty.tuple :=
      let* _ : Ty.tuple :=
        let* α0 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "Collected (0..10) into: ") in
...
") in
    ...
    let* _ : Ty.tuple :=
      let* _ : Ty.tuple :=
        let* α0 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "Initial vector: ") in
        let* α1 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "
") in
        let* α2 :
...
") in
    ...
    let* _ : Ty.tuple :=
      let* _ : Ty.tuple :=
        let* α0 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "Vector length: ") in
        let* α1 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "
") in
        let* α2 :
    ...
    let* _ : Ty.tuple :=
      let* _ : Ty.tuple :=
        let* α0 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "Second element: ") in
        let* α1 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "
") in
        let* α2 :
        ...
        let* α3 :
          ...
          ltac:(M.get_method (fun ℐ =>
            core.ops.index.Index.index
              ...
              (Idx := Ty.path "usize")
              (Trait := ℐ))) in
        let* α4 : Ty.apply (Ty.path "ref") [Ty.path "i32"] :=
    ...
    let* _ : Ty.tuple :=
      let* _ : Ty.tuple :=
        let* α0 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "Pop last element: ") in
        let* α1 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "
") in
        let* α2 :
...
") in
    ...
    let* _ : Ty.tuple :=
      ...
      let* α4 : Ty.apply (Ty.path "core::slice::iter::Iter") [Ty.path "i32"] :=
        M.call (α0 α3) in
      let* α5 : Ty.apply (Ty.path "core::slice::iter::Iter") [Ty.path "i32"] :=
        M.alloc α4 in
      let* α6 : Ty.tuple :=
        match_operator
          α5
...
") in
    ...
    let* _ : Ty.tuple :=
      let* _ : Ty.tuple :=
        let* α0 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "Updated vector: ") in
        let* α1 : Ty.apply (Ty.path "ref") [Ty.path "str"] :=
          M.read (mk_str "
") in
        let* α2 :
