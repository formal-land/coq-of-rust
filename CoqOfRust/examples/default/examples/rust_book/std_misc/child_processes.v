                  ...
                  M.use
                    (M.alloc (|
                      M.call_closure (|
                        ...
                        [
                          M.call_closure (|
                            M.get_struct_record_field "std::process::Output" "status",
                            [ output ]
                          |)
                        ]
                      |)
                    ...
                    M.call_closure (|
                      ...
                      [
                        M.call_closure (|
                          ...
                          [
                            M.call_closure (|
                              M.get_struct_record_field "std::process::Output" "stdout",
                              [ output ]
                            |)
                          ]
                        |)
                    ...
                    M.call_closure (|
                      ...
                      [
                        M.call_closure (|
                          ...
                          [
                            M.call_closure (|
                              M.get_struct_record_field "std::process::Output" "stderr",
                              [ output ]
                            |)
                          ]
                        |)
