...
Definition value_LOREM_IPSUM : A.t :=
  M.run
    ltac:(M.monadic
      (M.alloc (|
        M.of_value (|
        ...
        let path :=
          M.alloc (|
            M.call_closure (|
              ...
              [ M.read (| M.of_value (| Value.String "lorem_ipsum.txt" |) |) ]
            |)
          |) in
        let display :=
          M.alloc (|
                                    ...
                                    M.of_value (|
                                      Value.Array
                                        [
                                          A.to_value
                                            (M.read (|
                                              M.of_value (| Value.String "couldn't create " |)
                                            |));
                                          A.to_value
                                ...
                                M.of_value (|
                                  Value.Array
                                    [
                                      A.to_value
                                        (M.read (|
                                          M.of_value (| Value.String "couldn't write to " |)
                                        |));
                                ...
                                M.of_value (|
                                  Value.Array
                                    [
                                      A.to_value
                                        (M.read (|
                                          M.of_value (| Value.String "successfully wrote to " |)
                                        |));
                                      A.to_value (M.read (| M.of_value (| Value.String "
" |) |))
                                    ]
