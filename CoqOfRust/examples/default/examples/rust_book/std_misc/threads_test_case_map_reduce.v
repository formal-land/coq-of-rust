...
16278424637452589860345374828574668") in
    ...
    let* chunked_data :=
      ...
      let* α1 := M.read data in let* α2 := M.call_closure α0 [ α1 ] in M.alloc α2 in
    let* _ :=
      let* α0 :=
        M.get_trait_method
...
") in
                        ...
                        let* _ :=
                          ...
                          let* α1 :=
                            M.get_function
                              "std::thread::spawn"
                              [ Ty.function [ Ty.tuple [] ] (Ty.path "u32"); Ty.path "u32" ] in
                          let* α2 :=
                            M.call_closure
                              α1
                              [
                      ...
                      fun γ =>
                        ...
                        let* α1 :=
                          M.get_associated_function
                            ...
                            [] in
                        let* α2 := M.read c in
                        let* α3 := M.call_closure α1 [ α2 ] in M.call_closure α0 [ α3 ]
                    ]
                | _ => M.impossible
                end)
          ] in
