      ...
      ltac:(M.monadic
        ...
        M.call_closure (|
          ...
          [
            ...
            M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| Value.String "Unit" |) |) |)
          ]
        |)))
    ...
    | [], [], [ self; f ] =>
      ltac:(M.monadic
        ...
        M.call_closure (|
          ...
          [
            M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| f |) |) |);
            M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| Value.String "Pair" |) |) |);
            M.borrow (|
              Pointer.Kind.Ref,
              M.deref (|
                M.borrow (|
...
Definition main (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [], [] =>
    ltac:(M.monadic
      (M.read (|
        let~ unit_ : Ty.path "clone::Unit" := M.alloc (| Value.StructTuple "clone::Unit" [] |) in
        let~ copied_unit : Ty.path "clone::Unit" := M.copy (| unit_ |) in
        let~ _ : Ty.tuple [] :=
          let~ _ : Ty.tuple [] :=
            M.alloc (|
              M.call_closure (|
...
" |)
            ...
            |) in
          M.alloc (| Value.Tuple [] |) in
        let~ moved_pair : Ty.path "clone::Pair" := M.copy (| pair_ |) in
        let~ _ : Ty.tuple [] :=
          let~ _ : Ty.tuple [] :=
            M.alloc (|
              M.call_closure (|
