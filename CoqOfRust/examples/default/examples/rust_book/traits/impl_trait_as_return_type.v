...
*)
Definition combine_vecs_explicit_return_type (τ : list Ty.t) (α : list A.t) : M :=
  match τ, α with
  | [], [ v; u ] =>
    ltac:(M.monadic
      (let v := M.alloc (| v |) in
...
*)
Definition combine_vecs (τ : list Ty.t) (α : list A.t) : M :=
  match τ, α with
  | [], [ v; u ] =>
    ltac:(M.monadic
      (let v := M.alloc (| v |) in
                    ...
                    [
                      ...
                      M.pointer_coercion (|
                        M.alloc (|
                          M.of_value (|
                            Value.Array
                              [ A.to_value (M.read (| M.of_value (| Value.String "all done
" |) |))
                              ]
                          |)
                        |)
