...
Definition main (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [], [] =>
    ltac:(M.monadic
      (M.read (|
        let~ shadowed_binding : Ty.path "i32" := M.alloc (| Value.Integer IntegerKind.I32 1 |) in
        let~ _ : Ty.tuple [] :=
          let~ _ : Ty.tuple [] :=
            let~ _ : Ty.tuple [] :=
              M.alloc (|
...
" |)
            ...
            |) in
          M.alloc (| Value.Tuple [] |) in
        let~ shadowed_binding : Ty.path "i32" := M.alloc (| Value.Integer IntegerKind.I32 2 |) in
        let~ _ : Ty.tuple [] :=
          let~ _ : Ty.tuple [] :=
            M.alloc (|
              M.call_closure (|
...
Global Instance Instance_IsFunction_main : M.IsFunction.Trait "variable_shadowing::main" main.
Admitted.
