...
"
        ...
        let* α11 :
            ltac:(refine (M.Val scoping_rules_borrowing_aliasing.Point.t)) :=
          deref mutable_borrow in
        let* α12 : ltac:(refine (M.Val (ref i32.t))) := borrow α11.["z"] in
