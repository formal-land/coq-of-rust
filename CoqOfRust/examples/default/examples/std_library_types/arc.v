        ...
        loop
          (let* _ : M.Val unit :=
            ...
            | core.option.Option.Some _ =>
              let* apple : M.Val (alloc.sync.Arc.t (ref str.t)) :=
                let* α0 : ref (alloc.sync.Arc.t (ref str.t)) := borrow apple in
                let* α1 : alloc.sync.Arc.t (ref str.t) :=
...
" ] in
                        ...
                        let* α5 : ref (alloc.sync.Arc.t (ref str.t)) :=
                          borrow apple in
  ...
  let* _ : M.Val unit :=
    ...
    let* α2 : core.time.Duration.t := core.time.Duration.t::["from_secs"] α1 in
