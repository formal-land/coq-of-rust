...
") in
      ...
      let* α6 : core.fmt.rt.Argument.t :=
        M.call
          (impl core.fmt.rt.Argument.t "new_debug" (borrow optional_float)) in
      let* α7 : core.option.Option.t f32.t := M.read optional_float in
      let* α8 : f32.t :=
        M.call (impl (core.option.Option.t f32.t) "unwrap" α7) in
...
") in
      ...
      let* α5 : ref (slice (ref str.t)) :=
        M.read (pointer_coercion "Unsize" α4) in
      let* α6 : core.fmt.rt.Argument.t :=
        M.call (impl core.fmt.rt.Argument.t "new_debug" (borrow none)) in
      let* α7 : core.option.Option.t i32.t := M.read none in
      let* α8 : i32.t :=
        M.call (impl (core.option.Option.t i32.t) "unwrap" α7) in
