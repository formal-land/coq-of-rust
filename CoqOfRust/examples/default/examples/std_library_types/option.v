...
" ] in
        ...
        let* α6 : ltac:(refine (M.Val (ref i32.t))) := borrow divisor in
...
" ] in
        ...
        let* α7 := core.fmt.rt.Argument.t::["new_display"] α6 in
        let* α8 : ltac:(refine (M.Val core.fmt.rt.Argument.t)) := M.alloc α7 in
        let* α9 : ltac:(refine (M.Val (ref i32.t))) := borrow quotient in
...
" ] in
        ...
        let* α7 : ltac:(refine (M.Val f32.t)) := M.alloc α6 in
        let* α8 : ltac:(refine (M.Val (ref f32.t))) := borrow α7 in
