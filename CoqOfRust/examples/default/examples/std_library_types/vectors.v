    ...
    let* _ : ltac:(refine (M.Val unit)) :=
      ...
      let* α7 :=
        (core.iter.traits.collect.IntoIterator.into_iter
            ...
            (Trait := ltac:(refine _)))
          α6 in
      let* α8 : ltac:(refine (M.Val (core.slice.iter.Iter.t i32.t))) :=
        M.alloc α7 in
      let* α9 := M.read α8 in
      let* α10 : ltac:(refine (M.Val unit)) :=
        match α9 with
        | iter =>
...
" ] in
    ...
    let* _ : ltac:(refine (M.Val unit)) :=
      ...
      let* α12 : ltac:(refine (M.Val unit)) :=
        match α11 with
        | iter =>
          let* iter := M.alloc iter in
          loop
    ...
    let* _ : ltac:(refine (M.Val unit)) :=
      ...
      let* α1 :=
        (core.ops.deref.DerefMut.deref_mut
            ...
            (Trait := ltac:(refine _)))
          α0 in
      let* α2 : ltac:(refine (M.Val (mut_ref (slice i32.t)))) := M.alloc α1 in
      let* α3 : ltac:(refine (M.Val (slice i32.t))) := deref α2 in
      let* α4 : ltac:(refine (M.Val (mut_ref (slice i32.t)))) :=
        borrow_mut α3 in
      let* α5 := (slice i32.t)::["iter_mut"] α4 in
      let* α6 : ltac:(refine (M.Val (core.slice.iter.IterMut.t i32.t))) :=
        M.alloc α5 in
      let* α7 :=
        (core.iter.traits.collect.IntoIterator.into_iter
            ...
            (Trait := ltac:(refine _)))
          α6 in
      let* α8 : ltac:(refine (M.Val (core.slice.iter.IterMut.t i32.t))) :=
        M.alloc α7 in
      let* α9 := M.read α8 in
      let* α10 : ltac:(refine (M.Val unit)) :=
        match α9 with
