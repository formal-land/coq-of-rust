...
Definition echo
  ...
  M.catch_return
    ...
    let* α1 : ref (slice u8.t) := str.t::["as_bytes"] α0 in
...
" ] in
                    ...
                    let* α6 : std.path.PathBuf.t :=
                      std.fs.DirEntry.t::["path"] (borrow α5) in
