...
Definition main : M unit :=
  M.function_body
    ...
    let* new_path : ltac:(refine (M.Val std.path.PathBuf.t)) :=
      ...
      let* α3 : ltac:(refine (M.Val std.path.PathBuf.t)) := M.alloc α2 in
      let* α4 : ltac:(refine (M.Val (ref std.path.PathBuf.t))) := borrow α3 in
      let* α5 :=
        (core.ops.deref.Deref.deref
            (Self := std.path.PathBuf.t)
            (Trait := ltac:(refine _)))
          α4 in
      let* α6 : ltac:(refine (M.Val (ref std.path.Path.t))) := M.alloc α5 in
      let* α7 : ltac:(refine (M.Val std.path.Path.t)) := deref α6 in
      let* α8 : ltac:(refine (M.Val (ref std.path.Path.t))) := borrow α7 in
    ...
    let* α1 :=
      (core.ops.deref.Deref.deref
          ...
          (Trait := ltac:(refine _)))
        α0 in
    let* α2 : ltac:(refine (M.Val (ref std.path.Path.t))) := M.alloc α1 in
    ...
    let* α6 : ltac:(refine (M.Val (core.option.Option.t (ref str.t)))) :=
      M.alloc α5 in
    let* α7 := M.read α6 in
    match α7 with
