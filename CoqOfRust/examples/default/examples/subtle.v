    ...
    | [], [ self; f ] =>
      ltac:(M.monadic
        ...
        M.call_closure (|
          ...
          [
            M.read (| f |);
            M.read (| M.of_value (| Value.String "Choice" |) |);
            (* Unsize *)
            M.pointer_coercion (|
              M.alloc (|
...
Module Impl_subtle_Choice.
  ...
  *)
  Definition unwrap_u8 (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| self |) in
...
Module ConstantTimeEq.
  Definition ct_ne (Self : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ self; other ] =>
      ltac:(M.monadic
        (let self := M.alloc (| self |) in
...
Module Impl_subtle_ConstantTimeEq_where_subtle_ConstantTimeEq_T_for_slice_T.
  ...
  *)
  Definition ct_eq (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
...
Module Impl_subtle_ConstantTimeEq_for_subtle_Choice.
  ...
  *)
  Definition ct_eq (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ self; rhs ] =>
      ltac:(M.monadic
        (let self := M.alloc (| self |) in
...
Module ConditionallySelectable.
  Definition conditional_assign (Self : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ self; other; choice ] =>
      ltac:(M.monadic
        (let self := M.alloc (| self |) in
  ...
  Definition conditional_swap (Self : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ a; b; choice ] =>
      ltac:(M.monadic
        (let a := M.alloc (| a |) in
...
Module Impl_subtle_ConditionallySelectable_for_u8.
  ...
  *)
  Definition conditional_select (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ a; b; choice ] =>
      ltac:(M.monadic
        (let a := M.alloc (| a |) in
  ...
  *)
  Definition conditional_assign (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ self; other; choice ] =>
      ltac:(M.monadic
        (let self := M.alloc (| self |) in
  ...
  *)
  Definition conditional_swap (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ a; b; choice ] =>
      ltac:(M.monadic
        (let a := M.alloc (| a |) in
...
Module Impl_subtle_ConditionallyNegatable_where_subtle_ConditionallySelectable_T_where_core_ops_arith_Neg_ref__T_for_T.
  ...
  *)
  Definition conditional_negate (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self T in
    match τ, α with
    | [], [ self; choice ] =>
      ltac:(M.monadic
    ...
    | [], [ self; f ] =>
      ltac:(M.monadic
        ...
        M.call_closure (|
          ...
          [
            M.read (| f |);
            M.read (| M.of_value (| Value.String "CtOption" |) |);
            ...
            M.pointer_coercion (|
              ...
              |)
            |);
            M.read (| M.of_value (| Value.String "is_some" |) |);
            (* Unsize *)
            M.pointer_coercion (|
              M.alloc (|
                M.SubPointer.get_struct_record_field (|
...
Module Impl_subtle_CtOption_T.
        ...
        M.of_value (|
          Value.StructRecord
            ...
            [
              ...
              ("is_some", A.to_value (M.read (| is_some |)))
            ]
        |)))
    | _, _ => M.impossible
    end.
  ...
  *)
  Definition expect (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self T in
    match τ, α with
    | [], [ self; msg ] =>
      ltac:(M.monadic
                    ...
                    [
                      A.to_value
                        (M.alloc (|
                          ...
                          |)
                        |));
                      A.to_value (M.alloc (| M.of_value (| Value.Integer 1 |) |))
                    ]
                |)
              |),
              [
  ...
  *)
  Definition unwrap (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self T in
    match τ, α with
    | [], [ self ] =>
      ltac:(M.monadic
  ...
  *)
  Definition unwrap_or (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self T in
    match τ, α with
    | [], [ self; def ] =>
      ltac:(M.monadic
  ...
  *)
  Definition unwrap_or_else (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self T in
    match τ, α with
    | [ F ], [ self; f ] =>
      ltac:(M.monadic
  ...
  *)
  Definition is_some (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self T in
    match τ, α with
    | [], [ self ] =>
      ltac:(M.monadic
  ...
  *)
  Definition is_none (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self T in
    match τ, α with
    | [], [ self ] =>
      ltac:(M.monadic
  ...
  *)
  Definition and_then (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self T in
    match τ, α with
    | [ U; F ], [ self; f ] =>
      ltac:(M.monadic
  ...
  *)
  Definition or_else (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self T in
    match τ, α with
    | [ F ], [ self; f ] =>
      ltac:(M.monadic
...
Module Impl_subtle_ConditionallySelectable_where_subtle_ConditionallySelectable_T_for_subtle_CtOption_T.
  ...
  *)
  Definition conditional_select (T : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    let Self : Ty.t := Self T in
    match τ, α with
    | [], [ a; b; choice ] =>
      ltac:(M.monadic
...
Module Impl_subtle_ConstantTimeGreater_for_u8.
  ...
  *)
  Definition ct_gt (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ self; other ] =>
      ltac:(M.monadic
        (let self := M.alloc (| self |) in
        ...
        M.read (|
          ...
          let ltb :=
            M.alloc (|
              ...
              |)
            |) in
          let pow := M.alloc (| M.of_value (| Value.Integer 1 |) |) in
          let _ :=
            M.loop (|
              ltac:(M.monadic
                (M.match_operator (|
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        (let γ :=
                          M.use
                            (M.alloc (|
                              BinOp.Pure.lt (| M.read (| pow |), M.of_value (| Value.Integer 8 |) |)
                            |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        let _ :=
            ...
            M.call_closure (|
              ...
              [
                M.read (|
                  M.use
                    (M.alloc (|
                      BinOp.Pure.bit_and (| M.read (| bit |), M.of_value (| Value.Integer 1 |) |)
                    |))
                |)
              ]
            |)
...
Module ConstantTimeLess.
  Definition ct_lt (Self : Ty.t) (τ : list Ty.t) (α : list A.t) : M :=
    match τ, α with
    | [], [ self; other ] =>
      ltac:(M.monadic
        (let self := M.alloc (| self |) in
