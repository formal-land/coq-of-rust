...
Section Impl_core_cmp_PartialOrd_for_derive_Centimeters_t.
  ...
  *)
  Definition partial_cmp
    ...
    let* α3 : ref derive.Centimeters.t := M.read other in
    let* α4 : M.Val derive.Centimeters.t := deref α3 in
    let* α5 : ref f64.t := borrow α4.["0"] in
    (core.cmp.PartialOrd.partial_cmp (Self := f64.t) (Trait := ltac:(refine _)))
      α2
      α5.
...
Section Impl_core_fmt_Debug_for_derive_Inches_t.
  ...
  *)
  Definition fmt
    ...
    let* α3 : M.Val derive.Inches.t := deref α2 in
...
" ] in
      ...
      let* α5 : ref derive.Inches.t := borrow foot in
  ...
  let* cmp : M.Val (ref str.t) :=
    ...
    let* α1 : derive.Centimeters.t := derive.Inches.t::["to_centimeters"] α0 in
...
" ] in
      ...
      let* α3 : M.Val (ref (slice (ref str.t))) :=
        pointer_coercion "Unsize" α2 in
      let* α4 : ref (slice (ref str.t)) := M.read α3 in
      let* α5 : ref (ref str.t) := borrow cmp in
      let* α6 : core.fmt.rt.Argument.t :=
