...
" ] in
  ...
  let* array : M.Val (array u32.t) :=
    ...
    let* α1 : M.Val u32.t := M.alloc (Integer.of_Z 3) in
    let* α2 : M.Val u32.t := M.alloc (Integer.of_Z 3) in
    let* α3 : M.Val u32.t := M.alloc (Integer.of_Z 7) in
...
" ] in
      ...
      let* α4 : core.fmt.rt.Argument.t :=
        core.fmt.rt.Argument.t::["new_debug"] (borrow α3) in
  ...
  let* α2 : core.slice.iter.Iter.t u32.t := (slice u32.t)::["iter"] α1 in
