...
Definition fibonacci : M iterators.Fibonacci.t :=
  ...
  M.pure {| iterators.Fibonacci.curr := α1; iterators.Fibonacci.next := α3; |}.
...
" ] in
      ...
      let* α3 : M.Val (ref (slice (ref str.t))) :=
        pointer_coercion "Unsize" α2 in
      let* α4 : ref (slice (ref str.t)) := M.read α3 in
      let* α5 : mut_ref (core.ops.range.Range.t i32.t) := borrow_mut sequence in
...
" ] in
  ...
  let* α6 : M.Val unit :=
    ...
    | iter =>
      ...
      loop
        (let* _ : M.Val unit :=
          let* α0 : mut_ref (core.slice.iter.Iter.t u32.t) := borrow_mut iter in
