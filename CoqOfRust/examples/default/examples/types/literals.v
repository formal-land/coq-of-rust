...
" ] in
      ...
      let* α3 : usize.t := core.mem.size_of_val (borrow x) in
...
" ] in
      ...
      let* α2 : ref (slice (ref str.t)) :=
        M.read (pointer_coercion "Unsize" α1) in
      let* α3 : usize.t := core.mem.size_of_val (borrow y) in
      let* α4 : M.Val usize.t := M.alloc α3 in
      let* α5 : core.fmt.rt.Argument.t :=
        core.fmt.rt.Argument.t::["new_display"] (borrow α4) in
      let* α6 : M.Val core.fmt.rt.Argument.t := M.alloc α5 in
...
" ] in
      ...
      let* α2 : ref (slice (ref str.t)) :=
        M.read (pointer_coercion "Unsize" α1) in
      let* α3 : usize.t := core.mem.size_of_val (borrow z) in
      let* α4 : M.Val usize.t := M.alloc α3 in
      let* α5 : core.fmt.rt.Argument.t :=
        core.fmt.rt.Argument.t::["new_display"] (borrow α4) in
      let* α6 : M.Val core.fmt.rt.Argument.t := M.alloc α5 in
...
" ] in
      ...
      let* α2 : ref (slice (ref str.t)) :=
        M.read (pointer_coercion "Unsize" α1) in
      let* α3 : usize.t := core.mem.size_of_val (borrow i) in
      let* α4 : M.Val usize.t := M.alloc α3 in
      let* α5 : core.fmt.rt.Argument.t :=
        core.fmt.rt.Argument.t::["new_display"] (borrow α4) in
      let* α6 : M.Val core.fmt.rt.Argument.t := M.alloc α5 in
...
" ] in
      ...
      let* α2 : ref (slice (ref str.t)) :=
        M.read (pointer_coercion "Unsize" α1) in
      let* α3 : usize.t := core.mem.size_of_val (borrow f) in
      let* α4 : M.Val usize.t := M.alloc α3 in
      let* α5 : core.fmt.rt.Argument.t :=
        core.fmt.rt.Argument.t::["new_display"] (borrow α4) in
      let* α6 : M.Val core.fmt.rt.Argument.t := M.alloc α5 in
