...
(** @TODO ink depds, use ink_env!? *)
Module ink_storage_traits.
  Module storage.
    Module AutoStorableHint.
      Parameter Type_ : Set.
      
      Global Instance Default_impl_for_Type_ {T : Set} : core.default.Default.Trait Type_ (T := T). Admitted.
    End AutoStorableHint.
  End storage.
End ink_storage_traits.
    ...
    Module dispatch.
      ...
      Module DispatchableConstructorInfo.
        Class Trait (Self : Set) : Set := {
            ...
            CALLABLE : ink_storage_traits.storage.AutoStorableHint.Type_ -> M Self;
            PAYABLE : bool;
            SELECTOR : list Z;
            LABEL : string;
          }.
...
Module erc20.
  ...
  Definition MAX_EVENT_TOPICS : M usize :=
  ...
  Module Impl_core_default_Default_for_erc20_erc20_Erc20.
    ...
    Definition default (_ : unit) : M erc20.Erc20 :=
  ...
  Module Transfer.
    Record t : Set := {
      from : core.option.Option erc20.AccountId;
      to : core.option.Option erc20.AccountId;
      value : erc20.Balance;
    }.
  ...
  Module Approval.
    Record t : Set := {
      owner : erc20.AccountId;
      spender : erc20.AccountId;
      value : erc20.Balance;
    }.
  ...
  Module Impl_ink_codegen_event_topics_EventLenTopics_for_erc20_erc20_Approval.
    Definition Self := erc20.Approval.
  ...
  Module
    ...
    Definition Input : Set := erc20.Balance.
    
    Definition Output : Set := Self.
    
    Definition Storage : Set := erc20.Erc20.
    
    Definition Error : Set := ink.reflect.dispatch.ConstructorOutput.Error.
    
    Definition
      IS_RESULT := run (Pure ink.reflect.dispatch.ConstructorOutput.IS_RESULT).
    ...
    Global Instance Erc20_new_method : Notation.DoubleColon Erc20 "new" (T := ink_storage_traits.storage.AutoStorableHint.Type_ -> M Erc20). Admitted.
    
    Definition
      CALLABLE := Pure
        (fun __ink_binding_0 => erc20.Erc20::["new"] __ink_binding_0).
...
Module
  ...
  Global Instance I : ink.reflect.dispatch.DecodeDispatch.Trait Self := {
    ink.reflect.dispatch.DecodeDispatch.decode_dispatch := decode_dispatch;
  }.
End
  Impl_ink_reflect_dispatch_DecodeDispatch_for_erc20_erc20_____ink_ConstructorDecoder.
