  ...
  Module dispatch.
    Module execution.
      Definition deny_payment
        ...
        let* transferred := ink_env.api.transferred_value  in
        let* _ :=
...
Module env_access.
  ...
  Module Impl_ink_env_access_EnvAccess_E.
    ...
    Definition extension
      ...
      ink.chain_extension.ChainExtensionInstance.instantiate .
  ...
  Module Impl_ink_env_access_EnvAccess_E_2.
    ...
    Definition caller (self : Self) : M ImplE.AccountId := ink_env.api.caller .
    ...
    Definition gas_left (self : Self) : M u64 := ink_env.api.gas_left .
    ...
    Definition account_id (self : Self) : M ImplE.AccountId :=
      ink_env.api.account_id .
    
    Global Instance Method_account_id : Notation.Dot "account_id" := {
      Notation.dot := account_id;
    }.
    
    Definition balance (self : Self) : M ImplE.Balance := ink_env.api.balance .
    ...
    Definition hash_bytes
      ...
      let* output := ink_env.hash.HashOutput.Type::["default"]  in
