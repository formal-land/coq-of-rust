...
Module client.
  ...
  Module Impl_ink_e2e_client_CallResult_C_E_V.
    ...
    Global Instance Method_message_result `{State.Trait} :
      Notation.Dot "message_result" := {
      Notation.dot := message_result;
    }.
    
    Definition return_value `{State.Trait} (self : Self) : M V :=
    ...
    Definition return_data `{State.Trait} (self : ref Self) : M (ref Slice) :=
      let* α0 := self.["dry_run"].["exec_return_value"] in
      Pure (addr_of α0.["data"]).
    
    Global Instance Method_return_data `{State.Trait} :
    ...
    Global Instance Method_contains_event `{State.Trait} :
  ...
  Module Impl_ink_e2e_client_CallDryRunResult_E_V.
    ...
    Definition is_err `{State.Trait} (self : ref Self) : M bool :=
      self.["exec_result"].["result"].["is_err"].
    
    Global Instance Method_is_err `{State.Trait} : Notation.Dot "is_err" := {
      Notation.dot := is_err;
    }.
    ...
    Global Instance Method_exec_return_value `{State.Trait} :
  ...
  Section
    ...
    Global Instance I : subxt.events.StaticEvent.Trait Self := {
      subxt.events.StaticEvent.PALLET `{State.Trait} := PALLET;
      subxt.events.StaticEvent.EVENT `{State.Trait} := EVENT;
    }.
  End
    Impl_subxt_events_StaticEvent_for_ink_e2e_client_ContractInstantiatedEvent_E.
  End
  ...
  Module Impl_ink_e2e_client_Client_C_E.
    ...
    Global Instance Method_create_and_fund_account `{State.Trait} :
    ...
    Global Instance Method_instantiate_dry_run `{State.Trait} :
...
For a contract to be built, add it as a dependency to the `Cargo.toml`, or add the manifest path to `#[ink_e2e::test(additional_contracts = ..)]`"
    ...
    Global Instance Method_load_code `{State.Trait} :
    ...
    Global Instance Method_exec_instantiate `{State.Trait} :
      Notation.Dot "exec_instantiate" := {
      Notation.dot := exec_instantiate;
    }.
    
    Definition salt `{State.Trait} (_ : unit) : M (alloc.vec.Vec u8) :=
    ...
    Global Instance AssociatedFunction_salt `{State.Trait} :
    ...
    Global Instance Method_upload `{State.Trait} : Notation.Dot "upload" := {
      Notation.dot := upload;
    }.
    ...
    Global Instance Method_exec_upload `{State.Trait} :
    ...
    Global Instance Method_runtime_call `{State.Trait} :
    ...
    Global Instance Method_call_dry_run `{State.Trait} :
...
Module node_proc.
  ...
  Module Impl_ink_e2e_node_proc_TestNodeProcess_R.
    ...
    Global Instance Method_kill `{State.Trait} : Notation.Dot "kill" := {
      Notation.dot := kill;
    }.
    ...
    Global Instance Method_client `{State.Trait} : Notation.Dot "client" := {
      Notation.dot := client;
    }.
    
    Definition url `{State.Trait} (self : ref Self) : M (ref str) :=
      Pure (addr_of self.["url"]).
    
    Global Instance Method_url `{State.Trait} : Notation.Dot "url" := {
      Notation.dot := url;
    }.
  ...
  Module Impl_ink_e2e_node_proc_TestNodeProcessBuilder_R.
    ...
    Global Instance Method_with_authority `{State.Trait} :
      Notation.Dot "with_authority" := {
      Notation.dot := with_authority;
    }.
    
    Definition spawn `{State.Trait} (self : ref Self) : M OpaqueDef :=
      Pure
        (fun _task_context =>
          let self := self in
          let* cmd :=
    ...
    Global Instance Method_spawn `{State.Trait} : Notation.Dot "spawn" := {
      Notation.dot := spawn;
    }.
...
Module xts.
  ...
  Module Impl_core_clone_Clone_for_ink_e2e_xts_Weight.
    ...
    Definition clone `{State.Trait} (self : ref Self) : M ink_e2e.xts.Weight :=
      let _ := tt in
      self.["deref"].
  ...
  Module Impl_core_default_Default_for_ink_e2e_xts_Weight.
    ...
    Definition default `{State.Trait} (_ : unit) : M ink_e2e.xts.Weight :=
      let* α0 := core.default.Default.default tt in
  ...
  Module Impl_core_convert_From_for_sp_weights_weight_v2_Weight.
    ...
    Definition from `{State.Trait} (weight : ink_e2e.xts.Weight) : M Self :=
  ...
  Module Impl_ink_e2e_xts_ContractsApi_C_E.
    ...
    Global Instance Method_try_transfer_balance `{State.Trait} :
    ...
    Global Instance Method_instantiate_with_code_dry_run `{State.Trait} :
    ...
    Global Instance Method_submit_extrinsic `{State.Trait} :
    ...
    Global Instance Method_instantiate_with_code `{State.Trait} :
    ...
    Global Instance Method_upload_dry_run `{State.Trait} :
...
Module Impl_serde_ser_Serialize_for_ink_e2e_xts_Weight.
  ...
  Global Instance Method_serialize `{State.Trait} :
    Notation.Dot "serialize" := {
    Notation.dot := serialize;
  }.
  
  Global Instance I : serde.ser.Serialize.Trait Self := {
    serde.ser.Serialize.serialize `{State.Trait} := serialize;
  }.
...
Module Impl_serde_de_Visitor_for_ink_e2e_xts___deserialize___FieldVisitor.
  ...
  Global Instance Method_visit_u64 `{State.Trait} :
  ...
  Global Instance Method_visit_str `{State.Trait} :
  ...
  Global Instance Method_visit_bytes `{State.Trait} :
    Notation.Dot "visit_bytes" := {
    Notation.dot := visit_bytes;
  }.
  
  Global Instance I : serde.de.Visitor.Trait Self := {
    serde.de.Visitor.expecting `{State.Trait} := expecting;
  }.
...
Module Impl_serde_de_Visitor_for_ink_e2e_xts___deserialize___Visitor.
  ...
  Global Instance Method_visit_seq `{State.Trait} :
  ...
  Global Instance Method_visit_map `{State.Trait} :
...
Definition __init
    `{State.Trait}
    (_ : unit)
    : M (core.cell.RefCell alloc.string.String) :=
...
Definition log_prefix `{State.Trait} (_ : unit) : M alloc.string.String :=
  ink_e2e.LOG_PREFIX.["with"]
    (fun log_prefix =>
      let* α0 := log_prefix.["borrow"] in
      α0.["clone"]).

Definition log_info `{State.Trait} (msg : ref str) : M unit :=
  let* _ :=
    let* enabled :=
      let* α0 :=
        tracing_core.metadata.Level::["INFO"].["le"]
...
Definition log_error `{State.Trait} (msg : ref str) : M unit :=
  let* _ :=
    let* enabled :=
      let* α0 :=
        tracing_core.metadata.Level::["ERROR"].["le"]
