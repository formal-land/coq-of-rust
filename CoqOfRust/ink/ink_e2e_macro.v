...
Module codegen.
  ...
  Definition set_already_built_contracts
    ...
    let* _ :=
      ink_e2e_macro.codegen.ALREADY_BUILT_CONTRACTS.["with"]
        (fun metadata_paths =>
          let* _ :=
            let* α0 := metadata_paths.["borrow_mut"] in
            let* α1 := α0.["deref"] in
            assign α1 hash_map in
          Pure tt) in
    Pure tt.
          ...
          let* _ :=
            ink_e2e_macro.codegen.BUILD_ONCE.["call_once"]
              (fun  =>
                ...
                let* _ :=
                  let* α0 := contracts_to_build_and_import.["into_iter"] in
                  match α0 with
                  | iter =>
                    loop
                      (let* _ :=
                        ...
                        | core.option.Option.Some manifest_path =>
                          let* dest_wasm :=
          ...
          if (α0 : bool) then
            ...
            let* α1 :=
              LanguageItem.format_placeholder::["new"]
                ...
                LanguageItem.format_count::["Implied"] in
            let* α2 :=
              LanguageItem.format_placeholder::["new"]
                0
                " "%char
  ...
  Module Impl_ink_e2e_macro_codegen_ContractManifests.
    ...
    Definition from_cargo_metadata `{H : State.Trait} : M (H := H) Self :=
            ...
            (let* _ :=
              ...
              | core.option.Option.Some arg =>
                ...
                if (α0 : bool) then
                  ...
                  if (α0 : bool) then
                    let* _ :=
                      match additional_contracts with
