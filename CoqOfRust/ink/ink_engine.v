...
Module ext.
  ...
  Module Impl_ink_engine_ext_Engine.
    ...
    Definition new  : M Self :=
      let* α0 := ink_engine.database.Database::["new"]  in
      let* α1 := ink_engine.exec_context.ExecContext::["new"]  in
      let* α2 := ink_engine.test_api.DebugInfo::["new"]  in
      let* α3 := ink_engine.ext.ChainSpec::["default"]  in
      let* α4 := ink_engine.chain_extension.ChainExtensionHandler::["new"]  in
      Pure
        {|
          Self.database := α0;
...
Module test_api.
  ...
  Module Impl_ink_engine_test_api_DebugInfo.
    ...
    Definition new  : M Self :=
      let* α0 := alloc.vec.Vec::["new"]  in
      let* α1 := ink_engine.test_api.RecordedDebugMessages::["new"]  in
      let* α2 := std.collections.hash.map.HashMap::["new"]  in
      let* α3 := std.collections.hash.map.HashMap::["new"]  in
      let* α4 := std.collections.hash.map.HashMap::["new"]  in
      Pure
        {|
        ...
        let* α1 :=
          α0.["and_modify"]
            (fun hm =>
              ...
              Pure tt) in
        let* hm := std.collections.hash.map.HashMap::["new"]  in
...
Module chain_extension.
  ...
  Module
    ...
    Definition default  : M Self :=
      ink_engine.chain_extension.ChainExtensionHandler::["new"] .
...
Module exec_context.
  ...
  Module Impl_ink_engine_exec_context_ExecContext.
    ...
    Definition new  : M Self := core.default.Default.default .
...
Module hashing.
  Definition blake2b_256
      ...
      (output : mut_ref list u8)
      : M unit :=
    let* blake2 := ink_engine.hashing.blake2b_256.Blake2b256::["new"]  in
  ...
  Definition blake2b_128
      ...
      (output : mut_ref list u8)
      : M unit :=
    let* blake2 := ink_engine.hashing.blake2b_128.Blake2b128::["new"]  in
    let* _ := blake2.["update"] input in
    let* result := blake2.["finalize"] in
    let* _ := output.["copy_from_slice"] (addr_of result) in
    Pure tt.
  ...
  Definition keccak_256
      ...
      (output : mut_ref list u8)
      : M unit :=
    let* hasher := sha3.Keccak256::["new"]  in
