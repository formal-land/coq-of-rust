...
Module air.
  ...
  Module AirBuilder.
    ...
    Definition assert_bool
      ...
      | [], [ _ as I ], [ self; x ] =>
        ltac:(M.monadic
          ...
          let x := M.alloc (| I, x |) in
          M.read (|
            let~ x : Ty.associated_in_trait "p3_air::air::AirBuilder" [] [] Self "Expr" :=
              M.call_closure (|
                Ty.associated_in_trait "p3_air::air::AirBuilder" [] [] Self "Expr",
                M.get_trait_method (|
                  "core::convert::Into",
    ...
    Axiom ProvidedMethod_assert_tern :
      M.IsProvidedMethod "p3_air::air::AirBuilder" "assert_tern" assert_tern.
  End AirBuilder.
            ...
            [
              ...
              M.call_closure (|
                ...
                M.pointer_coercion
                  ...
                  (Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "&mut") [] [ AB ] ])
                  (Ty.apply (Ty.path "&") [] [ Ty.dyn [ ("core::fmt::Debug::Trait", []) ] ]),
                [
                  M.borrow (|
                    Pointer.Kind.Ref,
