...
Module file_format_common.
  ...
  *)
  ...
  Module Impl_move_binary_format_file_format_common_BinaryConstants.
    ...
    Definition value_MOVE_MAGIC : Value.t :=
      M.run
        ltac:(M.monadic
          (M.alloc (|
            Value.Array [ Value.Integer 161; Value.Integer 28; Value.Integer 235; Value.Integer 11 ]
          |))).
        ...
        ltac:(M.monadic
          (M.alloc (|
            BinOp.Wrap.add
              Integer.Usize
              (M.read (|
                M.get_constant (| "move_binary_format::file_format_common::MOVE_MAGIC_SIZE" |)
              |))
              (Value.Integer 5)
          |))).
  ...
  Definition value_TABLE_OFFSET_MAX : Value.t :=
    M.run ltac:(M.monadic (M.alloc (| Value.Integer 4294967295 |))).
  ...
  Definition value_TABLE_INDEX_MAX : Value.t :=
    M.run ltac:(M.monadic (M.alloc (| Value.Integer 65535 |))).
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MODULE_HANDLES" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "STRUCT_HANDLES" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "FUNCTION_HANDLES" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "FUNCTION_INST" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "SIGNATURES" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "CONSTANT_POOL" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "IDENTIFIERS" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "ADDRESS_IDENTIFIERS" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "STRUCT_DEFS" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "STRUCT_DEF_INST" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "FUNCTION_DEFS" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "FIELD_HANDLE" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "FIELD_INST" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "FRIEND_DECLS" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "METADATA" |) |)))
                  ]
                |)
              |)
            ]
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "BOOL" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "ADDRESS" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "REFERENCE" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MUTABLE_REFERENCE" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "STRUCT" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "TYPE_PARAMETER" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "VECTOR" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "STRUCT_INST" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "SIGNER" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "U256" |) |)))
                  ]
                |)
              |)
            ]
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "NATIVE" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "DECLARED" |) |)))
                  ]
                |)
              |)
            ]
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "POP" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "RET" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "BR_TRUE" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "BR_FALSE" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "BRANCH" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "LD_U64" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "LD_CONST" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "LD_TRUE" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "LD_FALSE" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "COPY_LOC" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MOVE_LOC" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "ST_LOC" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MUT_BORROW_LOC" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "IMM_BORROW_LOC" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MUT_BORROW_FIELD" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "IMM_BORROW_FIELD" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "PACK" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "UNPACK" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "READ_REF" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "WRITE_REF" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "BIT_OR" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "BIT_AND" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "XOR" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "ABORT" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "NOP" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "FREEZE_REF" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "SHL" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "SHR" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "LD_U8" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "LD_U128" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "CAST_U8" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "CAST_U64" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "CAST_U128" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MUT_BORROW_FIELD_GENERIC" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "IMM_BORROW_FIELD_GENERIC" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "CALL_GENERIC" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "PACK_GENERIC" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "UNPACK_GENERIC" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "VEC_PACK" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "VEC_LEN" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "VEC_IMM_BORROW" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "VEC_MUT_BORROW" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "VEC_PUSH_BACK" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "VEC_POP_BACK" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "VEC_UNPACK" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "VEC_SWAP" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "LD_U16" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "LD_U32" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "LD_U256" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "CAST_U16" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "CAST_U32" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "CAST_U256" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "EXISTS_DEPRECATED" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MUT_BORROW_GLOBAL_DEPRECATED" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "IMM_BORROW_GLOBAL_DEPRECATED" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MOVE_FROM_DEPRECATED" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MOVE_TO_DEPRECATED" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "EXISTS_GENERIC_DEPRECATED" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MOVE_FROM_GENERIC_DEPRECATED" |) |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                        let _ :=
                          ...
                          |) in
                        M.alloc (| M.read (| Value.String "MOVE_TO_GENERIC_DEPRECATED" |) |)))
                  ]
                |)
              |)
            ]
            ...
            (M.read (|
              let~ _ :=
                M.loop (|
                  ltac:(M.monadic
                    (let~ cur :=
                      M.alloc (| BinOp.Pure.bit_and (M.read (| val |)) (Value.Integer 127) |) in
                    M.match_operator (|
                      M.alloc (| Value.Tuple [] |),
                      [
                        fun γ =>
                          ltac:(M.monadic
                            (let γ :=
                              M.use
                                (M.alloc (|
                                  BinOp.Pure.ne (M.read (| cur |)) (M.read (| val |))
                                |)) in
                            let _ :=
                              M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                            let~ _ :=
                            ...
                            let~ _ :=
                              let β := val in
                              M.write (| β, BinOp.Wrap.shr (M.read (| β |)) (Value.Integer 7) |) in
                            M.alloc (| Value.Tuple [] |)));
                        fun γ =>
                          ltac:(M.monadic
                            (M.alloc (|
    ...
    | [], [], [ cursor ] =>
      ltac:(M.monadic
        ...
        M.catch_return (|
          ltac:(M.monadic
            (M.read (|
              let~ buf := M.alloc (| repeat (| Value.Integer 0, Value.Integer 1 |) |) in
              let~ _ :=
                M.match_operator (|
                  M.alloc (|
                    M.call_closure (|
              ...
              M.alloc (|
                Value.StructTuple
                  ...
                  [
                    M.read (|
                      M.SubPointer.get_array_field (| buf, M.alloc (| Value.Integer 0 |) |)
                    |)
                  ]
              |)
            |)))
    ...
    | [], [], [ cursor ] =>
      ltac:(M.monadic
        ...
        M.catch_return (|
          ltac:(M.monadic
            (M.read (|
              let~ buf := M.alloc (| repeat (| Value.Integer 0, Value.Integer 4 |) |) in
              let~ _ :=
                M.match_operator (|
                  M.alloc (|
                    M.call_closure (|
  ...
  *)
      ...
      ltac:(M.monadic
        ...
        M.catch_return (|
          ltac:(M.monadic
            (M.never_to_any (|
              M.read (|
                let~ value := M.alloc (| Value.Integer 0 |) in
                let~ shift := M.alloc (| Value.Integer 0 |) in
                let~ _ :=
                  M.loop (|
                    ltac:(M.monadic
                      (M.match_operator (|
                          ...
                          fun γ =>
                            ltac:(M.monadic
                              ...
                              let~ cur :=
                                M.alloc (|
                                  M.rust_cast
                                    (BinOp.Pure.bit_and (M.read (| byte |)) (Value.Integer 127))
                                |) in
                              let~ _ :=
                                M.match_operator (|
                                  M.alloc (| Value.Tuple [] |),
                              ...
                              let~ _ :=
                                ...
                                M.write (|
                                  β,
                                  BinOp.Wrap.add Integer.U32 (M.read (| β |)) (Value.Integer 7)
                                |) in
                              M.match_operator (|
                                M.alloc (| Value.Tuple [] |),
                                [
  ...
  Definition value_VERSION_1 : Value.t := M.run ltac:(M.monadic (M.alloc (| Value.Integer 1 |))).
  
  Definition value_VERSION_2 : Value.t := M.run ltac:(M.monadic (M.alloc (| Value.Integer 2 |))).
  
  Definition value_VERSION_3 : Value.t := M.run ltac:(M.monadic (M.alloc (| Value.Integer 3 |))).
  
  Definition value_VERSION_4 : Value.t := M.run ltac:(M.monadic (M.alloc (| Value.Integer 4 |))).
  
  Definition value_VERSION_5 : Value.t := M.run ltac:(M.monadic (M.alloc (| Value.Integer 5 |))).
  
  Definition value_VERSION_6 : Value.t := M.run ltac:(M.monadic (M.alloc (| Value.Integer 6 |))).
