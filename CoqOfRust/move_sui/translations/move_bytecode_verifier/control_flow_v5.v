                          ...
                          [
                            fun γ =>
                              ltac:(M.monadic
                                ...
                                let i := M.copy (| Ty.path "u16", γ1_0 |) in
                                let instr :=
                                  M.copy (|
                                    Ty.apply
                                      (Ty.path "&")
                            ...
                            ltac:(M.monadic
                              ...
                              M.match_operator (|
                                ...
                                [
                                  fun γ =>
                                    ltac:(M.monadic
                                      (let last_continue := M.copy (| Ty.path "u16", γ |) in
                                      M.write (|
                                        M.deref (|
                                          M.call_closure (|
                                            Ty.apply
                                      ...
                                      M.call_closure (|
                                        ...
                                        [
                                          M.borrow (|
                                            Pointer.Kind.Ref,
                                            M.deref (|
                                              M.borrow (| Pointer.Kind.Ref, loop_depth |)
                                            |)
                                          |)
                                        ]
                                      |)
                                          ...
                                          [
                                            ...
                                            fun γ =>
                                              ltac:(M.monadic
                                                ...
                                                let cur_instr := M.copy (| Ty.path "u16", γ1_0 |) in
                                                let instr :=
                                                  M.copy (|
                                                    Ty.apply
                                                      (Ty.path "&")
  ...
  *)
  Definition is_back_edge (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ cur_instr; target_instr ] =>
      ltac:(M.monadic
        (let cur_instr := M.alloc (| Ty.path "u16", cur_instr |) in
        let target_instr := M.alloc (| Ty.path "u16", target_instr |) in
        M.call_closure (|
          Ty.path "bool",
          BinOp.le,
          [ M.read (| target_instr |); M.read (| cur_instr |) ]
        |)))
    | _, _, _ => M.impossible "wrong number of arguments"
    end.
                            ...
                            ltac:(M.monadic
                              ...
                              M.match_operator (|
                                ...
                                [
                                  fun γ =>
                                    ltac:(M.monadic
                                      (let jump_target := M.copy (| Ty.path "u16", γ |) in
                                      M.read (|
                                        M.match_operator (|
                                          Ty.path "bool",
                                          M.alloc (|
      ...
      ltac:(M.monadic
        ...
        M.read (|
          let~ last_continues :
            ...
            |) in
          let~ count : Ty.path "usize" := Value.Integer IntegerKind.Usize 0 in
          let~ counts :
              Ty.apply
                (Ty.path "alloc::vec::Vec")
                []
