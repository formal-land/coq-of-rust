                                        ...
                                        M.match_operator (|
                                          M.alloc (|
                                            M.call_closure (|
                                              ...
                                              |),
                                              [ dependency_visibilities; dep_function ]
                                            |)
                                          |),
                                          [
                                            fun γ =>
                                                ...
                                                let~ def_handle :=
                                                  M.alloc (|
                                                    M.call_closure (|
                                                      ...
                                                      |),
                                                      [
                                                        M.read (| M.read (| owner_module |) |);
                                                        M.read (| M.read (| def_idx |) |)
                                                      ]
                                                    |)
                                                  |) in
                                                M.match_operator (|
                ...
                [
                  ...
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      M.match_operator (|
                        M.alloc (| M.read (| M.read (| struct_inst1 |) |) |),
                        [
                          fun γ =>
                            ltac:(M.monadic
                              (let γ := M.read (| γ |) in
                              ...
                              M.match_operator (|
                                M.alloc (| M.read (| M.read (| struct_inst2 |) |) |),
                                [
                                  fun γ =>
                                    ltac:(M.monadic
                                      (let γ := M.read (| γ |) in
