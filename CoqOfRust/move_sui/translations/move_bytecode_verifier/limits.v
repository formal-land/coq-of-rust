                        ...
                        ltac:(M.monadic
                          ...
                          let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let limit := M.copy (| Ty.path "usize", γ0_0 |) in
                          M.read (|
                            M.use
                              (M.alloc (|
                                Ty.tuple [],
                        ...
                        ltac:(M.monadic
                          ...
                          let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let max_function_definitions := M.copy (| Ty.path "usize", γ0_0 |) in
                          M.match_operator (|
                            Ty.tuple [],
                            M.alloc (| Ty.tuple [], Value.Tuple [] |),
                            [
                        ...
                        ltac:(M.monadic
                          ...
                          let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let max_struct_definitions := M.copy (| Ty.path "usize", γ0_0 |) in
                          M.match_operator (|
                            Ty.tuple [],
                            M.alloc (| Ty.tuple [], Value.Tuple [] |),
                            [
                        ...
                        ltac:(M.monadic
                          ...
                          let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let max_fields_in_struct := M.copy (| Ty.path "usize", γ0_0 |) in
                          M.read (|
                            M.use
                              (M.alloc (|
                                Ty.tuple [],
                        ...
                        ltac:(M.monadic
                          ...
                          let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let max_idenfitier_len := M.copy (| Ty.path "u64", γ0_0 |) in
                          M.read (|
                            M.use
                              (M.alloc (|
                                Ty.tuple [],
