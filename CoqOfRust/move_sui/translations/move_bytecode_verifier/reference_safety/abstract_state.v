          ...
          ltac:(M.monadic
            ...
            M.read (|
              ...
              let~ next_id : Ty.path "usize" :=
                BinOp.Wrap.add (| M.read (| num_locals |), Value.Integer IntegerKind.Usize 1 |) in
              let~ state :
                  Ty.path
                    "move_bytecode_verifier::reference_safety::abstract_state::AbstractState" :=
                Value.StructRecord
                            ...
                            M.never_to_any (|
                              M.call_closure (|
                                ...
                                [
                                  M.read (|
                                    Value.String
                                      "assertion failed: self.borrow_graph.is_mutable(id)"
                                  |)
                                ]
                              |)
                            |)
                            ...
                            M.never_to_any (|
                              M.call_closure (|
                                ...
                                [
                                  M.read (|
                                    Value.String
                                      "assertion failed: self.locals.len() == locals.len()"
                                  |)
                                ]
                              |)
                            |)
