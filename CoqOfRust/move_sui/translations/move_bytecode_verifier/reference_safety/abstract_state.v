  ...
  Module abstract_state.
                ...
                fun γ =>
                  ltac:(M.monadic
                    ...
                    M.call_closure (|
                      ...
                      [
                        M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| f |) |) |);
                        M.borrow (| Pointer.Kind.Ref, M.deref (| mk_str (| "NonReference" |) |) |)
                      ]
                    |)))
              ]
            |)))
    ...
    *)
    ...
    Definition value_STEP_PER_LOCAL_COST
        ...
        (α : list Value.t)
        : M :=
      ltac:(M.monadic (M.alloc (| Ty.path "u128", Value.Integer IntegerKind.U128 20 |))).
    ...
    Definition value_STEP_PER_GRAPH_ITEM_COST
        ...
        (α : list Value.t)
        : M :=
      ltac:(M.monadic (M.alloc (| Ty.path "u128", Value.Integer IntegerKind.U128 50 |))).
    ...
    Definition value_JOIN_BASE_COST (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ltac:(M.monadic (M.alloc (| Ty.path "u128", Value.Integer IntegerKind.U128 100 |))).
                                        ...
                                        [
                                          ...
                                          fun γ =>
                                            ltac:(M.monadic
                                              ...
                                              let param_idx := M.copy (| Ty.path "usize", γ1_0 |) in
                                              let param_ty :=
                                                M.copy (|
                                                  Ty.apply
                                                    (Ty.path "&")
          ...
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                ...
                self
              |) in
            let mut_ := M.alloc (| Ty.path "bool", mut_ |) in
            M.read (|
          ...
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                ...
                self
              |) in
            let parent := M.alloc (| Ty.path "move_borrow_graph::references::RefID", parent |) in
            let child := M.alloc (| Ty.path "move_borrow_graph::references::RefID", child |) in
            M.call_closure (|
              Ty.tuple [],
              M.get_associated_function (|
                Ty.apply
      ...
      Definition add_field_borrow (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; parent; field; child ] =>
          ltac:(M.monadic
            ...
            let parent := M.alloc (| Ty.path "move_borrow_graph::references::RefID", parent |) in
            let field :=
              M.alloc (| Ty.path "move_binary_format::file_format::FieldHandleIndex", field |) in
            let child := M.alloc (| Ty.path "move_borrow_graph::references::RefID", child |) in
            M.call_closure (|
              Ty.tuple [],
              M.get_associated_function (|
          ...
          ltac:(M.monadic
            (let self :=
              M.alloc (|
                ...
                self
              |) in
            let local := M.alloc (| Ty.path "u8", local |) in
            let id := M.alloc (| Ty.path "move_borrow_graph::references::RefID", id |) in
            M.call_closure (|
              Ty.tuple [],
              M.get_associated_function (|
                Ty.apply
                                      ...
                                      [
                                        M.call_closure (|
                                          ...
                                          [
                                            ...
                                            M.borrow (|
                                              Pointer.Kind.Ref,
                                              M.deref (| M.borrow (| Pointer.Kind.Ref, label |) |)
                                            |)
                                          ]
                                        |);
                                        M.closure
                  ...
                  ltac:(M.monadic
                    (let γ0_0 :=
                      M.SubPointer.get_struct_tuple_field (|
                        ...
                        0
                      |) in
                    let id := M.copy (| Ty.path "move_borrow_graph::references::RefID", γ0_0 |) in
                    M.call_closure (|
                      Ty.tuple [],
                      M.get_associated_function (|
                        Ty.path
                        ...
                        fun γ =>
                          ltac:(M.monadic
                            (let γ0_0 :=
                              ...
                              |) in
                            let id :=
                              M.copy (| Ty.path "move_borrow_graph::references::RefID", γ0_0 |) in
                            Value.StructTuple
                              "core::result::Result::Ok"
                              []
                              [
                  ...
                  let~ _ : Ty.tuple [] :=
                    M.match_operator (|
                      ...
                      M.alloc (|
                        ...
                        Value.Tuple [ M.read (| v1 |); M.read (| v2 |) ]
                      |),
                      [
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let γ1_0 :=
                              ...
                              |) in
                            let id1 :=
                              M.copy (| Ty.path "move_borrow_graph::references::RefID", γ1_0 |) in
                            let γ1_0 :=
                              M.SubPointer.get_struct_tuple_field (|
                                γ0_1,
                                "move_bytecode_verifier::reference_safety::abstract_state::AbstractValue::Reference",
                  ...
                  let~ _ : Ty.tuple [] :=
                    M.read (|
                      M.use
                        ...
                        |))
                    |) in
                  let~ returned_refs : Ty.path "usize" := Value.Integer IntegerKind.Usize 0 in
                  let~ return_values :
                      Ty.apply
                        (Ty.path "alloc::vec::Vec")
                        []
                                    ...
                                    [
                                      fun γ =>
                                        ltac:(M.monadic
                                          (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                                          let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                                          let local := M.copy (| Ty.path "usize", γ0_0 |) in
                                          let value :=
                                            M.copy (|
                                              Ty.apply
                                                (Ty.path "&")
                                        ...
                                        ltac:(M.monadic
                                          ...
                                          M.match_operator (|
                                            ...
                                            M.alloc (|
                                              ...
                                              Value.Tuple
                                                [ M.read (| self_value |); M.read (| other_value |)
                                                ]
                                            |),
                                            [
                                              fun γ =>
