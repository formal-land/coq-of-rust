    ...
    | [], [], [ module; idx; check_signature ] =>
      ltac:(M.monadic
        (let module :=
          ...
          |) in
        let idx :=
          M.alloc (| Ty.path "move_binary_format::file_format::FunctionDefinitionIndex", idx |) in
        let check_signature :=
          M.alloc (|
            Ty.function
              [
        ...
        M.read (|
          ...
          let~ parameters : Ty.path "move_binary_format::file_format::SignatureIndex" :=
            M.read (|
              ...
              |)
            |) in
          let~ return_ : Ty.path "move_binary_format::file_format::SignatureIndex" :=
            M.read (|
              M.SubPointer.get_struct_record_field (|
                M.deref (| M.read (| fhandle |) |),
                "move_binary_format::file_format::FunctionHandle",
      ...
      ltac:(M.monadic
        (let module :=
          M.alloc (|
            ...
            module
          |) in
        let is_entry := M.alloc (| Ty.path "bool", is_entry |) in
        let parameters_idx :=
          M.alloc (| Ty.path "move_binary_format::file_format::SignatureIndex", parameters_idx |) in
        let return_idx :=
          M.alloc (|
            Ty.apply
              (Ty.path "core::option::Option")
      ...
      ltac:(M.monadic
        (let _resolver :=
          M.alloc (|
            ...
            _resolver
          |) in
        let _is_entry := M.alloc (| Ty.path "bool", _is_entry |) in
        let _parameters :=
          M.alloc (| Ty.path "move_binary_format::file_format::SignatureIndex", _parameters |) in
        let _return_type :=
          M.alloc (|
            Ty.apply
              (Ty.path "core::option::Option")
        ...
        M.read (|
          ...
          let~ all_args_have_valid_type : Ty.path "bool" :=
            M.read (|
              ...
              |)
            |) in
          let~ has_valid_return_type : Ty.path "bool" :=
            M.call_closure (|
              Ty.path "bool",
              M.get_associated_function (|
                Ty.apply
