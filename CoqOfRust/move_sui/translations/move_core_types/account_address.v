  ...
  Module Impl_move_core_types_account_address_AccountAddress.
          ...
          (let address :=
            M.alloc (|
              Ty.apply
                ...
                [
                  M.unevaluated_const
                    (mk_str (| "move_core_types_account_address_new_discriminant" |))
                ]
                [ Ty.path "u8" ],
              address
            |) in
        ...
        ltac:(M.monadic
          (M.read (|
            let~ rng : Ty.path "rand_core::os::OsRng" :=
              Value.StructTuple "rand_core::os::OsRng" [] [] [] in
            let~ buf :
                Ty.apply
                  (Ty.path "array")
                  [ Value.Integer IntegerKind.Usize 32 ]
                ...
                [
                  fun γ =>
                    ltac:(M.monadic
                      ...
                      |)));
                  fun γ => ltac:(M.monadic (M.read (| hex_str |)))
                ]
              |)
            |)
          |)))
    ...
    *)
    Definition into_bytes (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.path "move_core_types::account_address::AccountAddress", self |) in
          M.read (|
            M.SubPointer.get_struct_tuple_field (|
              self,
              "move_core_types::account_address::AccountAddress",
    ...
    *)
    Definition from_hex_literal (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ literal ] =>
        ltac:(M.monadic
          (let literal := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], literal |) in
          M.catch_return
            (Ty.apply
          ...
          (let bytes :=
            M.alloc (|
              Ty.apply
                ...
                [
                  M.unevaluated_const
                    (mk_str (| "move_core_types_account_address_from_discriminant" |))
                ]
                [ Ty.path "u8" ],
              bytes
            |) in
            ...
            [
              fun γ =>
                ltac:(M.monadic
                  ...
                  let address :=
                    M.copy (| Ty.path "move_core_types::account_address::AccountAddress", γ0_0 |) in
                  Value.StructTuple
                    "core::result::Result::Ok"
                    []
                    [
