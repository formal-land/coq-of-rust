...
Module parser.
          ...
          M.match_operator (|
            ...
            [
              ...
              fun γ =>
                ltac:(M.monadic
                  (let γ := M.deref (| M.read (| γ |) |) in
                  let _ := M.is_struct_tuple (| γ, "move_core_types::parser::Token::U128Type" |) in
                  M.call_closure (|
                    Ty.apply
                      (Ty.path "core::result::Result")
                      []
              ...
              fun γ =>
                ltac:(M.monadic
                  (let γ := M.deref (| M.read (| γ |) |) in
                  let _ := M.is_struct_tuple (| γ, "move_core_types::parser::Token::U256Type" |) in
                  M.call_closure (|
                    Ty.apply
                      (Ty.path "core::result::Result")
                      []
              ...
              fun γ =>
                ltac:(M.monadic
                  (let γ := M.deref (| M.read (| γ |) |) in
                  let _ := M.is_struct_tuple (| γ, "move_core_types::parser::Token::BoolType" |) in
                  M.call_closure (|
                    Ty.apply
                      (Ty.path "core::result::Result")
                      []
  ...
  *)
  Definition token_as_name (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ tok ] =>
      ltac:(M.monadic
        (let tok := M.alloc (| Ty.path "move_core_types::parser::Token", tok |) in
        M.catch_return
          (Ty.apply
            (Ty.path "core::result::Result")
            []
                        ...
                        (M.find_or_pattern (Ty.tuple []) (|
                          ...
                          [
                            ...
                            fun γ =>
                              ltac:(M.monadic
                                (let _ :=
                                  M.is_struct_tuple (| γ, "move_core_types::parser::Token::Lt" |) in
                                Value.Tuple []));
                            fun γ =>
                              ltac:(M.monadic
                                (let _ :=
                                  M.is_struct_tuple (| γ, "move_core_types::parser::Token::Gt" |) in
                                Value.Tuple []));
                            fun γ =>
                              ltac:(M.monadic
                                (let _ :=
      ...
      ltac:(M.monadic
        ...
        M.match_operator (|
          ...
          [
            ...
            fun γ =>
              ltac:(M.monadic
                (let _ := is_constant_or_break_match (| M.read (| γ |), mk_str (| "signer" |) |) in
  ...
  *)
  Definition next_number (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [ impl_Iterator_Item___char_ ], [ initial; it ] =>
      ltac:(M.monadic
        (let initial := M.alloc (| Ty.path "char", initial |) in
        let it := M.alloc (| impl_Iterator_Item___char_, it |) in
        M.catch_return
          (Ty.apply
            (Ty.path "core::result::Result")
            []
                          ...
                          [
                            fun γ =>
                              ltac:(M.monadic
                                ...
                                let tok :=
                                  M.copy (| Ty.path "move_core_types::parser::Token", γ1_0 |) in
                                let n := M.copy (| Ty.path "usize", γ1_1 |) in
                                M.read (|
                                  let~ _ : Ty.tuple [] :=
                                    M.call_closure (|
                                      Ty.tuple [],
                    ...
                    ltac:(M.monadic
                      (let γ0_0 :=
                        M.SubPointer.get_struct_tuple_field (|
                          ...
                          0
                        |) in
                      let tok := M.copy (| Ty.path "move_core_types::parser::Token", γ0_0 |) in
                      Value.StructTuple
                        "core::result::Result::Ok"
                        []
                        [ Ty.path "move_core_types::parser::Token"; Ty.path "anyhow::Error" ]
                        ...
                        ltac:(M.monadic
                          (let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let val := M.copy (| Ty.path "move_core_types::parser::Token", γ0_0 |) in
                          M.read (| val |)))
                    ]
                  |) in
                let~ _ : Ty.tuple [] :=
        ...
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              ...
              self
            |) in
          let parse_list_item := M.alloc (| F, parse_list_item |) in
          let end_token := M.alloc (| Ty.path "move_core_types::parser::Token", end_token |) in
          let allow_trailing_comma := M.alloc (| Ty.path "bool", allow_trailing_comma |) in
          M.catch_return
            (Ty.apply
              (Ty.path "core::result::Result")
              []
                                          ...
                                          M.call_closure (|
                                            ...
                                            [
                                              M.call_closure (|
                                                ...
                                                |),
                                                [
                                                  M.borrow (| Pointer.Kind.Ref, parse_list_item |);
                                                  Value.Tuple
                                                    [
                                                      M.borrow (|
                                                        Pointer.Kind.MutRef,
                ...
                [
                  M.match_operator (|
                          ...
                          fun γ =>
                            ltac:(M.monadic
                              (let γ0_0 :=
                                ...
                                |) in
                              let val :=
                                M.copy (| Ty.path "move_core_types::parser::Token", γ0_0 |) in
                              M.read (| val |)))
                        ]
                      |)
                    |),
                    [
                      ...
                      fun γ =>
                        ltac:(M.monadic
                          (let tok := M.copy (| Ty.path "move_core_types::parser::Token", γ |) in
                          M.never_to_any (|
                            M.read (|
                              M.return_ (|
                                Value.StructTuple
                        ...
                        ltac:(M.monadic
                          (let γ0_0 :=
                            M.SubPointer.get_struct_tuple_field (|
                              ...
                              0
                            |) in
                          let addr := M.copy (| Ty.path "alloc::string::String", γ0_0 |) in
                          M.read (|
                            let~ _ : Ty.tuple [] :=
                              M.match_operator (|
                                Ty.tuple [],
                                    ...
                                    ltac:(M.monadic
                                      (M.match_operator (|
                                        ...
                                        [
                                          fun γ =>
                                            ltac:(M.monadic
                                              (let e := M.copy (| Ty.path "anyhow::Error", γ |) in
                                              M.call_closure (|
                                                Ty.path "anyhow::Error",
                                                M.get_associated_function (|
                                                  Ty.path "anyhow::Error",
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        (let γ0_0 :=
                          ...
                          |) in
                        let val :=
                          M.copy (| Ty.path "move_core_types::language_storage::TypeTag", γ0_0 |) in
                        M.read (| val |)))
                  ]
                |) in
              M.alloc (|
