...
Module runtime_value.
  Definition value_MOVE_STRUCT_NAME (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ltac:(M.monadic
      (M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], mk_str (| "struct" |) |))).
  ...
  Definition value_MOVE_STRUCT_TYPE (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ltac:(M.monadic
      (M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], mk_str (| "type" |) |))).
  ...
  Definition value_MOVE_STRUCT_FIELDS (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ltac:(M.monadic
      (M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], mk_str (| "fields" |) |))).
    ...
    Definition fmt (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; f ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (|
              Ty.apply (Ty.path "&") [] [ Ty.path "move_core_types::runtime_value::MoveStruct" ],
              self
            |) in
          let f :=
  ...
  Module Impl_move_core_types_runtime_value_MoveValue.
                                                      ...
                                                      ltac:(M.monadic
                                                        (let γ0_0 :=
                                                          M.SubPointer.get_struct_tuple_field (|
                                                            ...
                                                            0
                                                          |) in
                                                        let u8 := M.copy (| Ty.path "u8", γ0_0 |) in
                                                        M.read (|
                                                          let~ _ : Ty.tuple [] :=
                                                            M.call_closure (|
                                                              Ty.tuple [],
    ...
    *)
    Definition decorate (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; layout ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.path "move_core_types::runtime_value::MoveValue", self |) in
          let layout :=
            M.alloc (|
              Ty.apply
                (Ty.path "&")
          ...
          M.match_operator (|
            ...
            M.alloc (|
              ...
              Value.Tuple [ M.read (| self |); M.read (| layout |) ]
            |),
            [
              fun γ =>
                ltac:(M.monadic
                  ...
                  let γ1_0 :=
                    ...
                    |) in
                  let s :=
                    M.copy (| Ty.path "move_core_types::runtime_value::MoveStruct", γ1_0 |) in
                  let γ0_1 := M.read (| γ0_1 |) in
                  let γ2_0 :=
                    M.SubPointer.get_struct_tuple_field (|
                      γ0_1,
                        ...
                        M.get_trait_method (|
                          ...
                          Ty.apply
                            ...
                            [
                              ...
                              Ty.function
                                [ Ty.tuple [ Ty.path "move_core_types::runtime_value::MoveValue" ] ]
                                (Ty.path "move_core_types::annotated_value::MoveValue")
                            ],
                          [],
                          [],
                ...
                ltac:(M.monadic
                  ...
                  let γ1_0 :=
                    M.SubPointer.get_struct_tuple_field (|
                      ...
                      0
                    |) in
                  let a := M.copy (| Ty.path "u8", γ1_0 |) in
                  Value.StructTuple
                ...
                ltac:(M.monadic
                  ...
                  let γ1_0 :=
                    M.SubPointer.get_struct_tuple_field (|
                      ...
                      0
                    |) in
                  let u := M.copy (| Ty.path "u64", γ1_0 |) in
                  Value.StructTuple
                ...
                ltac:(M.monadic
                  ...
                  let γ1_0 :=
                    M.SubPointer.get_struct_tuple_field (|
                      ...
                      0
                    |) in
                  let u := M.copy (| Ty.path "u128", γ1_0 |) in
                  Value.StructTuple
                ...
                ltac:(M.monadic
                  ...
                  let γ1_0 :=
                    M.SubPointer.get_struct_tuple_field (|
                      ...
                      0
                    |) in
                  let b := M.copy (| Ty.path "bool", γ1_0 |) in
                  Value.StructTuple
              ...
              fun γ =>
                ltac:(M.monadic
                  ...
                  let γ1_0 :=
                    ...
                    |) in
                  let a :=
                    M.copy (| Ty.path "move_core_types::account_address::AccountAddress", γ1_0 |) in
                  Value.StructTuple
                ...
                ltac:(M.monadic
                  ...
                  let γ1_0 :=
                    M.SubPointer.get_struct_tuple_field (|
                      ...
                      0
                    |) in
                  let u := M.copy (| Ty.path "u16", γ1_0 |) in
                  Value.StructTuple
                ...
                ltac:(M.monadic
                  ...
                  let γ1_0 :=
                    M.SubPointer.get_struct_tuple_field (|
                      ...
                      0
                    |) in
                  let u := M.copy (| Ty.path "u32", γ1_0 |) in
                  Value.StructTuple
                ...
                ltac:(M.monadic
                  ...
                  let γ1_0 :=
                    M.SubPointer.get_struct_tuple_field (|
                      ...
                      0
                    |) in
                  let u := M.copy (| Ty.path "move_core_types::u256::U256", γ1_0 |) in
                  Value.StructTuple
  ...
  Module Impl_move_core_types_runtime_value_MoveStruct.
    ...
    *)
    Definition decorate (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; layout ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.path "move_core_types::runtime_value::MoveStruct", self |) in
          let layout :=
            M.alloc (|
              Ty.apply
                (Ty.path "&")
    ...
    *)
    Definition into_fields (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.path "move_core_types::runtime_value::MoveStructLayout", self |) in
          M.read (|
            M.SubPointer.get_struct_tuple_field (|
              self,
              "move_core_types::runtime_value::MoveStructLayout",
    ...
    *)
    Definition visit_seq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ A ], [ self; seq ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.path "move_core_types::runtime_value::VectorElementVisitor", self |) in
    ...
    *)
    Definition visit_seq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ A ], [ self; seq ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.path "move_core_types::runtime_value::StructFieldVisitor", self |) in
          let seq := M.alloc (| A, seq |) in
          M.catch_return
            (Ty.apply
              (Ty.path "core::result::Result")
                      ...
                      M.read (|
                        let~ t :
                            Ty.associated_in_trait
                              ...
                              "SerializeSeq" :=
                          M.match_operator (|
                            Ty.associated_in_trait "serde::ser::Serializer" [] [] S "SerializeSeq",
                            M.alloc (|
                              Ty.apply
                                (Ty.path "core::ops::control_flow::ControlFlow")
                                []
