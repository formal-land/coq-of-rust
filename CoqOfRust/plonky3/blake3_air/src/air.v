...
Module air.
  ...
  Module Impl_core_fmt_Debug_for_p3_blake3_air_air_Blake3Air.
    Definition Self : Ty.t := Ty.path "p3_blake3_air::air::Blake3Air".
        ...
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            [
              ...
              M.borrow (| Pointer.Kind.Ref, M.deref (| mk_str (| "Blake3Air" |) |) |)
            ]
          |)))
  ...
  End Impl_core_fmt_Debug_for_p3_blake3_air_air_Blake3Air.
  
  Module Impl_p3_blake3_air_air_Blake3Air.
    Definition Self : Ty.t := Ty.path "p3_blake3_air::air::Blake3Air".
          ...
          M.read (|
            ...
            M.alloc (|
              M.call_closure (|
                ...
                M.get_function (| "p3_blake3_air::generation::generate_trace_rows", [], [ F ] |),
    ...
    *)
    Definition quarter_round_function (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      match ε, τ, α with
          ...
          M.read (|
                                    ...
                                    Value.StructRecord
                                      ...
                                      [
                                        ("end_",
                                          M.read (|
                                            get_constant (|
                                              "p3_blake3_air::constants::BITS_PER_LIMB",
                                              Ty.path "usize"
                                            |)
                                          |))
                                      ]
            ...
            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.tuple [],
                  M.get_function (| "p3_air::utils::add3", [], [ AB ] |),
                  [
            ...
            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.tuple [],
                  M.get_function (| "p3_air::utils::xor_32_shift", [], [ AB ] |),
                  [
                    M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| builder |) |) |);
                    M.borrow (|
                      Pointer.Kind.Ref,
            ...
            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.tuple [],
                  M.get_function (| "p3_air::utils::add2", [], [ AB ] |),
                  [
                    M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| builder |) |) |);
                    M.borrow (|
                      Pointer.Kind.Ref,
    ...
    Global Instance AssociatedFunction_quarter_round_function :
      M.IsAssociatedFunction.C Self "quarter_round_function" quarter_round_function.
    Admitted.
    Global Typeclasses Opaque quarter_round_function.
    ...
    *)
                ...
                M.borrow (|
                  ...
                  M.deref (|
                    M.borrow (|
                      Pointer.Kind.Ref,
                      M.SubPointer.get_array_field (|
                        M.deref (| M.read (| m_vector |) |),
                        M.call_closure (|
                          Ty.path "usize",
                          BinOp.Wrap.mul,
                          [ Value.Integer IntegerKind.Usize 2; M.read (| index |) ]
                        |)
                      |)
                    |)
                  |)
    ...
    Global Instance AssociatedFunction_full_round_to_column_quarter_round :
      M.IsAssociatedFunction.C
        Self
        "full_round_to_column_quarter_round"
        full_round_to_column_quarter_round.
    Admitted.
    Global Typeclasses Opaque full_round_to_column_quarter_round.
    ...
    *)
                        ...
                        M.call_closure (|
                          ...
                          [
                            M.call_closure (|
                              Ty.path "usize",
                              BinOp.Wrap.add,
                              [ M.read (| index |); Value.Integer IntegerKind.Usize 2 ]
                            |);
                            Value.Integer IntegerKind.Usize 4
                          ]
                        |)
    ...
    Global Instance AssociatedFunction_full_round_to_diagonal_quarter_round :
      M.IsAssociatedFunction.C
        Self
        "full_round_to_diagonal_quarter_round"
        full_round_to_diagonal_quarter_round.
    Admitted.
    Global Typeclasses Opaque full_round_to_diagonal_quarter_round.
    ...
    *)
    Definition verify_round (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      match ε, τ, α with
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [
                    ...
                    M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| round_data |) |) |);
                    M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| m_vector |) |) |);
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [
                    ...
                    M.borrow (|
                      Pointer.Kind.Ref,
                      M.deref (| M.borrow (| Pointer.Kind.Ref, trace_column_0 |) |)
                    |)
                  ]
                |)
              |) in
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [
                    ...
                    M.borrow (|
                      Pointer.Kind.Ref,
                      M.deref (| M.borrow (| Pointer.Kind.Ref, trace_column_1 |) |)
                    |)
                  ]
                |)
              |) in
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [
                    ...
                    M.borrow (|
                      Pointer.Kind.Ref,
                      M.deref (| M.borrow (| Pointer.Kind.Ref, trace_column_2 |) |)
                    |)
                  ]
                |)
              |) in
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [
                    ...
                    M.borrow (|
                      Pointer.Kind.Ref,
                      M.deref (| M.borrow (| Pointer.Kind.Ref, trace_column_3 |) |)
                    |)
                  ]
                |)
              |) in
            let~ trace_diagonal_0 :
                Ty.apply
                  (Ty.path "*")
                  []
                  [
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [
                    ...
                    M.borrow (|
                      Pointer.Kind.Ref,
                      M.deref (| M.borrow (| Pointer.Kind.Ref, trace_diagonal_0 |) |)
                    |)
                  ]
                |)
              |) in
            let~ trace_diagonal_1 :
                Ty.apply
                  (Ty.path "*")
                  []
                  [
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [
                    ...
                    M.borrow (|
                      Pointer.Kind.Ref,
                      M.deref (| M.borrow (| Pointer.Kind.Ref, trace_diagonal_1 |) |)
                    |)
                  ]
                |)
              |) in
            let~ trace_diagonal_2 :
                Ty.apply
                  (Ty.path "*")
                  []
                  [
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [
                    ...
                    M.borrow (|
                      Pointer.Kind.Ref,
                      M.deref (| M.borrow (| Pointer.Kind.Ref, trace_diagonal_2 |) |)
                    |)
                  ]
                |)
              |) in
            let~ trace_diagonal_3 :
                Ty.apply
                  (Ty.path "*")
                  []
                  [
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [
                    ...
                    M.borrow (|
                      Pointer.Kind.Ref,
                      M.deref (| M.borrow (| Pointer.Kind.Ref, trace_diagonal_3 |) |)
                    |)
                  ]
                |)
              |) in
    ...
    Global Instance AssociatedFunction_verify_round :
      M.IsAssociatedFunction.C Self "verify_round" verify_round.
    Admitted.
    Global Typeclasses Opaque verify_round.
  End Impl_p3_blake3_air_air_Blake3Air.
  
  Module Impl_p3_air_air_BaseAir_F_for_p3_blake3_air_air_Blake3Air.
    Definition Self (F : Ty.t) : Ty.t := Ty.path "p3_blake3_air::air::Blake3Air".
  ...
  End Impl_p3_air_air_BaseAir_F_for_p3_blake3_air_air_Blake3Air.
  
  Module Impl_p3_air_air_Air_where_p3_air_air_AirBuilder_AB_AB_for_p3_blake3_air_air_Blake3Air.
    Definition Self (AB : Ty.t) : Ty.t := Ty.path "p3_blake3_air::air::Blake3Air".
              ...
              M.alloc (|
                M.call_closure (|
                  ...
                  [
                    ...
                    M.borrow (|
                      Pointer.Kind.Ref,
                      M.deref (| M.borrow (| Pointer.Kind.Ref, m_values |) |)
                    |)
                  ]
                |)
              |) in
            let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.tuple [],
                  M.get_function (|
                    "p3_blake3_air::constants::permute",
                    [],
                    [
                      Ty.apply
                        (Ty.path "array")
                  ...
                  [
                    M.borrow (|
                      Pointer.Kind.MutRef,
                      M.deref (| M.borrow (| Pointer.Kind.MutRef, m_values |) |)
                    |)
                  ]
                |)
              |) in
                                        ...
                                        M.call_closure (|
                                          ...
                                          [
                                            ...
                                            M.borrow (|
                                              Pointer.Kind.Ref,
                                              M.deref (|
                                                M.borrow (| Pointer.Kind.Ref, left_words |)
                                              |)
                                            |);
                                            M.borrow (|
                                              Pointer.Kind.Ref,
                                              M.deref (|
                                                M.borrow (| Pointer.Kind.Ref, out_bits |)
                                              |)
                                            |);
                                            M.borrow (|
                                              Pointer.Kind.Ref,
                                              M.deref (|
                                                M.borrow (| Pointer.Kind.Ref, right_bits |)
                                              |)
                                            |);
                                            Value.Integer IntegerKind.Usize 0
                                          ]
  ...
  End Impl_p3_air_air_Air_where_p3_air_air_AirBuilder_AB_AB_for_p3_blake3_air_air_Blake3Air.
End air.
