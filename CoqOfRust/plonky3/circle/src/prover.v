...
Module prover.
            ...
            (M.read (|
                                                              ...
                                                              [
                                                                M.borrow (|
                                                                  ...
                                                                  M.deref (|
                                                                    M.read (|
                                                                      get_constant (|
                                                                        "p3_circle::prover::prove::__CALLSITE",
                                                                        Ty.apply
                                                                          (Ty.path "&")
                                                                          []
                                                                          [
                        ...
                        M.alloc (|
                          M.never_to_any (|
                            M.call_closure (|
                              ...
                              [
                                mk_str (|
                                  "assertion failed: inputs.iter().tuple_windows().all(|(l, r)| l.len() >= r.len())"
                                |)
                              ]
                            |)
                          |)
              ...
              let~ commit_phase_result :
                  Ty.apply
                    (Ty.path "*")
                    []
                    [ Ty.apply (Ty.path "p3_circle::prover::CommitPhaseResult") [] [ Challenge; M_ ]
                    ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.apply (Ty.path "p3_circle::prover::CommitPhaseResult") [] [ Challenge; M_ ],
                    M.get_function (|
                      "p3_circle::prover::commit_phase",
                      [],
                                                      ...
                                                      [
                                                        M.borrow (|
                                                          ...
                                                          M.deref (|
                                                            M.read (|
                                                              get_constant (|
                                                                "p3_circle::prover::prove::__CALLSITE'1",
                                                                Ty.apply
                                                                  (Ty.path "&")
                                                                  []
                                                                  [
                                                                                    ...
                                                                                    M.borrow (|
                                                                                      ...
                                                                                      M.deref (|
                                                                                        M.borrow (|
                                                                                          ...
                                                                                          M.SubPointer.get_struct_record_field (|
                                                                                            commit_phase_result,
                                                                                            "p3_circle::prover::CommitPhaseResult",
                                                                                            "data"
                                                                                          |)
                                                                                        |)
                                                                                      |)
  ...
  Global Instance Instance_IsFunction_prove : M.IsFunction.C "p3_circle::prover::prove" prove.
  Admitted.
          ...
          ltac:(M.monadic
            (M.read (|
                                                              ...
                                                              [
                                                                M.borrow (|
                                                                  ...
                                                                  M.deref (|
                                                                    M.read (|
                                                                      get_constant (|
                                                                        "p3_circle::prover::commit_phase::__CALLSITE",
                                                                        Ty.apply
                                                                          (Ty.path "&")
                                                                          []
                                                                          [
                            ...
                            M.read (|
                              let~ __tracing_attr_fake_return :
                                  Ty.apply
                                    ...
                                    [
                                      Ty.apply
                                        (Ty.path "p3_circle::prover::CommitPhaseResult")
                                        []
                                        [ Challenge; M_ ]
                                    ] :=
                                M.alloc (|
                                  ...
                                  M.call_closure (|
                                    ...
                                    [
                                      ...
                                      M.call_closure (|
                                        Ty.path "usize",
                                        M.get_associated_function (|
                                          Ty.apply (Ty.path "p3_fri::config::FriConfig") [] [ M_ ],
                                          "blowup",
                                          [],
                                          []
                                        |),
              ...
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                ...
                |) in
              let~ final_poly : Ty.apply (Ty.path "*") [] [ Challenge ] :=
                M.copy (|
                  M.deref (|
                    M.call_closure (|
                      ...
                      M.get_trait_method (|
                        ...
                        []
                      |),
                      [ M.borrow (| Pointer.Kind.Ref, folded |); Value.Integer IntegerKind.Usize 0 ]
                    |)
                  |)
                |) in
              let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
  ...
  Global Instance Instance_IsFunction_commit_phase :
    M.IsFunction.C "p3_circle::prover::commit_phase" commit_phase.
  Admitted.
  ...
  *)
  ...
  Global Instance Instance_IsFunction_answer_query :
    M.IsFunction.C "p3_circle::prover::answer_query" answer_query.
  Admitted.
