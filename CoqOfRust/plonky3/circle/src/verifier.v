...
Module verifier.
  ...
  *)
  Definition verify (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [],
        [
          ...
          M_;
          Challenger;
          impl_Fn_usize___G_InputProof__arrow_Result_Vec__usize__Challenge____G_InputError_
        ],
                                                ...
                                                M.call_closure (|
                                                  ...
                                                  [
                                                    M.call_closure (|
                                                      ...
                                                      M.get_function (|
                                                        "p3_circle::verifier::verify_query",
                                                        [],
                                                        [
                                                          G;
                                                          Challenge;
  ...
  Global Instance Instance_IsFunction_verify : M.IsFunction.C "p3_circle::verifier::verify" verify.
  Admitted.
  Global Typeclasses Opaque verify.
  
  Axiom CommitStep :
    forall (F M_ : Ty.t),
    (Ty.apply (Ty.path "p3_circle::verifier::CommitStep") [] [ F; M_ ]) =
      (Ty.tuple
        [
          Ty.tuple
            [
  ...
  *)
  Definition verify_query (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [],
        ...
        [ g; config; index; steps; reduced_openings; log_max_height ] =>
      ltac:(M.monadic
        (let g := M.alloc (| g |) in
        let config := M.alloc (| config |) in
  ...
  Global Instance Instance_IsFunction_verify_query :
    M.IsFunction.C "p3_circle::verifier::verify_query" verify_query.
  Admitted.
