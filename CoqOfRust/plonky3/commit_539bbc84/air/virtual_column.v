          ...
          Value.mkStructRecord
            ...
            [
              ("column_weights",
                ...
                |));
              ("constant", M.read (| get_constant (| "p3_field::field::FieldAlgebra::ZERO", F |) |))
            ]))
      | _, _, _ => M.impossible "wrong number of arguments"
      end.
                                        ...
                                        fun γ =>
                                          ltac:(M.monadic
                                            ...
                                            let column :=
                                              ...
                                              |) in
                                            let weight :=
                                              M.alloc (| Ty.apply (Ty.path "&") [] [ F ], γ2_1 |) in
                                            M.read (|
                                              let~ _ : Ty.tuple [] :=
                                                M.call_closure (|
                                                  Ty.tuple [],
