...
Module array.
  ...
  Module Impl_p3_field_field_FieldAlgebra_where_p3_field_field_Field_F_for_p3_field_array_FieldArray_N_F.
    Definition Self (N : Value.t) (F : Ty.t) : Ty.t :=
      Ty.apply (Ty.path "p3_field::array::FieldArray") [ N ] [ F ].
    
    (*     type F = F; *)
    Definition _F (N : Value.t) (F : Ty.t) : Ty.t := F.
    ...
    Axiom Implements :
      ...
      M.IsTraitInstance
        ...
        [
          ...
          ("from_f", InstanceField.Method (from_f N F));
          ("from_canonical_u8", InstanceField.Method (from_canonical_u8 N F));
          ("from_canonical_u16", InstanceField.Method (from_canonical_u16 N F));
          ("from_canonical_u32", InstanceField.Method (from_canonical_u32 N F));
          ("from_canonical_u64", InstanceField.Method (from_canonical_u64 N F));
          ("from_canonical_usize", InstanceField.Method (from_canonical_usize N F));
          ("from_wrapped_u32", InstanceField.Method (from_wrapped_u32 N F));
          ("from_wrapped_u64", InstanceField.Method (from_wrapped_u64 N F))
        ].
  End Impl_p3_field_field_FieldAlgebra_where_p3_field_field_Field_F_for_p3_field_array_FieldArray_N_F.
