...
Module packed.
  ...
  Module Impl_p3_field_packed_PackedValue_where_p3_field_packed_Packable_T_for_array_WIDTH_T.
    ...
    Definition value_WIDTH
      ...
      ltac:(M.monadic (M.alloc (| Ty.path "usize", WIDTH |))).
              ...
              Ty.apply
                ...
                [
                  Ty.apply
                    (Ty.path "slice")
                    []
                    [ Ty.associated_in_trait "p3_field::packed::PackedValue" [] [] T "Value" ]
                ],
              slice
            |) in
          M.borrow (|
