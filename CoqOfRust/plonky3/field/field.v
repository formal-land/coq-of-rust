...
Module field.
  ...
  Module PrimeCharacteristicRing.
    ...
    Definition from_u8 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "u8", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
    ...
    Definition from_u16 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "u16", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition from_u32 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "u32", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition from_u64 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "u64", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition from_u128 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "u128", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition from_usize (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "usize", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition from_i8 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "i8", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition from_i16 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "i16", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition from_i32 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "i32", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition from_i64 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "i64", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition from_i128 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "i128", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition from_isize (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ int ] =>
        ltac:(M.monadic
          (let int := M.alloc (| Ty.path "isize", int |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
    ...
    Definition xor (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; y ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Self ], self |) in
          let y := M.alloc (| Ty.apply (Ty.path "&") [] [ Self ], y |) in
          M.call_closure (|
            Self,
    ...
    Definition xor3 (Self : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; y; z ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Self ], self |) in
          let y := M.alloc (| Ty.apply (Ty.path "&") [] [ Self ], y |) in
          let z := M.alloc (| Ty.apply (Ty.path "&") [] [ Self ], z |) in
          M.call_closure (|
            Self,
            M.get_trait_method (|
              "p3_field::field::PrimeCharacteristicRing",
                              ...
                              [
                                ...
                                ("end_",
                                  M.call_closure (|
                                    Ty.path "usize",
                                    M.get_function (|
                                      "p3_field::exponentiation::bits_u64",
                                      [],
                                      []
                                    |),
                                    [ M.read (| power |) ]
            ...
            let~ _ : Ty.tuple [] :=
              M.match_operator (|
                ...
                M.alloc (|
                  ...
                  Value.Tuple
                    [
                      M.borrow (| Pointer.Kind.Ref, M.alloc (| Ty.path "usize", N |) |);
                      M.borrow (|
                        Pointer.Kind.Ref,
                        M.alloc (|
                          Ty.path "usize",
          ...
          (let self :=
            M.alloc (|
              Ty.apply
                (Ty.path "&mut")
                []
                [ Ty.apply (Ty.path "p3_field::field::Powers") [] [ R ] ],
              self
            |) in
          M.read (|
            let~ result : R :=
