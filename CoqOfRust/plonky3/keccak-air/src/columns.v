          ...
          M.read (|
            ...
            let~ a : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.alloc (|
                ...
                |)
              |) in
            let~ b : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] := M.copy (| x |) in
            let~ rot : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.alloc (|
                M.cast
                  (Ty.path "usize")
                  (M.read (|
      ...
      ltac:(M.monadic
        ...
        M.read (|
          let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
            ...
            |) in
          let~ i_u64 : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
            M.alloc (|
              M.call_closure (|
                Ty.path "usize",
                BinOp.Wrap.div,
              ...
              |)
            |) in
          let~ limb_index : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
            M.alloc (|
              M.call_closure (|
                Ty.path "usize",
                BinOp.Wrap.rem,
