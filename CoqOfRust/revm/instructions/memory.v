...
Module instructions.
  Module memory.
    ...
    *)
    Definition mload (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [ H ], [ interpreter; _host ] =>
        ltac:(M.monadic
                ...
                let new_size :=
                  M.alloc (|
                    M.call_closure (|
                      ...
                      [ M.read (| offset |); M.of_value (| Value.Integer 32 |) ]
                    |)
                  |) in
                let _ :=
                  M.match_operator (|
    ...
    *)
    Definition mstore (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [ H ], [ interpreter; _host ] =>
        ltac:(M.monadic
          (let interpreter := M.alloc (| interpreter |) in
    ...
    *)
    Definition mstore8 (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [ H ], [ interpreter; _host ] =>
        ltac:(M.monadic
          (let interpreter := M.alloc (| interpreter |) in
                      ...
                      ltac:(M.monadic
                        ...
                        let new_size :=
                          M.alloc (|
                            M.call_closure (|
                              M.get_associated_function (| Ty.path "usize", "saturating_add", [] |),
                              [ M.read (| offset |); M.of_value (| Value.Integer 1 |) ]
                            |)
                          |) in
                        let _ :=
                          M.match_operator (|
                          ...
                          M.call_closure (|
                            ...
                            [
                              ...
                              M.call_closure (|
                                ...
                                [ value; M.of_value (| Value.Integer 0 |) ]
                              |)
                            ]
                          |)
                        |)))
    ...
    *)
    Definition msize (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
      | [ H ], [ interpreter; _host ] =>
        ltac:(M.monadic
          (let interpreter := M.alloc (| interpreter |) in
    ...
    *)
    Definition mcopy (τ : list Ty.t) (α : list A.t) : M :=
      match τ, α with
