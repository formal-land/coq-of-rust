            ...
            ltac:(M.monadic
              (M.read (|
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ eof : Ty.apply (Ty.path "*") [] [ Ty.path "revm_bytecode::eof::Eof" ] :=
                  M.copy (|
                    M.match_operator (|
                      Some (Ty.apply (Ty.path "*") [] [ Ty.path "revm_bytecode::eof::Eof" ]),
                      M.alloc (|
                        M.call_closure (|
                          Ty.apply
                          ...
                          M.use
                            (M.alloc (|
                              M.call_closure (|
                                Ty.path "bool",
                                BinOp.eq,
                                [ M.read (| codes_size |); Value.Integer IntegerKind.Usize 0 ]
                              |)
                            |)) in
      ...
      Definition access_code (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; index ] =>
          ltac:(M.monadic
            ...
            M.read (|
              let~ was_accessed : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "bool",
      ...
      Definition fmt (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; f ] =>
          ltac:(M.monadic
            ...
            let f := M.alloc (| f |) in
            M.read (|
              let~ s : Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "&") [] [ Ty.path "str" ] ] :=
                M.copy (|
                  M.match_operator (|
                    Some
                      (Ty.apply (Ty.path "*") [] [ Ty.apply (Ty.path "&") [] [ Ty.path "str" ] ]),
              ...
              (M.read (|
                ...
                let~ jumps :
                  ...
                  M.alloc (|
                    ...
                    |)
                  |) in
                let~ is_after_termination : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                  M.alloc (| Value.Bool false |) in
                let~ next_smallest : Ty.apply (Ty.path "*") [] [ Ty.path "i32" ] :=
                  M.alloc (|
                    M.cast
                      (Ty.path "i32")
                      (M.read (|
                      ...
                      |))
                  |) in
                let~ next_biggest : Ty.apply (Ty.path "*") [] [ Ty.path "i32" ] :=
                  M.alloc (|
                    M.cast
                      (Ty.path "i32")
                      (M.read (|
                      ...
                      |))
                  |) in
                let~ is_returning : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                  M.alloc (| Value.Bool false |) in
                        ...
                        [
                          fun γ =>
                            ltac:(M.monadic
                              ...
                              let _ :=
                                is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                              let~ op : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                                M.copy (|
                                  M.SubPointer.get_array_field (|
                                    M.deref (| M.read (| code |) |),
                                    M.read (| i |)
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ max_stack_requirement : Ty.apply (Ty.path "*") [] [ Ty.path "i32" ] :=
