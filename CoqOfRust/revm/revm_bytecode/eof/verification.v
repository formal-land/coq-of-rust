                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let _ :=
                          ...
                          |) in
                        M.borrow (| Pointer.Kind.Ref, M.deref (| mk_str (| "ReturnOrStop" |) |) |)))
                  ]
                |)
              ]
            |)))
                  ...
                  [
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        M.borrow (|
                          Pointer.Kind.Ref,
                          M.deref (| mk_str (| "Bytecode is missing bytes after RJUMPV opcode" |) |)
                        |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        M.borrow (|
                          Pointer.Kind.Ref,
                          M.deref (| mk_str (| "RETF biggest stack num is more than outputs" |) |)
                        |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        M.borrow (|
                          Pointer.Kind.Ref,
                          M.deref (| mk_str (| "Smallest stack items is more than output type" |) |)
                        |)));
                    fun γ =>
                      ltac:(M.monadic
                        (let γ := M.read (| γ |) in
