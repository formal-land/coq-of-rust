              ...
              [
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let~ sstore_clears_schedule : Ty.apply (Ty.path "*") [] [ Ty.path "i64" ] :=
                      M.copy (|
                        M.match_operator (|
                          Some (Ty.apply (Ty.path "*") [] [ Ty.path "i64" ]),
                          M.alloc (| Value.Tuple [] |),
                          ...
                          ltac:(M.monadic
                            (M.match_operator (|
                              ...
                              [
                                ...
                                fun γ =>
                                  ltac:(M.monadic
                                    (let~ refund : Ty.apply (Ty.path "*") [] [ Ty.path "i64" ] :=
      ...
      | [], [], [ value ] =>
        ltac:(M.monadic
          ...
          M.catch_return (Ty.path "u64") (|
            ltac:(M.monadic
              (M.read (|
                let~ l : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                  M.alloc (| Value.Integer IntegerKind.U64 256 |) in
                                          ...
                                          M.use
                                            (M.alloc (|
                                              M.call_closure (|
                                                Ty.path "bool",
                                                BinOp.eq,
                                                [ M.read (| l |); Value.Integer IntegerKind.U64 0 ]
                                              |)
                                            |)) in
                                        let _ :=
                                          is_constant_or_break_match (|
                                            ...
                                            M.read (|
                                              M.return_ (|
                                                M.call_closure (|
                                                  Ty.path "u64",
                                                  BinOp.Wrap.sub,
                                                  [ M.read (| l |); Value.Integer IntegerKind.U64 1
                                                  ]
                                                |)
                                              |)
                                            |)
    ...
    Definition extcodecopy_cost (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ spec_id; len; load ] =>
        ltac:(M.monadic
          ...
          M.read (|
            let~ base_gas : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.copy (|
                M.match_operator (|
                  Some (Ty.apply (Ty.path "*") [] [ Ty.path "u64" ]),
                  M.alloc (| Value.Tuple [] |),
                  ...
                  ltac:(M.monadic
                    (let γ :=
                      M.use
                        ...
                        |)) in
                    let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                    let~ gas_cost : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "u64",
                          M.get_function (|
    ...
    Definition selfdestruct_cost (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ spec_id; res ] =>
        ltac:(M.monadic
          ...
          M.read (|
            let~ should_charge_topup : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
              M.copy (|
                M.match_operator (|
                ...
                |)
              |) in
            let~ selfdestruct_gas_topup : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.copy (|
                M.match_operator (|
                  Some (Ty.apply (Ty.path "*") [] [ Ty.path "u64" ]),
                  M.alloc (| Value.Tuple [] |),
                ...
                |)
              |) in
            let~ selfdestruct_gas : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.copy (|
                M.match_operator (|
                  Some (Ty.apply (Ty.path "*") [] [ Ty.path "u64" ]),
                  M.alloc (| Value.Tuple [] |),
                ...
                |)
              |) in
            let~ gas : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "u64",
                  BinOp.Wrap.add,
    ...
    Definition memory_gas (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ num_words ] =>
        ltac:(M.monadic
          ...
          M.read (|
            let~ num_words : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
    ...
    Definition validate_initial_tx_gas (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [ AccessListT ], [ spec_id; input; is_create; access_list; authorization_list_num ] =>
        ltac:(M.monadic
          ...
          M.read (|
            let~ initial_gas : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.alloc (| Value.Integer IntegerKind.U64 0 |) in
            let~ zero_data_len : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.alloc (|
                M.cast
                  (Ty.path "u64")
                  (M.call_closure (|
                  ...
                  |))
              |) in
            let~ non_zero_data_len : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "u64",
                  BinOp.Wrap.sub,
