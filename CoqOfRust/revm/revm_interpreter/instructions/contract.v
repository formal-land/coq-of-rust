            ...
            ltac:(M.monadic
              (M.read (|
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ initcontainer_index : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "u8",
                      M.get_trait_method (|
            ...
            ltac:(M.monadic
              (M.read (|
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ deploy_container_index : Ty.apply (Ty.path "*") [] [ Ty.path "u8" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "u8",
                      M.get_trait_method (|
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let~ aux_data_size : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                          M.copy (|
                            M.match_operator (|
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                          ...
                          |) in
                        let~ gas_reduce : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                          M.alloc (|
                            M.call_closure (|
                              Ty.path "u64",
                      ...
                      ltac:(M.monadic
                        ...
                        let~ to :
                          ...
                          M.alloc (|
                            ...
                            |)
                          |) in
                        let~ local_gas_limit : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                          M.alloc (|
                            M.call_closure (|
                              Ty.path "u64",
                              M.get_associated_function (|
                            ...
                            |)
                          |) in
                        let~ has_transfer : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                          M.alloc (|
                            UnOp.not (|
                              M.call_closure (|
                                Ty.path "bool",
