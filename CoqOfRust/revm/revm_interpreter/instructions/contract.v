                                          ...
                                          M.call_closure (|
                                            ...
                                            [
                                              ...
                                              M.borrow (|
                                                Pointer.Kind.Ref,
                                                M.deref (|
                                                  mk_str (| "Subcontainer is verified" |)
                                                |)
                                              |)
                                            ]
                                          |) in
                              ...
                              fun γ =>
                                ltac:(M.monadic
                                  (let γ0_0 :=
                                    ...
                                    |) in
                                  let input :=
                                    M.copy (| Ty.path "alloy_primitives::bytes_::Bytes", γ0_0 |) in
                                  M.match_operator (|
                                    Ty.tuple [],
                                    M.alloc (|
                                      Ty.apply
                                        ...
                                        ltac:(M.monadic
                                          (let γ0_0 :=
                                            M.SubPointer.get_struct_tuple_field (|
                                              ...
                                              0
                                            |) in
                                          let gas_limit := M.copy (| Ty.path "u64", γ0_0 |) in
                                          M.read (|
                                            let~ _ : Ty.tuple [] :=
                                              M.call_closure (|
                                                Ty.tuple [],
                ...
                let~ _ : Ty.tuple [] :=
                  M.match_operator (|
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          (let γ := M.use (M.alloc (| Ty.path "bool", IS_CREATE2 |)) in
                          let _ :=
                            is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                          M.read (|
                            let~ _ : Ty.tuple [] :=
                            ...
                            [
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  let input :=
                                    M.copy (| Ty.path "alloy_primitives::bytes_::Bytes", γ1_0 |) in
                                  let return_memory_offset :=
                                    M.copy (|
                                      Ty.apply
                                        (Ty.path "core::ops::range::Range")
