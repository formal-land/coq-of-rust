            ...
            ltac:(M.monadic
              (M.read (|
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ offset : Ty.apply (Ty.path "*") [] [ Ty.path "isize" ] :=
                  M.alloc (|
                    M.cast
                      (Ty.path "isize")
                      (M.call_closure (|
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let~ case : Ty.apply (Ty.path "*") [] [ Ty.path "isize" ] :=
                          M.alloc (|
                            M.call_closure (|
                              Ty.path "isize",
                              M.get_associated_function (|
                            ...
                            |)
                          |) in
                        let~ max_index : Ty.apply (Ty.path "*") [] [ Ty.path "isize" ] :=
                          M.alloc (|
                            M.cast
                              (Ty.path "isize")
                              (M.call_closure (|
      ...
      | [], [ WIRE ], [ interpreter; target ] =>
        ltac:(M.monadic
          ...
          M.catch_return (Ty.tuple []) (|
            ltac:(M.monadic
              (M.read (|
                let~ target : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.copy (|
                    M.match_operator (|
                    ...
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                          ...
                          |) in
                        let~ pc : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                          M.alloc (|
                            M.call_closure (|
                              Ty.path "usize",
                              M.get_associated_function (|
