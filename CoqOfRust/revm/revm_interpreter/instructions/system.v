                          ...
                          M.copy (|
                            M.match_operator (|
                              ...
                              [
                                ...
                                fun γ =>
                                  ltac:(M.monadic
                                    (let~ from : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                      M.copy (|
                                        M.match_operator (|
                                          Some (Ty.apply (Ty.path "*") [] [ Ty.path "usize" ]),
                                          M.alloc (|
                          ...
                          [
                            fun γ =>
                              ltac:(M.monadic
                                ...
                                let~ code_offset : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                  M.alloc (|
                                    M.call_closure (|
                                      Ty.path "usize",
                                      M.get_associated_function (|
                            ...
                            fun γ =>
                              ltac:(M.monadic
                                (let γ0_0 :=
                                  ...
                                  |) in
                                let memory_offset := M.copy (| γ0_0 |) in
                                let~ data_offset : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                  M.alloc (|
                                    M.call_closure (|
                                      Ty.path "usize",
                                      M.get_associated_function (|
                      ...
                      ltac:(M.monadic
                        ...
                        let~ data_offset : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                          M.alloc (|
                            ...
                            |)
                          |) in
                        let~ data_end : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                          M.alloc (|
                            M.call_closure (|
                              Ty.path "usize",
                              M.get_associated_function (|
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        ...
                        let γ1_1 := M.SubPointer.get_tuple_field (| γ0_0, 1 |) in
                        let offset := M.copy (| γ1_1 |) in
                        let~ offset_usize : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                          M.alloc (|
                            M.call_closure (|
                              Ty.path "usize",
                              M.get_associated_function (|
                            ...
                            [
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  let~ copy_len : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                    M.alloc (|
                                      M.call_closure (|
                                        Ty.path "usize",
                                        M.get_trait_method (|
            ...
            ltac:(M.monadic
              (M.read (|
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ memory_offset : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.copy (|
                    M.match_operator (|
                      Some (Ty.apply (Ty.path "*") [] [ Ty.path "usize" ]),
                      M.alloc (|
