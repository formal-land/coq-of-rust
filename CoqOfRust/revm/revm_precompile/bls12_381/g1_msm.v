...
Module bls12_381.
  Module g1_msm.
    ...
    Definition value_ADDRESS (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ltac:(M.monadic (M.alloc (| Value.Integer IntegerKind.U64 13 |))).
            ...
            ltac:(M.monadic
              (M.read (|
                                          ...
                                          let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                                            M.alloc (|
                                              M.call_closure (|
                                                ...
                                                |),
                                                [
                                                  M.borrow (| Pointer.Kind.MutRef, g1_points |);
                                                  M.read (| p0 |)
                                                ]
                                              |)
                                            |) in
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ points : Ty.apply (Ty.path "*") [] [ Ty.path "blst::p1_affines" ] :=
                  M.alloc (|
                    M.call_closure (|
                    ...
                    |)
                  |) in
                let~ multiexp : Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_p1" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "blst::blst_p1",
                    ...
                    |)
                  |) in
                let~ multiexp_aff : Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_p1_affine" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "blst::blst_p1_affine",
                      M.get_trait_method (|
