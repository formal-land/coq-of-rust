  ...
  Module g1_mul.
          ...
          Value.StructTuple
            ...
            [
              M.call_closure (|
                ...
                [
                  M.read (|
                    get_constant (| "revm_precompile::bls12_381::g1_mul::ADDRESS", Ty.path "u64" |)
                  |)
                ]
              |);
              (* ReifyFnPointer *)
    ...
    *)
              ...
              (M.read (|
                ...
                let~ p0_aff :
                  ...
                  M.alloc (|
                    ...
                    |)
                  |) in
                let~ p0 : Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_p1" ] :=
                  M.alloc (|
                    M.call_closure (|
                ...
                let~ input_scalar0 : Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_scalar" ] :=
                  M.copy (|
                    ...
                    |)
                  |) in
                let~ p : Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_p1" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "blst::blst_p1",
                      M.get_trait_method (|
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  M.alloc (|
                    ...
                    |)
                  |) in
                let~ p_aff : Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_p1_affine" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "blst::blst_p1_affine",
                      M.get_trait_method (|
    ...
    Global Instance Instance_IsFunction_g1_mul :
      M.IsFunction.C "revm_precompile::bls12_381::g1_mul::g1_mul" g1_mul.
    Admitted.
