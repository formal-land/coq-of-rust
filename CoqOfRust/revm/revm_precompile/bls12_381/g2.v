                  ...
                  Value.StructRecord
                    ...
                    [
                      ("x",
                        M.read (|
                          M.match_operator (|
                            Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_fp2" ],
                            M.alloc (|
                              M.call_closure (|
                                Ty.apply
      ...
      | [], [], [ input_1; input_2 ] =>
        ltac:(M.monadic
          ...
          M.catch_return
            ...
            ltac:(M.monadic
              (M.read (|
                let~ fp_1 : Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_fp" ] :=
                  M.copy (|
                    M.match_operator (|
                      Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_fp" ],
                      M.alloc (|
                        M.call_closure (|
                          Ty.apply
                            (Ty.path "core::ops::control_flow::ControlFlow")
                    ...
                    |)
                  |) in
                let~ fp_2 : Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_fp" ] :=
                  M.copy (|
                    M.match_operator (|
                      Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_fp" ],
                      M.alloc (|
              ...
              (M.read (|
                ...
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  M.use
                    ...
                    |)) in
                let~ out : Ty.apply (Ty.path "*") [] [ Ty.path "blst::blst_p2_affine" ] :=
                  M.copy (|
                    M.match_operator (|
