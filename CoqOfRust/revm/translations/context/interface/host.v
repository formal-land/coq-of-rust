      ...
      Definition balance (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; address ] =>
          ltac:(M.monadic
            ...
            let address := M.alloc (| address |) in
            M.call_closure (|
              M.get_trait_method (| "revm_context_interface::host::Host", T, [], "balance", [] |),
              [ M.read (| M.read (| self |) |); M.read (| address |) ]
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
      ...
      Definition code (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; address ] =>
          ltac:(M.monadic
            ...
            let address := M.alloc (| address |) in
            M.call_closure (|
              M.get_trait_method (| "revm_context_interface::host::Host", T, [], "code", [] |),
              [ M.read (| M.read (| self |) |); M.read (| address |) ]
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
      ...
      Definition code_hash (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; address ] =>
          ltac:(M.monadic
            ...
            let address := M.alloc (| address |) in
            M.call_closure (|
              M.get_trait_method (| "revm_context_interface::host::Host", T, [], "code_hash", [] |),
              [ M.read (| M.read (| self |) |); M.read (| address |) ]
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
      ...
      Definition sload (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; address; index ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              M.get_trait_method (| "revm_context_interface::host::Host", T, [], "sload", [] |),
      ...
      Definition sstore (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; address; index; value ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              M.get_trait_method (| "revm_context_interface::host::Host", T, [], "sstore", [] |),
              [
                M.read (| M.read (| self |) |);
                M.read (| address |);
                M.read (| index |);
      ...
      Definition tload (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; address; index ] =>
          ltac:(M.monadic
            ...
            let index := M.alloc (| index |) in
            M.call_closure (|
              M.get_trait_method (| "revm_context_interface::host::Host", T, [], "tload", [] |),
              [ M.read (| M.read (| self |) |); M.read (| address |); M.read (| index |) ]
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
      ...
      Definition tstore (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; address; index; value ] =>
          ltac:(M.monadic
            ...
            let value := M.alloc (| value |) in
            M.call_closure (|
              M.get_trait_method (| "revm_context_interface::host::Host", T, [], "tstore", [] |),
              [
                M.read (| M.read (| self |) |);
                M.read (| address |);
                M.read (| index |);
      ...
      Definition log (T : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ self; log ] =>
          ltac:(M.monadic
            ...
            M.call_closure (|
              M.get_trait_method (| "revm_context_interface::host::Host", T, [], "log", [] |),
              [ M.read (| M.read (| self |) |); M.read (| log |) ]
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
          ...
          ltac:(M.monadic
            ...
            M.call_closure (|
              M.get_trait_method (|
                ...
                []
              |),
              [ M.read (| M.read (| self |) |); M.read (| address |); M.read (| target |) ]
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
