      ...
      | [], [], [ self; f ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            [
              M.read (| f |);
              M.read (| Value.String "AccountLoad" |);
              M.read (| Value.String "load" |);
              M.SubPointer.get_struct_record_field (|
                M.read (| self |),
                "revm_context_interface::journaled_state::AccountLoad",
                "load"
      ...
      | [], [], [ self; f ] =>
        ltac:(M.monadic
          ...
          M.call_closure (|
            ...
            [
              M.read (| f |);
              M.read (| Value.String "Eip7702CodeLoad" |);
              M.read (| Value.String "state_load" |);
              M.SubPointer.get_struct_record_field (|
                M.read (| self |),
                "revm_context_interface::journaled_state::Eip7702CodeLoad",
                "state_load"
              |);
              M.read (| Value.String "is_delegate_account_cold" |);
              M.alloc (|
                M.SubPointer.get_struct_record_field (|
                  M.read (| self |),
                  "revm_context_interface::journaled_state::Eip7702CodeLoad",
