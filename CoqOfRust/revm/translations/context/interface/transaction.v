              ...
              [
                M.call_closure (|
                  ...
                  [
                    M.alloc (|
                      Value.Array
                        [ M.read (| Value.String "not implemented: Eip2930 tx not supported" |) ]
                    |);
                    M.alloc (|
                      M.call_closure (|
                        M.get_associated_function (|
              ...
              [
                M.call_closure (|
                  ...
                  [
                    M.alloc (|
                      Value.Array
                        [ M.read (| Value.String "not implemented: Eip1559 tx not supported" |) ]
                    |);
                    M.alloc (|
                      M.call_closure (|
                        M.get_associated_function (|
              ...
              [
                M.call_closure (|
                  ...
                  [
                    M.alloc (|
                      Value.Array
                        [ M.read (| Value.String "not implemented: Eip4844 tx not supported" |) ]
                    |);
                    M.alloc (|
                      M.call_closure (|
                        M.get_associated_function (|
              ...
              [
                M.call_closure (|
                  ...
                  [
                    M.alloc (|
                      Value.Array
                        [ M.read (| Value.String "not implemented: Eip7702 tx not supported" |) ]
                    |);
                    M.alloc (|
                      M.call_closure (|
                        M.get_associated_function (|
                              ...
                              [
                                M.alloc (|
                                  Value.Array
                                    [
                                      M.read (|
                                        Value.String "not implemented: Custom tx not supported"
                                      |)
                                    ]
                                |);
                                M.alloc (|
          ...
          ltac:(M.monadic
            ...
            M.call_closure (|
              M.get_trait_method (|
                ...
                []
              |),
              [ M.read (| M.read (| self |) |); M.read (| base_fee |) ]
            |)))
        | _, _, _ => M.impossible "wrong number of arguments"
        end.
