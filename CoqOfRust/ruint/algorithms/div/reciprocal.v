            ...
            M.read (|
              ...
              let~ _ : Ty.tuple [] :=
                M.read (|
                  ...
                  |)
                |) in
              M.alloc (| Ty.path "u64", M.cast (Ty.path "u64") (M.read (| r |)) |)
            |)))
      ...
      *)
      ...
      Module reciprocal_mg10.
        ...
        Definition value_TABLE (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
          ltac:(M.monadic
            (M.alloc (|
              Ty.apply (Ty.path "array") [ Value.Integer IntegerKind.Usize 256 ] [ Ty.path "u16" ],
              M.alloc (|
                Ty.apply
                  (Ty.path "array")
                  [ Value.Integer IntegerKind.Usize 256 ]
            ...
            M.read (|
              ...
              let~ t1 : Ty.path "u64" :=
                M.cast
                  ...
                  |)) in
              let~ t0 : Ty.path "u64" := M.cast (Ty.path "u64") (M.read (| t |)) in
              let~ p : Ty.path "u64" :=
                M.call_closure (|
                  Ty.path "u64",
                  M.get_associated_function (| Ty.path "u64", "wrapping_add", [], [] |),
