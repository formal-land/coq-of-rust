            ...
            M.read (|
              ...
              let~ v : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  ...
                  |)
                |) in
              let~ p : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u64",
              ...
              let~ t1 : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                M.alloc (|
                  M.cast
                    ...
                    |))
                |) in
              let~ t0 : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
      ...
      Definition mul_hi (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ a; b ] =>
          ltac:(M.monadic
            ...
            let b := M.alloc (| b |) in
            M.read (|
              let~ a : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u128",
                    M.get_trait_method (|
                  ...
                  |)
                |) in
              let~ b : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u128",
                    M.get_trait_method (|
            ...
            M.read (|
              ...
              let~ b : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
                M.alloc (|
                  ...
                  |)
                |) in
              let~ c : Ty.apply (Ty.path "*") [] [ Ty.path "u128" ] :=
                M.alloc (|
                  M.call_closure (|
                    Ty.path "u128",
                    M.get_trait_method (|
