            ...
            M.read (|
              ...
              let~ v : Ty.path "u64" :=
                M.call_closure (|
                  ...
                  [ M.read (| d |) ]
                |) in
              let~ r : Ty.path "u64" := Value.Integer IntegerKind.U64 0 in
              let~ _ : Ty.tuple [] :=
                M.read (|
                  M.use
                    (M.match_operator (|
              ...
              ltac:(M.monadic
                (M.read (|
                                            ...
                                            M.never_to_any (|
                                              M.call_closure (|
                                                ...
                                                [
                                                  M.read (|
                                                    Value.String
                                                      "assertion failed: !limbs.is_empty()"
                                                  |)
                                                ]
                                              |)
                                            |)
                  ...
                  let~ divisor : Ty.path "u64" :=
                    BinOp.Wrap.shl (| M.read (| divisor |), M.read (| shift |) |) in
                  ...
                  let~ remainder : Ty.path "u64" :=
                    M.call_closure (|
                      ...
                      [
                        M.read (| last |);
                        BinOp.Wrap.sub (| Value.Integer IntegerKind.U32 64, M.read (| shift |) |)
                      ]
                    |) in
                  let~ _ : Ty.tuple [] :=
                    M.read (|
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          let~ _ : Ty.tuple [] :=
                            M.write (| M.deref (| M.read (| first |) |), M.read (| q |) |) in
                          M.alloc (|
                            BinOp.Wrap.shr (| M.read (| remainder |), M.read (| shift |) |)
                          |)))
                    ]
                  |)
                |)))
          ...
          ltac:(M.monadic
            ...
            M.read (|
              ...
              let~ d : Ty.path "u128" :=
                ...
                |) in
              let~ q : Ty.path "u64" :=
                M.cast (Ty.path "u64") (BinOp.Wrap.div (| M.read (| u |), M.read (| d |) |)) in
              let~ r : Ty.path "u64" :=
                M.cast (Ty.path "u64") (BinOp.Wrap.rem (| M.read (| u |), M.read (| d |) |)) in
            ...
            M.read (|
              ...
              let~ q : Ty.path "u128" :=
                BinOp.Wrap.add (|
                  M.read (| u |),
                  BinOp.Wrap.mul (|
                    BinOp.Wrap.shr (| M.read (| u |), Value.Integer IntegerKind.I32 64 |),
                    M.call_closure (|
                      Ty.path "u128",
                      M.get_trait_method (|
                        "core::convert::From",
                  ...
                  |)
                |) in
              let~ q0 : Ty.path "u64" := M.cast (Ty.path "u64") (M.read (| q |)) in
              let~ q1 : Ty.path "u64" :=
                M.call_closure (|
                  Ty.path "u64",
                  ...
                  [
                    M.cast
                      (Ty.path "u64")
                      (BinOp.Wrap.shr (| M.read (| q |), Value.Integer IntegerKind.I32 64 |));
                    Value.Integer IntegerKind.U64 1
                  ]
                |) in
              let~ r : Ty.path "u64" :=
                ...
                M.match_operator (|
                  ...
                  [
                    fun γ =>
                      ltac:(M.monadic
                        (let γ :=
                          M.use (M.alloc (| BinOp.gt (| M.read (| r |), M.read (| q0 |) |) |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        M.alloc (|
                          Value.Tuple
          ...
          ltac:(M.monadic
            ...
            M.read (|
              ...
              let~ n2 : Ty.path "u64" :=
                M.cast
                  (Ty.path "u64")
                  (BinOp.Wrap.shr (| M.read (| n21 |), Value.Integer IntegerKind.I32 64 |)) in
              let~ n1 : Ty.path "u64" := M.cast (Ty.path "u64") (M.read (| n21 |)) in
              let~ d1 : Ty.path "u64" :=
                M.cast
                  (Ty.path "u64")
                  (BinOp.Wrap.shr (| M.read (| d |), Value.Integer IntegerKind.I32 64 |)) in
              let~ d0 : Ty.path "u64" := M.cast (Ty.path "u64") (M.read (| d |)) in
              M.match_operator (|
                Some (Ty.path "u64"),
                M.alloc (| Value.Tuple [] |),
                [
                          ...
                          fun γ =>
                            ltac:(M.monadic
                              (let γ :=
                                M.use
                                  (M.alloc (|
                                    BinOp.gt (| M.read (| neg_remainder |), M.read (| d |) |)
                                  |)) in
                              let _ :=
                                M.is_constant_or_break_match (|
                                  M.read (| γ |),
                                      ...
                                      fun γ =>
                                        ltac:(M.monadic
                                          ...
                                          let~ overflow : Ty.path "bool" :=
                                            BinOp.lt (| M.read (| r |), M.read (| d1 |) |) in
                                          M.match_operator (|
                                            Some (Ty.tuple []),
                                            M.alloc (| Value.Tuple [] |),
                                            [
