    ...
    Module small.
          ...
          ltac:(M.monadic
            (let u :=
              M.alloc (|
                ...
                u
              |) in
            let d := M.alloc (| Ty.path "u64", d |) in
            M.read (|
              let~ _ : Ty.tuple [] :=
                M.match_operator (|
                  Ty.tuple [],
          ...
          ltac:(M.monadic
            (let limbs :=
              M.alloc (|
                ...
                limbs
              |) in
            let divisor := M.alloc (| Ty.path "u64", divisor |) in
                      ...
                      [
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let remainder := M.copy (| Ty.path "u64", γ0_1 |) in
                            M.read (|
                              let~ _ : Ty.tuple [] :=
          ...
          ltac:(M.monadic
            (let limbs :=
              M.alloc (|
                ...
                limbs
              |) in
            let divisor := M.alloc (| Ty.path "u128", divisor |) in
                      ...
                      [
                        fun γ =>
                          ltac:(M.monadic
                            ...
                            let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                            let q := M.copy (| Ty.path "u64", γ0_0 |) in
                            let remainder := M.copy (| Ty.path "u128", γ0_1 |) in
                            M.read (|
                              let~ _ : Ty.tuple [] :=
                                M.write (| M.deref (| M.read (| first |) |), M.read (| q |) |) in
                              M.alloc (|
      ...
      *)
      Definition div_2x1_ref (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ u; d ] =>
          ltac:(M.monadic
            (let u := M.alloc (| Ty.path "u128", u |) in
            let d := M.alloc (| Ty.path "u64", d |) in
            M.read (|
              let~ _ : Ty.tuple [] :=
                M.match_operator (|
                  ...
                  M.alloc (|
                    ...
                    M.match_operator (|
                      ...
                      [
                        ...
                        fun γ => ltac:(M.monadic (Value.Tuple [ M.read (| q1 |); M.read (| r |) ]))
                      ]
                    |)
                  |),
                  [
                    fun γ =>
                      ltac:(M.monadic
                        (let γ0_0 := M.SubPointer.get_tuple_field (| γ, 0 |) in
                        let γ0_1 := M.SubPointer.get_tuple_field (| γ, 1 |) in
                        let q1 := M.copy (| Ty.path "u64", γ0_0 |) in
                          ...
                          M.alloc (|
                            ...
                            M.match_operator (|
                              ...
                              [
                                ...
                                fun γ =>
                                  ltac:(M.monadic (Value.Tuple [ M.read (| q1 |); M.read (| r |) ]))
                              ]
                            |)
                          |),
                          [
                            fun γ =>
                              ltac:(M.monadic
                                ...
                                let q1 := M.copy (| Ty.path "u64", γ0_0 |) in
                                let r := M.copy (| Ty.path "u64", γ0_1 |) in
                                Value.Tuple [ M.read (| q1 |); M.read (| r |) ]))
                          ]
                        |)))
                  ]
                |)
      ...
      *)
      Definition div_3x2_ref (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ n21; n0; d ] =>
          ltac:(M.monadic
            (let n21 := M.alloc (| Ty.path "u128", n21 |) in
            let n0 := M.alloc (| Ty.path "u64", n0 |) in
            let d := M.alloc (| Ty.path "u128", d |) in
            M.read (|
              let~ _ : Ty.tuple [] :=
                M.match_operator (|
      ...
      *)
      Definition div_3x2_mg10 (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
        ...
        | [], [], [ u21; u0; d; v ] =>
          ltac:(M.monadic
            (let u21 := M.alloc (| Ty.path "u128", u21 |) in
            let u0 := M.alloc (| Ty.path "u64", u0 |) in
            let d := M.alloc (| Ty.path "u128", d |) in
            let v := M.alloc (| Ty.path "u64", v |) in
            M.read (|
              let~ _ : Ty.tuple [] :=
