            ...
            ltac:(M.monadic
              ...
              M.read (|
                ...
                let~ s : Ty.path "usize" :=
                  ...
                  |) in
                M.match_operator (|
                  Some (Ty.path "ruint::algorithms::gcd::matrix::Matrix"),
                  M.alloc (| Value.Tuple [] |),
                  [
                    fun γ =>
                      ltac:(M.monadic
                        (let γ :=
                          M.use
                            (M.alloc (|
                              BinOp.le (| M.read (| s |), Value.Integer IntegerKind.Usize 64 |)
                            |)) in
                        let _ :=
                          M.is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                        M.alloc (|
                      ...
                      M.never_to_any (|
                        M.read (|
                          M.loop (|
                            ...
                            ltac:(M.monadic
                              (let~ q : Ty.path "u64" :=
                                BinOp.Wrap.div (| M.read (| r0 |), M.read (| r1 |) |) in
                              let~ _ : Ty.tuple [] :=
                                let β := r0 in
                                M.write (|
                                  β,
                                  BinOp.Wrap.sub (|
                                    M.read (| β |),
                                    BinOp.Wrap.mul (| M.read (| q |), M.read (| r1 |) |)
                                  |)
                                |) in
                              let~ _ : Ty.tuple [] :=
                                let β := q00 in
                                M.write (|
                                  ...
                                  BinOp.Wrap.add (|
                                    M.read (| β |),
                                    BinOp.Wrap.mul (| M.read (| q |), M.read (| q10 |) |)
                                  |)
                                |) in
                              let~ _ : Ty.tuple [] :=
                                let β := q01 in
                                M.write (|
                                  ...
                                  BinOp.Wrap.add (|
                                    M.read (| β |),
                                    BinOp.Wrap.mul (| M.read (| q |), M.read (| q11 |) |)
                                  |)
                                |) in
                              let~ _ : Ty.tuple [] :=
                                M.read (|
                                ...
                                |) in
                              let~ q : Ty.path "u64" :=
                                BinOp.Wrap.div (| M.read (| r1 |), M.read (| r0 |) |) in
                              let~ _ : Ty.tuple [] :=
                                let β := r1 in
                                M.write (|
                                  β,
                                  BinOp.Wrap.sub (|
                                    M.read (| β |),
                                    BinOp.Wrap.mul (| M.read (| q |), M.read (| r0 |) |)
                                  |)
                                |) in
                              let~ _ : Ty.tuple [] :=
                                let β := q10 in
                                M.write (|
                                  ...
                                  BinOp.Wrap.add (|
                                    M.read (| β |),
                                    BinOp.Wrap.mul (| M.read (| q |), M.read (| q00 |) |)
                                  |)
                                |) in
                              let~ _ : Ty.tuple [] :=
                                let β := q11 in
                                M.write (|
                                  ...
                                  BinOp.Wrap.add (|
                                    M.read (| β |),
                                    BinOp.Wrap.mul (| M.read (| q |), M.read (| q01 |) |)
                                  |)
                                |) in
                              M.match_operator (|
                                Some (Ty.tuple []),
                ...
                ltac:(M.monadic
                  (M.read (|
                    ...
                    let~ _ : Ty.tuple [] :=
                      ...
                      |) in
                    let~ q : Ty.path "u64" :=
                      BinOp.Wrap.div (| M.read (| a0 |), M.read (| a1 |) |) in
                    let~ a2 : Ty.path "u64" :=
                      BinOp.Wrap.sub (|
                        M.read (| a0 |),
                        BinOp.Wrap.mul (| M.read (| q |), M.read (| a1 |) |)
                      |) in
                    let~ k2 : Ty.path "u64" :=
                      BinOp.Wrap.add (|
                        M.read (| k0 |),
                        BinOp.Wrap.mul (| M.read (| q |), M.read (| k1 |) |)
                      |) in
                    let~ _ : Ty.tuple [] :=
                      M.read (|
                        M.match_operator (|
                      ...
                      |) in
                    let~ q : Ty.path "u64" :=
                      BinOp.Wrap.div (| M.read (| a1 |), M.read (| a2 |) |) in
                    let~ a3 : Ty.path "u64" :=
                      BinOp.Wrap.sub (|
                        M.read (| a1 |),
                        BinOp.Wrap.mul (| M.read (| q |), M.read (| a2 |) |)
                      |) in
                    let~ k3 : Ty.path "u64" :=
                      BinOp.Wrap.add (|
                        M.read (| k1 |),
                        BinOp.Wrap.mul (| M.read (| q |), M.read (| k2 |) |)
                      |) in
                    let~ _ : Ty.tuple [] :=
                      M.read (|
                        M.loop (|
                                ...
                                fun γ =>
                                  ltac:(M.monadic
                                    ...
                                    let~ _ : Ty.tuple [] :=
                                      ...
                                      |) in
                                    let~ q : Ty.path "u64" :=
                                      BinOp.Wrap.div (| M.read (| a3 |), M.read (| a2 |) |) in
                                    let~ _ : Ty.tuple [] :=
                                      let β := a3 in
                                      M.write (|
                                        β,
                      ...
                      |) in
                    let~ u0 : Ty.path "u64" :=
                      BinOp.Wrap.shr (| M.read (| k0 |), Value.Integer IntegerKind.I32 32 |) in
                    let~ u1 : Ty.path "u64" :=
                      BinOp.Wrap.shr (| M.read (| k1 |), Value.Integer IntegerKind.I32 32 |) in
                    let~ u2 : Ty.path "u64" :=
                      BinOp.Wrap.shr (| M.read (| k2 |), Value.Integer IntegerKind.I32 32 |) in
                    let~ u3 : Ty.path "u64" :=
                      BinOp.Wrap.shr (| M.read (| k3 |), Value.Integer IntegerKind.I32 32 |) in
                    let~ v0 : Ty.path "u64" :=
                      BinOp.Wrap.rem (|
                        M.read (| k0 |),
                        M.read (|
                                  ...
                                  ltac:(M.monadic
                                    (let γ :=
                                      M.use
                                        (M.alloc (|
                                          BinOp.ge (|
                                            BinOp.Wrap.sub (| M.read (| a1 |), M.read (| a2 |) |),
                                            BinOp.Wrap.add (| M.read (| u2 |), M.read (| u1 |) |)
                                          |)
                                        |)) in
                                    let _ :=
                                      M.is_constant_or_break_match (|
                                    ...
                                    (let γ :=
                                      M.use
                                        (M.alloc (|
                                          BinOp.ge (|
                                            BinOp.Wrap.sub (| M.read (| a1 |), M.read (| a2 |) |),
                                            BinOp.Wrap.add (| M.read (| v2 |), M.read (| v1 |) |)
                                          |)
                                        |)) in
                                    let _ :=
                                      M.is_constant_or_break_match (|
                ...
                ltac:(M.monadic
                  (M.read (|
                    ...
                    let~ r0s : Ty.path "u128" :=
                      BinOp.Wrap.shl (| M.read (| r0 |), M.read (| s |) |) in
                    let~ r1s : Ty.path "u128" :=
                      BinOp.Wrap.shl (| M.read (| r1 |), M.read (| s |) |) in
