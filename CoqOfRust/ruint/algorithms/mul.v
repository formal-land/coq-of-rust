  ...
  Module mul.
                                    ...
                                    [
                                      ...
                                      fun γ =>
                                        ltac:(M.monadic
                                          ...
                                          let a := M.copy (| Ty.path "u64", γ1_1 |) in
                                          let~ result :
                                              Ty.apply
    ...
    *)
    Definition mac (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ lhs; a; b; c ] =>
        ltac:(M.monadic
          (let lhs := M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "u64" ], lhs |) in
          let a := M.alloc (| Ty.path "u64", a |) in
                                            ...
                                            [
                                              fun γ =>
                                                ltac:(M.monadic
                                                  ...
                                                  let new := M.copy (| Ty.path "u64", γ0_0 |) in
                                                  let b := M.copy (| Ty.path "u64", γ0_1 |) in
                                                  let~ _ : Ty.tuple [] :=
                                                    M.write (|
                                                      M.deref (| M.read (| lhs |) |),
                                                      M.read (| new |)
