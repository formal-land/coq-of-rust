        ...
        ltac:(M.monadic
          ...
          M.read (|
                                    ...
                                    M.alloc (|
                                      M.never_to_any (|
                                        M.call_closure (|
                                          ...
                                          [
                                            M.read (|
                                              Value.String "assertion failed: !m.is_empty()"
                                            |)
                                          ]
                                        |)
                                      |)
                                      ...
                                      M.never_to_any (|
                                        M.call_closure (|
                                          ...
                                          [
                                            M.read (|
                                              Value.String
                                                "assertion failed: temp[temp.len() - 1] <= 1"
                                            |)
                                          ]
                                        |)
                                      |)
            ...
            let~ _ : Ty.tuple [] :=
              ...
              |) in
            let~ reduce : Ty.path "bool" := Value.Bool true in
            let~ _ : Ty.tuple [] :=
              M.read (|
                M.match_operator (|
                  Some (Ty.tuple []),
              ...
              [
                fun γ =>
                  ltac:(M.monadic
                    ...
                    let~ carry : Ty.path "i128" := Value.Integer IntegerKind.I128 0 in
                    let~ _ : Ty.tuple [] :=
                      M.read (|
                        M.use
                          (M.match_operator (|
