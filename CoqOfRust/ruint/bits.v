                      ...
                      Value.Tuple
                        [
                          M.call_closure (|
                            Ty.path "usize",
                            BinOp.Wrap.div,
                            [ M.read (| index |); Value.Integer IntegerKind.Usize 64 ]
                          |);
                          M.call_closure (|
                            Ty.path "usize",
                            BinOp.Wrap.rem,
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          let limbs := M.copy (| Ty.path "usize", γ0_0 |) in
                          let bits := M.copy (| Ty.path "usize", γ0_1 |) in
                          M.call_closure (|
                            Ty.path "bool",
                            BinOp.ne,
                            [
                                ...
                                fun γ =>
                                  ltac:(M.monadic
                                    ...
                                    M.call_closure (|
                                      Ty.path "bool",
                                      BinOp.ne,
                                      [ M.read (| limb |); Value.Integer IntegerKind.U64 0 ]
                                    |)))
                              ]
                            |)))
                            ...
                            (M.match_operator (|
                              ...
                              [
                                fun γ =>
                                  ltac:(M.monadic
                                    (let limb :=
                                      M.copy (| Ty.apply (Ty.path "&") [] [ Ty.path "u64" ], γ |) in
                                    M.cast
                                      (Ty.path "usize")
                                      (M.call_closure (|
                                        Ty.path "u32",
                        ...
                        M.use
                          (M.alloc (|
                            ...
                            M.call_closure (|
                              Ty.path "bool",
                              BinOp.eq,
                              [ M.read (| first_set_limb |); Value.Integer IntegerKind.Usize 0 ]
                            |)
                          |)) in
                      let _ := is_constant_or_break_match (| M.read (| γ |), Value.Bool true |) in
                      Value.Tuple
                  ...
                  fun γ =>
                    ltac:(M.monadic
                      (M.read (|
                          ...
                          M.read (|
                            M.SubPointer.get_array_field (|
                              ...
                              M.call_closure (|
                                Ty.path "usize",
                                BinOp.Wrap.sub,
                                [ M.read (| first_set_limb |); Value.Integer IntegerKind.Usize 1 ]
                              |)
                            |)
                          |) in
                            ...
                            [
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  M.call_closure (|
                                    ...
                                    [
                                      M.call_closure (|
                                        Ty.path "u64",
                                        BinOp.Wrap.shl,
                                        [ M.read (| hi |); M.read (| leading_zeros |) ]
                                      |);
                                      M.call_closure (|
                                        Ty.path "u64",
                                        BinOp.Wrap.shr,
                                  ...
                                  |)));
                              fun γ => ltac:(M.monadic (M.read (| hi |)))
                            ]
                          |) in
                          ...
                          M.call_closure (|
                            ...
                            [
                              M.call_closure (|
                                Ty.path "usize",
                                BinOp.Wrap.mul,
                                [ M.read (| first_set_limb |); Value.Integer IntegerKind.Usize 64 ]
                              |);
                        ...
                        M.alloc (|
                          Ty.tuple [ Ty.path "u64"; Ty.path "usize" ],
                          Value.Tuple [ M.read (| bits |); M.read (| exponent |) ]
                        |)
                      |)))
                ]
              |)
                  ...
                  Value.Tuple
                    [
                      M.call_closure (|
                        Ty.path "usize",
                        BinOp.Wrap.div,
                        [ M.read (| rhs |); Value.Integer IntegerKind.Usize 64 ]
                      |);
                      M.call_closure (|
                        Ty.path "usize",
                        BinOp.Wrap.rem,
                                          ...
                                          [
                                            fun γ =>
                                              ltac:(M.monadic
                                                ...
                                                M.read (|
                                                  let~ _ : Ty.tuple [] :=
                                                    M.write (| overflow, Value.Bool true |) in
                                                  M.alloc (| Ty.tuple [], Value.Tuple [] |)
                                                |)));
                                            fun γ => ltac:(M.monadic (Value.Tuple []))
                                          ]
    ...
    *)
    Definition shl
      ...
      | [], [], [ self; rhs ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [], self |) in
          let rhs := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "u8" ], rhs |) in
          M.call_closure (|
            Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
            M.get_trait_method (|
              "core::ops::bit::Shl",
    ...
    *)
    Definition shl
      ...
      | [], [], [ self; rhs ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [], self |) in
          let rhs := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "u16" ], rhs |) in
          M.call_closure (|
            Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
            M.get_trait_method (|
              "core::ops::bit::Shl",
    ...
    *)
    Definition shl
      ...
      | [], [], [ self; rhs ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [], self |) in
          let rhs := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "u32" ], rhs |) in
          M.call_closure (|
            Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
            M.get_trait_method (|
              "core::ops::bit::Shl",
    ...
    *)
    Definition shl
      ...
      | [], [], [ self; rhs ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [], self |) in
          let rhs := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "isize" ], rhs |) in
          M.call_closure (|
            Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
            M.get_trait_method (|
              "core::ops::bit::Shl",
    ...
    *)
    Definition shl
      ...
      | [], [], [ self; rhs ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [], self |) in
          let rhs := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "i8" ], rhs |) in
          M.call_closure (|
            Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
            M.get_trait_method (|
              "core::ops::bit::Shl",
    ...
    *)
    Definition shl
      ...
      | [], [], [ self; rhs ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [], self |) in
          let rhs := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "i16" ], rhs |) in
          M.call_closure (|
            Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
            M.get_trait_method (|
              "core::ops::bit::Shl",
    ...
    *)
    Definition shl
      ...
      | [], [], [ self; rhs ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [], self |) in
          let rhs := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "i32" ], rhs |) in
          M.call_closure (|
            Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
            M.get_trait_method (|
              "core::ops::bit::Shl",
    ...
    *)
    Definition shl
      ...
      | [], [], [ self; rhs ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [], self |) in
          let rhs := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "u64" ], rhs |) in
          M.call_closure (|
            Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
            M.get_trait_method (|
              "core::ops::bit::Shl",
    ...
    *)
    Definition shl
      ...
      | [], [], [ self; rhs ] =>
        ltac:(M.monadic
          (let self := M.alloc (| Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [], self |) in
          let rhs := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "i64" ], rhs |) in
          M.call_closure (|
            Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
            M.get_trait_method (|
              "core::ops::bit::Shl",
