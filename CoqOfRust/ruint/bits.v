                          ...
                          [
                            fun γ =>
                              ltac:(M.monadic
                                (let n := M.copy (| γ |) in
                                M.read (|
                                  let~ fixed : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                    M.alloc (|
                                      M.cast
                                        (Ty.path "usize")
                                        (M.call_closure (|
                                        ...
                                        |))
                                    |) in
                                  let~ skipped : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                    M.alloc (|
                                      M.call_closure (|
                                        Ty.path "usize",
                                        BinOp.Wrap.mul,
                                      ...
                                      |)
                                    |) in
                                  let~ top : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                                    M.alloc (|
                                      M.cast
                                        (Ty.path "usize")
                                        (M.call_closure (|
    ...
    Definition most_significant_bits
      ...
      | [], [], [ self ] =>
        ltac:(M.monadic
          (let self := M.alloc (| self |) in
          M.read (|
            let~ first_set_limb : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
              M.alloc (|
                M.call_closure (|
                  Ty.path "usize",
                  M.get_associated_function (|
              ...
              |) in
            M.match_operator (|
              Some (Ty.apply (Ty.path "*") [] [ Ty.tuple [ Ty.path "u64"; Ty.path "usize" ] ]),
              M.alloc (| Value.Tuple [] |),
              [
                fun γ =>
                  ltac:(M.monadic
                ...
                fun γ =>
                  ltac:(M.monadic
                    (let~ hi : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                      M.copy (|
                        M.SubPointer.get_array_field (|
                          M.deref (|
                            M.call_closure (|
                        ...
                        |)
                      |) in
                    let~ lo : Ty.apply (Ty.path "*") [] [ Ty.path "u64" ] :=
                      M.copy (|
                        M.SubPointer.get_array_field (|
                          M.deref (|
                            M.call_closure (|
                        ...
                        |)
                      |) in
                    let~ leading_zeros : Ty.apply (Ty.path "*") [] [ Ty.path "u32" ] :=
                      M.alloc (|
                        M.call_closure (|
                          Ty.path "u32",
            ...
            ltac:(M.monadic
              (M.read (|
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ sign : Ty.apply (Ty.path "*") [] [ Ty.path "bool" ] :=
                  M.alloc (|
                    M.call_closure (|
                      Ty.path "bool",
                      M.get_associated_function (|
            ...
            ltac:(M.monadic
              (M.read (|
                let~ _ : Ty.apply (Ty.path "*") [] [ Ty.tuple [] ] :=
                  ...
                  |) in
                let~ rhs : Ty.apply (Ty.path "*") [] [ Ty.path "usize" ] :=
                  M.alloc (|
                    M.call_closure (| Ty.path "usize", BinOp.Wrap.rem, [ M.read (| rhs |); BITS ] |)
                  |) in
                M.alloc (|
                  M.call_closure (|
                    Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
