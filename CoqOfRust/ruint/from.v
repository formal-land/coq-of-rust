                ...
                ltac:(M.monadic
                  ...
                  M.call_closure (|
                    ...
                    [
                      ...
                      M.borrow (| Pointer.Kind.Ref, M.deref (| mk_str (| "ValueTooLarge" |) |) |);
                      M.call_closure (|
              ...
              fun γ =>
                ltac:(M.monadic
                  ...
                  M.call_closure (|
                    ...
                    [
                      M.borrow (| Pointer.Kind.MutRef, M.deref (| M.read (| f |) |) |);
                      M.borrow (| Pointer.Kind.Ref, M.deref (| mk_str (| "ValueNegative" |) |) |);
                      M.call_closure (|
                        Ty.apply (Ty.path "&") [] [ Ty.dyn [ ("core::fmt::Debug::Trait", []) ] ],
                        M.pointer_coercion
                          M.PointerCoercion.Unsize
                            ...
                            M.deref (|
                              M.borrow (|
                                ...
                                M.alloc (|
                                  ...
                                  Value.Array
                                    [ mk_str (| "Value is too large for Uint<" |); mk_str (| ">" |)
                                    ]
                                |)
                              |)
                            |)
                            ...
                            M.deref (|
                              M.borrow (|
                                ...
                                M.alloc (|
                                  ...
                                  Value.Array
                                    [
                                      mk_str (| "Negative values cannot be represented as Uint<" |);
                                      mk_str (| ">" |)
                                    ]
                                |)
                              |)
                              ...
                              M.borrow (|
                                ...
                                M.alloc (|
                                  Ty.apply
                                    ...
                                    [ Ty.apply (Ty.path "&") [] [ Ty.path "str" ] ],
                                  Value.Array
                                    [ mk_str (| "Uint<" |); mk_str (| "> value is too large for " |)
                                    ]
                                |)
                              |)
                            |)
  ...
  Module Impl_core_fmt_Debug_for_ruint_from_ToFieldError.
    ...
    Definition fmt (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
      ...
      | [], [], [ self; f ] =>
        ltac:(M.monadic
          (let self :=
            M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "ruint::from::ToFieldError" ], self |) in
          let f :=
            M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "core::fmt::Formatter" ], f |) in
          M.call_closure (|
            Ty.apply
                  ...
                  M.call_closure (|
                    ...
                    [
                      ...
                      M.borrow (|
                        Pointer.Kind.Ref,
                        M.deref (|
                          mk_str (| "Number is equal or larger than the target field modulus." |)
                        |)
                      |)
                    ]
                  |)))
                  ...
                  M.find_or_pattern (Ty.tuple []) (|
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          (let _ :=
                            M.is_struct_tuple (| γ, "ruint::from::ToUintError::ValueNegative" |) in
                          Value.Tuple []));
                      fun γ =>
                        ltac:(M.monadic
                          (let γ0_0 :=
    ...
    *)
    Definition from_uint
      ...
      | [ BITS_SRC; LIMBS_SRC ], [], [ value ] =>
        ltac:(M.monadic
          (let value :=
            M.alloc (| Ty.apply (Ty.path "ruint::Uint") [ BITS_SRC; LIMBS_SRC ] [], value |) in
          M.call_closure (|
            Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
            M.get_associated_function (|
              Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
  ...
  Module Impl_core_convert_TryFrom_f64_for_ruint_Uint_BITS_LIMBS.
    ...
    *)
    Definition try_from
      ...
      | [], [], [ value ] =>
        ltac:(M.monadic
          (let value := M.alloc (| Ty.path "f64", value |) in
          M.catch_return
            (Ty.apply
              (Ty.path "core::result::Result")
              []
                    ...
                    [
                      fun γ =>
                        ltac:(M.monadic
                          ...
                          M.never_to_any (|
                            M.read (|
                              let~ wrapped : Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [] :=
                                M.call_closure (|
                                  Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
                                  M.get_associated_function (|
                                    Ty.apply (Ty.path "ruint::Uint") [ BITS; LIMBS ] [],
  ...
  Module Impl_core_convert_TryFrom_f32_for_ruint_Uint_BITS_LIMBS.
    ...
    *)
    Definition try_from
      ...
      | [], [], [ value ] =>
        ltac:(M.monadic
          (let value := M.alloc (| Ty.path "f32", value |) in
          M.call_closure (|
            Ty.apply
              (Ty.path "core::result::Result")
              []
