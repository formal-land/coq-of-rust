    ...
    Module processor.
      ...
      *)
      Definition process_initialize (τ : list Ty.t) (α : list Value.t) : M :=
        match τ, α with
        | [], [ _program_id; accounts; authority; member_address ] =>
          ltac:(M.monadic
                              ...
                              M.alloc (|
                                M.call_closure (|
                                  ...
                                  [
                                    M.read (|
                                      Value.String
                                        "The group member pointer extension requires at least an authority or an address for initialization, neither was provided"
                                    |)
                                  ]
                                |)
                              |) in
      ...
      *)
      Definition process_update (τ : list Ty.t) (α : list Value.t) : M :=
        match τ, α with
        | [], [ program_id; accounts; new_member_address ] =>
          ltac:(M.monadic
            (let program_id := M.alloc (| program_id |) in
            let accounts := M.alloc (| accounts |) in
            let new_member_address := M.alloc (| new_member_address |) in
            M.catch_return (|
              ltac:(M.monadic
                (M.read (|
                  let account_info_iter :=
                  ...
                  let _ :=
                    M.write (|
                      M.SubPointer.get_struct_record_field (|
                        ...
                        "member_address"
                      |),
                      M.read (| M.read (| new_member_address |) |)
                    |) in
                  M.alloc (| Value.StructTuple "core::result::Result::Ok" [ Value.Tuple [] ] |)
                |)))
            |)))
                          ...
                          (let _ :=
                            M.alloc (|
                              M.call_closure (|
                                ...
                                [
                                  M.read (|
                                    Value.String "GroupMemberPointerInstruction::Initialize"
                                  |)
                                ]
                              |)
                            |) in
                            ...
                            [
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  let member_address := M.alloc (| γ1_1 |) in
                                  M.alloc (|
                                    M.call_closure (|
                                      M.get_function (|
                                        "spl_token_2022::extension::group_member_pointer::processor::process_initialize",
                                        []
                                      |),
                                      [
                                        M.read (| program_id |);
                        ...
                        ltac:(M.monadic
                          (let _ :=
                            M.alloc (|
                              M.call_closure (|
                                M.get_function (| "solana_program::log::sol_log", [] |),
                                [ M.read (| Value.String "GroupMemberPointerInstruction::Update" |)
                                ]
                              |)
                            |) in
                          M.match_operator (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  let γ1_0 :=
                                    M.SubPointer.get_struct_record_field (|
                                      ...
                                      "member_address"
                                    |) in
                                  let member_address := M.alloc (| γ1_0 |) in
                                  M.alloc (|
                                    M.call_closure (|
                                      M.get_function (|
                                        "spl_token_2022::extension::group_member_pointer::processor::process_update",
                                        []
                                      |),
                                      [
                                        M.read (| program_id |);
