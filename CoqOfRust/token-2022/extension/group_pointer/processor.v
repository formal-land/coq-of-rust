    ...
    Module processor.
      ...
      *)
      Definition process_initialize (τ : list Ty.t) (α : list Value.t) : M :=
        match τ, α with
        | [], [ _program_id; accounts; authority; group_address ] =>
          ltac:(M.monadic
                              ...
                              M.alloc (|
                                M.call_closure (|
                                  ...
                                  [
                                    M.read (|
                                      Value.String
                                        "The group pointer extension requires at least an authority or an address for initialization, neither was provided"
                                    |)
                                  ]
                                |)
                              |) in
                            ...
                            [
                              M.call_closure (|
                                M.get_trait_method (|
                                  ...
                                  [ Ty.path "spl_token_2022::pod::PodMint" ],
                                  "init_extension",
                                  [ Ty.path "spl_token_2022::extension::group_pointer::GroupPointer"
                                  ]
                                |),
      ...
      *)
      Definition process_update (τ : list Ty.t) (α : list Value.t) : M :=
        match τ, α with
        | [], [ program_id; accounts; new_group_address ] =>
          ltac:(M.monadic
            (let program_id := M.alloc (| program_id |) in
            let accounts := M.alloc (| accounts |) in
            let new_group_address := M.alloc (| new_group_address |) in
            M.catch_return (|
              ltac:(M.monadic
                (M.read (|
                  let account_info_iter :=
                  ...
                  let _ :=
                    M.write (|
                      M.SubPointer.get_struct_record_field (|
                        ...
                        "group_address"
                      |),
                      M.read (| M.read (| new_group_address |) |)
                    |) in
                  M.alloc (| Value.StructTuple "core::result::Result::Ok" [ Value.Tuple [] ] |)
                |)))
            |)))
                        ...
                        ltac:(M.monadic
                          (let _ :=
                            M.alloc (|
                              M.call_closure (|
                                M.get_function (| "solana_program::log::sol_log", [] |),
                                [ M.read (| Value.String "GroupPointerInstruction::Initialize" |) ]
                              |)
                            |) in
                          M.match_operator (|
                            M.match_operator (|
                            ...
                            [
                              fun γ =>
                                ltac:(M.monadic
                                  ...
                                  let group_address := M.alloc (| γ1_1 |) in
                                  M.alloc (|
                                    M.call_closure (|
                                      M.get_function (|
                                        "spl_token_2022::extension::group_pointer::processor::process_initialize",
                                        []
                                      |),
                                      [
                                        M.read (| program_id |);
                        ...
                        ltac:(M.monadic
                          (let _ :=
                            M.alloc (|
                              M.call_closure (|
                                M.get_function (| "solana_program::log::sol_log", [] |),
                                [ M.read (| Value.String "GroupPointerInstruction::Update" |) ]
                              |)
                            |) in
                          M.match_operator (|
                            M.match_operator (|
                                ...
                                ltac:(M.monadic
                                  ...
                                  let γ1_0 :=
                                    M.SubPointer.get_struct_record_field (|
                                      ...
                                      "group_address"
                                    |) in
                                  let group_address := M.alloc (| γ1_0 |) in
                                  M.alloc (|
                                    M.call_closure (|
                                      M.get_function (|
                                        "spl_token_2022::extension::group_pointer::processor::process_update",
                                        []
                                      |),
                                      [
                                        M.read (| program_id |);
