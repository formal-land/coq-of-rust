  ...
  Module etable.
    Module op_configure.
      Module op_br_if_eqz.
        ...
        (* StructTuple
          {
            name := "BrIfEqzConfigBuilder";
            ty_params := [];
            fields := [];
          } *)
        
        Module Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfigBuilder_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_br_if_eqz_BrIfEqzConfigBuilder.
                    ...
                    let memory_table_lookup_stack_read_return_value :=
                      M.alloc (|
                        M.call_closure (|
                          ...
                          [
                            M.read (| allocator |);
                            M.read (| Value.String "op_br_if_eqz stack read return value" |);
                            M.read (| constraint_builder |);
                            M.read (| eid |);
                            M.closure
                              (fun γ =>
                    ...
                    let memory_table_lookup_stack_write_return_value :=
                      M.alloc (|
                        M.call_closure (|
                          ...
                          [
                            M.read (| allocator |);
                            M.read (| Value.String "op_br_if_eqz stack write return value" |);
                            M.read (| constraint_builder |);
                            M.read (| eid |);
                            M.closure
                              (fun γ =>
                          ...
                          M.get_associated_function (|
                            Ty.apply
                              ...
                              [
                                Ty.apply
                                  (Ty.path
                                    "delphinus_zkwasm::circuits::etable::op_configure::op_br_if_eqz::BrIfEqzConfig")
                                  [ F ];
                                Ty.path "alloc::alloc::Global"
                              ],
                            "new",
        ...
        End Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfigBuilder_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_br_if_eqz_BrIfEqzConfigBuilder.
        ...
        End Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfig_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_br_if_eqz_BrIfEqzConfig_F.
      End op_br_if_eqz.
    End op_configure.
  End etable.
End circuits.
