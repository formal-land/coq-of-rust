...
Module circuits.
  Module etable.
    Module op_configure.
      Module op_global_get.
        (* StructRecord
          {
            name := "GlobalGetConfig";
            ty_params := [ "F" ];
            fields :=
              [
                ("idx_cell",
        ...
        (* StructTuple
          {
            name := "GlobalGetConfigBuilder";
            ty_params := [];
            fields := [];
          } *)
        
        Module Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfigBuilder_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_global_get_GlobalGetConfigBuilder.
                  ...
                  (M.read (|
                    ...
                    let eid_cell :=
                      M.copy (|
                        ...
                        |)
                      |) in
                    let memory_table_lookup_global_read :=
                      M.alloc (|
                        M.call_closure (|
                          M.get_associated_function (|
                            Ty.apply
                          ...
                          [
                            M.read (| allocator |);
                            M.read (| Value.String "op_global_get global read" |);
                    ...
                    let memory_table_lookup_stack_write :=
                      M.alloc (|
                        M.call_closure (|
                          ...
                          [
                            M.read (| allocator |);
                            M.read (| Value.String "op_global_get stack write" |);
                            M.read (| constraint_builder |);
                            M.read (| eid_cell |);
                            M.closure
                              (fun γ =>
                          ...
                          M.get_associated_function (|
                            Ty.apply
                              ...
                              [
                                Ty.apply
                                  (Ty.path
                                    "delphinus_zkwasm::circuits::etable::op_configure::op_global_get::GlobalGetConfig")
                                  [ F ];
                          ...
                          [
                            Value.StructRecord
                              ...
                              [
                                ...
                                ("memory_table_lookup_global_read",
                                  M.read (| memory_table_lookup_global_read |));
                                ("memory_table_lookup_stack_write",
        ...
        End Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfigBuilder_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_global_get_GlobalGetConfigBuilder.
          ...
          Definition opcode (F : Ty.t) (τ : list Ty.t) (α : list Value.t) : M :=
            ...
            | [], [ self; meta ] =>
              ltac:(M.monadic
                ...
                M.call_closure (|
                  M.get_function (|
                    "specs::encode::opcode::encode_global_get",
        ...
        End Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfig_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_global_get_GlobalGetConfig_F.
      End op_global_get.
    End op_configure.
  End etable.
End circuits.
