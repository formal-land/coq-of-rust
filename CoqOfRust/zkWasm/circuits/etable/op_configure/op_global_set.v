...
Module circuits.
  Module etable.
    Module op_configure.
      Module op_global_set.
        (* StructRecord
          {
            name := "GlobalSetConfig";
            ty_params := [ "F" ];
            fields :=
              [
                ("idx_cell",
        ...
        (* StructTuple
          {
            name := "GlobalSetConfigBuilder";
            ty_params := [];
            fields := [];
          } *)
        
        Module Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfigBuilder_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_global_set_GlobalSetConfigBuilder.
                    ...
                    let memory_table_lookup_stack_read :=
                      M.alloc (|
                        M.call_closure (|
                          ...
                          [
                            M.read (| allocator |);
                            M.read (| Value.String "op_global_set stack read" |);
                        ...
                        |)
                      |) in
                    let memory_table_lookup_global_write :=
                      M.alloc (|
                        M.call_closure (|
                          M.get_associated_function (|
                            Ty.apply
                          ...
                          [
                            M.read (| allocator |);
                            M.read (| Value.String "op_global_set global write" |);
                            M.read (| constraint_builder |);
                            M.read (| eid_cell |);
                            M.closure
                              (fun γ =>
                          ...
                          M.get_associated_function (|
                            Ty.apply
                              ...
                              [
                                Ty.apply
                                  (Ty.path
                                    "delphinus_zkwasm::circuits::etable::op_configure::op_global_set::GlobalSetConfig")
                                  [ F ];
        ...
        End Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfigBuilder_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_global_set_GlobalSetConfigBuilder.
          ...
          Definition opcode (F : Ty.t) (τ : list Ty.t) (α : list Value.t) : M :=
            ...
            | [], [ self; meta ] =>
              ltac:(M.monadic
                ...
                M.call_closure (|
                  M.get_function (|
                    "specs::encode::opcode::encode_global_set",
        ...
        End Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfig_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_global_set_GlobalSetConfig_F.
      End op_global_set.
    End op_configure.
  End etable.
End circuits.
