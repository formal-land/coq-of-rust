  ...
  Module etable.
    Module op_configure.
      Module op_local_get.
        ...
        (* StructTuple
          {
            name := "LocalGetConfigBuilder";
            ty_params := [];
            fields := [];
          } *)
        
        Module Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfigBuilder_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_local_get_LocalGetConfigBuilder.
                    ...
                    let memory_table_lookup_stack_read :=
                      M.alloc (|
                        M.call_closure (|
                          ...
                          [
                            M.read (| allocator |);
                            M.read (| Value.String "op_local_get stack read" |);
                    ...
                    let memory_table_lookup_stack_write :=
                      M.alloc (|
                        M.call_closure (|
                          ...
                          [
                            M.read (| allocator |);
                            M.read (| Value.String "op_local_get stack write" |);
                            M.read (| constraint_builder |);
                            M.read (| eid_cell |);
                            M.closure
                              (fun γ =>
                          ...
                          M.get_associated_function (|
                            Ty.apply
                              ...
                              [
                                Ty.apply
                                  (Ty.path
                                    "delphinus_zkwasm::circuits::etable::op_configure::op_local_get::LocalGetConfig")
                                  [ F ];
        ...
        End Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfigBuilder_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_local_get_LocalGetConfigBuilder.
        ...
        End Impl_delphinus_zkwasm_circuits_etable_EventTableOpcodeConfig_where_pairing_bn256_arithmetic_fields_FieldExt_F_F_for_delphinus_zkwasm_circuits_etable_op_configure_op_local_get_LocalGetConfig_F.
      End op_local_get.
    End op_configure.
  End etable.
End circuits.
