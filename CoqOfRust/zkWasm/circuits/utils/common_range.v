...
Module circuits.
  Module utils.
    Module common_range.
      ...
      Module Impl_core_clone_Clone_where_core_clone_Clone_F_where_pairing_bn256_arithmetic_fields_FieldExt_F_for_delphinus_zkwasm_circuits_utils_common_range_CommonRangeColumn_F.
        Definition Self (F : Ty.t) : Ty.t :=
          Ty.apply
            (Ty.path "delphinus_zkwasm::circuits::utils::common_range::CommonRangeColumn")
            [ F ].
      ...
      End Impl_core_clone_Clone_where_core_clone_Clone_F_where_pairing_bn256_arithmetic_fields_FieldExt_F_for_delphinus_zkwasm_circuits_utils_common_range_CommonRangeColumn_F.
      
      Module Impl_delphinus_zkwasm_circuits_utils_common_range_CommonRangeColumn_F.
        Definition Self (F : Ty.t) : Ty.t :=
          Ty.apply
            (Ty.path "delphinus_zkwasm::circuits::utils::common_range::CommonRangeColumn")
            [ F ].
                  ...
                  M.alloc (|
                    M.call_closure (|
                      ...
                      [
                        M.read (| rtable |);
                        M.read (| meta |);
                        M.read (| Value.String "common range" |);
                        M.closure
                          (fun γ =>
                            ltac:(M.monadic
                              match γ with
                                        ...
                                        | [ α0 ] =>
                                          M.match_operator (|
                                            ...
                                            [
                                              fun γ =>
                                                ltac:(M.monadic
                                                  (M.read (| Value.String "common range value" |)))
                                            ]
                                          |)
                                        | _ => M.impossible (||)
                                        end));
      ...
      End Impl_delphinus_zkwasm_circuits_utils_common_range_CommonRangeColumn_F.
    End common_range.
  End utils.
End circuits.
