                ...
                [
                  M.read (|
                    let~ args :
                      ...
                      Value.Tuple [ M.borrow (| Pointer.Kind.Ref, v |) ] in
                    let~ args :
                        Ty.apply
                          (Ty.path "array")
...
Definition function_table : list (string * PolymorphicFunction.t) :=
  [ ("constructor_as_function::matching", matching); ("constructor_as_function::main", main) ].
...
Definition trait_method_table : list (string * list Ty.t * Ty.t * string * PolymorphicFunction.t) :=
  [
    ("core::fmt::Debug",
      ...
      Ty.path "constructor_as_function::Constructor",
      "fmt",
      Impl_core_fmt_Debug_for_constructor_as_function_Constructor.fmt)
  ].
