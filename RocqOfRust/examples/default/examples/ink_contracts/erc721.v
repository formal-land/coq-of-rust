  ...
  Definition contains (K V : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _key ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "erc721::Mapping") [] [ K; V ] ],
            self
          |) in
  ...
  Definition insert (K V : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _key; _value ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "erc721::Mapping") [] [ K; V ] ],
            self
          |) in
...
Module Impl_core_clone_Clone_for_erc721_AccountId.
  ...
  Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc721::AccountId" ], self |) in
        M.match_operator (|
    ...
    | [], [], [ self; other ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc721::AccountId" ], self |) in
        let other :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc721::AccountId" ], other |) in
        M.call_closure (|
          Ty.path "bool",
          BinOp.eq,
          [
...
Module Impl_core_cmp_PartialEq_erc721_Error_for_erc721_Error.
  ...
  Definition eq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; other ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc721::Error" ], self |) in
        let other := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc721::Error" ], other |) in
        M.read (|
...
Module Impl_erc721_Env.
  ...
  *)
  Definition caller (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc721::Env" ], self |) in
        M.read (|
  ...
  *)
  Definition emit_event (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _event ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc721::Env" ], self |) in
        let _event := M.alloc (| Ty.path "erc721::Event", _event |) in
        M.never_to_any (|
          M.call_closure (|
            Ty.path "never",
            M.get_function (| "core::panicking::panic", [], [] |),
...
Module Impl_erc721_Erc721.
  ...
  *)
  Definition clear_approval (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; id ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc721::Erc721" ], self |) in
        let id := M.alloc (| Ty.path "u32", id |) in
        M.read (|
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
              Ty.tuple [],
  ...
  *)
  Definition approved_for_all (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; owner; operator ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc721::Erc721" ], self |) in
        let owner := M.alloc (| Ty.path "erc721::AccountId", owner |) in
        let operator := M.alloc (| Ty.path "erc721::AccountId", operator |) in
        M.call_closure (|
          Ty.path "bool",
          M.get_associated_function (|
            Ty.apply
  ...
  Definition approve_for_all (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; to; approved ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc721::Erc721" ], self |) in
        let to := M.alloc (| Ty.path "erc721::AccountId", to |) in
  ...
  Definition approve_for (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; to; id ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc721::Erc721" ], self |) in
        let to := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc721::AccountId" ], to |) in
        let id := M.alloc (| Ty.path "u32", id |) in
        M.catch_return
          (Ty.apply (Ty.path "core::result::Result") [] [ Ty.tuple []; Ty.path "erc721::Error" ]) (|
          ltac:(M.monadic
  ...
  Definition remove_token_from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; from; id ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc721::Erc721" ], self |) in
        let from := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "erc721::AccountId" ], from |) in
        let id := M.alloc (| Ty.path "u32", id |) in
        M.catch_return
          (Ty.apply (Ty.path "core::result::Result") [] [ Ty.tuple []; Ty.path "erc721::Error" ]) (|
          ltac:(M.monadic
                    ...
                    M.read (|
                      ...
                      let~ _ : Ty.tuple [] :=
                        M.call_closure (|
                          ...
                          |),
                          [
                            M.borrow (| Pointer.Kind.Ref, M.deref (| M.read (| token_owner |) |) |);
                            M.read (| id |)
                          ]
                        |) in
                      M.alloc (|
  ...
  *)
  Definition add_token_to (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    match ε, τ, α with
    | [], [], [ self; to; id ] =>
      ltac:(M.monadic
        (let self :=
                                  ...
                                  M.read (|
                                    M.return_ (|
                                      Value.StructTuple
                                        ...
                                        []
                                        [ Ty.tuple []; Ty.path "erc721::Error" ]
                                        [ Value.StructTuple "erc721::Error::TokenExists" [] [] [] ]
                                    |)
                                  |)
                                |)));
                            fun γ => ltac:(M.monadic (Value.Tuple []))
  ...
  *)
  Definition transfer_token_from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    match ε, τ, α with
    | [], [], [ self; from; to; id ] =>
      ltac:(M.monadic
        (let self :=
                          ...
                          M.read (|
                            M.return_ (|
                              Value.StructTuple
                                ...
                                []
                                [ Ty.tuple []; Ty.path "erc721::Error" ]
                                [ Value.StructTuple "erc721::Error::NotApproved" [] [] [] ]
                            |)
                          |)
                        |)));
                    fun γ => ltac:(M.monadic (Value.Tuple []))
  ...
  Definition transfer (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; destination; id ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc721::Erc721" ], self |) in
        let destination := M.alloc (| Ty.path "erc721::AccountId", destination |) in
        let id := M.alloc (| Ty.path "u32", id |) in
        M.catch_return
          (Ty.apply (Ty.path "core::result::Result") [] [ Ty.tuple []; Ty.path "erc721::Error" ]) (|
          ltac:(M.monadic
  ...
  Definition transfer_from (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; from; to; id ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "erc721::Erc721" ], self |) in
        let from := M.alloc (| Ty.path "erc721::AccountId", from |) in
        let to := M.alloc (| Ty.path "erc721::AccountId", to |) in
        let id := M.alloc (| Ty.path "u32", id |) in
        M.catch_return
          (Ty.apply (Ty.path "core::result::Result") [] [ Ty.tuple []; Ty.path "erc721::Error" ]) (|
                                ...
                                M.call_closure (|
                                  ...
                                  M.get_trait_method (|
                                    ...
                                    Ty.apply
                                      (Ty.path "core::result::Result")
                                      []
                                      [ Ty.path "erc721::AccountId"; Ty.path "erc721::Error" ],
                                    [],
                                    [],
                                    "branch",
                                    [],
                                  ...
                                  ltac:(M.monadic
                                    (let γ0_0 :=
                                      M.SubPointer.get_struct_tuple_field (|
                                        ...
                                        0
                                      |) in
                                    let val := M.copy (| Ty.path "erc721::AccountId", γ0_0 |) in
                                    M.read (| val |)))
                              ]
                            |) in
                          let~ _ : Ty.tuple [] :=
                                      ...
                                      M.read (|
                                        M.return_ (|
                                          Value.StructTuple
                                            ...
                                            []
                                            [ Ty.tuple []; Ty.path "erc721::Error" ]
                                            [ Value.StructTuple "erc721::Error::NotOwner" [] [] [] ]
                                        |)
                                      |)
                                    |)));
                                fun γ => ltac:(M.monadic (Value.Tuple []))
