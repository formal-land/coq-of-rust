  ...
  Definition contains (K V : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _key ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&") [] [ Ty.apply (Ty.path "multisig::Mapping") [] [ K; V ] ],
            self
          |) in
  ...
  Definition insert (K V : Ty.t) (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _key; _value ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&mut") [] [ Ty.apply (Ty.path "multisig::Mapping") [] [ K; V ] ],
            self
          |) in
...
Module Impl_core_fmt_Debug_for_multisig_AccountId.
  ...
  Definition fmt (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; f ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::AccountId" ], self |) in
    ...
    | [], [], [ self; other ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::AccountId" ], self |) in
        let other :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::AccountId" ], other |) in
        M.call_closure (|
          Ty.path "bool",
          BinOp.eq,
          [
...
Definition value_MAX_OWNERS (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ltac:(M.monadic (M.alloc (| Ty.path "u32", Value.Integer IntegerKind.U32 50 |))).
...
Definition value_WRONG_TRANSACTION_ID (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ltac:(M.monadic
    (M.alloc (|
      ...
      mk_str (| "The user specified an invalid transaction id. Abort." |)
    |))).
...
Module Impl_core_clone_Clone_for_multisig_Error.
  ...
  Definition clone (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::Error" ], self |) in
...
Module Impl_core_cmp_PartialEq_multisig_Error_for_multisig_Error.
  ...
  Definition eq (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; other ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::Error" ], self |) in
        let other := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::Error" ], other |) in
        Value.Bool true))
    | _, _, _ => M.impossible "wrong number of arguments"
    end.
...
Module Impl_multisig_Env.
  ...
  *)
  Definition caller (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::Env" ], self |) in
        M.read (|
  ...
  *)
  Definition emit_event (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; _event ] =>
      ltac:(M.monadic
        (let self := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::Env" ], self |) in
        let _event := M.alloc (| Ty.path "multisig::Event", _event |) in
        M.never_to_any (|
          M.call_closure (|
            Ty.path "never",
            M.get_function (| "core::panicking::panic", [], [] |),
...
Definition ensure_requirement_is_valid (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [], [ owners; requirement ] =>
    ltac:(M.monadic
      (let owners := M.alloc (| Ty.path "u32", owners |) in
      let requirement := M.alloc (| Ty.path "u32", requirement |) in
      M.read (|
        let~ _ : Ty.tuple [] :=
          M.match_operator (|
            Ty.tuple [],
...
Module Impl_multisig_Multisig.
  ...
  *)
  Definition env (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::Multisig" ], self |) in
        M.call_closure (|
  ...
  Definition ensure_confirmed (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; trans_id ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::Multisig" ], self |) in
        let trans_id := M.alloc (| Ty.path "u32", trans_id |) in
        M.read (|
          let~ _ : Ty.tuple [] :=
            M.match_operator (|
              Ty.tuple [],
    ...
    | [], [], [ self; owner ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::Multisig" ], self |) in
        let owner :=
          M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "multisig::AccountId" ], owner |) in
        M.read (|
          let~ _ : Ty.tuple [] :=
            M.match_operator (|
              Ty.tuple [],
  ...
  *)
  Definition add_owner (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; new_owner ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "multisig::Multisig" ], self |) in
        let new_owner := M.alloc (| Ty.path "multisig::AccountId", new_owner |) in
        M.read (|
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
              Ty.tuple [],
  ...
  Definition remove_owner (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; owner ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "multisig::Multisig" ], self |) in
        let owner := M.alloc (| Ty.path "multisig::AccountId", owner |) in
        M.read (|
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
              Ty.tuple [],
  ...
  Definition replace_owner (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; old_owner; new_owner ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "multisig::Multisig" ], self |) in
        let old_owner := M.alloc (| Ty.path "multisig::AccountId", old_owner |) in
        let new_owner := M.alloc (| Ty.path "multisig::AccountId", new_owner |) in
        M.read (|
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
  ...
  Definition change_requirement (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; new_requirement ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "multisig::Multisig" ], self |) in
        let new_requirement := M.alloc (| Ty.path "u32", new_requirement |) in
        M.read (|
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
              Ty.tuple [],
  ...
  Definition confirm_by_caller (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; confirmer; transaction ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "multisig::Multisig" ], self |) in
        let confirmer := M.alloc (| Ty.path "multisig::AccountId", confirmer |) in
        let transaction := M.alloc (| Ty.path "u32", transaction |) in
        M.read (|
          let~ count : Ty.path "u32" :=
            M.call_closure (|
              Ty.path "u32",
  ...
  Definition submit_transaction (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self; transaction ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "multisig::Multisig" ], self |) in
        let transaction := M.alloc (| Ty.path "multisig::Transaction", transaction |) in
        M.read (|
          let~ _ : Ty.tuple [] :=
            M.call_closure (|
              Ty.tuple [],
          ...
          let~ _ : Ty.tuple [] :=
            ...
            |) in
          M.alloc (|
            Ty.tuple [ Ty.path "u32"; Ty.path "multisig::ConfirmationStatus" ],
            Value.Tuple
              [
                M.read (| trans_id |);
                M.call_closure (|
  ...
  *)
  Definition eval_transaction (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    match ε, τ, α with
    | [], [], [ self; trans_id ] =>
      ltac:(M.monadic
        (let self :=
