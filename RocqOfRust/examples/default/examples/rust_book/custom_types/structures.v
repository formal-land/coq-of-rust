            ...
            let~ _ : Ty.tuple [] :=
              M.call_closure (|
                ...
                [
                  M.read (|
                    let~ args :
                        Ty.tuple [ Ty.apply (Ty.path "&") [] [ Ty.path "structures::Person" ] ] :=
                      Value.Tuple [ M.borrow (| Pointer.Kind.Ref, peter |) ] in
                    let~ args :
                        Ty.apply
                          (Ty.path "array")
...
Definition function_table : list (string * PolymorphicFunction.t) := [ ("structures::main", main) ].
...
Definition trait_method_table : list (string * list Ty.t * Ty.t * string * PolymorphicFunction.t) :=
  [
    ("core::fmt::Debug",
      ...
      Ty.path "structures::Person",
      "fmt",
      Impl_core_fmt_Debug_for_structures_Person.fmt)
  ].
