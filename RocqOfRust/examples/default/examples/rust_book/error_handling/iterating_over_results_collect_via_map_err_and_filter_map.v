                ...
                [
                  M.read (|
                    let~ args :
                      ...
                      Value.Tuple [ M.borrow (| Pointer.Kind.Ref, numbers |) ] in
                    let~ args :
                        Ty.apply
                          (Ty.path "array")
                        ...
                        [
                          M.borrow (|
                            ...
                            M.deref (|
                              M.mk_byte_str_ref
                                14
                                [ 9; 78; 117; 109; 98; 101; 114; 115; 58; 32; 192; 1; 10; 0 ]
                            |)
                          |);
                          M.borrow (|
                            Pointer.Kind.Ref,
                ...
                [
                  M.read (|
                    let~ args :
                      ...
                      Value.Tuple [ M.borrow (| Pointer.Kind.Ref, errors |) ] in
                    let~ args :
                        Ty.apply
                          (Ty.path "array")
                          [ Value.Integer IntegerKind.Usize 1 ]
                        ...
                        [
                          M.borrow (|
                            ...
                            M.deref (|
                              M.mk_byte_str_ref
                                13
                                [ 8; 69; 114; 114; 111; 114; 115; 58; 32; 192; 1; 10; 0 ]
                            |)
                          |);
                          M.borrow (|
                            Pointer.Kind.Ref,
