    ...
    ltac:(M.monadic
      (M.read (|
                                  ...
                                  [
                                    M.read (|
                                      let~ args :
                                        ...
                                        Value.Tuple [ M.borrow (| Pointer.Kind.Ref, color |) ] in
                                      let~ args :
                                          Ty.apply
                                            (Ty.path "array")
        ...
        let~ _reborrow : Ty.apply (Ty.path "&") [] [ Ty.path "alloc::string::String" ] :=
          M.borrow (| Pointer.Kind.Ref, color |) in
        let~ _ : Ty.tuple [] :=
          M.call_closure (|
            Ty.tuple [],
            M.get_trait_method (|
                                      ...
                                      [
                                        M.read (|
                                          let~ args :
                                            ...
                                            Value.Tuple
                                              [ M.borrow (| Pointer.Kind.Ref, count |) ] in
                                          let~ args :
                                              Ty.apply
                                                (Ty.path "array")
                                                [ Value.Integer IntegerKind.Usize 1 ]
        ...
        let~ _count_reborrowed : Ty.apply (Ty.path "&mut") [] [ Ty.path "i32" ] :=
          M.borrow (| Pointer.Kind.MutRef, count |) in
        let~ movable :
            Ty.apply
                                      ...
                                      [
                                        M.read (|
                                          let~ args :
                                            ...
                                            Value.Tuple
                                              [ M.borrow (| Pointer.Kind.Ref, movable |) ] in
                                          let~ args :
                                              Ty.apply
                                                (Ty.path "array")
                                                [ Value.Integer IntegerKind.Usize 1 ]
...
Definition function_table : list (string * PolymorphicFunction.t) :=
  [ ("functions_closures_capturing::main", main) ].
