                ...
                [
                  M.read (|
                    let~ args : Ty.tuple [ Ty.apply (Ty.path "&") [] [ Ty.path "u32" ] ] :=
                      Value.Tuple [ M.borrow (| Pointer.Kind.Ref, acc |) ] in
                    let~ args :
                        Ty.apply
                          (Ty.path "array")
            ...
            let~ _ : Ty.tuple [] :=
              M.call_closure (|
                ...
                [
                  M.read (|
                    let~ args : Ty.tuple [ Ty.apply (Ty.path "&") [] [ Ty.path "u32" ] ] :=
                      Value.Tuple [ M.borrow (| Pointer.Kind.Ref, sum_of_squared_odd_numbers |) ] in
                    let~ args :
                        Ty.apply
                          (Ty.path "array")
                          [ Value.Integer IntegerKind.Usize 1 ]
...
Definition function_table : list (string * PolymorphicFunction.t) :=
  [ ("higher_order_functions::is_odd", is_odd); ("higher_order_functions::main", main) ].
