  ...
  | [], [], [] =>
    ltac:(M.monadic
      (M.read (|
        ...
        let~ container : Ty.path "generics_associated_types_solution::Container" :=
          Value.StructTuple
            "generics_associated_types_solution::Container"
            []
            []
                            ...
                            M.alloc (|
                              ...
                              M.call_closure (|
                                ...
                                [
                                  ...
                                  M.borrow (|
                                    Pointer.Kind.Ref,
                                    M.deref (| M.borrow (| Pointer.Kind.Ref, number_1 |) |)
                                  |);
                                  M.borrow (|
                                    Pointer.Kind.Ref,
                                    M.deref (| M.borrow (| Pointer.Kind.Ref, number_2 |) |)
                                  |)
                                ]
                              |)
                            |)
                            ...
                            M.alloc (|
                              ...
                              M.call_closure (|
                                ...
                                [
                                  M.borrow (|
                                    Pointer.Kind.Ref,
                                    M.deref (| M.borrow (| Pointer.Kind.Ref, container |) |)
                                  |)
                                ]
                              |)
                            |)
