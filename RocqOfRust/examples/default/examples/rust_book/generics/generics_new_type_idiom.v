  ...
  Definition to_days (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&") [] [ Ty.path "generics_new_type_idiom::Years" ],
            self
          |) in
        Value.StructTuple
  ...
  Definition to_years (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (|
            Ty.apply (Ty.path "&") [] [ Ty.path "generics_new_type_idiom::Days" ],
            self
          |) in
        Value.StructTuple
          "generics_new_type_idiom::Years"
...
Definition old_enough (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [], [ age ] =>
    ltac:(M.monadic
      (let age :=
        M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "generics_new_type_idiom::Years" ], age |) in
      M.call_closure (|
        Ty.path "bool",
        BinOp.ge,
        [
      ...
      (M.read (|
        let~ age : Ty.path "generics_new_type_idiom::Years" :=
          Value.StructTuple
            ...
            []
            []
            [ Value.Integer IntegerKind.I64 5 ] in
                        ...
                        [
                          M.borrow (|
                            ...
                            M.alloc (|
                              ...
                              M.call_closure (|
                                Ty.path "bool",
                                M.get_function (| "generics_new_type_idiom::old_enough", [], [] |),
                                [
                                  M.borrow (|
                                    Pointer.Kind.Ref,
                                        ...
                                        M.alloc (|
                                          ...
                                          M.call_closure (|
                                            ...
                                            M.get_associated_function (|
                                              ...
                                              []
                                            |),
                                            [ M.borrow (| Pointer.Kind.Ref, age_days |) ]
                                          |)
                                        |)
                                      |)
                                    |)
...
Definition function_table : list (string * PolymorphicFunction.t) :=
  [ ("generics_new_type_idiom::old_enough", old_enough); ("generics_new_type_idiom::main", main) ].
