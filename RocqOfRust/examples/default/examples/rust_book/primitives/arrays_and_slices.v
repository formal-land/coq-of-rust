                    ...
                    let~ args : Ty.tuple [ Ty.apply (Ty.path "&") [] [ Ty.path "i32" ] ] :=
                      Value.Tuple
                        [
                          M.borrow (|
                            Pointer.Kind.Ref,
                            M.SubPointer.get_array_field (| xs, Value.Integer IntegerKind.Usize 0 |)
                          |)
                        ] in
                    let~ args :
                        Ty.apply
                    ...
                    let~ args : Ty.tuple [ Ty.apply (Ty.path "&") [] [ Ty.path "i32" ] ] :=
                      Value.Tuple
                        [
                          M.borrow (|
                            Pointer.Kind.Ref,
                            M.SubPointer.get_array_field (| xs, Value.Integer IntegerKind.Usize 1 |)
                          |)
                        ] in
                    let~ args :
                        Ty.apply
                                                      ...
                                                      let~ args :
                                                        ...
                                                        Value.Tuple
                                                          [
                                                            ...
                                                            M.borrow (| Pointer.Kind.Ref, xval |)
                                                          ] in
                                                      let~ args :
                                                          Ty.apply
                                                            (Ty.path "array")
...
Definition function_table : list (string * PolymorphicFunction.t) :=
  [ ("arrays_and_slices::analyze_slice", analyze_slice); ("arrays_and_slices::main", main) ].
