                    ...
                    M.alloc (|
                      ...
                      M.call_closure (|
                        ...
                        M.get_associated_function (|
                          Ty.path "core::fmt::Arguments",
                          "new",
                          [ Value.Integer IntegerKind.Usize 34; Value.Integer IntegerKind.Usize 2 ],
                          []
                        |),
                        [
                          M.borrow (|
...
Definition function_table : list (string * PolymorphicFunction.t) :=
  [
    ("scoping_rules_lifetimes_functions::print_one", print_one);
    ("scoping_rules_lifetimes_functions::add_one", add_one);
    ("scoping_rules_lifetimes_functions::print_multi", print_multi);
    ("scoping_rules_lifetimes_functions::pass_x", pass_x);
    ("scoping_rules_lifetimes_functions::main", main)
  ].
