...
Definition call (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ...
  | [], [], [ number ] =>
    ltac:(M.monadic
      (let number := M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], number |) in
      M.match_operator (|
        ...
        [
          fun γ =>
            ltac:(M.monadic
              (let _ := is_constant_or_break_match (| M.read (| γ |), mk_str (| "798-1364" |) |) in
              M.borrow (|
                Pointer.Kind.Ref,
                M.deref (|
                  mk_str (|
          ...
          fun γ =>
            ltac:(M.monadic
              (let _ := is_constant_or_break_match (| M.read (| γ |), mk_str (| "645-7689" |) |) in
              M.borrow (|
                Pointer.Kind.Ref,
                M.deref (|
                  mk_str (|
            ...
            [
              ...
              M.borrow (|
                ...
                M.deref (|
                  M.borrow (|
                    Pointer.Kind.Ref,
                    M.alloc (| Ty.apply (Ty.path "&") [] [ Ty.path "str" ], mk_str (| "Ashley" |) |)
                  |)
                |)
              |)
            ]
                                              ...
                                              [
                                                M.read (|
                                                  let~ args :
                                                    ...
                                                    Value.Tuple
                                                      [
                                                        M.borrow (| Pointer.Kind.Ref, contact |);
                                                        M.borrow (|
                                                          Pointer.Kind.Ref,
                                                          M.alloc (|
                                                            Ty.apply
...
Definition function_table : list (string * PolymorphicFunction.t) :=
  [ ("hash_map::call", call); ("hash_map::main", main) ].
