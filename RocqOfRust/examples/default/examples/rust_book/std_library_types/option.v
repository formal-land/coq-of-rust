                        ...
                        let~ args :
                          ...
                          Value.Tuple
                            [
                              ...
                              M.borrow (| Pointer.Kind.Ref, divisor |)
                            ] in
                        let~ args :
                            Ty.apply
                              (Ty.path "array")
                            ...
                            [
                              M.borrow (|
                                ...
                                M.deref (|
                                  M.mk_byte_str_ref
                                    14
                                    [ 192; 3; 32; 47; 32; 192; 3; 32; 61; 32; 192; 1; 10; 0 ]
                                |)
                              |);
                              M.borrow (|
                                Pointer.Kind.Ref,
                    ...
                    M.alloc (|
                      ...
                      M.call_closure (|
                        ...
                        M.get_associated_function (|
                          Ty.path "core::fmt::Arguments",
                          "new",
                          [ Value.Integer IntegerKind.Usize 18; Value.Integer IntegerKind.Usize 2 ],
                          []
                        |),
                        [
                          M.borrow (|
                ...
                [
                  M.read (|
                    let~ args :
                      ...
                      Value.Tuple
                        [
                          M.borrow (| Pointer.Kind.Ref, none |);
                          M.borrow (|
                            Pointer.Kind.Ref,
                            M.alloc (|
                              Ty.path "i32",
...
Definition function_table : list (string * PolymorphicFunction.t) :=
  [
    ("option::checked_division", checked_division);
    ("option::try_division", try_division);
    ("option::main", main)
  ].
