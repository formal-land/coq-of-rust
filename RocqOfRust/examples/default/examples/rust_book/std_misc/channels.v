...
Definition value_NTHREADS (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
  ltac:(M.monadic
    (M.alloc (| Ty.path "i32", M.alloc (| Ty.path "i32", Value.Integer IntegerKind.I32 3 |) |))).
                        ...
                        [
                          M.read (|
                            let~ args :
                              ...
                              Value.Tuple [ M.borrow (| Pointer.Kind.Ref, ids |) ] in
                            let~ args :
                                Ty.apply
                                  (Ty.path "array")
...
Definition function_table : list (string * PolymorphicFunction.t) :=
  [ ("channels::NTHREADS", value_NTHREADS); ("channels::main", main) ].
