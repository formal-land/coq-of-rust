  ...
  *)
  Definition next (ε : list Value.t) (τ : list Ty.t) (α : list Value.t) : M :=
    ...
    | [], [], [ self ] =>
      ltac:(M.monadic
        (let self :=
          M.alloc (| Ty.apply (Ty.path "&mut") [] [ Ty.path "iterators::Fibonacci" ], self |) in
        M.read (|
      ...
      (M.read (|
        let~ sequence : Ty.apply (Ty.path "core::ops::range::Range") [] [ Ty.path "i32" ] :=
          Value.mkStructRecord
            ...
            []
            [ Ty.path "i32" ]
            [ ("start", Value.Integer IntegerKind.I32 0); ("end_", Value.Integer IntegerKind.I32 3)
            ] in
        let~ _ : Ty.tuple [] :=
          M.read (|
            let~ _ : Ty.tuple [] :=
                    ...
                    M.alloc (|
                      ...
                      M.call_closure (|
                        ...
                        M.get_associated_function (|
                          Ty.path "core::fmt::Arguments",
                          "new",
                          [ Value.Integer IntegerKind.Usize 7; Value.Integer IntegerKind.Usize 1 ],
                          []
                        |),
                        [
                          M.borrow (|
                            Pointer.Kind.Ref,
                            M.deref (| M.mk_byte_str_ref 7 [ 2; 62; 32; 192; 1; 10; 0 ] |)
                          |);
                          M.borrow (|
                            Pointer.Kind.Ref,
                                                  ...
                                                  [
                                                    M.read (|
                                                      let~ args :
                                                        ...
                                                        Value.Tuple
                                                          [ M.borrow (| Pointer.Kind.Ref, i |) ] in
                                                      let~ args :
                                                          Ty.apply
                                                            (Ty.path "array")
                                                            [ Value.Integer IntegerKind.Usize 1 ]
