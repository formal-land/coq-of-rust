            ...
            [
              fun γ =>
                ltac:(M.monadic
                  ...
                  let left_val := M.copy (| Ty.apply (Ty.path "&") [] [ Ty.path "u16" ], γ0_0 |) in
                  let right_val := M.copy (| Ty.apply (Ty.path "&") [] [ Ty.path "u16" ], γ0_1 |) in
                  M.match_operator (|
                    Ty.tuple [],
                    M.alloc (| Ty.tuple [], Value.Tuple [] |),
                    [
...
Definition function_table : list (string * PolymorphicFunction.t) :=
  [ ("inline_assembly_register_template_modifiers::main", main) ].
