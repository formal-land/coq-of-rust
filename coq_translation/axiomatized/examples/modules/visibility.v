...
Module my_mod.
  ...
  Module nested.
    ...
    Parameter public_function_in_my_mod : forall `{H : State.Trait},
        M (H := H) unit.
    
    Parameter public_function_in_nested : forall `{H : State.Trait},
        M (H := H) unit.
    
    Parameter public_function_in_super_mod : forall `{H : State.Trait},
        M (H := H) unit.
  End nested.
  ...
  Parameter public_function_in_crate : forall `{H : State.Trait},
      M (H := H) unit.
...
Parameter public_function_in_crate : forall `{H : State.Trait}, M (H := H) unit.
