...
" ] in
        ...
        let* α5 : ltac:(refine (ref (alloc.vec.Vec u8 alloc.alloc.Global))) :=
          borrow numbers in
        let* α6 : ltac:(refine (alloc.vec.Vec u8 alloc.alloc.Global)) :=
          deref α5 in
        let* α7 : ltac:(refine (ref (alloc.vec.Vec u8 alloc.alloc.Global))) :=
          borrow α6 in
