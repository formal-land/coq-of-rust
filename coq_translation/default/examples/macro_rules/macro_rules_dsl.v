...
" ] in
          ...
          let* α5 : ltac:(refine (ref usize)) := borrow val in
    ...
    let* val : ltac:(refine usize) :=
      let* α0 : ltac:(refine usize) := M.alloc 1 in
      let* α1 : ltac:(refine usize) := M.alloc 2 in
      let* α2 : ltac:(refine usize) := BinOp.add α0 α1 in
      let* α3 : ltac:(refine usize) := M.alloc 3 in
      let* α4 : ltac:(refine usize) := M.alloc 4 in
      let* α5 : ltac:(refine usize) := BinOp.div α3 α4 in
      BinOp.mul α2 α5 in
    let* _ : ltac:(refine unit) :=
      let* _ : ltac:(refine unit) :=
        let* α0 : ltac:(refine (array (ref str))) :=
