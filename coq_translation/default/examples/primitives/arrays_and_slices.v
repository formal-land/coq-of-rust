...
Definition analyze_slice
  ...
  let* _ :=
    let* _ :=
      let* α0 :=
        borrow [ "first element of the slice: "; "
" ] (list (ref str)) in
  ...
  let* _ :=
    let* _ :=
      let* α0 := borrow [ "the slice has "; " elements
" ] (list (ref str)) in
      let* α1 := deref α0 (list (ref str)) in
      let* α2 := borrow α1 (list (ref str)) in
      let* α3 := pointer_coercion "Unsize" α2 in
...
Definition main `{H' : State.Trait} : M (H := H') unit :=
  let xs := [ 1; 2; 3; 4; 5 ] in
  let* ys := repeat 0 500 in
  let* _ :=
    let* _ :=
      let* α0 :=
        borrow [ "first element of the array: "; "
" ] (list (ref str)) in
      let* α1 := deref α0 (list (ref str)) in
      let* α2 := borrow α1 (list (ref str)) in
      let* α3 := pointer_coercion "Unsize" α2 in
      let* α4 := borrow xs[0] i32 in
  ...
  let* _ :=
    let* _ :=
      let* α0 :=
        borrow [ "second element of the array: "; "
" ] (list (ref str)) in
      let* α1 := deref α0 (list (ref str)) in
      let* α2 := borrow α1 (list (ref str)) in
      let* α3 := pointer_coercion "Unsize" α2 in
      let* α4 := borrow xs[1] i32 in
      let* α5 := deref α4 i32 in
      let* α6 := borrow α5 i32 in
      let* α7 := core.fmt.rt.Argument::["new_display"] α6 in
      let* α8 := borrow [ α7 ] (list core.fmt.rt.Argument) in
  ...
  let* _ :=
    let* _ :=
      let* α0 :=
        borrow [ "number of elements in array: "; "
" ] (list (ref str)) in
      let* α1 := deref α0 (list (ref str)) in
      let* α2 := borrow α1 (list (ref str)) in
      let* α3 := pointer_coercion "Unsize" α2 in
  ...
  let* _ :=
    let* _ :=
      let* α0 := borrow [ "array occupies "; " bytes
" ] (list (ref str)) in
      let* α1 := deref α0 (list (ref str)) in
      let* α2 := borrow α1 (list (ref str)) in
      let* α3 := pointer_coercion "Unsize" α2 in
  ...
  let* _ :=
    let* _ :=
      let* α0 :=
        borrow [ "borrow the whole array as a slice
" ] (list (ref str)) in
      let* α1 := deref α0 (list (ref str)) in
      let* α2 := borrow α1 (list (ref str)) in
      let* α3 := pointer_coercion "Unsize" α2 in
...
" ]
  ...
  let* _ :=
    ...
    let* α1 :=
      core.ops.index.Index.index
        α0
        {| core.ops.range.Range.start := 1; core.ops.range.Range.end := 4; |} in
    let* α2 := deref α1 (Slice i32) in
    let* α3 := borrow α2 (Slice i32) in
    let* α4 := deref α3 (Slice i32) in
    let* α5 := borrow α4 (Slice i32) in
    arrays_and_slices.analyze_slice α5 in
  let empty_array := [ ] in
  let* _ :=
  ...
  let* α4 :=
    core.iter.traits.collect.IntoIterator.into_iter
      {| core.ops.range.Range.start := 0; core.ops.range.Range.end := α3; |} in
  let* α5 :=
    match α4 with
    | iter =>
      loop
