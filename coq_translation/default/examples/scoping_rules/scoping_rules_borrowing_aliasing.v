...
"
      ...
      let* α10 := deref another_borrow scoping_rules_borrowing_aliasing.Point in
      let* α11 := α10.["y"] in
...
"
      ...
      let* α8 := borrow α7 i32 in
      let* α9 := core.fmt.rt.Argument::["new_display"] α8 in
      let* α10 := deref mutable_borrow scoping_rules_borrowing_aliasing.Point in
      let* α11 := α10.["y"] in
      let* α12 := borrow α11 i32 in
      let* α13 := deref α12 i32 in
      let* α14 := borrow α13 i32 in
      let* α15 := core.fmt.rt.Argument::["new_display"] α14 in
      let* α16 := deref mutable_borrow scoping_rules_borrowing_aliasing.Point in
      let* α17 := α16.["z"] in
