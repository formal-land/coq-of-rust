...
Definition main `{ℋ : State.Trait} : M unit :=
  ...
  let* _ :=
    ...
    (std.collections.hash.map.HashMap _ _ _)::["insert"] α0 α2 α4 in
  let* _ :=
    let* α0 :=
      borrow_mut
        contacts
  ...
  let* _ :=
    ...
    let* α4 := (std.collections.hash.map.HashMap _ _ _)::["get"] α0 α3 in
    match α4 with
...
" ] (list (ref str)) in
  ...
  let* _ :=
    ...
    let* α2 := deref α1 (ref str) in
    let* α3 := borrow α2 (ref str) in
    (std.collections.hash.map.HashMap _ _ _)::["remove"] α0 α3 in
  let* α0 :=
    borrow
      contacts
      (std.collections.hash.map.HashMap
        ...
        (ref str)
        std.collections.hash.map.RandomState) in
  let* α1 := (std.collections.hash.map.HashMap _ _ _)::["iter"] α0 in
