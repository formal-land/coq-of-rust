...
Definition main `{ℋ : State.Trait} : M unit :=
  M.function_body
    (let* _immutable_binding : ltac:(refine i32) := M.alloc 1 in
    let* mutable_binding : ltac:(refine i32) := M.alloc 1 in
...
" ] in
        ...
        let* α5 : ltac:(refine (ref i32)) := borrow mutable_binding in
