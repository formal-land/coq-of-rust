...
Definition main `{ℋ : State.Trait} : M unit :=
  M.function_body
    (let* shadowed_binding : ltac:(refine i32) := M.alloc 1 in
...
" ] in
          ...
          let* α5 : ltac:(refine (ref i32)) := borrow shadowed_binding in
...
" ] in
          ...
          let* α4 : ltac:(refine (ref (slice (ref str)))) :=
            pointer_coercion "Unsize" α3 in
          let* α5 : ltac:(refine (ref (ref str))) := borrow shadowed_binding in
...
" ] in
        ...
        std.io.stdio._print α14 in
      M.alloc tt in
    let* shadowed_binding : ltac:(refine i32) := M.alloc 2 in
    let* _ : ltac:(refine unit) :=
      let* _ : ltac:(refine unit) :=
        let* α0 : ltac:(refine (array (ref str))) :=
