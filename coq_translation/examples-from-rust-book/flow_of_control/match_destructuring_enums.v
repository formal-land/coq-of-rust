  ...
  | Color.RGB (r, g, b) =>
    _crate.io._print
      (_crate.fmt.ImplArguments.new_v1
        [ "Red: "; ", green: "; ", and blue: "; "!\n" ]
        [
          _crate.fmt.ImplArgumentV1.new_display r;
          _crate.fmt.ImplArgumentV1.new_display g;
          _crate.fmt.ImplArgumentV1.new_display b
        ]) ;;
    tt
  | Color.HSV (h, s, v) =>
    _crate.io._print
      (_crate.fmt.ImplArguments.new_v1
        ...
        [
          _crate.fmt.ImplArgumentV1.new_display h;
          _crate.fmt.ImplArgumentV1.new_display s;
          _crate.fmt.ImplArgumentV1.new_display v
        ]) ;;
    tt
  | Color.HSL (h, s, l) =>
    _crate.io._print
      (_crate.fmt.ImplArguments.new_v1
        ...
        [
          _crate.fmt.ImplArgumentV1.new_display h;
          _crate.fmt.ImplArgumentV1.new_display s;
          _crate.fmt.ImplArgumentV1.new_display l
        ]) ;;
    tt
  | Color.CMY (c, m, y) =>
    _crate.io._print
      (_crate.fmt.ImplArguments.new_v1
        ...
        [
          ...
          _crate.fmt.ImplArgumentV1.new_display m;
    ...
    _crate.io._print
      (_crate.fmt.ImplArguments.new_v1
        ...
        [
          ...
          _crate.fmt.ImplArgumentV1.new_display m;
          _crate.fmt.ImplArgumentV1.new_display y;
          _crate.fmt.ImplArgumentV1.new_display k
        ]) ;;
    tt
  end.
