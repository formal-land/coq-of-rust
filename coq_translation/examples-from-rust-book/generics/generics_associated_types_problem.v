...
Module Contains.
  ...
  Global Instance Method_contains {A B Self : Set} `{Class A B Self}
    : Method "contains" _ := {|
    method := contains;
  |}.
  Global Instance Method_first {A B Self : Set} `{Class A B Self}
    : Method "first" _ := {|
    method := first;
  |}.
  Global Instance Method_last {A B Self : Set} `{Class A B Self}
    : Method "last" _ := {|
    method := last;
  |}.
End Contains.
