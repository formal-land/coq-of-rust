...
Module Impl_core_fmt_Debug_for_into_Number.
  ...
  Parameter debug_struct_field1_finish : forall `{H : State.Trait}, core.fmt.Formatter -> string -> 
    string -> i32 -> 
    M (H := H) core.fmt.Result.
  
  Global Instance Deb_debug_struct_field1_finish `{H : State.Trait} : Notation.DoubleColon
