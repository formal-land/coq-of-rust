...
Definition create_fn `{State.Trait} (_ : unit) : M OpaqueDef :=
...
Definition create_fnmut `{State.Trait} (_ : unit) : M OpaqueDef :=
...
Definition create_fnonce `{State.Trait} (_ : unit) : M OpaqueDef :=
