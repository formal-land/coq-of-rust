...
Module flipper.
  ...
  Module Impl_Root_ink_reflect_DispatchableConstructorInfo_for_Flipper.
    ...
    Definition IS_RESULT (_ : unit) :=
      Root.ink.reflect.ConstructorOutput.IS_RESULT.
    ...
    Definition PAYABLE (_ : unit) := false.
    ...
    Definition SELECTOR (_ : unit) := [ 155; 174; 157; 94 ].
  ...
  Module Impl_Root_ink_reflect_DispatchableConstructorInfo_for_Flipper_2.
    ...
    Definition SELECTOR (_ : unit) := [ 97; 239; 126; 62 ].
    ...
    Definition LABEL (_ : unit) := "new_default".
  ...
  Module Impl_Root_ink_reflect_DispatchableMessageInfo_for_Flipper.
    ...
    Definition SELECTOR (_ : unit) := [ 99; 58; 165; 81 ].
    ...
    Definition MUTATES (_ : unit) := true.
...
(* unit -> ImplFlipper.Self -> unit ->                                           bool *)
  ...
  Module Impl_Root_ink_reflect_DispatchableMessageInfo_for_Flipper_2. (* Had to add _2 here *)
    ...
    Definition SELECTOR (_ : unit) := [ 47; 134; 91; 217 ].
    ...
    Definition MUTATES (_ : unit) := false.
  ...
  Module Impl__crate_clone_Clone_for_FlipperRef.
    ...
    Definition clone (self : ref Self) : FlipperRef :=
      {| FlipperRef.inner := _crate.clone.Clone.clone self.["inner"]; |}.
  ...
  Module ImplFlipperRef.
    ...
    Definition flip (self : mut_ref Self) :=
      self.["try_flip"].["unwrap_or_else"]
        (fun error =>
          _crate.panicking.panic_fmt
            (format_arguments::["new_v1"]
              [ "encountered error while calling Flipper::flip: " ]
              [ format_argument::["new_debug"] error ])).
    ...
    Definition get (self : ref Self) : bool :=
      self.["try_get"].["unwrap_or_else"]
        (fun error =>
          _crate.panicking.panic_fmt
            (format_arguments::["new_v1"]
              [ "encountered error while calling Flipper::get: " ]
              [ format_argument::["new_debug"] error ])).
  ...
  Module Impl_Root_ink_ToAccountId_for_FlipperRef.
    ...
    Definition to_account_id (self : ref Self) : AccountId :=
      Root.ink.ToAccountId.to_account_id self.["inner"].
  ...
  Module Impl_Root_core_convert_AsRef_for_FlipperRef.
    ...
    Definition as_ref (self : ref Self) : ref AccountId :=
      Root.core.convert.AsRef.as_ref self.["inner"].
  ...
  Module Impl_Root_core_convert_AsMut_for_FlipperRef.
    ...
    Definition as_mut (self : mut_ref Self) : mut_ref AccountId :=
      Root.core.convert.AsMut.as_mut self.["inner"].
...
Module Impl_Root_ink_storage_traits_StorageKey_for_Flipper.
  ...
  Definition KEY (_ : unit) := Root.ink.storage.traits.StorageKey.KEY.
...
Module Impl_Root_ink_storage_traits_Storable_for_Flipper.
  ...
  Definition encode (self : ref Self) (__dest : mut_ref __ink_O) :=
    match self with
    | {| Flipper.value := __binding_0; |} =>
      Root.ink.storage.traits.Storable.encode __binding_0 __dest ;;
      tt
    end.
...
Module Impl_Root_ink_reflect_ContractName_for_Flipper.
  ...
  Definition NAME (_ : unit) := "Flipper".
...
Module Impl_Root_ink_reflect_DispatchableMessageInfo_for_Flipper.
  ...
  Definition CALLABLE (_ : unit) := fun storage _ => Flipper::["flip"] storage.
...
Definition CONSTRUCTOR_0 : list Root.core.primitive.u8 :=
  Root.ink.reflect.DispatchableConstructorInfo.SELECTOR.
...
Module Impl_Root_ink_reflect_ExecuteDispatchable_for___ink_ConstructorDecoder.
  ...
  Definition execute_dispatchable
    ...
    | ImplSelf.Constructor0.Build_t input =>
      ...
      let output_result :=
        Root.ink.reflect.ConstructorOutput.as_result output_value in
      if
        (let_if Root.core.result.Result.Ok contract := output_result.["as_ref"]
        : bool)
      then
        Root.ink.env.set_contract_storage
          Root.ink.storage.traits.StorageKey.KEY
          contract ;;
        tt
      else
        tt ;;
...
Definition MESSAGE_0 : list Root.core.primitive.u8 :=
  Root.ink.reflect.DispatchableMessageInfo.SELECTOR.
  ...
  Definition execute_dispatchable
    ...
    let contract :=
      Root.core.mem.ManuallyDrop::["new"]
        match Root.ink.env.get_contract_storage key with
        ...
        | Root.core.result.Result.Ok Root.core.option.Option.None =>
          _crate.panicking.panic_fmt
            (format_arguments::["new_const"] [ "storage entry was empty" ])
    ...
    | ImplSelf.Message0.Build_t input =>
      if
        (((false.["or"]
            ...
            let message_1 := Root.ink.reflect.DispatchableMessageInfo.PAYABLE in
            message_1).["andb"]
      ...
      then
        ...
        tt ;;
      let result :=
        Root.ink.reflect.DispatchableMessageInfo.CALLABLE contract input in
      let is_reverted :=
        (_crate.result_info.IsResultType
              Root.ink.reflect.DispatchableMessageInfo.Output)::["VALUE"].["andb"]
          (_crate.result_info.IsResultErr.Build_t result).["value"] in
      if (is_reverted.["not"] : bool) then
        push_contract
          contract
          Root.ink.reflect.DispatchableMessageInfo.MUTATES ;;
        tt
      else
        tt ;;
      Root.ink.env.return_value
        (Root.ink.env.ReturnFlags::["new_with_reverted"] is_reverted)
        (Root.ink.MessageResult::["Ok"] result)
...
Definition _ : Root.ink.codegen.utils.IsSameType Flipper :=
  (Root.ink.codegen.utils.IsSameType Flipper)::["new"] tt.
...
Module ImplFlipper.
  ...
  Definition flip (self : mut_ref Self) :=
    assign self.["value"] self.["value"].["not"] ;;
    tt.
...
Definition _ : unit :=
  Root.ink.codegen.utils.consume_type tt ;;
  Root.ink.codegen.utils.consume_type tt ;;
  tt.
...
Module Impl_Root_scale_Encode_for_CallBuilder.
  ...
  Definition encode_to
    ...
    Root.scale.Encode.encode_to self.["account_id"] __codec_dest_edqy.
  ...
  Definition encode
    ...
    Root.scale.Encode.encode self.["account_id"].
  ...
  Definition using_encoded (self : ref Self) (f : F) : R :=
    Root.scale.Encode.using_encoded self.["account_id"] f.
...
Module Impl__crate_hash_Hash_for_CallBuilder.
  ...
  Definition hash (self : ref Self) (state : mut_ref __H) : unit :=
    _crate.hash.Hash.hash self.["account_id"] state.
...
Module Impl__crate_clone_Clone_for_CallBuilder.
  ...
  Definition clone (self : ref Self) : CallBuilder :=
    {| CallBuilder.account_id := _crate.clone.Clone.clone self.["account_id"];
    |}.
...
Module Impl_Root_ink_ToAccountId_for_CallBuilder.
  ...
  Definition to_account_id (self : ref Self) : AccountId :=
    Root.core.clone.Clone.clone self.["account_id"].
...
Module Impl_Root_core_convert_AsRef_for_CallBuilder.
  ...
  Definition as_ref (self : ref Self) : ref AccountId := self.["account_id"].
...
Module Impl_Root_scale_Encode_for_FlipperRef.
  ...
  Definition encode_to
      (self : ref Self)
      (__codec_dest_edqy : mut_ref __CodecOutputEdqy) :=
    Root.scale.Encode.encode_to self.["inner"] __codec_dest_edqy.
  ...
  Definition encode
      (self : ref Self)
      : Root.scale.alloc.vec.Vec Root.core.primitive.u8 :=
    Root.scale.Encode.encode self.["inner"].
  ...
  Definition using_encoded (self : ref Self) (f : F) : R :=
    Root.scale.Encode.using_encoded self.["inner"] f.
...
Module
  ...
  Definition IS_RESULT (_ : unit) := true.
...
Module Impl_Root_ink_codegen_TraitCallBuilder_for_FlipperRef.
  ...
  Definition call (self : ref Self) : ref ImplSelf.Builder := self.["inner"].
    ...
    Root.ink.metadata.layout.Layout.Root
      (Root.ink.metadata.layout.RootLayout::["new"]
        ...
        (Root.ink.storage.traits.StorageLayout.layout
          Root.ink.storage.traits.StorageKey.KEY)) in
    ...
    (fun error =>
      _crate.panicking.panic_fmt
        (format_arguments::["new_v1"]
          ...
          [ format_argument::["new_display"] error ])) ;;
