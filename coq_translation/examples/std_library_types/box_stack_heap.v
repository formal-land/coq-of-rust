...
Module Impl_core_fmt_Debug_for_box_stack_heap_Point.
  ...
  Parameter debug_struct_field2_finish : forall `{H : State.Trait}, core.fmt.Formatter -> string -> 
    string -> f64 -> 
    string -> f64 -> 
    M (H := H) core.fmt.Result.
  
  Global Instance Deb_debug_struct_field2_finish `{H : State.Trait} : Notation.DoubleColon
