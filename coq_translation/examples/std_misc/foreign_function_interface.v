...
Module Impl_core_fmt_Debug_for_foreign_function_interface_Complex.
  ...
  Parameter struct_parameter_for_fmt : forall `{H : State.Trait}, core.fmt.Formatter -> string -> 
    string -> f32 -> 
    string -> f32 -> 
    M (H := H) core.fmt.Result.
  
  Global Instance Deb_struct_parameter_for_fmt `{H : State.Trait} : Notation.DoubleColon
